...
The SAN framework strongly emphasizes relational rather than absolute measures of neural activity. While specific correlates like crests of beta/gamma power or raw voltage are mentioned as possibilities in the initial query, the user-provided sources emphasize the broader concept of oscillations, [[phase-wave-differentials|phase wave differentials]], and their synchronization as underlying the timing and nature of conscious experience⁸. Reality is rendered in the phase variances of brainwave activity.

[[phase-wave-differentials|Phase wave differentials]], which are changes from the baseline [[tonic-oscillation|tonic oscillation]], are described as the units of neural rendering²⁴. Consciousness arises when these become dominant rhythms that persist spatially or temporally²⁰. Brainwave synchrony between regions is considered important for objects to become conscious²⁴, as synchrony helps create a temporal alignment between oscillating signals²⁴. This aligns with the SAN book's highlighting of "[[phase-wave-differentials|phase wave differentials]]" and "phase relationships across neural networks". Wavefront collisions and moments of significant phase synchronization across distributed neural arrays could serve as critical events defining a discrete "refresh" or instantiation of the [[perceptual-screen|perceptual screen]].
...
-   **Correlate:** Phasic High-Frequency Waves / Render Changes\
    **Proposed Mechanism:** Discrete rendering events carrying perceptual details; changes from baseline [[tonic-oscillation|tonic oscillation]].\
    **Key Oscillatory Bands / Features:** High-frequency (e.g., Gamma); [[phase-wave-differentials|Phase Wave Differentials]].\
    ...
    **Key Oscillatory Bands / Features:** Low-frequency (e.g., Alpha/Theta); high-magnitude [[tonic-oscillation|tonic oscillation]].\
    **Relevant SAN Concepts & Terms:** NAPOT, Ground of Being, Canvas of Consciousness, [[entification]].

    -   **Correlate:** [[phase-wave-differentials|Phase Wave Differentials]] / Phase Variances / Brainwave Synchrony\
    ...
    **Relevant SAN Concepts & Terms:** NAPOT, Oscillatory Physics, [[phase-wave-differentials|Phase Wave Differentials]], Brainwave Synchrony.
    ...
    **Proposed Mechanism:** Conscious experience arises when [[phase-wave-differentials|phase wave differentials]] become dominant and persist.\
...
[[micah-blumberg|Micah Blumberg]]'s [[super-information-theory|Super Information Theory (SIT)]] posits that "quantum coherence" drives phenomena including consciousness, explaining cognitive emergence and neural synchronization as "states of predictive synchronization". SIT's "coherence--decoherence informational duality" and "local time-density (ρt​)" could offer a fundamental physical basis for NAPOT's oscillatory dynamics and timing. Information is seen as an "active, evolutionary [[attractor]] guiding...neural synchronization, cognitive emergence" , aligning with NAPOT's [[attractor]] states and NDCA's interpretation of these states.
...
The SAN framework, significantly clarified by the user-provided information, offers a detailed model for the [[perceptual-screen|perceptual screen]].
...
-   **Multi-Scale Pattern Processing:** The ideas of patterns gaining dimensionality upon transmission¹⁴, neurons as projectors¹⁴, and [[dendritic-coincidence-detection|dendritic coincidence detection]] of phase signals³ ,⁴⁰ provide a richer view of how information is processed and transformed across neural arrays.
...
-   **Mechanisms of DPWDR Dominance and Persistence:** How do certain [[phase-wave-differentials|phase wave differentials]] become "dominant" and achieve the spatial/temporal persistence²⁰ necessary to form conscious objects? What are the specific dynamics of competition and stabilization among oscillatory patterns?
...
Section 6: Conclusion: Towards a Comprehensive Model of the [[perceptual-screen|Perceptual Screen]]
-----------------------------------------------------------------------------

The [[gh-a0206z|Self]]-Aware Networks theory, significantly illuminated by the detailed information provided, offers an increasingly comprehensive framework for understanding the "[[perceptual-screen|perceptual screen]]."

### 6.1. Summary of Key Findings on Screen Timing and Shape Encoding

The timing of the [[perceptual-screen|perceptual screen]]'s instantiations arises from "render changes"¹⁰---phasic, high-frequency oscillatory patterns (qualia)¹²---appearing on a persistent "canvas of consciousness" formed by low-frequency, high-magnitude tonic oscillations¹². The critical timing elements are "[[phase-wave-differentials|phase wave differentials]]"²⁴ and widespread "brainwave synchrony"²⁴, rather than simple voltage crests. Consciousness is a "temporally active loop"²⁸ with rapid rendering³⁰.
...
The [[gh-a0206z|Self]]-Aware Networks theory, with this enhanced level of detail, moves closer to providing a generative model of first-person experience, offering a unique and increasingly specified perspective on the mind's construction of reality.

## Source Provenance

Original source lineage:

- Source file: `09san.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/09san.md
