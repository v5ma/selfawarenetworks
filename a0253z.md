...
Quantum Gradient Time Crystal Dilation talks about mass as a time crystal but it connects neural function, the expansion & contraction of neuronal membrane during & after the action potential (and before the expansion of the dendrite) means the neuron is literally warping spacetime. The effect of the time crystal is magnified by density and it dissipates with distance (time dilation)
