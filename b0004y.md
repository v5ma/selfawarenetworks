...
My conjecture about why LTP Long term memory can form immediately without seeing new protein synthesis is because essentially the same memory oscillates repeatedly in neural firing activity until a new neural pattern replaces it.
