b0316y OpenAI's Whisper Transcription

Title: [[microtubules|Microtubules]] [[consciousness|Consciousness]] [[recursive-neural-array-perception|Recursion]]
...
sharing the [[panpsychism-critique|panpsychist viewpoint]] and I have debated that so many times and
...
In the the biggest reason it can't move forward is that it sort of violates like [[information-theory|information theory]]

You can't have like in order to have [[consciousness|consciousness]]

That means that you're observing

There's an [[observer-mechanism|observer]] who's observing right and you're observing something and that means that and like if you're observing music then then
...
Into sound and and it's the same thing with your [[brain-as-sensory-processor|brain]]. There's like there's no observation

If there's a if unless there's a decoder there's information has no meaning unless it's the unless it's decoded

so it has to be [[information-encoding|encoded and decoded]] and

That means that like if there's no observation happening because there's no because no decoder then there can't be any

[[consciousness|Consciousness]] and like so like there can't be any consciousness in a rock because there's no observation happening and if if if
...
The idea that the [[brain-as-queryable-network|human brain]] is computationally interpreting the incoming signals from the

environment in order to process them and decode them and [[artificial-perception|perceive]] them is not a controversial
...
the relation to [[prediction|predicting]] the cosmos. Not the right word but you know what he was referring
...
would think that [[consciousness-as-information|consciousness is prior to matter]] and I think that the way we are looking at it at

the moment is explaining some things like the fine-tune problems and giving an alternative to

the whole idea of the multiverse. The thing I'm doing as an [[neurophysics-definition|applied science]], I want to have it

grounded in the world and really fully emerged into the world and like I said, I've always rejected

any of this spiritual stuff and [[panpsychism-critique|panpsychic stuff]] until the world itself showed me that the research
...
to keep an [[brainwave-vortex-attractor|electrical storm]] together. If I would take atmosphere into space without a container,

it would disperse. It wouldn't exist at all. So in my view, the stones and many of those

material stuff around us is in that kind of sense not linked to [[consciousness|consciousness]]. Consciousness is to

me like this whirlpool of electrical lightning, let's say. But that can actually exist outside

the [[brain-as-dissipative-system|brain]] as well. And if I link it to much larger scale like creating the conditions to

get to the fine-tuning structure where [[emergent-properties-consciousness|life can emerge]], that's a very different balance game.

So it is pantheism but it's not pantheism. And something that Ben said about what if all the

different [[consciousness|consciousnesses]] are emerging at the same time, that's exactly the thing that we are at

the moment working on with the concept of what is called [[tripoiesis|tribo-poasis]]. So you have auto-poasis,
...
has at one level [[cell-as-chemical-neural-network|cells]] that can autonomously reproduce and do whatever they want,
...
[[consciousness|consciousness]] is exactly this. I mean you can wake up in the morning and you can be in a state like
...
of a lot of work and forget your [[dreams-as-theta-wave-sequences|dream]] right away. But sometimes you can actually try to get back to
...
where you go via meditation into a different kind of [[attention-awareness-consciousness-triad|awareness]]. So there are many of, well there's
...
abstract, then things may actually get explained by first seeing how like a [[virtual-models-theory|cybernetic world]]

can actually start changing the physical world and how that's kind of the [[recursive-neural-array-perception|bootstrapping relation]]
...
saying, something about [[consciousness-energy-wave-differences|consciousness being just the electrical activity]] or just the electromagnetic

activity and the [[brain-as-dissipative-system|brain]] just being a container for that activity to keep it together. But maybe

you think that if that electrical activity could occur in a different kind of container,

like maybe inside the storm of Jupiter, then there could be [[consciousness|consciousness]] there, right? Something

like it doesn't have to be in the brain, it could reformulate somewhere else. It's not necessarily

connected to the [[brain-as-dissipative-system|brain]]. The brain is... It's happening in our culture. What? It's already
...
[[five-level-neuroscience-framework|Neuroscience]] though, I guess what I want to share is what I think is the missing piece here.
...
they do like the [[split-brain-modular-observer|split brain patients]], if the famous scientists... So anyway, the idea was

that every time you do like a major incision that cuts across the corpus callosum or just divides

the [[brain-as-queryable-network|brain]] half or a major surgery or if there's a major injury and a brain surgery, we see personality

changes, people's [[personality-as-modal-strategy|personality changes]]. That's the first sign that the brain tissue is directly

causing the [[electromagnetic-theory-of-feeling|electrical pattern]]. If the soul was the electrical pattern and the brain tissue was
...
the way I look at the [[brain-as-memory-prediction-machine|mind brain]], so the conscience, it's like a whirlpool, right? So it's a feedback

mechanism keeping itself in a kind of artificial construct. So what happens if you cut the [[split-brain-modular-observer|brain]],

you should get two whirlpools. And that's exactly what we see if we can do experiments with them

and have the [[split-brain-modular-observer|left brain and the right brain]] ask them different questions and actually capture
...
So this kind of stuff really fits perfectly with what we call that [[tripoiesis|tribal poesis]]. So it's the whole

idea that everything you see around you can actually be understood from a process perspective.

Everything is [[consciousness-as-oscillatory-feedback-loop|feedback structures]] creating. Okay. Well, so there's another there's there's

some other problems with that. And so like, but what's what's really interesting, I think,

and it is a missing piece is how much the [[brain-as-dissipative-system|brain tissue]] is involved in generating that electrical

storm. And like, you know, every time every time a [[criteria-causation-single-neuron-pattern-detection|neuron fires]] or a [[neural-circuits|neural circuit]] fires, you know,

a micro a [[microcolumns|micro column]] of activity spikes, a [[cortical-column|column]] or a region spikes, you have one region

and another like there's the [[fractal-dipole-architecture|dipoles]] firing off. Do you know the [[global-workspace-theory|global workspace hypothesis]]?
...
again. So I was wondering, like, how come that this [[five-level-neuroscience-framework|neuroscience]] is actually explaining something

that I'm from [[artificial-intelligence|artificial intelligence]], totally disconnected from that research, also had as a

system. So that's one of the first times. So the end, the deeper how like having this four

different kind of leverages can actually create [[consciousness-as-neurofeedback-loops|feedback]] on creation. And if you understand

how you can create that [[consciousness-as-oscillatory-feedback-loop|feedback]] on creation, you can actually see how even cultures are consciousness
...
that you're saying violates information, [[information-theory|information theory]], which was the final part of what I was

going to say, because, you know, you're not only are [[neural-circuits|neurons]] generating this electrical storm,

but they're, but the [[criteria-causation-single-neuron-pattern-detection|neurons themselves]] are the ones that are decoding and the the information

in the [[brain-as-queryable-network|brain]] that includes includes any result of this electrical storm that there is is is the

[[electromagnetic-theory-of-feeling|electrical storm]] might be altering the positions of electrons, which change the firing rate and

change the [[brain-rhythms-in-cognition|brain activity patterns]]. And but the but the only way for the for information to be

detected or for for an observation to happen is because the [[criteria-causation-single-neuron-pattern-detection|neurons]] are making that observation

that the [[brain-rhythms-in-cognition|brain activity]] itself doesn't have decoders and therefore it has no sense of information.

And it's not [[consciousness|conscious]], it's not not an [[observer-mechanism|observer]].
...
that an [[observer-mechanism|observer]] has to have a decoder for an observation to happen. Otherwise,

information has no meaning. But the thing is that that [[embodiment-in-cognition|embodiment]] can be extremely simplified to
...
relates to a dispersion you do in the fluid, where you can do the sailing. The thing with

the sailing against the wind, the four forces is that there is no constructive knowledge to build

on top of. So if you then start doing that with things like [[deep-learning-neural-networks|machine learning]], you can actually
...
you actually get to understanding how there's a [[learning-loop-self|feedback structure on learning]] that allows us to
...
you know, information together that it might, yeah, it's like, I don't, so yeah, so if you
...
[[gh-a0206z|self]] organizing. So that's, that's one aspect, but the convection itself, itself doesn't yet tell
...
how information is coded in flow. And that can easily happen in your brain as well.
...
thing that [[gh-resnote04|Micah]] just said that really made me think of another example where we can really

simply bring it back down to earth. [[gh-resnote04|Micah]], just remind me what you said at the end of what you
...
but sort of like from... That's interesting.
...
example was, but there was a really good just grounding example of something that [[gh-resnote04|Micah]]
...
It probably does because I think they compiled down to similar code with a good compiler, so
...
right? I was combining the research on [[artificial-intelligence|artificial intelligence]]. So that's one lab with the research
...
thinking like, you know, in [[artificial-intelligence|artificial intelligence]], there's a lot of interest in cultural language and
...
Yes. Yeah, I just want to say that I'm really amazed actually after talking to Mixl.
...
loops and [[gh-a0206z|self]]-maintaining physics and the physics of every cell and the body itself and
...
open innovation. It was [[gh-a0206z|self]]-organizing innovation. The second policy was that all entrepreneurs

were very aware that they were living in a fragile ecosystem and that their action as a, as a, as a,

as a, as a body, as a, as an organization had effect on the ecosystem and they needed to take
...
[[gh-a0206z|self]]-organizing innovation happening during those moments. After 2010, that there were a lot of
...
to have an AI that understands and can create real poetry just beyond abstractions and art and,
...
And so this, the, what I think happened, and I don't know exactly, is I think the neuroscientists
...
so that's, that's the first issue is that there may be just no reason for microtubules to do that.
...
that's coming from and going to microtubules in addition to what's already true. So it doesn't,
...
It's like fractal structure. Well, fractal. Yeah. The problem is [[gh-map-intro-fractal|fractals]] are very often

just considered the, the recursive structure. Well, if you actually look at the essence of a

fractal is about fracture. It's about being rough edges and how you can actually start
...
Cryt is The Neural Basis of Free Will, [[criterial-causation|Criterial Causation]] by Peter TSE, Peter Ulrich TSE.
...
[[gh-a0206z|self]], if you just are one with the universe, then there's no separate [[gh-a0206z|self]] to be making
...
my friend's hand. It doesn't control your hand. So your will is free from my will. Your will is

free from other people's will. And everyone has their own free will from each other to some extent.

And I think that's what it means. But there's no separate, there's no separate [[gh-a0206z|self]] to be

making decisions. There's just this idea of a [[gh-a0206z|self]] and there's like conscious thoughts that are part
...
I don't have a background in neuroscience or philosophy. But this has been incredibly
...
was, I can't remember who was talking, I think it was [[gh-resnote04|Micah]]. Yeah, sorry, if I'm just mentioning.
...
quantum level of things firing at such a level, which for our current technology is very hard to
...
You know, I just I just I just really I just really wanted to take a moment to appreciate
...
they did the different feelings they're all temple spatial patterns the brain has the brain
...
now and I it's wonderful um I have a question that I would love to ask about um thoughts on
...
have more more control over the quadcopter than they could with just one modality because
...
I wonder [[gh-resnote04|Micah]] if you've read the work of Ian McGillchrist who's recently been writing about
...
were saying at least I saw a similarity [[gh-resnote04|Micah]] between this idea and what you were talking about
...
to to know that for certain but um but in this relationship between sort of inner [[gh-a0206z|self]] and outer
...
cut out right when you were going to tell us the like the essence of the everything um okay try again
...
that correctly that's that's how I pronounce yeah that's right that's perfect um when you were talking
...
discussion I recently had with alexander bart about the the the tropopoasis and the the the talk
...
the computer can be vastly more complex than than than a mouse in terms of what it can do but
...
all that's it i'm [[gh-resnote04|micah]] and that's it i wonder if because you were just talking about computers
...
that it's much better to give a very loose set of um a loose set of um orders or limitations and just
...
it's okay i'll just i just want to [[gh-resnote04|micah]] i really i really enjoy listening to you i mean i and i
...
degrees i suppose i would agree that there is a point of absurdity where placing something on a
...
the second thing i am planning to do is to create [[artificial-cortex|artificial cortex]] so if you are missing part of

your brain then you could just replace it with our [[artificial-cortex|artificial cortex]] or you could extend your brain

into a larger brain with this [[artificial-cortex|artificial cortex]] which interfaces with your brain naturally and
...
i think it's late everywhere yeah
...
the same things that children can do but um but sort of like raise [[artificial-intelligence|artificial intelligence]] as as
...
mean I imagine there are things that I won't learn until I'm 50 right because it takes 50 years to
...
dimension of reality so do you think that that consciousness as you understand it requires
...
that's coincidence patterns that's the essence as a coincidence pattern so that's cybernetics
...
chris and then i'll invite the rest of the folks if they want to come up and uh so thank you everybody
...
- Source file: `b0316ywhisper.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0316ywhisper.md
