...
I have to I say this idea ranks up there with open water and near a link it is yeah the super cool another project that exists is electrical impedance tomography combined with deep learning, so if you look up EIT and deep learning. That is another potential world-changing medical imaging technology, so now we have four right?
...
Now the there's there are arguments and evidence that the single neurons are self-regulating and that's not that it's not controversial at all and there's also arguments and evidence that that single neurons are actually being regulated by other neurons. And that's also not controversial both things are happening and this is you know in the in yeah,
...
Okay, okay, but look here's the you know, the problem the problem is you're defining a situation where it's not possible to have artificial general intelligence without a body but then but but then when you're talking about like what the body is for you're saying well, it's it's the the it's for you're saying the artificial generator intelligence that's only artificial intelligence that qualifies as artificial.

05:03:13

In general intelligence for you is artificial intelligence, why am I stumbling artificial AGI just called AGI it it is the the only kind of AGI that qualifies as AGI for you is the kind that understands the human condition in a spatial way in a body way. And I'm not talking about the human condition.
...
Well, I mean there's I mean that so there in a sense there's like that there's a location of where the stuff is right but this stuff doesn't have to be connected to a self right is it could just be yeah, this is the you could there's just a location.
...
We're forming multidimensional representations one set of dimensions is for ourself other sets of dimensions are for other things. And our brain is able to synthesize that into a self because it needs to because it's controlling a single body. And a machine with a multidimensional space that exists in it could have multiple bodies.
...
Was a clear delineation between what is controllable and what is not controlable. Does that make sense? All right. I hear what you're saying, but but then but the main point is. I'm just differing on the on the on the idea that you need a self in order to have AGI.

05:18:03

I don't think you do. That was my point. I think probably abstract my point a little bit to say you need a delineation between self whether that's a multi-part self or a single part self and that can be controlled and what is not controlable what exists outside the self.
...
Are they form a sense of self that's even if you're not controlling the weather you're not controlling the stark stock market, oh I the bottles that the models that are formed are kind of mini cells just being able to execute / think inherently means there's a self because. Your computing somewhere you are computing whether you think you're whether you're a human or a hard drive somewhere, that's a that that is an entity that's a self it belongs to a partner belongs to a greater apart or a better hole, sorry.

05:23:36

Or at least I would I would add to a grant to saying it could be a self-worthy at least be some sort of machine that is is that basically takes on the character the character of another self and be able to and can be able to say that it is represent is seeking to embody and represent that self for a time something like that.
...
Yeah, thanks Mike I enjoyed the conversation and I am heading to bed. I enjoyed the you know I enjoyed the comment I enjoyed the comment your thoughts today Kyle and I I enjoyed the other guys thoughts a little less it was a little bit difficult to deal with but still still a smart fellow and and Micah I think we every time that we meet, you know, we and to Kyle too every time we meet we sort of learn a little bit more about what the others doing and it's a it's a sort of a long winding road but I really appreciate you know, we're some of the few people on here that that actually stick it out with each other and sort of have the patience to sort of, you know iterate with the other and sort of imag.
