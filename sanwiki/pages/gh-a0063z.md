...
This note is from Oct 5, 2012, 9:04 AM
 (hebb, [dendrite](dendrite.md), causation, graphics, qualia, category, theory) Neural Darwinism
...
[Micah Blumberg](micah-blumberg.md) Okay so think about this twice before you answer. Blind people who can do echolocation do not render objects in color, they don't know light from dark, but they still have spatial...See More
...
Linus Torvalds puts it, “C is the only sane [choice](choice.md)”.
http://crypto.stanford.edu/~blynn/c/ch01.html
C Craft - Chapter 1. [Introduction](gh-a0403z.md)
crypto.stanford.edu
This is my favourite statement froma talk Rob Pike gave in 2001. Despite its a...See More
21 hours ago · Like

[Micah Blumberg](micah-blumberg.md) "Echolocation is less computationally expensive than normal vision." how do you figure?
21 hours ago · Like

Juan Carlos Kuri Pinto Because echolocation has less bandwidth than normal vision.
21 hours ago · Like

[Micah Blumberg](micah-blumberg.md) Less bandwidth means your getting less information, less information means lower resolution, lower resolution means it's harder to figure out, harder to figure out means more computational resources.
21 hours ago · Like · 1

[Micah Blumberg](micah-blumberg.md) A high resolution Ipad book costs the less computation resources for the brain reading it, because it's easier to read
21 hours ago · Like · 1
...
[Micah Blumberg](micah-blumberg.md) But you still have to put the intensity frequency and time in the right location spatially, with a lot less information about where things are, so there is a lot of figuring out space with little information to go on
21 hours ago · Like · 1

[Micah Blumberg](micah-blumberg.md) if echolocation is easier than seeing, then you should pick it up, are you reaching for a blindfold to learn it?
21 hours ago · Like · 1
...
[Micah Blumberg](micah-blumberg.md) The brain's efficiency making pattern will overtime take any computationally intense process and reduce it to the most energy efficient process. How can a computer reduce it's own computationally intense process into the simplest possible procedure that is computationally minimal?
21 hours ago · Like

[Micah Blumberg](micah-blumberg.md) How does intelligence rewrite it's code path to solve for the most efficient logic?
21 hours ago · Like
...
[Micah Blumberg](micah-blumberg.md) Hebbian learning is the programming challenge then, has anyone done it?
21 hours ago · Like

Juan Carlos Kuri Pinto I'm programming exactly that. And I've been doing it for many years. Hehe
21 hours ago · Unlike · 1

[Micah Blumberg](micah-blumberg.md) cells that fire together wire together, this is the message to describe in category theory-haskell, wait you've been doing that for years? with what programming languages?
21 hours ago · Like
...
[Micah Blumberg](micah-blumberg.md) http://en.wikibooks.org/wiki/Artificial_Neural_Networks/Hebbian_Learning
...
[Micah Blumberg](micah-blumberg.md) imagine that only one thin line of your vision is rendered in each 1/1000 thousands of a second, way less computational than rendering the whole image at once
21 hours ago · Like
...
[Micah Blumberg](micah-blumberg.md) You say selection, I say reaction
21 hours ago · Like

[Micah Blumberg](micah-blumberg.md) every cell is reactive, cells do not select, they do not choose, and they do not act, they react
21 hours ago · Like

Juan Carlos Kuri Pinto Neural networks can actually select.
21 hours ago · Like

[Micah Blumberg](micah-blumberg.md) maybe artificial ones, imagine you have three branching choices, a hotdog, or a protein shake, or eat later when you can get a third option. which one do you choose? why do you cho...See More
21 hours ago · Like · 1
...
[Micah Blumberg](micah-blumberg.md) I seem to have selected as an effect to which the cause was reason, so in retrospect (my [choice](choice.md) A) -> (reaction to reason B)
21 hours ago · Like

[Micah Blumberg](micah-blumberg.md) that's why you say selection, and I say reaction
21 hours ago · Like

[Micah Blumberg](micah-blumberg.md) does it make a difference, to you, in how you think about programming Hebbian learning, to program thinking about the whole program as a sequence of reactions instead the inclusion of points where selection is done?
21 hours ago · Like
...
or you could store the timeline locally, on the actual hierarchy, like a [dendrite](dendrite.md). each node in the hierarchy has nodes that count the frequency in which they become part of a representation identified by the upper level or lower level.
...
[Micah Blumberg](micah-blumberg.md) The top result then gets associated with newly added SDR's. Driving a new top result that is a convergence between what was previously learned, and what is newly added, and at the same time, we can see how the stream of what was previously added is conceptually associated with the stream of new information.
43 minutes ago · Like

[Micah Blumberg](micah-blumberg.md) I mean numerically associated. The SDR of a picture, and the SDR of a word have a commonality in SDR and combine (how to combine two SDR into a new SDR?) to becomes a new SDR, and then new pictures and new words come in, and we want to see what gets associated with the SDR that represents a common pattern between the word and the picture in the original SDR. Whatever gets associated is the decoded meaning of the combined SDR
38 minutes ago · Like

[Micah Blumberg](micah-blumberg.md) If we can relate new picture associations with pieces of syntax, one could create visual sentences, movies, from the artificial mind.
37 minutes ago · Like
...
- Source text states the note is from Oct. 5, 2012, 9:04 AM.
- Embedded original post attribution states: Juan Carlos Kuri Pinto on Thursday, Oct. 4, 2012 at 10:07 AM.
- Source file: `a0063z.md` in `github.com/v5ma/selfawarenetworks`.
- First public GitHub upload: `7d1431213cd4ac9788848a5396ec2992ece11cfd` on 2022-06-08 18:30:49 -0700.
- Current source snapshot: `d1c26a6fbf273695185a4036411215f53209eb71`.
- Current source snapshot permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0063z.md.
- Source history URL: https://github.com/v5ma/selfawarenetworks/commits/d1c26a6fbf273695185a4036411215f53209eb71/a0063z.md.
- Git history records later source-file modifications on 2022-08-16 11:22:29 -0700 and 2023-12-12 03:40:59 -0800, with no recorded rename events for `a0063z.md`.

### Wiki Import and Maintenance Metadata

- The following metadata describes wiki ingestion and maintenance only; it is separate from the original source lineage above.
