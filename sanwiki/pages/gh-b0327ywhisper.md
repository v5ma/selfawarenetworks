...
evoke some sort of [[artificial-perception|artificial perception]] would be the real way that perception happens so I
...
released and you know with us with a spike with an [[action-potential|action potential]] they release you know one or
...
article that says it's called [[synaptic-unreliability|synaptic unreliability]] what is it called what's the recipe so if you

go to vrma.io and look at look at the the article that's called so under the featured article

section like the third article down says [[synaptic-unreliability|synaptic unreliability]] hold on I'm just gonna leave my

mic on while I do this yeah go ahead okay third at WebAR digital fashion [[synaptic-unreliability|synaptic unreliability]] so um so
...
so in any case the artificial neuron was like saying that the [[action-potential|action potential]] was summed up
...
summing everything up in in the in the [[action-potential|action potential]] in a simplified way because because
...
going to affect the amount of uh um the pre-snaptic k potassium modifies the [[action-potential|action potential]] amplitude
...
what i think you're talking about so um so an [[action-potential|action potential]] is so uh cell is that right
...
[[action-potential|action potential]] instead of being just a split one millisecond event you by fucking with the

potassium you just made that [[action-potential|action potential]] a two millisecond or three millisecond event i don't
...
yeah so the there's there's sort of like so before the [[action-potential|action potential]] let's zoom in to just the

very tip of the axon terminal yeah before the [[action-potential|action potential]] it's just sitting there in
...
make this event where you have this wide [[action-potential|action potential]] and multi-vesticular release to where
...
so uh you only get so okay first i think it's best to clarify that the [[action-potential|action potential]]

you know only it starts at the cell body and it goes down the axon uh the in the simplest

way to think about it it it sort of doesn't the [[action-potential|action potential]] doesn't go up the dendrites at
...
get enough then it like has a burst right like and that burst is the [[action-potential|action potential]] so the

[[action-potential|action potential]] is only happening on the opposite side of all the [[dendrite]] leaky hose dendrites um
...
the opposite direction too and that causes what's called a back [[action-potential|action potential]] BAP uh it's and

back propagating yeah back propagating [[action-potential|action potential]] and uh that that is that is one component
...
spike uh well the well first off the back propagating [[action-potential|action potential]] that dendritic spike
...
tim erbin's [[gh-c0004x|intro]] to neurolink thing that 80 000 word thing he you've written that right
...
whole year in uh in [[gh-c0004x|intro]] neuro i could have just like read this article and got the same rough idea

you know um anyways i think this is his i might this might be from my [[gh-c0004x|intro]] textbook
...
cell spikes and sends a back propagating [[action-potential|action potential]] so now that area that got the input

now knows that there was a success on the other side you know like oh we got it to spike and so

maybe it gets that signal from the back propagating [[action-potential|action potential]] and because it still has calcium
...
brought up [[artificial-perception|artificial perception]] before um yeah yeah i was okay so that's something i've been

super interested in okay um so you know in the you you can uh in like the ar vr or in vr world

you can solve all the visual issues for [[artificial-perception|artificial perception]] but then you're missing tactile and
...
on my wrist uh that's sort of like I think a simple like [[artificial-perception|artificial perception]] issue
...
sort of where we're going here the [[artificial-perception|artificial perception]] yeah exactly yeah so if you
...
want [[artificial-perception|artificial perception]] what makes more sense is just find out what the input is before the
...
infantile like i i don't even know what 3js is what where what would be like a good [[gh-c0004x|intro]] uh
...
- Source file: `b0327ywhisper.md` in github.com/v5ma/selfawarenetworks
- First public fixation: October 23, 2022
- First-public commit SHA: `b2328af9f722e8cb4776ac361f622a1604350b35`
- First-public commit: https://github.com/v5ma/selfawarenetworks/commit/b2328af9f722e8cb4776ac361f622a1604350b35
- Retained later-state commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Later-state blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0327ywhisper.md
