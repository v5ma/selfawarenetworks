[[neural-lace|Neural Lace]] Podcast 3 (Auto transcript needs fixing)
...
And that's not the definition we're going to need for [[neural-lace|neural lace]].
...
But I want to take this, and I want to take, I want to do sort of like a [[gh-a0206z|self]]-traffin car
...
super, the, the supercomputers that goes in the back of your [[gh-a0206z|self]]-driving car and they're
...
about what they think is possible in terms of [[neural-lace|neural lace]], you know, especially with
...
If you want to work with a company that's doing [[neural-lace|neural lace]] tonight.
...
no secret sauce for [[neural-lace|neural lace]], you know, I could talk all day about all the things
...
The value of creating [[neural-lace-podcast|the neural lace podcast]] and talking about all this stuff is that I
...
guy wants to do [[neural-lace|neural lace]].

So it turns out it's not just Elon Musk, it's not just Carl, it's not just me.

There are other companies in stealth mode that want to do [[neural-lace|neural lace]] and that's the value
...
And this is important to [[neural-lace|neural lace]] because if we send an apple through the computer and

through the [[neural-lace|neural lace]], you know, okay, so we have the brain imaging, okay, if you know

you're getting an image through your [[neural-lace|neural lace]], then the brain wave pattern of an apple

you're getting through [[neural-lace|neural lace]] should be different from a VR apple and it should
...
[[action-potential|action potential]] fires it's a one and when it doesn't, it's a zero.
...
you can't just really like reduce all information to a one, besides the [[action-potential|action potential]] has
...
How do you square the [[observer-effect|observer effect]] with neural A's?
...
If we have a connection to what we're observing, then observation and the [[observer-effect|observer effect]] is
...
you know, sensors and all this [[artificial-intelligence|artificial intelligence]] technology.
...
from when you see a virtual apple and when you see an apple with [[neural-lace|neural lace]].
...
pattern from seeing a real apple because it is different [[gh-b0049y|summary]] of information in your
...
And where I think a lot of [[neural-lace|neural lace]] activity would go, so if you're trying to shock me
...
The first product of [[neural-lace|neural lace]] that I'm interested in building, we'll just mess with
...
the two, like UDP and have, you know, [[gh-a0206z|self]]-authorizations like HTTP, but for the brain.
...
I think if we want to have the [[neural-lace|neural lace]], be able to like lift your arm up, you know,
...
I think we're early enough along in the [[neural-lace|neural lace]] race, the [[neural-lace|neural lace]], turn to a poor
...
I'm talking about applying [[gh-a0206z|self]]-driving car type technology, [[artificial-intelligence|artificial intelligence]],
...
I would love a [[neural-lace|neural lace]].
...
- Source file: `nlp3.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/nlp3.md
