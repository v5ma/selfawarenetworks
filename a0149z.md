...
I argue that the electric field and the magnetic fields in the brain are EACH relevant as attractor points in the brainwave oscillations (of tempo-spatially distributed phase changes), and these brainwave fields serve as attractors that drive oscillatory activities such as coupling, decoupling, synchronization, desynchronization, tuning, detuning, phase precession, phase coherence or oscillatory decoherence (and my argument is that the phase differences are information states, like short term expectations, or attractors (that serve as information configurations) for short term memory oscillations)
