Not really relevant to the [[gh-a0001z|Self Aware Networks]] topic or book
b0018y 12,939 words 64,605 characters

Claude [[gh-b0313ysci|AI Summary:]]

This is a casual conversation between two professionals in the [[sensory-stabilized-volumetric-rendering|volumetric capture]]/3D scanning industry. One is working on [[brain-computer-interfaces|brain-computer interfaces]] and writing a book about [[neuroscience]] and [[deep-learning-neural-networks|neural networks]], while the other works at Volograms, a company specializing in [[volume-recognition|volumetric video]] capture. They discuss various technical aspects of 3D capture technologies, the evolution of depth sensors, and their views on the [[metaverse-consciousness-spacetime-merger|metaverse]] while having beers at a venue in San Francisco.

Most interesting arguments/points:

[[gh-a0257z|Depth Sensor]] Technology Evolution:
...
The limitations of current [[gh-a0257z|LiDAR]] technology in capturing moving subjects

[[sensory-stabilized-volumetric-rendering|Volumetric Capture]] Innovation:

Volograms' development of phone-based [[sensory-stabilized-volumetric-rendering|volumetric capture]] using [[deep-learning-neural-networks|neural networks]]

The concept of a "crapifying [[deep-learning-neural-networks|GAN]]" that deliberately degrades perfect [[gh-a0257z|depth maps]] to match real sensor data

The importance of data collection and curation in training [[deep-learning-neural-networks|neural networks]]

The trade-offs between mesh resolution and performance on different devices

[[metaverse-consciousness-spacetime-merger|Metaverse]] Perspective:

Criticism of the Ready Player One vision of the [[metaverse-consciousness-spacetime-merger|metaverse]]

Preference for [[augmented-reality|augmented reality]] over fully virtual worlds

Vision of enhancing real-world social interactions rather than replacing them

Discussion of Microsoft's acquisition of Activision Blizzard in the context of [[metaverse-consciousness-spacetime-merger|metaverse]] strategy


Business Insights:

The high barriers to entry in [[sensory-stabilized-volumetric-rendering|volumetric capture]] technology

The value of proprietary datasets in defending against competitors

The importance of data curation over raw [[age-mbn-algorithmic-genealogy-engine|algorithm]] development
...
The complexity of processing [[volume-recognition|volumetric video]] for different platforms
The challenge of maintaining consistent quality across different [[sensory-stabilized-volumetric-rendering|capture methods]]

The importance of proper data filtering and selection for [[deep-learning-neural-networks|training]]

The balance between quality and accessibility in consumer applications

The conversation provides a unique insider's perspective on the current state and future direction of [[sensory-stabilized-volumetric-rendering|volumetric capture]] technology, while touching on broader industry trends and technical challenges.

In this conversation, there is only a brief mention of "[[gh-a0206z|Self]]-Aware Networks Institute" when one of the participants discusses their future plans. 

Specifically, they mention:

"It's going to be part of the [[gh-a0206z|Self]]-Aware Networks Institute... And we're going to have a research institute on the web, [[virtual-reality|virtual]] and [[augmented-reality|augmented reality]] software, for people to do biological research and [[artificial-intelligence|artificial intelligence]] research, and [[brain-computer-interface|brain computer interface]] research."
...
New [[brain-computer-interfaces|brain computer interfaces]]
New kinds of [[deep-learning-neural-networks|neural networks]]
[[virtual-reality|VR]] and [[augmented-reality|AR]] applications
The study of biology

However, they don't go into detail about what makes networks "[[gh-a0206z|self]]-aware" or elaborate on the institute's specific approach to achieving this goal. The conversation quickly moves on to other topics about volumetric capture and 3D scanning technology.

The mention of [[gh-a0206z|Self]]-Aware Networks appears to be more of a future project/initiative rather than a central topic of the conversation. Most of the discussion focuses on technical aspects of 3D capture, depth sensing, and [[volume-recognition|volumetric video]] technology.
...
Well, okay, so the real story is that I write software for [[brain-computer-interfaces|brain-computer interfaces]],

and I'm currently writing a book about [[brain-computer-interfaces|brain-computer interfaces]], but it's also about the human brain,

and it's about [[deep-learning-neural-networks|artificial neural networks]] and all of the interesting things you can learn

from studying both [[neuroscience]] and [[deep-learning-neural-networks|artificial neural networks]] and [[brain-computer-interfaces|brain-computer interfaces]].

So it's about all three topics.

And intermix is there is some [[appendices-newton|physics]] that I'm going to be talking about.
...
and you're writing software for a human computer, like [[brain-computer-interfaces|brain-computer interfaces]].
...
[[virtual-reality|VR]] and [[augmented-reality|AR]] applications with [[webxr-bci-integration|WebXR]].
...
called [[hack-days-neural-lace-noisebridge-2017|Noisebridge]].
...
But what I did was, I invited people, I said, okay, I want to see if I can bring the [[eeg-frequency-bands|EEG]],

electroencephalogram, into [[virtual-reality|virtual reality]], into WebVR, so we can experience a representation,

a 3D representation of our [[eeg-frequency-bands|brain activity]].
...
in [[virtual-reality|VR]], so you can analyze it directly on a 3D environment?
...
like a 3D time series of, uh, ten different, ten different, uh, ten different rows of [[brain-rhythms-in-cognition|signals]].

So the, the [[eeg-frequency-bands|EEG]] headset had two sensors, and then you could divide them into five, five

different [[eeg-frequency-bands|frequency bands]] each.
...
in a [[gh-a0149z|time series in 3D]].

And then you get up in the [[virtual-reality|VR]] headset and walk amongst the representation of your [[eeg-frequency-bands|brain activity]].
...
[[eeg-frequency-bands|EEG]] being very noisy in [[virtual-reality|VR]], uh, just adding more noise to your...
...
So the next iteration that I'm working on is gonna use [[fnirs-functional-near-infrared-spectroscopy|functional mirror for spectroscopy]].
...
person moving around in the [[virtual-reality|VR]] headset because, uh, the, the signals are, it's, they're not
...
to create your [[gh-a0149z|time series]].

And so in that case, you can move as much as you want.

You're not going to, uh, disturb your signal quality.

It reminds me, I assume you've heard of this company, [[cognitive-privacy-xr-bci|OpenBCI]].
...
I was just amazed because I didn't know there was, like, a direct relation to the [[virtual-reality|VR]] world.

I mean, they were, I think they were, they had some kind of partnership with HPC or something

like that, where they were trying to build some of the sensors and do some prototype [[virtual-reality|headsets]]

and to understand a little bit the user, what were the emotions and, well, the [[brain-rhythms-in-cognition|signals]].
...
And just so I can like understand it firsthand, like maybe someone will make a [[virtual-reality|VR]] representation of it,

but [[sensory-stabilized-volumetric-rendering|volumetric]] [[virtual-reality|VR]] of the world and then I can...
...
with the NeuroHackster project, bringing easy into [[virtual-reality|VR]].
...
Uh, and, um, but yeah, so, like, I've got this [[gh-a0149z|3D]] carousel that changes scale, rotation,

and position.

So we can, it works in [[augmented-reality|augmented reality]], so, so that means that any kind of interface,
...
It's going to be part of the [[gh-a0206z|self]]-aware, sorry, I don't want to give away the name yet, but

it's going to be part of the Institute.

Okay, it's the [[gh-a0206z|Self]]-Aware Networks Institute.

Um, Sentient AI.

And we're going to have a research institute on the web, virtual and [[augmented-reality|augmented reality]] software,

for people to do, uh, biological research and [[artificial-intelligence|artificial intelligence]] research, and brain
...
computer interfaces, new kinds of [[deep-learning-neural-networks|neural networks]], and, um, new [[virtual-reality|VR]] and [[augmented-reality|AR]] applications,
...
I think of it as like the, um, the Redwood Neuroscience Institute, started by [[jeff-hawkins|Jeff Hawkins]].
...
So, what are you personally interested in [[sensory-stabilized-volumetric-rendering|volumetric capture]]?
...
So, I own a Microsoft Azure [[gh-a0257z|DK]].
...
But I think no one is actually using the Azure to refine the nodes or refine the [[point-cloud|point cloud]].

Everybody's just with a low power.

And then it's kind of a shame that, like, Intel, they had the [[gh-a0257z|RealSense]].

It was such a great series.

They had multiple different lines of the [[gh-a0257z|RealSense]].
...
Yeah, the [[gh-a0257z|RealSense]].

I'm not a big fan of the [[gh-a0257z|RealSense]].

I have a lot of experience with that.

I've never tried the Azure because I'm typical to guess.

But I did my PhD with [[gh-a0257z|Kinect]] 1 and [[gh-a0257z|Kinect]] 2.
...
Like, instead of [[gh-a0257z|Kinect]], free net.
...
Like [[gh-a0257z|Kinect]], so free net.

Oh, that was a [[gh-a0257z|Kinect]] thing?

Yeah, that's it.

It was a community that was basically hacking the [[gh-a0257z|Kinect]] to make it work on Linux.
...
So going back to new kinds of [[deep-learning-neural-networks|artificial neural networks]]

One of the things I'm really super interested in is not just [[volume-recognition|volumetric video]], but doing [[3d-semantic-segmentation|3D semantic segmentation]] on [[point-cloud|point clouds]]

[[deep-learning-neural-networks|GAN]] synthesis

[[object-segmentation|Shape completion]]
...
Really like a top engineer on [[3d-semantic-segmentation|3d semantic segmentation]]
...
The ones that were doing the [[point-cloud|point cloud]] actually mapping because they were not working really well
...
A [[sensory-stabilized-volumetric-rendering|depth kit]], you know, they've got this like monthly subscription or like
...
I was one of the first testers also of the [[sensory-stabilized-volumetric-rendering|depth kit]] when it was called RGBD kit

So that was the very first version and basically had to attach these other cameras on top of a [[gh-a0257z|Kinect]] because the RGB camera on the [[gh-a0257z|Kinect]] was so bad
...
Yeah, I talked to them a couple of years back because we wanted to help them move to [[sensory-stabilized-volumetric-rendering|volumetric capture]]
...
The funny story is I interviewed them with the Microsoft Desert DK so I captured them in [[volume-recognition|volumetric video]]
...
But unfortunately, so I captured his video with [[sensory-stabilized-volumetric-rendering|DepthKit]]

And I exported it as like an RGB [[gh-a0257z|depth]]
...
Into a [[point-cloud|point cloud]]
...
[[gh-a0257z|Depth estimation]]

From one single view

That's basically

A monocular [[gh-a0257z|depth estimation]]

Via a [[deep-learning-neural-networks|neural network]]
...
- Source file: `b0018y.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0018y.md
