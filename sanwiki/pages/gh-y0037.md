# Sensory Stabilization, Tonic Context, and Recurrent Rendering

This page preserves a November 5, 2023 author conversation about dreams, sensory constraint, tonic context, phasic differences, recurrent rendering, language, action, and artificial neurology. The original recording remains in source custody; the broken public audio placeholder has been removed.
...
6. The potential for creating conscious and [[gh-a0206z|self]]-aware artificial organisms, species, and robots, and the ethical and ecological implications of such creations are addressed.

7. The purpose of the brain is explained as being for navigation, with specific mention of highly coordinated movement and the creation of a representation of [[gh-a0206z|self]] and [[gh-a0206z|self]]-aware networks.
...
Implications for artificial consciousness: The author draws a parallel between human consciousness and [[artificial-intelligence|artificial intelligence]], particularly large language models (LLMs) like ChatGPT. They argue that for AI to achieve true consciousness, it needs a similar mechanism for stabilizing its outputs. This could involve connecting LLMs to the internet to access real-time data and verify their responses.
...
Consciousness arises from feedback loops in the brain that allow for [[gh-a0206z|self]]-awareness.

Computers can potentially achieve consciousness by replicating these feedback loops.

Artificial consciousness could be used to create robots with different levels of intelligence and [[gh-a0206z|self]]-awareness, including those resembling dogs and eagles.

A "Buddha robot" could be created that is fully [[gh-a0206z|self]]-aware and one with the universe.
...
[[artificial-intelligence|Artificial Intelligence]] and Species Design:
...
Insights from [[artificial-intelligence|artificial intelligence]] could lead to more precise treatments for mental illness in humans.
...
Misuse of [[gh-a0206z|self]]-replicating species: their uncontrolled reproduction could be disastrous.

The conversation then delves into the nature of consciousness and [[gh-a0206z|self]]-awareness:
Consciousness: Defined as "anticipation" or "identification" of events and stimuli.

[[gh-a0206z|Self]]-awareness: Defined as having a representation of oneself within the map of reality.

It is possible to be conscious without being [[gh-a0206z|self]]-aware (e.g., plants) and vice versa (e.g., some parts of the body).

[[gh-a0206z|Self]]-awareness is seen as a crucial aspect of navigation and survival, guiding our [[actions]] and predictions in the environment.

The "[[gh-a0206z|self]]" is described as a directional concept within the map of reality, always present but relative to other elements.
...
Continuing the discussion on consciousness and [[gh-a0206z|self]]-awareness, this part dives deeper into the technical aspects of these concepts:

# Bard AI Here are more key points:

[[gh-a0206z|Self]] as a Directional Concept: The "[[gh-a0206z|self]]" is described as a directional concept within the brain's map of reality. It's not fixed but constantly updated based on sensory inputs and internal activity.

Consciousness vs. [[gh-a0206z|Self]]-Awareness: Consciousness is defined as the ongoing stream of signals flowing through the brain, a unified entity like a flock of birds. 

[[gh-a0206z|Self]]-awareness involves not only this "live stream" but also a representation of oneself within that map.

Creating Conscious Artificial Brains: The goal is to create [[gh-a0206z|self]]-aware and conscious artificial brains, replicating the human brain's network and its interaction with sensory inputs.
...
Overall, this part delves into the technical complexities of consciousness and [[gh-a0206z|self]]-awareness, highlighting the potential for creating artificial brains that not only process information but also experience the world in a subjective way.

This part continues to explain the brain's internal workings in relation to consciousness and [[gh-a0206z|self]]-awareness:
...
# OpenAI Whisper Transcription:
 ...
 But they're all renderings in terms of 3D [[phase-wave-differentials|phase wave differentials]] in 3D space. 
 ...
 But what I'm saying is that we can fix that, because the experience of time is still doing what the brain, the only thing the brain does, which is rendering representations of, at a high level, the brain, abstractly, the brain is just creating memory prediction renderings or [[phase-wave-differentials|phase wave differentials]]. 
 
 Memory prediction renderings, [[phase-wave-differentials|phase wave differentials]], memory prediction renderings, phasor differentials. 
 ...
 It also includes spatial, temporal feeling, emotion, and a sense of time, yeah, a sense of time and space, and a sense of, but these are a sense of [[gh-a0206z|self]], a sense of [[gh-a0206z|self]]. 
 
 But these are all renderings. 
 
 They're just different kinds of renderings, different kinds of phase wave patterns. 
 
 And because we understand that, we can create representations of these phase wave patterns in a game engine and a physics engine, so that the computer, when it has all of this, all of these different components, it can have a [[gh-a0206z|self]], it can have a representation of a [[gh-a0206z|self]], it can have internal representations of a [[gh-a0206z|self]], it can have an internal representation of reality. 
 ...
 That it observed that its neural, I call it a nap out of it, [[neural-array-projection|neural array projection]] oscillation tomography, that its neural arrays can detect and project, detect and project, they sense and transmit, they sense and transmit. 
 ...
 And all these different loops allow you to take a rendering and basically the rendering is passed from here to here to here to here to here to here to here to here to here and it's passed around so much that you have feedback that in which your renderings exist in time but they're also allowing you to be [[gh-a0206z|self]]-aware of you. 
 
 So you're like a computer that became [[gh-a0206z|self]]-aware of you. 
 
 And because we know that, we can make computers that are [[gh-a0206z|self]]-aware like us. 
 ...
 Would this be a separate species? The robot species? Or if it's [[gh-a0206z|self]]-aware, wouldn't it have awareness of either its? Well, we can define species. 
 ...
 But the brain mimics... I mean, isn't this getting a little into the like, near-Shelley kind of Frankenstein consciousness moment? Of like, you're trying to, you're creating something that is [[gh-a0206z|self]]-aware. 
 ...
 But like the point is you could kind of customize whether the robot would be, have features of, like what depth of [[gh-a0206z|self]]-awareness would it have. 
 
 Like what if we created like a Buddha robot. 
 
 Yeah, that's one of my plans. 
 
 And what would that even look like? Would it just be so [[gh-a0206z|self]]-aware that it would be silent? It would realize the Buddha robot, to make a Buddha robot. 
 
 And what would that even look like? Would it just be so [[gh-a0206z|self]]-aware that it would be silent? It would realize the Buddha robot is a special robot that would realize itself as being one with the universe. 
...
g., they might have a lot of low frequency, which means they're feeling down. 
 ...
 We can do that synthetically with computer code Do you think it could be like I think it could be integrated to help humans with the advancement of a completely separate [[artificial-intelligence|artificial intelligence]] or brain. 
 
 You're wanting to create an artificial brain that could then produce artificial consciousness, but consciousness wouldn't be artificial if it's [[gh-a0206z|self]]-aware. 
 ...
 I'm curious though, in this like, version that you're creating here, with the artificial brain and [[artificial-intelligence|artificial intelligence]], like, what about humans just being humans and kind of being very... Yeah, we say we're going to take our meds, but do we? Not always. 
 ...
 And so future [[gh-a0069z|medical imaging technology]] will allow us to collect the data from our minds to build memory backups. 
 ...
 Or you do that with genetically modified seeds, where they try to make it so that the seeds can't, they can only be used once, right? Or you could literally make species that can [[gh-a0206z|self]] replicate and put them on another planet and see what happens. 
 ...
 Yeah, like what would the ecosystem of Earth look like with the [[gh-a0403z|introduction]] of artificial brain species? Yeah. 
 ...
 But they're talking about [[gh-a0206z|self]]-replicating species. 
 ...
 Which is conscious, [[gh-a0206z|self]]-aware computing. 
 
 [[gh-a0206z|Self]]-aware computing that you have. 
 
 Well, [[gh-a0206z|self]]-aware and conscious. 
 
 [[gh-a0206z|Self]]-aware and conscious, not just one. 
 ...
 So like a group of fireflies can be a conscious entity, but it doesn't have a [[gh-a0206z|self]]-aware identity. 
 ...
 Yeah, so each bird has its own [[gh-a0206z|self]]-awareness, maybe, probably, most likely. 
 
 But the flock, the flock of birds doesn't have a [[gh-a0206z|self]]-awareness. 
 ...
 So it's conscious but it's not [[gh-a0206z|self]]-aware. 
 
 It's not a [[gh-a0206z|self]]-aware, the unified entity is not [[gh-a0206z|self]]-aware. 
 
 Okay. 
 
 And so [[gh-a0206z|self]]-awareness is separate. 
 
 So you could be conscious but not [[gh-a0206z|self]]-aware. 
 
 OK. 
 
 And so [[gh-a0206z|self]]-awareness is separate. 
 
 So you can be conscious but not [[gh-a0206z|self]]-aware. 
 
 Yeah. 
 
 But could you be [[gh-a0206z|self]]-aware but not conscious? I would say most of your body is conscious but not [[gh-a0206z|self]]-aware. 
 ...
 It's not [[gh-a0206z|self]]-aware. 
 
 OK. 
 
 What is [[gh-a0206z|self]]-aware? [[gh-a0206z|Self]]-aware is when you have a representation of yourself. 
 
 [[gh-a0206z|Self]]-aware is a, it's like- Is [[gh-a0206z|self]] a singular entity? [[gh-a0206z|Self]] is, well not necessarily, doesn't have to be. 
 
 But [[gh-a0206z|self]] is, you could have a representation of a fragmented [[gh-a0206z|self]] that's multiple pieces, you could. 
 ...
 But the [[gh-a0206z|self]] is a representation, it's like a rendering. 
 
 The rendering of [[gh-a0206z|self]] is not just a rendering, but it's a, I would reduce the [[gh-a0206z|self]] in the small, I would reduce the [[gh-a0206z|self]] to say that if a human brain is for highly coordinated movement, so we have plants and we have animals, plants don't have big brains. 
 ...
 And so the idea that, what was I talking about? We're talking about [[gh-a0206z|self]]-awareness versus consciousness. 
 
 Oh, yeah. 
 
 [[gh-a0206z|Self]]-awareness in animals and plants being different than consciousness. 
 ...
 And then [[gh-a0206z|self]] is a directional concept in this navigational map. 
 
 The [[gh-a0206z|self]] is where, is the direction from whence causes emerge from. 
 ...
 And eventually, maybe you see your face someday in a mirror if you have a mirror in your environment, right? But at the root level, the [[gh-a0206z|self]] is a directional concept that is in this. 
 
 So you're navigating, you have a map of reality, which is all your representations, and the [[gh-a0206z|self]] is a directional concept in that it's always here in this map of reality. 
 
 Everything else is changing in this map of reality, where you are in the map of reality is always changing But the [[gh-a0206z|self]] is always here So it's a directional concept here Relative here relative to there so [[gh-a0206z|self]] is here relative to there and [[gh-a0206z|Self]] is always here Yeah, so that's why I say that's why I say the [[gh-a0206z|self]] is a directional concept at the root of it in the context that your brain is about navigation for evolution's purposes. 
 
 [[gh-a0206z|Self]]-awareness is directed always inward in the context of consciousness. 
 
 Well, it's a directional concept. 
 
 As a directional concept. 
 
 That your brain eventually turns into a model of what's attached to this directional concept of where all these, everything that causes my arms to move, everything that causes the sounds out of my mouth, this is associated with this directional concept of [[gh-a0206z|self]], which is this here-ness, which is not the map of reality that's constantly changing. 
 ...
 That's the concept of [[gh-a0206z|self]] as a directional entity that we start to attach these representations of hands and legs, and that are your hands, your legs, your eyes, your nose. 
 
 This is the concept of [[gh-a0206z|self]] being rendered as a directional entity in the map of reality in the context of your brain is a neural network that evolution evolved for navigation. 
 
 And so that's how you get [[gh-a0206z|self]]-aware networks. 
 
 [[gh-a0206z|Self]]-aware networks. 
 ...
 If you could have a representation of [[gh-a0206z|self]] in a computer that's not conscious. 
 
 It's just a directional concept that is more about the data of [[gh-a0206z|self]]. 
 
 But it's not a conscious experience of [[gh-a0206z|self]]. 
 
 So a [[self-aware-network|self-aware network]] is conscious when it has both a representation of [[gh-a0206z|self]] as a directional concept and all the things attached to that. 
 
 And it's conscious because there's an online live stream of signals, temporal and spatial signals, from all of the sensory inputs and all of the internal activity of the [[self-aware-network|self-aware network]] that allow it to allow for a persistent flow of information that is transmitted and received between all these different receptors. 
 ...
 Shorts are getting a little about the [[gh-a0206z|self]]-awareness consciousness differential, but generally speaking, I think I understand overall what that distinction is based on the directional navigational context. 
...
- Source file: `y0037.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/y0037.md
