a0328z My Initial thoughts on [[adaptive-resonance-theory|Adaptive Resonance Theory]].
...
I write about the [[tonic-oscillation|tonic oscillation]] being the ground of being, or baseline that incoming sensory information as [[phase-wave-differentials|phase wave differentials]] is compared against, this is a similar concept to ART theory, but SAO:NAPOT is specific about the neural mechanisms involved in the comparison.
...
György Buzsáki's The Brain from Inside Out book has a brain centric view, where the brain has pre existing patterns, instinctual Rhythms, [[tonic-oscillation|tonic oscillation]] patterns, inherent connectivity bias, and this provides the stability against which incoming sensory patterns must interact with. 
...
György Buzsáki's viewpoint is almost also a match for ART [[adaptive-resonance-theory|Adaptive Resonance Theory]]. 
...
I think Buzsaki's book the Brain from Inside Out is a good match for the basic ideas of [[adaptive-resonance-theory|Adaptive Resonance Theory]], but not for the specific implementations of ART in Artificial Neural Networks none of which appear to be biologically plausible.
...
- Source file: `a0328z.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0328z.md
