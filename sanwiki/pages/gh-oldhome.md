New plan: Because you cannot download the wiki on the chromebook ONLY EDIT THE MAPS in the regular [[gh-a0001z|self aware networks]] repo, and then copy them to the wiki when you have wifi.

map.home

Source lineage: legacy `map.home` table of contents from the `v5ma/selfawarenetworks` GitHub wiki. Wiki import and maintenance metadata: this SAN page is the canonical `gh-oldhome` repair surface.

# The Self Aware Networks Institute Wiki on github!

![Self Aware Networks logo](https://raw.githubusercontent.com/v5ma/picturesforbook/86f4c145087058d9213f7e14529b010e7871cfec/logo%20landscape-1%20(1).jpg)
...
[[gh-c0004x|Intro]].Title [[gh-a0001z|Self Aware Networks]] IO 
...
[[intro-fractal-legacy-wiki|Intro.Fractal]] 

[[intro-gravity-legacy-wiki|Intro.Gravity]]

Chapter One: Genesis via [[neo-mind-cycle|Neo Mind Cycle]]

[[gh-c0004x|Intro]].BCI The Ultimate Brain Computer Interface

Brain Network Protocols Brainwaves

[[gh-c0004x|Intro]].ArtificialIntelligence

[[gh-c0004x|Intro]].ArtificialIntelligence+XR+BCI
...
[[gh-map-intro-fractal|Fractals]].Physics 1/F Magnitude/Frequency EEG to Spacetime to life to atoms

[[gh-map-intro-fractal|Fractals]].Morphology (Retina/Greymatter, [[dendrite]]/hand, SensorThresholds/Transmitters)

[[gh-map-intro-fractal|Fractals]].Phases tonic, phasic, inhibited, a multi-scale pattern **_fractal_**

[[gh-map-intro-fractal|Fractals]].Focusing A pattern recorded from a small portion of the cortex looks like a pattern recorded from the whole. the lens of the mind, from a memory stored in a synapse, to the whole brain focusing on that memory, that one detail, a multi-level graph network
...
## [[gh-a0053z|The Phasic Tonic Relationship]]

## [[gh-a0008z|My 2014 Neurons are transmitting their shapes theory revised]]
...
[[gh-a0206z|Self]] Similarity of brain areas

How can we interface with any part the brain: David Eagleman

BCI Industry Map
[[brain-interface-bci-map|Brain.Interface]]
...
[[neomindcycle-legacy-wiki|NeoMindCycle]]
...
The Measurement Problem, the [[observer-effect|Observer Effect]], and the Observer"
...
[[attention-schema|Attention Schema]] Theory: [[attention-schema|Attention Schema]]: How we focus and

Holographic [[attention-schema|attention schema]]
...
- Source file: `oldhome.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/oldhome.md
