...
Ilona Markedeternal
This is where [Micah](gh-resnote04.md) enlightens Ilona. 
...
Christopher Mann OK, so assuming [self](gh-a0206z.md) is real, does a chimp also have a sense of [self](gh-a0206z.md)? how bout a fish? horseshoe crab? earthworm? paramecium? Or is sense of [self](gh-a0206z.md) strictly in humans only?
19 minutes ago · Like ·  1 person

[Micah Blumberg](micah-blumberg.md)
 its a learning loop that learns itself, it refers to this association with its own loop as [self](gh-a0206z.md)
...
Christopher Mann But if they PERCEIVE [self](gh-a0206z.md) does that prove [self](gh-a0206z.md) exists? I'm not talking about physical [self](gh-a0206z.md).
13 minutes ago · Like
[Micah Blumberg](micah-blumberg.md)
...
Ilona Markedeternal Learning loop that learns itself. Does that prove that [self](gh-a0206z.md) exists?
...
[Micah Blumberg](micah-blumberg.md)
the [self](gh-a0206z.md) is a learning loop that learns itself, thats what [self](gh-a0206z.md) refers too, thats proof the [self](gh-a0206z.md) exists
6 minutes ago · Like
...
"We present a framework for using transformer networks as universal computers by programming them with specific weights and placing them in a loop. Our input sequence acts as a punchcard, consisting of instructions and memory for data read/writes. We demonstrate that a constant number of encoder layers can emulate basic computing blocks, including embedding edit operations, non-linear functions, function calls, program counters, and conditional branches. Using these building blocks, we emulate a small instruction-set computer. This allows us to map iterative algorithms to programs that can be executed by a looped, 13-layer transformer. We show how this transformer, instructed by its input, can emulate a basic calculator, a basic linear algebra library, and in-context learning algorithms that employ [backpropagation](backpropagation.md). Our work highlights the versatility of the [attention](attention.md) mechanism, and demonstrates that even shallow transformers can execute full-fledged, general-purpose programs."
...
- Original note date recorded in the source text: Sep 21, 2011
- First public GitHub lineage event for this file: `a0051z ctpr.txt` was renamed to `a0051z.md` in github.com/v5ma/selfawarenetworks on 10 Jun 2022.
- First lineage commit checked: `bab1e8f9060aa36d571fafcda46d3ab6256ff2c2` (`Update and rename a0051z ctpr.txt to a0051z.md`)
- Later checked source snapshot: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink for the checked snapshot: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0051z.md
