...
So the action potential inhibits many neurons simultaneously and the, this might trigger, it should trigger an eventual oscillation, but it triggers the oscillation of the network in stages.
