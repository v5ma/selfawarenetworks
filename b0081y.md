...
One person who was blind for a long time had their sight restored with modern technology and they went through a sort of relearning phase. This is in the book at action, the action and to action in perception. And so they went through this, you know, they they were looking at out of out of the window for a long time across the street and they thought they were seeing like black holes across the street.

21:30

But eventually it turned out that the black holes that that they thought looked like black holes were actually windows in another building but it took a long time for their minds to sort of go from a I guess just a really basic food interpretation of colors in our in a region of space like black holes to recon textualizing that visual image to have a higher resolution pattern that demonstrated a neurology graphic concept of a window with in a, in a building.

22:25
So I went from looking like a weird black hole thing to being having a sharper, contrast sharper, image contrast, which was a window in a and another building. And this is a really good sort of like improvement in in their the visual learning process. But it also highlights that what might be true for when human beings are first born that there is no no real distinction of of space and time no road distinct center space in time.
23:03
But over time, that newborn human being is learning to to make distinctions from the stimulation that is occurring to that human beings eyes and ears that new newborn human beings eyes and ears and other senses. So I I would say that I would think that newborns are functionally blind when they are when they first emerge from the womb.
23:38
...
24:02
Sort of like the preconditioning of reflexes that these are these are like there's a lot of muscle patterns that are firing randomly and they're they're causing the baby to sort of make make like some random facial expressions. And you I remember the last time I was at a live birth, that almost immediately, it seemed like the people who were observing this newborn for projecting, all of this personality and all this, at least characteristics personality characteristics into the expressions that the baby could not possibly have any concept of what these expressions might mean to the adults around them.
24:53
Not it's just not possible but these people were but but I people project emotions onto the faces of babies and they they project interpretations for like as if the baby is making volitional muscle movements instead of random muscle movements. And so, so there is a sort of like, there's a learning process through which the eye, movements are going to respond to sources of stimulation at a low level.
25:32
But it doesn't mean that there's any sort of functional, there's any sort of functional vision happening for a newborn so that. So the eyes may be able to track objects. You know they can track faces that the facial expressions might begin to will begin to over time, begins a copy, other facial expressions, hand movements will copy hand movements and the baby will learn to predict the patterns in the world until there's some perception emerging of, of how of some perception of space in time and the patterns within space in time, that emerges and develops for the baby through the action and perception cycle.
26:27
And so, basically, like constructing reality from the ground up. That's what the brain is doing. And that's what I think the brain is doing, is basically starting off with no conception of space and time and then constructing a conception of space and time from the ground up, from from the court, the, the correlations and decorations of incoming sensory data.
26:54
The learned patterns that are acquired to the action and perception cycle and they these learned patterns acquired through the action and perception cycle eventually. Take on the the, basically a simulation of the universe from the baby from the human beings perspective. Like it in essence, each one of us is sort of simulating the universe from our own perspective, and each one of us in a sense, created our own perception of this universe, we in a sense created our own reality and, but that doesn't.
27:46
But that is, that is in a sense, formed from the building blocks of of inner perception innocentation. And,
28:12
External perception. And and so and in the combination of and then the link between the body of causation which is your body and your mouth, your your voice, the body of causation and your fingers and the the sensory data that is giving you feedback how of, for what the body of causation is doing what you're doing to help you put together.
28:55
And map of your ecosystems that you as the organism to navigate. So our mind is like a holiday deck. And in a sense we are The mind is in a sense. Creating. Its own rendering of space time. But what's interesting is that I don't know. I like to speculate on the the possible idea that everyone is see we're not.
29:39
It's like the idea is that the atom and that every oscillator universe every body of oscillators, which is a human being, is on some of our body of oscillators body of dissipated systems. Every cell is a bit of oscillator, just paid up system. That's oscillating. Every every every person is a dissipative system that's oscillating, we are each.
30:09
Like my argument is that every like every oscillator like a planet is creating space, it's creating a the warping of space time around itself. That space time is relative to to oscillators at all scales from planets to atoms to galaxies that the quantity of space time, emerges from, or expands from the, from, from the atom.
30:50
And so my argument is not only we do, we have a simulation of the universe, that we are creating from the beginning, but in a sense. Also, as oscillators we are creating space time and it's as if every oscillator that ever existed across space time is also contributing to creating space time every bird, every human being, every fish is in effect, creating a note of space time.
31:30
And what happens when we interact with with other oscillators? We're visiting like we we're it's like it's like we're all this sort of like he's like each person is sort of like a strange attractor and and chaos theory or in the but you know Lorenz equation the stranger. That is creating a no to space time that can interact with other nodes of space time.
32:07
And you, you are space-time interacting with space time. But but when you whenever you interact with anyone else and you know, thinking about how all this works is, it's sort of takes away identity. It takes away identity in a sense that I now sort of see myself in everyone and in every life form, like, I see what I thought was me everywhere.
32:43
I mean it is kind of me but it's also not me because it's everyone I see myself in everyone and I can't think of anything about myself this unique other than the position of my of the relative position of my of my head than that. I like, I can't like, I have if my the position of my head comes with, a sort of, I would say.
33:16
Like if there's uniqueness to everybody, it's that everyone is a unique configuration of information, but that can configuration of information is is it's like, Legos. It's like made of common parts. It's like, we all have common parts for you all are made out of Legos and it's all like the same Legos.
33:40
The same DNA. Letters. The same protein molecules the same nucleotide RNA sequences the the we use the but this this this uniqueness is sort of like the uniqueness of of a neurons position in the brain, the neurons position in the brain and notes that in the nose that it's connected to which are turning on and off.
34:20
So sometimes you know a neuron is is connected to some neurons and sometimes it's connects to other neurons. And what this neuron is connected to is.
34:39
To a great extent about sort of like it defines. It's what makes that neuron different from any other neuron is. It's connections. It's, it's synaptic connections and that determines that neurons perspective. In a sense, which determines, which is going to be like, okay, well, when we, when that neuron fires, it means that it's perspective has been activated at that path.
35:12
That's an epic pattern and the brain has been activated and that synaptic pattern, then makes its own pattern to let the rest of the brain know that it has been activated. And so when that when it, when that neuron makes its own pattern, it's firing pattern. That allows it's a perception.
35:32
It's pattern perception to link with other pattern perceptions and so, patterns linked together and now they fire together. And so, basically, you have a firing sequence that represents one pattern and then represents another pattern and then represents another pattern. And that's like, that's like a movie, right? Where a pattern can represent, you know, a pixel on a screen in a movie, or it could represent a line where we could represent a whole frame, you know, a pattern can represent a whole image frame in a movie, you know, movies, you know that sometimes they you've heard, you know, they things like 20 famous per second, 30 frames per second, 60 frames per second movies, have different different possible friends per second.
36:21
So, you know, some, you know, some computer monitors in in 2020 we hearing about the you computer monitor is now doing 120 frames per second or 300 frames per second. There was this NVIDIA monitor, it's a really just basically flash at 1700 frames per second and and they really just wanted to it was really low detail because imagine how much, how much computing power.
36:55
The more frames you have per second, the more computing power it's going, it's going to demand and, but that also to, they had to make it, like, a really low resolution 1700 frames per second. So if you have, if you increase the resolution, more cost, more computing, computing power, and you increase the speed frame rate, then it cost more computing power to render each of the, the frames.
37:24
And so, we need ever larger amounts of computing power, for faster frames per second. Renderings and rendering really is like rendering is the result of a sequence of a firing that unites a bunch of independent marks into a single image that's displayed on us on some sort of surface whether that is a topological surface.
38:04
Or a the functional equivalent of a topological surface and that's where I'm like. Yes. So so people might say okay, well if you're brain is a holiday. Where is the topological surface? And so I'm arguing that we have basically the sparse in distributed representation of topological surfaces that amounts to the functionally equivalent of a holiday.
38:49
But a holiday that's accomplished with with sparse representations. It's like the neurons need only to sort of like reflect a tiny piece of of a pattern just to combine many tiny pieces of patterns for each interval of time and each area of your perceptive field to to produce the functional equivalent of a holiday and your minds.
39:31
And this this then also, I can explain how dreams can be so visual and so vivid, even though you may not be getting any sensory input. In fact, if you go into your sensory deprivation tank, where you aren't getting any light and and ideally you're not hearing any sounds if they if it's not basically sound, the hope is that it sounds for about not every sensory deprivation tank that I've tried was a hundred percent soundproof.
40:06
But, but they really can get pretty close. And So when people get it to a sensory deprivation tank, the the result is that they can have the experience of seeing hallucinatory images without medication and it's it's not, it's also, it's also possible. I mean, I have tried basic. I've also had attacked high hallucinations from drinking 16 hours after drinking a couple of shots of of absent, green absent.
41:03
It tastes like black licorice and about 16 hours after I had tactile sensations as if there were hands all over my body and it was so amazing.
41:19
But so you could have so you could have visual hallucinations, some people have audio hallucinations. They hear they hear sounds and other people can't hear. They hear voices that other people can't hear. This is real, some people see hallucinations without medication. All of our sacks was one of those people.
41:42
He would see like really cartoony funny, weird faces and stuff, and that, nobody else could see. But that this is of pretty well within the range of of what your brain is capable of provided, that things are aren't going aren't going well in terms of your, in terms of your brains health in terms of your brain function.
42:13
According to I guess neurotypical standards. But it can be very like it's not just neurotypical standards. It can be very, they could be very like objective measures. For what is and maybe maybe the subject of measures for what is basically inconvenient, brain function or disabling brain brain function if you are unable to
42:48
So your function as well as you know, someone who's so called neurotypical and the same settings as neurotypicals, that that difference, the neurodivergent behavior can be considered a kind of disability for for you in a very real way. It's it's, you know, I don't know if it's useful to use terms like subjective or objective here in terms of describing what your experiences.
43:17
But certainly they can measure the it. There are differences in your in your function compared to other people's function that could be objectively measured on tests on, you know, your comfort levels around other people your ability to pay attention, your ability to remember. There's lots of tests that can be used to to sort of try to analyze create data that we can be analyzed to sort of poke at and explore.
43:53
The differences between people who are neurodivergent in different ways whether that's autism ADHD or hundreds of other possible mental. Divergent situations and mental disability situations where, you know, someone might be hallucinating audio or visual or or tactile experiences. They may even be, you know, the idea that there is one artist a friend of mine in, who lives in Alameda, not far from San Francisco and the Bay Area and she describes the way.
44:39
I would have described LSD to to another person is the way she describes her normal perception of reality, as if her brain has basically sort of, for sort of like, put her in a situation where she trying to has, she's kind of in an LSD trip all the time.
45:02
She's always kind of like, in a like sort of like visual meltdown and it. And, and she has, she has basically issues related to. I don't want to go into too much detail, but she basically, you know, she has. She has a therapist to for to help her through her difficult moments because her mind is in a sense.
45:37
Rendering in an alternate experience of reality, that's not neurotypical. It's narrow divergent. And it's it's it's it's it's what it's like, it's like imagine if you ever get to try LSD like a match, just like when you try it and you're blown away by the patterns that you see and you just have this like sort of mind expanding experience and you start to question your mind and who you are and and everything you start to think about your own cognition and really interesting ways just like just realize that some people are stuck there.
46:18
Some people are they don't leave that. That place that perspective, that is there reality. And in week could also start to think about, you know, there was this great. So I so I have always been on the autistic spectrum and there was this great a video that for my perspective, just sort of shot out of nowhere on HBO's called Temple.
46:46
Grandin HBO special and tempo. Granted was this sort of like autistic savant or she was really just an autistic person. Who? I don't want to say like me, I think maybe all to maybe all autistic, people are savants in a way, but she was able to see patterns that were beyond the scale of what the narrow typical architects around her.
47:19
Could see she was able to interpret that she was able to see that the cows preferred to move in a sort of circular motion and or spiral like motion and so if you if you designed the cow pens to be around so the cows could sort of like move in a circle and you divide that sort of like even designed the solder houses and and everything so that cows could sort of like move in clockwise circles that meant so much to the cows.
47:54
They meant it was so comforting for cows, to be able to walk around and a spiral versus straight lines. And this is something that people who this is, like, a high level of pattern that neurotypicals are not, they're not paying enough attention to the, the movements of kind of house to have noticed.
48:17
This in autistic architect, it was the one who is able to notice. And so she designed more successful enclosures for cattle that caused less panic. The like the even slaughterhouse is where you know instead of losing instead of you know, the cows becoming frightened in stamping over your over each other and and stepping on the one unfortunate cow that it slipped.
48:48
She was able to keep the callus calmed by moving them, in a sort of circular pathway. That was suiting to the the cows, by rhythms, the calmed them down when they were able to move in a circular path and then temple, granted went on to suggest that autism sort of makes her her perspective a little bit closer, to the perspective of an animal's perspective.
49:23
And so you kind of like you start to wonder, okay. Well, what how many other human beings like Lake? What about the in the evolution of human beings? Over time, the development of perspectives? How many people, you know, sort of in ancient times, would have really been on autistic spectrum and recognize the importance of moving in, circular circular directions.
49:52
And for greater calm, for the greater column of of the collective. This is weird. What a circular, why does moving a circular way? Beneficial to an animal, why? And in another thing that temple granted was she would to design this machine that would squeeze her to apply physical pressure to different sides of her body simultaneously.
50:20
It was a squeeze machine. She could squeeze herself in it. And she found this like immense liberating calm. 
