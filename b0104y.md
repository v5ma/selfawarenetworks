...
30:29
You know, like anyway, guys, so imagine that that the, that the narrow network is going to oscillate through every button combination until that imprisoned score Like playing the same game over and over again and trying different things. Each time until you get it right, all right, so
31:05
