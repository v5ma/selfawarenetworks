...
Our [[agentic-brain|brains]] are constantly generating ideas—some beneficial and others not so much. Take, for example, an angry teenager who might consider breaking a window. This [[thought-is-physical|thought]] arises because, within their range of experiences, such an [[actions|action]] seems possible or even common among peers. However, upon reflection, they might recognize the significant social, legal, and personal consequences of acting on this impulse. They may realize that such an action could harm their reputation and future prospects within their community.

Instead of engaging in destructive behavior, the teenager might choose a more constructive activity, like washing a car. This alternative not only avoids negative repercussions but also contributes positively to their image as a helpful and kind person. The key here is the ability to connect immediate impulses with long-term outcomes—a process that can be disrupted by factors like brain lesions or altered states due to drugs. When this connection is impaired, the wisdom that usually guides better [[choice|decision-making]] may not come into play, leading to regrettable [[actions]].

But why do such negative or impulsive thoughts occur in the first place? Our [[thought-patterns-as-em-patterns|thought processes]] are not entirely random; they are shaped by our life experiences and [[hebbian-learning|learned patterns]]. While we might sometimes generate "stupid" ideas, these thoughts are often the result of not considering all important perspectives. For instance, someone might inadvertently cause an accident—like a person on an electric unicycle changing lanes without looking, leading to a collision with an electric skateboarder. This is not necessarily malicious but could stem from a lack of awareness, highlighting how incomplete consideration can lead to unintended [[actions|consequences]].

As we age, the scope of our imaginations tends to narrow based on what we perceive as plausible. A six-year-old might dream of jumping from Mars to Saturn, but by the time we are in our twenties or older, such fantasies often give way to more realistic considerations. This shift does not eliminate creativity but focuses it within the bounds of our accumulated [[learning-loop-self|knowledge and experience]].

The generation of thoughts is more procedural than random. Our brains create new possibilities based on [[pattern-neurons|patterns]] we have learned over time. These thoughts, whether good or bad, surface and undergo a deliberation process where we decide to act on them, discard them, or refine them. This process involves [[computational-phase-synchronization|oscillating neural patterns]] that represent learned sequences.

Neuroscientist Grace Lindsay, in her book Models of the Mind, explains that [[neuron-computational-analogies|neurons]] primarily respond to changes. If there is no change, neural activity remains constant. This means our brains are essentially tracking differences over time. These changes are encoded in [[action-potential-phase-space|phase patterns]] within [[cortical-columns|cortical columns]], where sequences are learned using individual neurons. The encoding is virtual; if one neuron does not fire, another can represent the activity because the group functions cohesively—much like a swarm of fireflies.

This concept relates to [[hebbian-learning|Hebbian learning]], often summarized as "neurons that fire together wire together." However, it is more accurate to say that neurons fire in close sequence, not necessarily simultaneously. Peter Tass, a professor at Princeton University and author of The Neurobiology of You, emphasizes that [[hebbian-plasticity|neurons strengthen their connections]] when they fire within milliseconds of each other.

An illustrative analogy is how fireflies synchronize their flashing. Individually, they react to stimuli, but collectively, they create a unified pattern through [[gamma-oscillations|oscillatory activity]]. This group behavior can be seen as a form of "wireless consciousness" that grows in complexity with increased feedback. Similarly, groups of neurons in our brains work together to represent complex [[thought-is-physical|thoughts and ideas]].

Understanding how our brains generate and process thoughts helps us recognize why certain ideas arise and how we choose to act on them. By reflecting on the broader impact of our [[actions]] and seeking wisdom daily, we can make [[choice|decisions]] that lead to better outcomes for ourselves and those around us.

[[gh-b0036y|Original Whisper Transcription:]]
So, let's talk about [[choice|choices]] and how your [[agentic-brain|brain]] is making choices.
So I'm thinking about the possibility of certain kinds of certain categories of [[thought-is-physical|thoughts]]
...
about that idea that was generated. And they say, well if I compare this to my whole [[brain-as-memory-prediction-machine|pattern of my
...
of results you're going to get from those two different kinds of [[actions|activities]], right? One of them,
...
so this is like, well, maybe the part of your [[agentic-brain|brain]] that sort of like helps you to connect the
dots to your bigger picture is disrupted because of a cancerous lesion or something.
Or maybe drugs and even altered [[cognitive-states-and-stages|brain state]]. And so that the wisdom perspective doesn't make it
...
then maybe you'll avoid making disastrous [[choice|choices]]. But the part about like, okay,
...
important [[multi-perspective-pattern-convergence|perspective]]. Like I saw someone on an electric unicycle, it was video. I saw a video
...
about harming someone else. That's a stupid [[thought-is-physical|thought]]. Because there's always a better strategy,
right? But it's like, okay, why are you have why do stupid thoughts happen?
And say it was kind of something that's kind of like a random generation of [[thought-patterns-as-em-patterns|thoughts]], right? Maybe
you hurt yourself, you get angry and you create an [[emotions-as-spatiotemporal-patterns|angry thought]] and, you know, whatever.
...
procedural generation of new possibilities or new [[thought-patterns-as-em-patterns|thoughts]] based upon
likely [[hebbian-learning|patterns that have been learned]] over time. So it may seem that we have sort of like random
...
those ideas. There's some sort of [[neuroscience-of-volition|deliberation process]] that could be shorter, could be long,
could be a move down long before the end of this long recording. But the point is that in each
stage, all of those ideas are represented by [[computational-phase-synchronization|oscillating patterns]] by basically, you know,
what we're talking about and thinking about are the actual
[[neural-sequence-representation|learned sequences]], learned patterns. Because she said in her book, models of the mind,
Grace Lindsay, she said that she was saying that the [[neuron-computational-analogies|neurons]] don't, they only respond when there's a
...
as a change. If there is no change, then the pattern remains the same. So it's a difference,
it's like a difference tracker. It tracks differences over time or sequences of changes
and those changes are tracked in terms of [[action-potential-phase-space|phase patterns]] that increase or decrease
in learned sequences. And it's the [[cortical-columns|cortical columns]] that learn these sequences
...
like the original book, [[hebbian-learning|Hebbian learning]]. So everyone took away this idea that Hebbian learning was,
...
is actually right is that [[hebbian-plasticity|neurons are firing in close sequence]] with one another, not at the same
...
fireflies are able to act as a [[neuron-as-sensor-analogies|single sensor]] because of their [[gamma-oscillations|oscillatory activity]], because
...
fireflies is, is a [[spontaneous-harmonic-synchronization|wireless consciousness]]. And that wireless consciousness grows in intelligence
with the, with the more feedback that it has.

## Source Provenance

- Source file: `b0014y.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0014y.md
