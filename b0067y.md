...
When a neuron fires, it creates this, it inhibits a lot of other neurons that could have fired from firing and it's on layer. So that's like the first neuron. It's like, it's like, okay, so imagine.
