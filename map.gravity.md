...
This is a copy of the Self Aware Networks wiki page: gravity.md

Contained are all mentioned of "gravity" in this repo at the time this note was created.
...
a0005z.md:
  ...
  8: rethinking electricity & gravity, Bose-Einstein Condensates & Fermionic Condensates
...
a0018z.md:
   ...
   51: One of the weird perks of having a new unpublished theory of quantum gravity is that I have new quantum gravity jokes that I can't tell you about yet (until after the theory is published), lets just say for now that these jokes are mind blowing.
   76: Theoretical Neurophysics: Self-Aware Neural Networks (Real & Artificial), Quantum Gravity, & Brain Computer Interfaces.
  ...
  109: In short gravity is not the electrical force
  ...
  133: suppose repulsive force was like gravity assist
...
a0049z.md:
  ...
  220: It also means that resurrections, astonishing feats of healing, walking on water, and defying gravity are each slightly more plausible.
  222: its because gravity is accomplished by the em field traffic lanes emerging the fusion of fermionic condensation from dense oscillators (any oscillator as small as an atom or large as a galaxy) 
  228: The Pyramid of Giza probably is a gravity defying warp capable spaceship that can cross between galaxies and between solar systems by manipulating spacetime around it.
  238: The idea is that, oh shit, the pyramid focuses electromagnetic energy in a way that is perpendicular to earths gravity, its reflection of electromagnetism with its tetrahedronsurface sends a fermion condensate beam through its center down into the earth
  240: earths gravity is not just sending out lanes from fermion condensates, its sending them out radially
  287: so in my hypothesis gravity on earthy is like a positively charged oscillation emitting hot waves into space that expand space time temporally causing gravity right?
  299: So the direction of the oscillatory flow of the whole machine is going to cause reverse gravity or the expansion of space between them, pushing the two objects apart OR changing the axis, so that the pyramid is in effect orbiting earth
  311: so an elevator flying straight up causes gravity in that elevator, but a rotating planet has the same effect without directional thrust because it is shaping or curving space to mimic directional thrust
  313: so earths rotating dipole or quadrupoles are more accurately the emission lines and lanes of quantum gravity and earths electromagnetic field
  320: so that the spaceship is out of phase with the gravity of earth, and that is like its orbiting earth inside of falling to earth, its fall is in a different direction so long as it has positive energy to sustain the direction of its flight
  332: this potentially reverses or interferes with the local em field of the earth creating anti gravity
...
a0206z.md:
  60: 2 pi r squared? look up how to calculate gravity
  62: # trying to plot the per atom strength of gravity as the time dilation effect,
...
b0009y.md:
  230: Yeah, advanced mathematics. I I'm at the point where I'm confident that that the that eventually he humanity is going to catch up to my work and and they're gonna in there, they're gonna be like, wow, this is like amazing. You've got a new gravity theory and it's real. It's a didn't it works, and you've got self-aware networks, you meant that them and and now the with best.
...
c0001x:
  51: a0329z from action potential to a new theory of gravity
  52: Gravity - Quantum Gravity - Strong Nuclear
  54: quantum gravity equation
  58: * bad points & exceptional points: * bad points: spacetime has no real area in summary, but rather area is relative to time  * exceptional points: time dilation, and gravity, the surface area of a sphere like the earth represents and expansion of the number of possible directions that a particle can randomly travel towards, increasing the changes that it travels towards an exceptional point
...
map.fractal.extended.md:
  ...
  286:   75: All being interact. They're all being interacted with by the gravitational force. Right. There is an intro. There is interactivity between gravity and the electromagnetic fields because because, you know, we like gravity is sort of described at the at the classical scale or the the the molecule scale, right? But mechanical waves are really just fractals.

map.start.intro.gravity:
   3: # Start.Intro.Gravity
   4: Gravity Map - A map to all the notes that mention Gravity.
   6: [a0033z.md Gravity is gradient time dilation at the particle & atomic scale](https://github.com/v5ma/selfawarenetworks/blob/76a5ab76ce79ed797fa5ebb0818e84f76900dd80/a0033z.md)
  ...
  14: [a0397z Lets consider how gravity as a quantum gradient time dilation is pressurizing the spacetime field, and imagine how depressuring space might cause lift, or expansion.](https://github.com/v5ma/selfawarenetworks/blob/main/a0397z.md)

map.wiki.home.md:
   33: [Start.Intro.Gravity](https://github.com/v5ma/selfawarenetworks/wiki/Start.Intro.Gravity)
  423: a0329z from action potential to a new theory of gravity
  425: # Gravity - Quantum Gravity - Strong Nuclear
  427: quantum gravity equation
...
README.md:
   ...
   10: Self Aware Networks: A longer explanation of my research, my past work, and what I have built. #Physics #Gravity #Math #Science #Quantum #Brain #ArtificialIntelligence
