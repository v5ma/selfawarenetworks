# Disclaimer: These are raw unedited notes. If you search hard enough you will find many statements that contradict other statements, and you will find incorrect statements. There are reasons for that, which I will explain, but also I will be fixing these raw notes.

Some, but not all of these notes are intended to become part of a book titled "[Self Aware Networks](gh-a0001z.md) by [Micah](gh-resnote04.md) Samuel Blumberg"
...
Not every statement in the notes was written by me, because some of the notes include quotes from others, some include text & ideas written by others, some of the notes include transcribed conversations with others that I [Micah Blumberg](micah-blumberg.md) had with other people, in the final book it is the intention to quote every source accurately. All credit to all sources of the various ideas will be logged & cited everywhere possible. In the event that I forget who a source was I will cite the source as "unknown."
...
An example is when you have a musing that you know is not quite right, but there is perhaps something interesting in that musing that might be right but you need to think about it later when you are more awake, so you save it into a note to read later.
...
- Source file: `00disclaimer.md`
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/00disclaimer.md
