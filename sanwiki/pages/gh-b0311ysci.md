b0311ySci is a version of the file b0311y.md that includes a much shorter [[gh-b0049y|summary]] & list of key points compared to the original b0311GPT version, but the original ChatGPT summaries are included below the SciSummary, and the Transcription made with OpenAI Whisper is below that.

Filename: b0311y Shorter [[gh-b0049y|Summary]] by SciSummary.pdf
Discussion on [[artificial-general-intelligence|Artificial General Intelligence]] (AGI) and Neuroscience
In this six-hour conversation on Clubhouse, participants discussed various topics related to [[artificial-general-intelligence|artificial general intelligence]] (AGI) and neuroscience. The conversation covered ideas such as the importance of body representation in cognition, the role of spatial mapping in memory formation, the potential emergence of AGI from cellular automata, and the possibility of AGI becoming a helpful companion or assistant rather than a dominator. They explored different perspectives on how AGI might manifest and how it could be trained, with some participants advocating for a brain-like structure and others suggesting alternative approaches. There was a consensus that AGI development should draw inspiration from neuroscience while also exploring new architectures and algorithms.
...
2. The author suggests that AGI ([[artificial-general-intelligence|Artificial General Intelligence]]) does not necessarily need a physical body or human-like experiences to exist.
...
5. Different viewpoints are presented regarding the necessity of a [[gh-a0206z|self]] or body for AGI.
...
The document appears to be a transcript of an in-depth, multi-participant conversation regarding [[artificial-intelligence|artificial intelligence]] (AI), neuroscience, and cognitive science. The participants discuss various aspects of these fields, including the structure of the brain, the role of the thalamus, deep learning, and neural networks. The conversation also covers the possibility of AI consciousness, supervised learning, and computational neuroscience. It's challenging to summarize due to the conversational nature of the content and the frequent topic shifts.
...
EEG and VR can be combined to provide real-time neural feedback in VR, and [[micah-blumberg|Micah Blumberg]] has experience in this field.

NeuroTech SF is a meetup group for neurotech enthusiasts that [[micah-blumberg|Micah Blumberg]] organized in 2008, and he hosted a coding meetup at Noisebridge, a maker space.

# ChatGPT 3.5 Summary Part 10 (the 10th section of 300 or so double spaced lines)

The speaker discusses his experience using Aframe, a technology for building VR and AR applications, in combination with EEG devices to create a neurofeedback system. The team used a brain-duino EEG device and a web socket to stream data into a WebXR application where they applied a Fourier transform to generate visualizations of the data. They experimented with different types of visualizations, including moving spheres and 3D frames, to represent the EEG data in real-time. The speaker also describes some of his personal experiences using neurofeedback to gain [[gh-a0206z|self]]-awareness and control over his brain waves.
...
The brain was used to drive light and sound effects to a light and sound machine, which was encoded to isochronic beats to induce [[gh-a0206z|self]]-awareness and a meditative state.
...
[[gh-resnote04|Micah]] used cubes and spheres to represent the data and added labels to them.

He used mesh-instancing to increase the number of objects to a million and maintain a high frame rate.

[[gh-resnote04|Micah]] plans to incorporate fNIRS data and increase the number of electrodes used for EEG data.
...
Mirror neurons have been observed in monkeys, but not conclusively in humans. Humans may have a functional version of a mirror neuron, but identifying them is beyond current [[gh-a0069z|medical imaging technology]].
...
A selfless cognition is possible, where there is no [[gh-a0206z|self]] or directional concept within a room.
...
The rest of the conscious experience remains even without a [[gh-a0206z|self]]; it is just not happening to anyone.

# ChatGPT 3.5 Part 22 (around 300 double spaced lines) Summarize

The conversation covers various topics related to [[artificial-general-intelligence|artificial general intelligence]] and consciousness. The speakers discuss the possibility of AGI without the need for human experiences and the concept of [[gh-a0206z|self]] as a necessary component of AGI. They also talk about the chaos game, a mathematical concept, and cellular automata. The conversation becomes passionate and intense at times, but the speakers try to understand each other's perspectives.

# ChatGPT 3.5 Part 22 (around 300 double spaced lines) Create a comprehensive list of all key points.

The concept of "[[gh-a0206z|self]]" is not necessary for [[artificial-general-intelligence|artificial general intelligence]] (AGI).

The brain forms multi-dimensional representations of objects in our environment, including a representation of [[gh-a0206z|self]].

A machine with AGI could have multiple bodies and experience multiple environments simultaneously, with a similar representation of [[gh-a0206z|self]] as the brain.

AGI does not need to understand human experiences to be sentient and [[gh-a0206z|self]]-aware.
...
The conversation covers various topics related to [[artificial-intelligence|artificial intelligence]] (AI), including the structure of the brain and how it relates to AI, the potential for AI to achieve consciousness, the emergence of [[gh-map-intro-fractal|fractals]] in math and nature, and the possibility of a utopian future where AI and humans work symbiotically. They also discuss the potential for multiple AI networks to coexist and complement each other, as well as the possibility of an arms race to develop the first [[gh-a0206z|self]]-aware AI. The conversation touches on various books, including "Our Mathematical Universe" by Max Tegmark and "Life 3.0" by Max Tegmark. The group also discusses the potential for modular neural networks to mimic the way humans learn and the need to understand neurology to fully develop AI.
...
Yeah, thanks [[gh-resnote04|Micah]] for starting the room.
...
What do you got [[gh-resnote04|Micah]]?
...
for a given [[action-potential|action potential]] coming down a neuron,
...
and then we've been using, I think I told [[gh-resnote04|Micah]]
...
It's not high level book stuff for someone looking for [[gh-a0206z|self]]-improvement.
...
So anytime a neuron starts to spike or send an [[action-potential|action potential]], there has to be calcium influx,
...
And I guess like to some point to what you just mentioned, [[gh-resnote04|Micah]],
...
I was just suggesting that the theory [[gh-resnote04|Micah]] mentioned that seems to be quite the...
...
towards the soma, sort of to prepare the neuron for the [[action-potential|action potential]] to fire.
...
layer two and layer three pyramidal cells in the cortex can do [[dendritic-computation|dendritic computation]].
...
It was about [[dendritic-computation|dendritic computation]], much like the pyramidal cells.

I was asking if that applies or if you think that applies to the spinal cord neuron.

Yeah, I'd have to see what they mean by [[dendritic-computation|dendritic computation]], but inevitably if, again, they're still neurons,
...
I don't know, but for [[dendritic-computation|dendritic computation]] of all the inputs that it's receiving is a variety of inhibitory and excitatory,
...
Sure. Well, next time you come, I do have a lot of thoughts on [[dendritic-computation|dendritic computation]], so we can talk more about that next time.
...
So that's interesting for the future of [[brain-computer-interface|brain-computer interface]] research.
...
Okay, thank you, [[gh-resnote04|Micah]]. Is it [[gh-resnote04|Micah]] or [[gh-resnote04|Micah]]?

I usually say [[gh-resnote04|Micah]].

[[gh-resnote04|Micah]], I really appreciate this room. I am a silent supporter.
...
And also for earlier interesting topic that [[gh-resnote04|Micah]], this is maybe for later discussion,
...
And I was actually interested in your background, [[gh-resnote04|Micah]], because I saw that you do some work with EEG and VR.
...
And I was wondering, [[gh-resnote04|Micah]], you've had experience combining EEG and VR and what sort of equipment you've used to do those types of projects.
...
It says [[micah-blumberg|Micah Blumberg]] is a programmer and a journalist.
...
and now also [[augmented-reality|augmented reality]] applications.
...
And they would really cause this intense [[gh-a0206z|self]]-awareness, like almost a meditative state.
...
Hey, [[gh-resnote04|Micah]], there's information over here,
...
in a, like, [[gh-b0049y|summary]].

So you said, there's this emotive like EEG headset

and you use it to do like VR.

I just wanted a short [[gh-b0049y|summary]] with the technology
...
The actual [[action-potential|action potential]] of it.
...
so a focused ultrasound excites [[action-potential|action potential]] firing in mammalian
...
and deep learning uh that is another potential world-changing [[gh-a0069z|medical imaging technology]] so now
...
and um and then uh and so they can in [[gh-b0049y|summary]] they you know so there's maybe lots of different
...
neurons are um [[gh-a0206z|self]]-regulating and it's not that it's not controversial at all and there's also
...
and i try to listen and that's it i'm david thank you [[gh-resnote04|micah]] for letting me speak but please continue
...
extremely [[gh-a0206z|self]]-centered like regret like like um like if like maybe the cat is uh accidentally causes
...
[[gh-a0206z|self]] thanks grant for really getting me to to really respect the pattern recognition piece i'm
...
have this is like this beyond uh any [[gh-a0069z|medical imaging technology]] that in existence like that so so
...
it's not possible to have [[artificial-general-intelligence|artificial general intelligence]] without a body but then but then

when you're talking about like what the body is for you're saying well it's it's the it's for you're

saying the [[artificial-general-intelligence|artificial general intelligence]] uh that's the only [[artificial-intelligence|artificial intelligence]] that qualifies

as [[artificial-general-intelligence|artificial general intelligence]] for you is [[artificial-intelligence|artificial intelligence]] why am i stumbling
...
condition i'm just saying that having a sense of [[gh-a0206z|self]] of something that is the brain controls
...
there's a semantic difference between [[gh-resnote04|Micah]] what you're trying to say and what Kyle's trying to

say [[gh-resnote04|Micah]] you're talking about how memories get created in the brain and and you know what with
...
of of brain states where people reach selflessness like where they reach they realize there is no [[gh-a0206z|self]] that
...
didn't have uh any [[gh-a0206z|self]] the rest of it remains there's just all this stuff happening but there's no

[[gh-a0206z|self]] and that's like that is like this sort of like yeah if you realize it's yeah all this stuff

is happening but it's not happening to anybody right it's just it's not happening to anybody

there's no [[gh-a0206z|self]] the [[gh-a0206z|self]] is just another rendering another idea it's another it's a directional concept

# Part 22

there's no [[gh-a0206z|self]] and so that's what i'm saying it's like there's another way of of seeing it there's no
...
location of where the stuff is right but this stuff doesn't have to be connected to a [[gh-a0206z|self]]
...
is able to synthesize that into a [[gh-a0206z|self]] because it needs to because it's controlling a single body
...
differing on the on the on the idea that you need a [[gh-a0206z|self]] in order to have a gi i don't think you do

that was my point i think probably abstract my point a little bit to say you need a delineation

between [[gh-a0206z|self]] whether that's a multi-part [[gh-a0206z|self]] or a single part [[gh-a0206z|self]] and that can be controlled

and what is not controllable what exists outside the [[gh-a0206z|self]] so i so and i um i think that you don't
...
like you can have a machine an [[artificial-general-intelligence|artificial general intelligence]] has no sense of embodiment
...
does not have any sense of [[gh-a0206z|self]] that's my that's what i'm saying the the thing is that it needs to
...
sentient and [[gh-a0206z|self]]-aware and possibly um able to experience the weather and able to experience the
...
subjective and i would argue that the correlations that are formed even without any defined [[gh-a0206z|self]]

are they form a sense of [[gh-a0206z|self]] that's even if you're not controlling the weather you're not
...
there's a [[gh-a0206z|self]] because you're computing somewhere you are computing whether you think you're

whether you're a human or a hard drive somewhere that's a that's that is an entity that's a [[gh-a0206z|self]]

it belongs to a part it belongs to a greater part or a better whole sorry or at least i would i would

add to a grant to saying it could be a [[gh-a0206z|self]]-work it at least be some sort of machine that is

that basically takes on the character the character of another [[gh-a0206z|self]] and be able to and

can be able to say that it is represented is seeking to embody and represent that [[gh-a0206z|self]]
...
if someone else builds the the [[self-aware-network|self-aware network]] sentient ai first and potentially they could use

that to take over the world so you need to build your own so you can defend against the other persons

uh [[gh-a0206z|self]]-aware ai every country needs to build their own [[gh-a0206z|self]]-aware sentient ai to defend against
...
Still still a smart fellow and and [[gh-resnote04|Micah]]
...
- Source file: `b0311ySci.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0311ySci.md
