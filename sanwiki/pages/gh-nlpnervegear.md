...
Hi everyone. This is [[gh-resnote04|Micah]] here and I'm here with Sarah who's with Virtual Bites.
...
This book is The Neurobasis of Free Will by Peter C. [[criterial-causation|Criterial Causation]] is a subtitle. And that book is really great because it's sort of like...
...
And this is how the [[gh-a0206z|self]]-driving cars are designed to work, where you see if I have the [[gh-a0206z|self]]-driving car one.

I don't know if I brought it.

So the idea is that the [[gh-a0206z|self]]-driving car is basically using deep learning neural networks to representations of the world.
...
And what's interesting, I think we said we tried to talk about the sense of [[gh-a0206z|self]], right?

How does our brain abstract a sense of [[gh-a0206z|self]] that all, I guess, meanings have?

Yeah, so and I think that, you know, if you look at like, so look at, I was going to get the book for Douglas Hofstadter.

Douglas Hofstadter says that the [[gh-a0206z|self]] is a strange loop of, so it's like a learning feedback loop.
...
And then if you had a [[gh-a0206z|self]]-driving car or a person observing the world long enough, they begin to notice features about like the [[gh-a0206z|self]]-driving car should begin to notice features of itself.

If it could see itself or its relationship to other things.

And if you had that in a feedback loop, it would begin to formulate a model of a [[gh-a0206z|self]].

In some sense, it has like, it's not a [[gh-a0206z|self]]-aware [[gh-a0206z|self]], but it's like a [[gh-a0206z|self]] like, can I move forward?

And to get a [[gh-a0206z|self]]-aware [[gh-a0206z|self]], you'd have to have not only a model of the [[gh-a0206z|self]], but you'd have to have it in a feedback loop with all the other data.
...
And for instance, the clothes that we wear, the tools that we use, they all become a part of this [[gh-a0206z|self]] model of what we think of ourselves and the basic bodies that we have.
...
They say that the [[action-potential|action potential]] travels between cells in a chemical synapse.
...
But what, what's actually happening is the [[action-potential|action potential]] is just passing along the body of a single cell.
...
and they're lighting up in a sequence, in a neural circuit, and because they are, in anyway, because of the [[dendritic-computation|dendritic computation]],
...
And the, so separating of charges, positive and negative charges, and that results in an [[action-potential|action potential]],
...
the thalamus could be the optimal place to look for to, to create a new [[brain-computer-interface|brain-computer interface]].
...
So the idea here is that if we could take the [[gh-a0206z|self]]-driving car type of computer to put it in the backpack
...
I have a [[gh-a0206z|self]]-driving car.

So the idea is all these lines and edges that represent the [[gh-a0206z|self]]-driving car as a conceptual pattern in the computer
...
or transport your sense of [[gh-a0206z|self]] into an artificial body,
...
like [[artificial-intelligence|artificial intelligence]] and virtual reality
...
- Source file: `nlpnervegear.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/nlpnervegear.md
