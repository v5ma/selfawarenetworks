...
Fractals.Morphology compares retina, gray matter, [dendrite](dendrite.md), hand, sensor thresholds, and transmitters.
The 3D structure of biology can be considered fractal when the brain is treated as a fractal of modules.
...
A fractal is a [self](gh-a0206z.md)-repeating pattern. In this sense, the universe can be described as a functional fractal, with broad similarities across scales: a galaxy can be modeled as a vortex, a planet can be modeled as a vortex or dissipative system, life can be modeled as a dissipative system in a functional way, and particles can be interpreted through the same analogy.

Fractal Concept of Cosmos as a neural network including the brain

[Neo Mind Cycle](neo-mind-cycle.md), scaling fractals, and the fractal dissipating cosmos are related concepts in these notes.


The universe is a fractal of clocks, a fractal of computation, a fractal of neural networks, or basically like each unit of the cosmos at each scale is [self](gh-a0206z.md) similar in that it's cyclical progression over time includes state changes at each interval of time that increase the information complexity in some area, and increase the overall entropy in another area.
...
A hand is described here as a fractal analogue of a [dendrite](dendrite.md).
...
In Thousand Brains Theory, many [self](gh-a0206z.md)-similar copies of the same brain activity can be distributed across multiple areas. The memory-distribution analogy is consistent with the paper "Brain-wide mapping reveals that engrams for a single memory are distributed across multiple brain regions."

The brain can be framed as a series of fractal sensor arrays that magnify their receptive fields onto other sensor arrays, which then de-magnify the incoming signal into focused [attention schema](attention-schema.md) dynamics.
...
- Source file: `map.intro.fractal.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Commit timestamp: 2025-08-30T22:40:07Z, from the GitHub commit record for the source SHA.
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/map.intro.fractal.md
- Source relation: The first line of the source file says it is a copy of `intro.fractal`.

Wiki import and maintenance metadata:

- Imported: 24 Apr 2026 by Lane F (bulk file-driven import)
- Lane: F.bulk-import
- Wiki relation: The imported wiki page relates to the [intro](gh-c0004x.md) fractal notes.
