...
This is the original Google Recorder transcription for a better transcription see the [whisper version](gh-b0328ywhisper.md) of this note.
* It features a few links that I plan to copy to the other notes, so don't delete this until it's reviewed carefully *

[Micah Blumberg](micah-blumberg.md): I started a group on faceobok. It's called [Neurophysics](neurophysics-definition.md) & Medical Research and I'm starting to share some stories there and basically news stories about in in general research that in some cases is many years old about [Parkinson's disease](gh-a0340z.md).

I think that the protein folding situation with [Alpha Go](mind-code-brain-code-alphago-2017.md) with using a [neural network](deep-learning-neural-networks.md) to discover to, basically create a map between gene sequences and the 3D shapes that can be produced by [proteins](three-dimensional-protein-structures.md) is a big step forward, obviously that has to continue to where we can understand what [cellular communication](cellular-communication-graph-neural-network.md) sequences at the genetic level can lead to the formation of specific [receptor shapes](3d-protein-receptor.md), specific cell types. This is this is massive future work that has to be, we're going to need even bigger computer systems than we have today to sort of like get to the point where we can you know, have have a neural network basically discover a point by point. What are all the messages that [cells](cells-as-pattern-recognition-devices.md) need to communicate to go from, you know, basically taking the existing to genetic code and building a person out of that code. Because all of that has to do with basically unlocking these cellular functions through the communication between cells.

and and when that goes wrong, we have all these diseases. What I sort of like if recently been focused on is is all these links between these different major diseases that we have that, you know, there are proteins that are being identified that link together [cancer](gh-a0604z.md) and [neurodegenerative diseases](gh-a0620z.md) and [vascular diseases](gh-a0621z.md).

And there could be some like really profound discoveries ahead of us in the near term by using [artificial](artificial-intelligence.md) neural networks. To accelerate research in biology. So that the computer can look for basically patterns and in a way that is just sort of tireless compared to, you know, human researchers needing to try to figure out things because they're like automating the process of looking for for patterns that help us to map [cellular functions](cells-as-pattern-recognition-devices.md) & misfunctions.

We see papers like there's this [protein](three-dimensional-protein-structures.md) called FMNL2.

05:40

And that as recently been linked to both [Alzheimer's](gh-a0321z.md) and [vascular](gh-a0621z.md), disease and [cancer](gh-a0604z.md), including color, rectal, and breast cancer.

Yes a researchers identified this but this took a long time and and when we are using [neural networks](deep-learning-neural-networks.md) to help us identify [proteins](three-dimensional-protein-structures.md), that are that are sort of broadly involved in a lot of different illnesses.
...
I think that that's very interesting. I have a question because I tend to favor some kind of new research that's been building, that maybe the microbiome or low-grade [infection](gh-a0125z.md) underlies a lot of conditions, and I'm thinking it's not necessarily mutually exclusive with what you're talking about [Parkinson's disease](gh-a0340z.md).
...
whichever, I don't know that it could cause stress on the [cells](cellular-memory.md) and cause different malfunctions, and I don't know what you think of the growing literature on L-form bacteria,

L-form bacteria
https://en.wikipedia.org/wiki/L-form_bacteria

for one thing, or there's some research on both bacteria and fungi in the [brain](brain-as-memory-prediction-machine.md) of some of these conditions.
...
[Micah Blumberg](micah-blumberg.md) speaking: 
Hmm. Let me think, well, I think that, I guess, I guess, I guess that the

08:24

And in terms of causes, I think that that's right on target, that basically anything that can get in there and into the [brain](brain-as-memory-prediction-machine.md) to stress out our [cells](cells-as-pattern-recognition-devices.md) might cause malfunctions, right? So we could be talking about bacteria or fungi, or we could be talking about just [inflammation](gh-a0125z.md) resulting from a virus, from physical injury, or from some other pathogen or force.

08:53

So, I mean, I generally agree that, you know, if we're if you're if you're putting a lot of, if you're putting a lot of mechanical stress on a [cell](cells-as-pattern-recognition-devices.md) from from, you know, it's being attacked by bacteria or fungi or viruses, specifically, including [COVID-19](gh-a0233z.md) that, that might cause a malfunction.
...
As you are probably familiar with the work of Rudy Tanzi.

Rudolph E. Tanzi, PhD
https://en.wikipedia.org/wiki/Rudolph_E._Tanzi
https://brain.harvard.edu/?people=rudolph-e-tanzi

And then there's also somebody who put out a contest for called germ. Quest for [Alzheimer's disease](gh-a0321z.md). He, he was thinking that he was like a former CDC researcher and and then they, they had a business, they made a lot of money.

10:07

So he put out a million dollar reward for someone who could find an [Alzheimer's microbe](gh-a0321z.md), if it was a cause, but I found out he ended up dividing it among six different people because no one really proved that it was any one thing. They submitted proposals that were fairly convincing on the role of several different microbes.
...
But for myself I am I'm more of a know more of the care management holistic approach. So not too much input on that. Sorry. All right, I think I'm gonna agree with Joyce that there's there's a potentially multiple things that can that can cause [disease](gh-a0620z.md). And so, yeah, I'm gonna look up so germ quest and you said Rudy Tansy.

11:43

How do you spell that one? Yeah, Tanzi. T a n z i. He's at Harvard, and through that Germ Quest thing I heard about an NIH workshop, a National Institute on Aging workshop online, and Rudy Tanzi spoke, along with a number of other people. It was focused on the role of [infections](gh-a0125z.md) in [Alzheimer's](gh-a0321z.md), or maybe it was just more general dementia, and I was especially excited about this researcher, Dr.

12:22

David Corey from Baylor and that research. I don't think has been published yet, but I keep looking for it because he, he found using kind of novel methods, bacteria and fungi in the [brain](brain-as-memory-prediction-machine.md) in a very unusual sort of arrangement. He said it, I don't know what he called it something like like a noses is if the bacteria and fungi were living in, you know, a mutualistic relationship like, like, in the lichen that he also referred to the work of Louis Carasco.

13:04

Who's an established microbiologist and now retired. He's written a lot of articles about his research finding fungi and bacteria that were quite different in the brains of various [neurodegenerative conditions](gh-a0620z.md), and he referred to Dr. Carrasco's work. Then I've heard of another researcher in Scotland who's working along those lines, and then there's a researcher at Oxford that I was kind of excited about hearing.
...
Okay, so yes. I think that's where I'm sort of optimistic: we can accelerate the work of studying the functions and misfunctions of [cells](cells-as-pattern-recognition-devices.md) with [neural networks](deep-learning-neural-networks.md). That would include studying how pathogens affect cells, how fungi affect cells, and so on. Yeah, you know, Rudy Tanzi is doing work on [Alzheimer's](gh-a0321z.md) at several different levels.

16:04

This kind of interesting, he talks about select three different stages and the early stage where things are going bad is when the diet, he thinks altars the microbiome. And then the middle stage is where that [plaque](three-dimensional-protein-structures.md) is developing, and he's working on drugs against that too. But then the final stage is where the [inflammation](gh-a0125z.md) kind of takes over.
...
Whereas, I think, like you say, there are multiple pathogens, but I tend to think the bacteria and the fungi may have more of a role, and the viruses come along when the [immune systems](immune-self-nonself-analogy.md) are really weakened. But they are actually also part of the situation.

17:33

Well, so our so is, is the the thought that of how the fungi is is sort of causing a disruption of the [cell](cells-as-pattern-recognition-devices.md)? Is that is it, you think that's is that linked directly with with the, the [misfolded proteins](three-dimensional-protein-structures.md), like, like [alpha-synuclein](alpha-synuclein-synaptic-silencing.md)? Do you think or yeah I don't know the details of the molecular aspects of it.

18:05

But Luis Carrasco may have done something in [Parkinson's](gh-a0340z.md) more at that level. I know that [amyloid beta](three-dimensional-protein-structures.md) is thought to be an antimicrobial peptide, so I don't know enough of the molecular level to know how that ties into misfolded [proteins](three-dimensional-protein-structures.md).

18:31

But is the [amyloid beta](three-dimensional-protein-structures.md)? Misfolded. All right, I can't remember, it's cleaved to differently as I recall the
...
I've also read a book by Dale Bredison. I don't know if you've heard of him I mean pull up his Dale. How do you spell his last last name? Bradison breadison b, r e, d e, s e n. Okay, he was a long time, researcher and [Alzheimer's](gh-a0321z.md) in the laboratory.

19:18

19:43

A lot of different things that go wrong in [Alzheimer's](gh-a0321z.md), and he even talks about something like, there's 36 different problems and if you just try it, you know, to come up with a drug and attack, one of them, you're not going to get anywhere. And so he is, he came up with his comprehensive approach and he's published on it and he's doing another trial because he had a trouble with the IRB because they didn't want to do a study that had multiple interventions.
...
So he could do a regular study. Yeah, I mean I so I mean, I just started really digging into. I was looking at I was, I was looking at the brain in terms of trying to understand how how [LTP](ltp.md) and [LTD](ltd.md), you know, long-term memory and, and forgetting like work in a very precise way.

21:05

And, and that sort of like led me to like, looking at dementia and [Alzheimer's](gh-a0321z.md), and then, and now [Parkinson's](gh-a0340z.md), and, and a lot of. And now generally speaking [neurodegenerative disorders](gh-a0620z.md) in their causes and like the whole chain and in the link. And so like you know that that what what you're saying about?

21:26

Like I didn't I didn't in terms of there being 31 different things going wrong, I haven't gotten that far, my research, but I have been like, yes it it's there's issues going going on with with [misfolded proteins](three-dimensional-protein-structures.md) and with the, the [receptors](3d-protein-receptor.md) on the cells malfunctioning. And with the the you know, with neurons dying date like the aneurons [dopamine](dopamine.md) neurons dying and in certain in very specific places and the brain and then and then, you know, there's like new research that that says that speculates, that the reason the EBS works is because it's it's there's there's like a [brain wave](brainwave-entrainment.md) and treatment effect happening from the DPS machine, a certain frequencies.

22:15

That's it's really causing the. It, it seems to be like in training. The the the [neurons](neuron-electrical-firing-threshold.md) that weren't that weren't [firing](neuron-electrical-firing-threshold.md) to sort of like fire again in in. So like I I think of, I think of, I'm thinking of the disruption's that are, that are happening to the biology at the, on the, on the, you know, to the tissue it's leading to.

22:46

It's, it's like a, it's like an, it's like a receptor disease. It's that's you know it's also killing neurons and there's like all these different points of like you know it started with the misfold of protein and now the [cells](cells-as-pattern-recognition-devices.md) not firing correctly and now that is that is like why there's this you know these these problems that show up on the synth on the symptomatic side because you know the patients, not able to function the way that used to function and they're not able to move their hands and arms the way they used to move them or you know, in the case of dementia, they're they're not all, they're not all there, they're memories.

23:21

Not all there. And so, you know, if it's like the difference is between these different [neurodegenerative diseases](gh-a0620z.md) are sort of like, which proteins are are misfolding and in collecting and in becoming lewy bodies or or, you know, becoming basically [protein deposits](three-dimensional-protein-structures.md) like like amyloid beta protein deposits, right? And like, and where it's happening.

23:54

It's like which [proteins](three-dimensional-protein-structures.md) are involved and which part of the [brain](brain-as-memory-prediction-machine.md) is being affected, and why this part of the brain is being affected. But then that is contributing to [cellular miscommunication](cellular-communication-graph-neural-network.md) or specifically to timing issues in the [firing of neurons](neuron-electrical-firing-threshold.md), which are treated with things like [DBS](brainwave-entrainment.md).

24:17

And and also there are some there's been some experiments for their. They can play music to people who have Alzheimer's and they can see that the patient can temporarily sort of come back a little bit from listening to the music and that would be similar to to the concept of [brainwave](brainwave-entrainment.md) and treatment where you're getting those neurons.

24:38

Sort of like fire in the right sequence. Timing sequence again, and that restore some functionality to the patient that they that they lost at least temporarily in. And so I'm sort of like really interested in and and gently work, you know, he wrote the book, the secret language of cells because he sort of like says, well let's move the focus on biology to basically the communication between neurons and and not answer the [communication between cells](cellular-communication-graph-neural-network.md) not neurons.

25:12

But any cells because there is sort of let that's where like maybe the point of study to where we can we can we can bring in the copy to the the people from from, from the the [artificial neural network](deep-learning-neural-networks.md) side of things that the computer engineers to sort of like, do this biology work, to take accelerate it by having the computer, look for the things that we used to have neuroscientists and biologists looking for.

25:45

And but there's I think that that, you know, that's sort of like the conversation is beginning between, you know, between the folks who do, you know, [artificial neural networks](deep-learning-neural-networks.md) and the folks who study, you know, biology and anise to keep continuing and that's sort of like what I wanted to sort of like maybe start a conversation around.
...
But I don't personally don't think they'll be the root cause they might help some, you know, like he said the [deep brain stimulation](brainwave-entrainment.md), you know, it helps some that, you know, wasn't anything like it cure or something, you know. It's interesting about Dr. Cory. He comes from came from a kind of respiratory illness background and he discovered that at least in where he lives in Houston, Texas, that fungi, kind of basically a [fungal infection](gh-a0125z.md), probably under lies [Alzheimer's](gh-a0321z.md).

27:26

A lot of asthma and it's interesting that asthma is a big predispatch predisposition for [Alzheimer's](gh-a0321z.md) and having worse Alzheimer's. But anyway, it turns out that the fungi are not being detected because, you know, he was able to detect them by altering, the technique that he said, he found out the mucus is very good at killing the fungi and so when you sampled the normal way, you're taking the fungi out with the mucus and you get, you don't get anything alive and so he figured out how to do it without killing them.
...
So so was one interesting thought that I have is that, you know, we could we could sort of like, okay, let's say that I was reading this. There was looking at this paper that was about how I think it was all. I think it may have been [ultrasound](non-invasive-brain-stimulation.md) or mechanos how mechanical vibrations could could basically cause nuclear deformations or basically, they can impact the nucleus of a [cell](cells-as-pattern-recognition-devices.md), and that will trigger the cell to unlock a certain response.

29:16

Like the [cell](cells-as-pattern-recognition-devices.md) will respond based upon how you on the signal, you've given it's it's nucleus. And so it would be interesting to say, okay well if there's a fungi that basically can produce a certain response from a cell because at some point a signal goes from the fungi to the nucleus of the cell and that produces a cell to have a certain response where it does a certain thing.

29:46

Maybe it creates a [new protein](protein-synthesis.md) and a new [cell receptor](3d-protein-receptor.md). I'm, you know, or maybe it mistles a protein that so we'll find out what that is. But if we could say, all right, well this fungi affects the the cell nucleus and it produces this result and this ultrasound vibration affects the nuclei and produces the same result.

30:10

And basically we can say that, you know, we can start to because start to describe, okay? Well, now there's an there's a similar pattern between the emerging from the [cell](cells-as-pattern-recognition-devices.md) if you stimulate it with you with with signals from from the fungus or signals from [ultrasound](non-invasive-brain-stimulation.md) or signals from some chemical and that causes the cell to exhibit the same behavior because in some way at this on the tissue level, there's an isomorphism between these different signals.

30:45

They're causing the [cell](cells-as-pattern-recognition-devices.md) to respond in a specific in this specific way, that's the same way. And so at that point, the treatment could be a chemical or. It could be [ultrasound](non-invasive-brain-stimulation.md) or like a mechanical vibration or it could be, you know, I mean, maybe it's it's a, it's a, it's a message that's basically a piece of RNA, or, or a, and it or it could be just a T cell that has been configured, like, the way that configuring, you know, T cells with [immunotherapy](immune-self-nonself-analogy.md), the, basically the T cell identifies, the cells that are problematic and then it transmits.

31:29

An exciting new immunotherapy approach to [brain inflammation](gh-a0125z.md).
https://twitter.com/worksalt/status/1530305736089038848?s=20&t=hVsgzcwCZTFXPzwvCK2gVA

The particular message that the [deep learning](deep-learning-neural-networks.md) known networks. Have identified that we'll trigger the [cell](cells-as-pattern-recognition-devices.md) to behave in the way we want the [self](gh-a0206z.md) to behave in order to clear the cure the illness. And so that's sort of like what I'm looking for is, you know, to bring in the fungal research with with all this other research, it might be of a way to sort of, like look for isomorphisms between different ways of communicating with the cell.
...
Yeah, you know, and, and for one thing, it at this stage of things that I'm not sure whether one could reverse, the kind of [infection](gh-a0125z.md), you know, assuming that doctor Cory and Dr. Crossbow is cracked that and very elderly person. Might not be able to withstand treatment to kill the microbes, so they might be able to just use some method to kind of ameliorate the effects, you know, using something like you're talking about, but I would really might really be interested in like reading doctors book because it's fairly easy to understand.

33:17

Or if you don't want to read his book, he's actually on a lot of interviews and podcasts and stuff. You can hear a kind of [summary](gh-b0049y.md) view of it, because he talks about, you know, blood sugar. Insulin is a big factor, he talks about several different types. He calls them types of Alzheimer's, based on their data.
...
Great. So these are people you're very familiar with and so this is a topic that you like a lot. That's great. Okay. Now, well, I'm and interested in all sorts of [diseases](gh-a0620z.md) that I think I have a feeling that these hard to detect, my probes could underly. A lot of diseases.

35:34

Yeah, so I think they underlie [chronic fatigue syndrome](sit-cfs-conceptual-convergence.md). You know, this researcher I was mentioning, Karl Morten. Karl Morten, m o r t e n? Okay. The Karl with a K. Yeah, K a r l. Okay. I just watched this YouTube video that he did; in a few minutes I could get you the link if you're interested, but you might be able to find it if you Google it better.

36:08

I love the I think I Googled the L form that area Oxford Chrome Morton, and I think this YouTube video came up, okay. Separate video. I'm really excited that it's research. I was so excited that it that I wrote to, I don't know if you know that open medicine foundation are it's it's devoted to solving [chronic fatigue syndrome](sit-cfs-conceptual-convergence.md) and related conditions, and they've raised a lot of money.
...
Yeah, Carl Morton. Yeah, I found his name and I found his crowdfunding campaign, understanding the causes of, of [chronic fatigue syndrome](sit-cfs-conceptual-convergence.md). And and my allergic and [self](gh-a0206z.md)-lightus and I'm sorry. Open medicine. Foundation open medicine. Yeah, open medicine foundation. It's it's headed. Well, I don't know exactly who heads it, but the research effort is headed by wrong Davis.
...
Because I discovered a lot of things, and I think I may be able to help a lot of people. Do you want to talk about some of the things that you've discovered? I'm totally curious. Okay. Well, there is this book I learned about a long time ago called The Pulse Test by Dr.
...
It's sort of like more on the research or side of things but that's that's sounds like a promising idea. I hope you perceive that. Well yeah, well I have to pursue it. I don't I don't have any [choice](choice.md) in the matter. Yeah. That's the way I look upon it.
...
But in addition to that, there are numerous studies and several meta-analyses showing that resting heart rate elevation is associated with all-cause mortality, including [cancer](gh-a0604z.md) and [Alzheimer's](gh-a0321z.md). You know, in various other conditions, Coka was able to lower people's resting heart rate, and I have lowered my own resting heart rate, so in the research studies with the meta-analyses, at least some of them controlled for exercise.
...
You could use it to combine with the heart rate data and to look for correlations, or basically have the computer create a log of observations that might have medical value. So, just to sort of brainstorm, yeah, I tried to, in my provisional patent.

47:10

I tried to think of all the different possible times, kind of measurements, you could use. And and actually I'm making measurements on [myself](gh-a0206z.md), you know, and you actually said something very interesting one day that see I am using an [EEG](eeg.md) headband, also often times during my meals, but kind of on purpose, I decided not to really study much about them.

47:37

Because, you know, I and I know people are always going to say, oh it's psychological like I've affected my [EEG](eeg.md), which I would have no idea how to effect it. But I thought if I didn't know much about what it meant and then I couldn't really be accused of somehow affecting it, but I have noticed changes with the EEG as my sensitivities have gone down.

48:05

I remember I heard overheard you saying something like the delta and [theta waves](theta-brainwaves.md) were indication of like lower energy in your brain or something. So, something like that. So you always, we always have Delta in the way it's happening, but if you have an, if you have a predominance of Delta in theta, they that's that's seen more often when people are depressed or a low energy or chronic fatigue or sleeping.

48:35

So that's probably close to what I'm saying. Yeah. Yeah and then I remember, I heard years ago that [chronic fatigue syndrome](sit-cfs-conceptual-convergence.md) was characterized by intrusions of [delta waves](brainwaves.md) during the daytime and then intrusion of waves associated with wakefulness in the night. But the thing that I've observed, one of the things with the [EEG](eeg.md) is that it used to be almost always when I was eating things especially when I reacted more to them.
...
Yeah, I really found. So, I did a lot of back in between 2012 and 2014. I, I did a lot of work with [EEG](eeg.md) and a lot of different experiments actually. And I think of it as if you do [neurofeedback](neurofeedback.md), if you just sort of like find a way to either visualize or listen to your own [brain signals](brain-rhythms-in-cognition.md) or other, you know, [biofeedback signals](eeg-biofeedback-self-reflective-loop.md) then that it is a little bit like studying yourself, studying your facial expressions in the mirror or just like, you know, really listening to your voice as a singer as or you know, in in terms of like what it?

50:29

What it, what a person can do from studying themselves in the mirror, like an actor, studying them studying their fate, their own face in the mirror is sort of become more aware of how what they're doing on the inside. And their brain is, is causing different. Facial expressions to emerge or different sounds to emerge from, you know, from their voice if they're practicing singing or practicing acting and and with [EEG](eeg.md) it's it's what I found was that the more I sort of focused on how my [brainwave](brain-rhythms-in-cognition.md) has were changing the [light and sound effects](brainwave-driven-photic-stimulation.md).

51:07

The more I started to understand how I was changing my [brain waves](brain-rhythms-in-cognition.md) because then I could I could actually sort of like with my thoughts and feelings sort of exert some significant influence over the light and sound that I was saying. And so that that's what I was doing for a couple years was just a lot of experimentation with with [EEG](eeg.md).
...
As I think that I think there's a in a relationship between the food reactions and the microbes, You know that microbes do up regulate the [immune system](immune-self-nonself-analogy.md) for one thing and and I think what I'm doing helps normalize the microbiota in your gut and and maybe even in your tissues, you know because if you're functioning better you're going to be able to control [infections](gh-a0125z.md) better and actually that's another thing that Dr.
...
I just didn't tolerate the medications anymore. So killing the microbes may be difficult, but maybe, you know, you think Ideally, you might be able to combine antimicrobials with some kind of [immune modulation](immune-self-nonself-analogy.md) to to maybe to maybe do it, but it's going to be difficult. But anyway, whatever happens I I think that you know, it could be that my approach will be helpful, you know, it may not be the best.
...
There's different. Sort of like emerging research and emerging mysteries around how [self](gh-a0206z.md) behavior is affected by a chemical gradient. And how chemical gradients are sort of like important for [cells to be able to communicate](cellular-communication-graph-neural-network.md) with other cells, in a spatial way to solve certain certain certain problems and or just to conduct certain sort of certain functions like that, I don't want to answer.

01:00:41

Like, sometimes I read researchers and they sounds like they're sort of, anthropomorphizing the cells and the behaviors that are observed to some degree. Like the cells aware of it's environment, what does that mean exactly? But there's also just like, like little bacteria. I think about when the [immune systems](immune-self-nonself-analogy.md) fighting the microbes is like we have our two little armies of.

01:01:03

It's almost like they're little microbes fighting each other. You know you mean cells fighting the bacteria? Yeah, and [cancer](gh-a0604z.md) is the, the parallels between cancer and, and, and little armies, like they're like the very sophisticated behaviors coming from kit from cancer where they, these are like, they that, like, they colonize other cells and they, and they have strategies like war strategies and they they take out they'll take cells over and make the cell act against the rest of the organism.
...
- Source file: `original archived b0328ygoogle.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/original archived b0328ygoogle.md
