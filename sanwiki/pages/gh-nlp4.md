[[neural-lace-podcast|The Neural Lace Podcast]] #4 Guest: Andre Watson
...
Welcome to the Neuro Lace Talks with guest Andre Watson, host [[micah-blumberg|Micah Blumberg]], edited by Adam Alonzi.

I see myself mostly spending time between the world of [[biological-computation|engineering biological systems]] and materials and science,

materials science and engineering as relates to making nanoparticles to deliver [[infogenetics|genes]] to different places in the body.

So what I spend my day-to-day really building is my company, Ligandl, where we are using ligands or things that stick to different markers and things like [[3d-protein-receptor|receptors]]

to guide these vectors for [[infogenetics|gene therapy]] to really specific locations in the body.

And I have spent a lot of time on thinking about [[synapse|synapse physiology]].

I was going to go to McGill for a [[computational-neuroscience|neuroengineering]] PhD, but I decided to come out here and work on this.

So I really love pharmacology and for me, understanding [[consciousness]] or at least a piece of it is incomplete unless we try to look at the [[bridging-molecular-mechanisms|molecular picture]] too.

Yeah, I agree.

So it would be really fascinating to talk about maybe how that plays a role in the future of the [[consciousness-multimodal-rendering-loop|human experience]] and also how we're going to build machines that capture various aspects of [[artificial-general-intelligence|human intelligence]].

What got you on this journey?

What got me on this journey was a book called Unintelligence by [[jeff-hawkins|Jeff Hawkins]]. He was a neuroscientist at the Reading Institute and he was also the president and founder of POMP, made the POMP pilot and the POMP 5 and the hand-spraying device.

And then eventually that sort of, you know, then iPhone came along and sort of took over the market.

So the POMP went away, so what [[jeff-hawkins|Jeff Hawkins]] did instead was he started a neuroscience research institute and he wrote a book called Unintelligence.

And he started this computer company called Numenta and Numenta has their whole idea is basically create a computer that's based on the [[neocortical-dynamics|neocortex]].

And so this computer uses what they call [[hierarchical-temporal-memory|hierarchal temporal memory]] and they say the neocortex is like a hierarchy and the top of the hierarchy is [[thalamus]].

And so [[hierarchical-temporal-memory|hierarchal temporal memory]] means that, well, basically you're sort of describing the structure of a [[deep-learning-neural-networks|neural network]], like as if a deep learning network was specifically structured like a hierarchy.

And so the lower levels of the hierarchy would just focus on the lines and edges and bits and at a higher level you turn the lines and edges into the computer recognizes a concept because it's like a statistically relevant [[coincidence-pattern-neural-bit|coincidence pattern]].

And then at a higher level of the [[3d-neural-network-brain|network]], you have the computer begins to put together the concept of eyes or words or, you know, it's just basically a map of the associations of the lines and edges.

But at a higher level, the computer says this is an eye because that's what the [[deep-learning-neural-networks|neural network]] represents with its weights at different levels.

So, so basically he was describing his book on intelligence he was describing [[deep-learning-neural-networks|deep learning]], which was sort of like this.

So the [[deep-learning-neural-networks|neural networks]] that existed since since the 80s.

A lot of a lot of great designs for computers came from the 80s.

But now that since 2012, we, you know, we had some new ideas about how to make the [[deep-learning-neural-networks|neural networking]] deeper.

So they called it the deep, [[deep-learning-neural-networks|deep learning]], because you pretty much going to get about three layers deep.
...
And that's something that would be really interesting to discuss with you because I've spent a lot of time thinking about [[synapse|synapses]] and sort of how things build from a really bottom up level just, you know, molecular pharmacology,

how different drugs and ligands and things in your brain bind to these different [[3d-protein-receptor|receptors]] in order to create all these different effects.
...
An EEG can tell you some basic things. And if you have a direct interface or some more advanced technology, you can learn a lot more. And certainly even with existing [[fmri|fMRIs]], we're able to recreate visual imagery that our brains are seeing based on the [[fmri|fMRI data]] on its own.
...
Sure. And I never thought about that. Because, so do you remember, Steven Spielberg made this movie called AI [[artificial-intelligence|Artificial Intelligence]]. And in the movie, it was good. It was good. It was a vision of what the future might feature in the future.
...
with [[gh-a0138zcalcium|calcium ions]], and on the inner sac filled with [[potassium-channel-modulation|potassium ions]], you know, the calcium ions are, you know, the positively charged and the, or, and the potassium is the potassium positively charged and it's also positively charged.
...
spending processes, we're able to control not only the [[action-potential|action potentials]], but sort of the, the arc of, yeah, the shape of our firing and [[ionic-magnetic-fields|magnetic field]]. Yeah. Yeah. At a really just fine, superb level of electrophysiological weirdness.

That's why, you know, I like to say I believe that [[consciousness]] is magnetic, because our brains are manipulating a [[ionic-magnetic-fields|magnetic field]].
...
The universe is a [[fractal-pattern|fractal]]. And they'll be like, Okay.

The interesting thing to consider is the, the basis of the kind of [[consciousness]] that we have versus the kind of consciousness that a [[artificial-intelligence|machine intelligence]] would have.

Because we've entirely evolved even from the time of being [[cell-as-chemical-neural-network|single cellular organisms]] to feel the world around us in the form of [[3d-protein-receptor|receptors]] by these different molecules.
...
You have this family of [[3d-protein-receptor|cell surface markers]] known as integrins integrins bind to collagen, elastin, these different extracellular matrix proteins that form the mesh of what comprises your skin and all of your tissues.

And through binding to these surface markers, these [[3d-protein-receptor|receptors]], the receptors are actually mechanosensory.
...
So you have an extracellular matrix of, you know, we think of cells as having, you know, we have, you know, 70 trillion [[cell-as-chemical-neural-network|cells]] in our body.
...
we're able to derive very specific information where pulling on a single [[3d-protein-receptor|receptor]] that is bound to by an extracellular matrix protein can trigger very specific [[soliton-wave-mechano-neural-signaling|signaling cascades]] that cause remodeling of the entire system around it.

And this is no different with [[apical-pyramidal-neurons|neurons]]. If you think about a neuron and the axon and the [[dendrite]] being latched together, people always think of them as just, they're just sending signals and it's just electricity.

Have you ever wondered why a [[dendrite]] sticks to an axon?

Yes.

And that's, that's the same thing, actually. It's an extracellular matrix that holds them together. And you have these different [[3d-protein-receptor|surface markers]] that latch the [[emotion-as-axon-frequency|axon]] to the [[dendrite]] physically.

So you have, for example, this family of proteins known as neturins that bind to neturin [[3d-protein-receptor|receptors]], and they're one of the major extracellular matrix components that hold together axons and neturins.

What are their electrical properties? I mean, they want to, you don't want to have like, because you need this [[synaptic-cleft|synaptic gap]] for the [[chemical-synapse|chemical synapse]]. So whatever's connecting the two can't, can't, you can't have an electricity running across that because otherwise it would defeat the synaptic gap.
...
Well, someone was saying that the deep blue, not deep blue, but the guy who's working on the blue brain, he was saying that they created a model, a computer program to try to simulate where [[synapse|synapses]] would, where they would connect, where cells would connect.
...
So they're basically, they're saying that basically in the beginning when people are born and their [[synapse|synapses]] are first growing and connecting, that it's basically like random.
...
Well, one of the things there that I really wanted to talk about is the nature of kind of, we can call it the, the now brain versus the evolving brain. Or if we want to say it perhaps in terms of pharmacology, the [[ionotropic-signaling|ionotropic brain]] versus the [[metabotropic-signaling|metatrophic brain]].

So when you think of an [[action-potential|action potential]], when you think about these metal ions flowing in and out of the cell and being pushed around to change the way that charges work, that's ionotropic.
...
So most serotonin receptors, every [[dopamine]] receptor, if as you go through the thousands of receptors, like, you know, 800 receptors that are [[3d-protein-receptor|G protein coupled receptors]], they're actually the most common protein in your body.

You have about 800 of them.

So all [[dopamine]] receptors, all but one serotonin receptor are [[3d-protein-receptor|G protein coupled receptors]].

They have all these different subclasses.

G protein in itself is a ton of calculation, [[cell-as-chemical-neural-network|chemical calculation]].
...
In your [[deep-learning-neural-networks|neural network]], if you only capture the [[ionotropic-signaling|ionotropic]] part, how do you predict how each brain will change?

Well, I mean, okay, so I mean, you know, I think, okay, so I guess in terms of, you know, look at, consider [[neural-tomography|diffusion tensor imaging]], right?
...
If you imagine kind of the picture of the neural tract that you mentioned through the data of the [[fmri|fMRI]].
...
So, it's just like... That's why using [[deep-learning-neural-networks|neural networks]] to decode brain activity is going to work.

Because we can identify the pattern of broccoli in our real world.

And if we're able to look at [[brainwaves|brain waves]] long enough, if we had the senses to understand brain waves long enough, then we could identify broccoli in our brain waves.
...
Because, well, let's look at... I mean, a good analogy is to look at how does a [[gh-a0206z|self]]-driving car recognize if it can move forward or not?

So, you dive into this topic and it's... How [[deep-learning-neural-networks|neural networks]] work is useful to talk about because then you can start to have ideas about how our brains are working.

So, if you say, well, a [[deep-learning-neural-networks|neural network]] is recognizing that there's a car in front of its path.
...
And the [[deep-learning-neural-networks|neural network]] is putting together all the little different...
...
Your eye has tons of [[3d-protein-receptor|receptors]] in it.
...
You know, you have a separation of positive and negative charges and there's an [[action-potential|action potential]]
...
and then back to the [[visual-cortex|occipital lobes]] and pridelobes and the rest of the brain activity.
...
and they're bouncing off your eye and then they're triggering [[brainwaves|brain waves]].

And these [[brainwaves|brain waves]], they have characteristics that in time, like frequency patterns

and they have characteristics in space.

And your brain as a network is processing [[brainwaves|brain waves]] that have their spatial and temporal patterns.
...
and the computer is watching the [[brainwaves|brain waves]] while the computer is watching the bottle.

The computer is learning the [[brainwaves|brain waves]] in the bottle at the same time and saying this is this and this is this.
...
What [[deep-learning-neural-networks|neural networks]] are able to do in terms of [[pattern-neurons|pattern matching]] and the [[gh-a0206z|self]]-driving.
...
we're able to form such different experiences from moment to moment because even every single one of our 100 trillion [[synapse|synapses]] can possess so many states

that it's a functional equivalent of, I think people like to abstract the neuron away when they're thinking about [[deep-learning-neural-networks|neural networks]].
...
The brain is very much a [[multimodal-integration|multimodal system]].

Having two eyes and two nostrils and two ears allows for a [[multimodal-integration|sensory confirmation]].

Two [[3d-protein-receptor|receptors]] cluster together hundreds of millions of times on a single [[synapse]] with the two being not only far more unique,

but also forming their own unique signaling cascade versus the two existing in isolation.

Our very most basic signaling unit of this heterodimer or heterotrimer of two or three [[3d-protein-receptor|receptors]] cluster together
...
is [[fractal-pattern|fractal]] and it's all mathematics.

And there's this conference coming up but it's on the other side of the planet and I

wish I could go to it.

It's all about how the [[dendrites-as-computational-units|dendrites computer]] and it's a Nementa conference.

And [[dendrite|dendrites]] are they're hugely important.
...
We're going to dive deeper into dendrites and [[dendritic-computation|dendritic computation]].
...
topic of [[artificial-intelligence|artificial intelligence]] and the latest innovations that people are discovering.

And one of those is really interesting because they're discovering that because if you want

[[artificial-intelligence|AI]] to take sensor data and recreate a 3D structure from that, it's actually a really hard problem.
...
And so they're giving this [[artificial-intelligence|AI]] 3D models and it's more able to handle this.
...
So you have the crocodiles, let's say it's a [[deep-learning-neural-networks|deep learning]] program and like a neural network
...
And so the crocodile is getting to each eye has millions of sensors in it, [[retinal-oscillations|light sensors]],

and it's going through the [[deep-learning-neural-networks|neural network]] and it's creating like all these [[brainwaves]]

which are the sort of like a brainwave of four dimensional patterns.

It's like an [[ionic-magnetic-fields|electromagnetic tensor field]] moving with all these different parts moving
...
how we potentially might build better AI by making it [[multimodal-integration|multimodal]].

And I think it needs to be at the very baseline level

the more we can mimic the [[dendritic-computation|architecture]] of how single [[synapse]] functions

the closer we'll probably get to capturing the breadth and the richness of the human experience.

## Source Provenance

- Source file: `nlp4.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/nlp4.md
