...
I am not enjoying the thought experiment of picturing the interior of my mind as giant volumetric computer screen. It's like look around you, what you are seeing is not reality, it's a replication of reality that is computationally rendered in the volumetric computer screen of your brain.
...
# There is a neuropath defined by grown biological connections (LTP synaptic growth/LTD synaptic atrophy), and there is a shorter term neuropath (for faster shorter term memory) defined by active & inactive synaptic connections that can change with somatic phase changes (that differ from the tonic rate ie when the soma is inhibited, fires phasically, or fires burstlets). (Why does this remind me of FPGA, a Field Programmable Gate Array is not meant to change this fast, not the right hardware)
