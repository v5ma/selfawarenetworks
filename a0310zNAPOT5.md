...
Spacetime event cells (or Place cells outside the Hippocampus) create burst firing events, initiating sharp wave ripples, when there is a pattern match between the pre-soma & post-soma sides of the neuron. And I am arguing that place cells or what I like to call "local spacetime event cells" are effectively ubiquitous throughout the neo cortex, not just in the Hippocampus, but in every cortical column, and mini column.
