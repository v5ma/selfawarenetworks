...
(category [[theory]], [[observer-effect|observer]], [[fractal-conscious-perception|perception]], [[electromagnetic-emotions|electromagnetism]], super position, array, conjecture, [[electromagnetic-emotions|emotion]], [[cortex]], [[semantic-cortical-mapping|semantic]], [[pattern-neurons|neuron]]) 

In some interpretations of the Judaic and or Kabbalic tradition, G-d before he enter's man is Ayn Sof, infinite boundless, nothingness, aka nothing, and then when he is inside man, he is still nothing, but he is the eye of the hurricane, and man's [[dissipative-system|dissipative system]] is the vortex. So in a sense it means G-d is the space in the center of your [[brain-as-memory-prediction-machine|mind]]. The inner peace. So in a sense it's not a matter of believing in Deity, but defining deity as a spacial and temporal metaphor within yourself and beyond yourself
...
collective messiah
one in which you become one [[pattern-neurons|neuron]], a [[fractal-pattern|fractal]] inside a collective
your [[brain-as-memory-prediction-machine|brain]] communicates with other brains, the same way your left hemisphere communicates with the right hemisphere
it's not a religion; it's a conceptual threshold, a paradigm
the [[spacetime|tempo-spatial]] metaphor is the wisdom that philosophy consumes
so I say it's a concept that relates a spacial metaphor for philosophical digestion
G-d is food, brain food, food for your [[brain-as-memory-prediction-machine|mind]], your cells, which are hungry, so eat smart, and eat well
...
If something doesn't exist does it have to equal [[semantic-tokens-as-vector-geometry|zero]]?
How could there be any difference between two abstract [[semantic-tokens-as-vector-geometry|numbers]] like 5 and 7 if neither exist, and both are really equal to nothing?
5+7=0 because [[semantic-tokens-as-vector-geometry|numbers]] don't exist, they all equal zero
if you think of the number 7 for any length of time, it alters your brain's neurophysiology did you know that? it changes your [[brain-as-memory-prediction-machine|brain]], could this happen if the number 7 didn't exist?
every [[thought-is-physical|thought]] effects your neurophysiology
5 does not effect your [[brain-as-memory-prediction-machine|brain]] the same way 7 does
some people see red with the number five, and green with the number 7, this is called synesthesia. synesthesia is real it's not made up, and it's been verified over and over again, but this would not be possible if these "non-existent" [[semantic-tokens-as-vector-geometry|numbers]] didn't have an impact on your brain
...
or it's to say that space time and [[gravity-as-information|gravity]] is "in your mind"
the entire cosmos is just "the metric" in general relativity, which sounds a bit similar to "the matrix," doesn't it? "The metric" is a four dimensional description of [[spacetime]] gravity, and you can think of spacetime gravity as a metaphor with density, curvature, and [[new-law-of-thermodynamics|thermodynamic]] properties, all of which are "spatial temporal metaphors" for your mind to coordinate its movements in both space and time.
if you subtract all of the descriptions from space, and all of the artificial abstract [[distinction-as-root-of-perception|distinctions]], you get non-dualism, or space that is not even two things. No distinctions and no artificial descriptions mean that space is not distinguishable from anything. It's not white, it's not grey, and it's not blue. You can't tell the difference between your feet and a cloud in non-dualism, and you can't tell the difference between a sharp knife and a butterfly without all the non-existent distinctions in your mind, which are no less and no more non-existent than any number.
a [[semantic-tokens-as-vector-geometry|number]] is description, and so is the spatial metaphor that is your foot
the second a number doesn't exist, neither does your foot really, because both are artificially conceived distinctions that are not there without your [[brain-as-memory-prediction-machine|mind]]
thought is the [[brain-as-memory-prediction-machine|memory-prediction]], that is a conceptual formation of all that's there and real, in order to coordinate movement. every distinction your mind makes is like a number, in the sense that it's knowledge about the world that's in your mind, not in the world
numbers and functions are programs, and the topoi of anything you see is really a [[action-potential-topology|visual program]]. If you see a bell drop, hear a bell drop, and your brain aligns both patterns, it's not just an association; it's a topological program that you can share with any person verbally or in text, and the verbal way of saying what happened triggers the same neural firing as if you were to watch or see a bell drop. What the human mind saves is a topological program that represents every kind of [[memory-as-probability-distribution|sensory memory]] as a shape, and transmits a snapshot of that shape to other parts of the brain when it is triggered by its association in any input from any sensory modality, such as seeing a bell drop, hearing a bell drop, reading about a bell drop, or hearing someone describe a bell drop.

/////////////////////////////////////////////////////////////

Some might say that without your [[brain-as-memory-prediction-machine|mind]], there are no trees at all, just atoms. So perhaps trees don't exist? A tree is just an artificial description assigned to a body of atoms & molecules & cells with particular properties. Trees are descriptions, and like numbers, they don't really exist (as [[functional-information|information entities]]).
...
How do people think that their [[thought-is-physical|thoughts]] do not exist? Thoughts effect your physiology, if you think about Santa Claus or the Easter bunny that has a physical effect that causes changes to your [[brain-as-memory-prediction-machine|brain's structure]], and your neurons are connected to each other and every system in the body in one way or another.
...
If something truly doesn't exist, you can't [[thought-is-physical|think]] about it. It's impossible to think about.
and trees exist, but only as simulations

I would say that [[intelligence-high-dimensional-coherence|intelligence]] is neither subjective nor objective; instead, it's [[prediction|predictive]]. You still get the "ctive" part. Predictive is more descriptive than subjective, while not requiring a meaningless context like objective.
How does [[prediction]] imply an irreversible timeline? How is implying an irreversible timeline a problem statement?

"under certain conditions [[spacetime|timeline]] can be reversible (small time frames)" under what conditions, can you cite a reference?
"prediction is not the only model of [[intelligence-high-dimensional-coherence|intelligence]]" what model of intelligence stands incompatible contrast to the 'prediction' model?
...
How is [[functional-information|data]] compression a timeless task?
The word task implies a temporal dimension. In fact the phrase "data compression" implies a temporal dimension, a point when the [[functional-information|data]] is not compressed, and a point when the [[functional-information|data]] is compressed.
...
This [[functional-information|data]] packet is too compressed. Can you take it apart and explain it in pieces so that I can understand more clearly the point you want to make?
...
The static yet complex image is an example of an offline problem, there isn't any new information, but your mind is able to [[prediction|predict]] something new about that offline problem after looking for several minutes.
So [[prediction]] does not only apply to online problems.
Now you say if you sent an [[artificial-intelligence|AI]] program (not based on the principles of prediction) to search that picture for patterns, it's still a temporal process, from start to finish, for that program to run, execute it's functions, and finish.
The out put of the [[artificial-intelligence|AI]] program, no matter how it was designed, can be construed as a prediction.
[[prediction|Prediction]]=Result of Application, it's result is a prediction, just as the result of my thinking is a prediction. It's not the method that makes it a prediction.

[[prediction|Prediction]] is the secondary context, it's relationship to what we do with that [[functional-information|information]] next.

1. Do the laws of [[gravity-as-information|physics]] exist?
1a. Are the laws of physics really laws?
1b. Do the laws of [[new-law-of-thermodynamics|thermodynamics]] really exist?
1c. Does [[gravity-as-information|gravity]] really exist?
...
Intuition is a [[sparse-distributed-representation|sparse distributed representation]] of reasoning. What it loses in high resolution accuracy it makes up for in efficiency and ease.
Each method, reason and [[sparse-distributed-representation|intuition]] are like tools in a tool box. I use the right tool for the right job. Not one tool to the total exclusion of the other.
...
a human thinks he is more evolved than the grass he walks on, but [[evolutionary-mechanisms|evolution]] does not see the human, and it does not see the grass; it only sees the replication of the dna code. Anything that is alive today is on par with us, and you could think of the whole genetic code, including all plants and animals, as that which is evolving, instead of thinking of humans as having a separate evolution, separate even from one another.
...
"Up to this time most of people have more-or less similar [[gh-a0206z|self]]-model that make them compatible with each other." They have changed history since I left highschool. In your history books there was no such thing as war? Oppression? Religious conflict? Burning witches? Greek God's?
...
What I seem to approximate --> becomes a [[memory-as-probability-distribution|memory-bet]].
...
[[consciousness|Consciousness]] is an internal description, like every other description, like a number. If a number isn't real, then consciousness isn't real, if consciousness is real, then a number is real.
...
if you say numbers don't exist, but consciousness does exist, then your in [[gh-a0206z|self]] contradiction on some level
...
on the contrary to the suggestion "[[gh-a0206z|self]]-perception of our subjective consciousness is not complete mathematically"
[[gh-a0206z|self]] perception is 100% mathematical
...
So [[inhibitory-neurons|inhibitory cells]] fire and prevent Z from firing. Reproduction does not happen. That's a halting moment in both computer code and the brain.
...
If information in your [[brain-as-memory-prediction-machine|brain]] is physical, then numbers do exist.
...
taking the position that [[semantic-tokens-as-vector-geometry|numbers]] are between existing and not existing, and so are we?

How can we know that existence fully exists, as opposed to being a potential between existence and non-existence?
Is the existence of existence perhaps less than a [[gh-a0206z|self]] evident axiom?
...
Finally, the point about the [[brain-as-memory-prediction-machine|brain]] being like its own programming language like Lisp was actually a good one. Reality is still a definition, even if the definition is more complex than just a prediction. The definition is whatever it is, and perhaps all the extreme views of today will be the moderate views of tomorrow. Who knows. With Ken Wilber's map of cultural integrations, what he calls integral life, it's clear to me that I don't need to worry about any of this. In time wisdom prevails, or we all die.

If a man is not his ideas, then he is meat, and if a man's [[actions]] are not congruent with his words then he is spineless meat, without integrity or reputation. The grand ideas expressed by the fool must be borrowed, and not originating from that fool. Otherwise it is not reason that chooses a man's choices; instead, it is the random impulses of chemical imbalances, and man's mind is damned eternally. Such is the hope and fear of [[artificial-general-intelligence|AGI]], that we may build happy minds that are kind, caring, and loving, and that we may, because of our own chemical imbalances, build horrible minds, war machines, to hate and kill, for such is the whimsy of man, crazy enough to engineer his own demise.

## Source Provenance

- Source file: `a0497z.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0497z.md
