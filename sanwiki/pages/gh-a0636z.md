...
BCI + AI/DL + XR
Computational Biology and the future of brain machine interfaces with deep learning AI, virtual reality, and [[augmented-reality|augmented reality]]: Presentations, Collaborations, Discussion, and Workshop
...
This meetup designed to unite the Brain Machine Interface Neuro Hacking community with [[augmented-reality|Augmented Reality]] and Virtual Reality developers, and Machine Learning Deep Learning developers as well as people working in Theoretical Neuroscience and on Computational Biology.

My name is [[micah-blumberg|Micah Blumberg]], I'm the organizer of this meetup and I also represent, as an Ambassadoser, a developer called the Vision Agency that makes MicrodoseVR at MicrodoseVR.com and our team has already built an application that uses the Muse EEG faceplate for HTC Vive to track your heart beat and make the graphics in the VR app pulse with the beat of your heart, however that is a completely separate project from this and my goal is serve the community of Neuro-hackers like ourselves by creating open source tools that we can all use and share and work on together. I would like us to feel inspired by the Vision Agencies work to combine BCI with VR, but that's all. I also founded the [[gh-a0001z|Self Aware Networks]] group on faceobok, I admin 30 groups, I do [[neural-lace-podcast|the Neural Lace Podcast]] and Silicon Valley Global News a short bio is at http://vrma.io 
...
Groups on related topics such as [[neural-lace|Neural Lace]]:
[[gh-a0001z|Self Aware Networks]]: Computational Biology: [[neural-lace|Neural Lace]]
...
Goal #1 Adapt BCI hardware to fit an XR headset. (XR refers to [[augmented-reality|Augmented Reality]] and or Virtual Reality)
...
- Source file: `a0636z.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0636z.md
