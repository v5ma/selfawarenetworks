# a0048z: Neural Variability, Dissipation, and the Early SAN Program Map

a0048z

(synap, semantic, metaverse, perception, oscillat, neuralink, [[dendrite]]) 

[[gh-a0001z|Self Aware Networks]], Artificial Neurology, Nerve Gear
...
life is an [[oscillating-network-of-oscillators|oscillating network of oscillators]] that cooperate so that we maintain their collective equilibrium, when complex vortices combine forces to stay motivated and alive
...
3. Robots, VR, AR, Volumetric Video, Deep Learning, [[3d-semantic-segmentation|3D Semantic Segmentation]], John Carmack from VR to AGI. AI multi-modal approaches (GP3), Pointnet++

4. Biologically plausible artificial brains. Perception 2021, Brain extensions, Metaverse, Simulation, Numenta , FPGA, Comp Neuro

The Neurons synapses, via Potassium are preseting the criteria for what patterns the neuron will respond to, and they are presetting the shape of the wave form of the axonal [[action-potential|action potential]], by changing the time for when it closes, which will determine the amplitudinal/frequency deviation from its local oscillatory body should its threshold be triggered early into a phasic burst or should it become inhibited from firing tonically.

## Source Provenance

- Original source repository: https://github.com/v5ma/selfawarenetworks
- Original source file: `a0048z.md`
- First GitHub upload: commit `7c8d8d5b46eceda55b0c1b1f11ef79a23fab9610`, authored 12 Jun 2022 at 15:25:27 -0700, with subject `Rename a0040z.md to a0048z.md`.
- Latest checked source commit: `d1c26a6fbf273695185a4036411215f53209eb71`
- Source blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0048z.md
- Source history: https://github.com/v5ma/selfawarenetworks/commits/d1c26a6fbf273695185a4036411215f53209eb71/a0048z.md
