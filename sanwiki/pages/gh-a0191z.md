...
In the same book [[gh-resnote04|Micah]] is reading:
...
Though, yes, that is an upper bound, as the owl is an extreme auditory specialist, and that is just for one part of the brain. The mechanism is via coincidence detection using dendritic trees, which highlights there's more going on in the brain than is taught to AI researchers. [[dendritic-computation|Dendritic computation]] isn't even properly appreciated by most neuroscientists, and has only recently has interest in them surged.
1 hr · Like · 1
...
[[gh-resnote04|Micah]] says: No they don't, because memory isn't a stored pattern, it's a strong chance of a pattern based on previous experiences.
...
[[gh-resnote04|Micah]] says: I think it's possible to increase or decrease the resolution of memory experiences by changing the chemical ecosystem of the brain, in other words formatting is not hard coded like a program, it's dependent on chemical conditions in the brain.
57 mins · Like · 2

Pierre de Lacaze
So given that [[gh-resnote04|Micah]], how accurate is it to call what the brain is doing "computation"?
53 mins · Unlike · 1
...
Juan Carlos Kuri Pinto
[[gh-resnote04|Micah]], I prefer NOT to intervene in my brain chemistry.  Neuroscientists don't know enough about the brain to safely intervene in its chemistry.
47 mins · Unlike · 1
...
Juan Carlos Kuri Pinto
Kurzweil's estimate for the computational capacity of the human brain is useful to multiply it by whatever factors future neuroscientists think are relevant for [[artificial-intelligence|artificial intelligence]].
43 mins · Like
...
[[micah-blumberg|Micah Blumberg]]
Pierre de Lacaze said "So given that [[gh-resnote04|Micah]], how accurate is it to call what the brain is doing "computation"?"

Black Square said
"Pierre de Lacaze I'm sure you're familiar with the Physical Church-Turing Thesis. So how is what the brain is doing anything other than computation?"

[[gh-resnote04|Micah]] till the end:
...
Pierre de Lacaze
Very nicely stated [[gh-resnote04|Micah]]. This is like a model of computation in which the computation itself affects the computation.
20 mins · Unlike · 1
...
This Apr 10, 2014 thread centers on whether [[memory-as-probability-distribution|memory is better modeled as a probability distribution]] than as a stored media file, and it repeatedly contrasts [[brain-as-memory-prediction-machine|memory prediction]], [[working-memory|working memory]], [[memory-consolidation|memory consolidation]], [[attractor-memory|attractor memory]], [[cellular-memory|cellular memory]], and [[self-activating-content-addressable-memory|content-addressable memory]]. The exchange also ties those memory claims to [[dendrite|dendrites]], [[apical-dendrite|apical dendrites]], [[dendritic-computation|dendritic computation]], [[dendrites-as-computational-units|dendrites as computational units]], [[human-dendritic-computation|human dendritic computation]], [[dendritic-pattern-recognition|dendritic pattern recognition]], [[dendritic-morphology-memory|dendritic morphology memory]], [[synapse|synapses]], [[chemical-synapse|chemical synapses]], [[long-term-potentiation|long-term potentiation]], [[long-term-depression|long-term depression]], [[neurotransmitters|neurotransmitters]], [[glial-cells|glial cells]], [[neuronal-membrane|neuronal membranes]], and [[sensory-cortex-encoding|sensory cortex encoding]].

The debate's computation vocabulary runs through [[artificial-intelligence|artificial intelligence]], [[biological-computation|biological computation]], [[computational-neuroscience|computational neuroscience]], [[computational-phase-synchronization|computational phase synchronization]], [[predictive-coding|predictive coding]], [[cells-as-pattern-recognition-devices|cells as pattern recognition devices]], [[sparse-distributed-representation|sparse distributed representation]], [[brain-as-queryable-network|brain as queryable network]], [[brain-as-rendering-engine|brain as rendering engine]], and [[brain-as-hard-drive-vrma-2017|brain-as-hard-drive criticism]]. Its timing and signal arguments connect [[action-potential|action potentials]], [[action-potential-waveform|action potential waveforms]], [[neural-spikes|neural spikes]], [[information-theory-in-spiking|information theory in spiking]], [[phasic-firing|phasic firing]], [[phasic-burst-firing|phasic burst firing]], [[burst-event|burst events]], [[brainwaves|brainwaves]], [[brain-rhythms|brain rhythms]], [[theta-oscillations|theta oscillations]], [[oscillators|oscillators]], [[oscillatory-coupling|oscillatory coupling]], [[phase-reset|phase reset]], [[phase-space|phase space]], [[synchrony|synchrony]], [[wave-synchronization|wave synchronization]], [[coincidence-detection|coincidence detection]], and [[coincidence-pattern-neural-bit|coincidence pattern neural bit]].

The later comments frame consciousness as a dispute over [[qualia|qualia]], [[consciousness|consciousness]], [[phenomenological-consciousness|phenomenological consciousness]], [[neural-rendering-of-qualia|neural rendering of qualia]], [[consciousness-as-dissipative-self-organizing-system|consciousness as a dissipative self-organizing system]], [[brain-as-dissipative-system|brain as dissipative system]], [[dissipative-system|dissipative systems]], [[brain-self-organized-criticality|brain self-organized criticality]], [[brain-plasticity|brain plasticity]], [[jeff-hawkins|Jeff Hawkins]], and the [[micah-blumberg|Micah Blumberg]] source lineage represented by [[gh-resnote04|Micah]].
...
- Source file: `a0191z.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0191z.md
