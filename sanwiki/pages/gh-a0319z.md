...
The mind is a point when reality is convex, when reality that has a [[fractal-pattern|form]] is now sort of doubled back on itself.

I mean to argue that forms exist in nature, in the mountain, the river, the snow, and the land and sea. But these are not [[agentic-brain|actors]]; they have no intentions, no mental organization, and no goals. It is just [[life-as-cooperative-oscillations|physics]].

A human being, or an animal with a [[brain-as-queryable-network|brain]], is also just physics, but this is a different physical system because its flow is [[gh-a0206z|self]] referential, its flow is an [[agent-phase-sync-feedback-loop|feedback loop]], and its flow has the structure of a [[3d-neural-network-brain|3D neural network]], evolved to have special functions, a [[gh-a0206z|self]]-replicating dissipative system, and an evolved [[biological-computation|computation]].

We can argue that the nature of the evolution of the universe is like a [[3d-neural-network-brain|3D neural network]] that evolved from the harmonic oscillating field of space, from the [[fractal-oscillation-cosmos|physics of oscillation]], which clumps together over time, increasing in extropy in one area while increasing in [[entropy-complexity-duality|entropy]] in another area.

I think of [[phenomenological-consciousness|consciousness]] as something that arises from a set of [[brain-as-memory-prediction-machine|memory-prediction-rendering]] arrays that are firing off patterns in temporal-spatial sequences, but specifically the firing represents some extended interval of time. What I mean by this is that when a video is playing, you have one frame playing back on one screen at a time, but when a conscious entity does video playback it is like 100 simultaneously different videos playing back on 100 different screens. If one neuron is a screen defined by its inceptive field or its exit terminal array, then you have 86 or 87 billion screens and 86 or 87 billion variations of the video.

In an [[gh-a0004z|artificial neural network]], such as a deep neural network, there is an input layer, then there are hidden Markov layers, and finally there is an output.

Effectively NAPOT ([[neural-array-projection|Neural Array Projection]] Oscillation Tomography, the main argument of [[gh-a0001z|Self Aware Networks]] theory) is arguing that each layer in the brain's neural network is a [[neural-array|neural array]], an input layer (array), and an output layer (array). In fact, each node or neuron is both an [[observer-observed-entification|observer]] (input) and a [[brain-as-rendering-engine|display]] (output). This contradicts Daniel Dennett's work Consciousness Explained, which claims we do not have an internal display in the brain. I am arguing that we do, but it is distributed. The [[neural-array-projection|neural array projections]] are the displays, and the eyes are the receptors, the dendrites, and the somas, and the observers are the [[neural-oscillation-hierarchy|oscillating groups of cells]].

Whereas a diffusion neural network renders only the output the neural networks process, in the human brain each output from each neuron is the [[continuous-neural-rendering|rendering]].

Metaphorically you can imagine that there is no central canvas, no computer screen where all the renderings show up, because the [[distributed-observer-vs-consciousness-module|rendered outputs are distributed]] all over the place and absorbed by the brain for the next iteration of the rendering.

The [[consciousness-multimodal-rendering-loop|rendering of the content of the mind]] is both distributed and constantly changing, but it is organized by neural pathways that are organized into [[attractor-loop|feedback loops]]. The neural pathways are constantly changing at the [[dendritic-spine-temporal-memory|synaptic scale]], like train switches redirecting the flow of traffic, and this process develops new patterns. The patterns are also bound together by the physics of oscillation taking place in both time and space, with [[brainwaves|brainwaves]] serving as [[attractor|attractors]] that regularize the oscillating feedback loops into a coherent pattern, with the perturbations and deviations from that regular pattern serving as [[qualia|qualia]] or the rendered information content of the mind.
...
But there is a display. It is just embedded and distributed across your cells as differences or [[phase-wave-differentials|phase wave differentials]] in signals that flow through the [[neural-oscillation-hierarchy|oscillating feedback loops]] of your brain.

Scaling up micro changes in distributed micro-displays, defined by the inceptive fields of [[neural-array|neural arrays]] transmitting or projecting to the [[receptive-field|receptive fields]] of the next set of neural arrays, we have to imagine how micro changes that we are not aware of at the individual synapse scale transform into [[brain-data-structure-query|information forms]] that we are aware of in the experience of [[phenomenological-consciousness|phenomenological consciousness]].

The argument is that these forms are consistently replicated, or variations of [[functional-fractal-isomorphism|isomorphic]] replications are oscillating enough times across enough of our neural arrays to change the macroscale of information formation in terms of [[brain-rhythms-in-cognition|brainwave oscillations]].

In other words, when the microscale changes are compounded through many iterations across many of our internal screens into persistent forms or forms that persist over time, we become aware of them when they achieve some threshold of [[competitive-neural-pattern-dominance|pattern dominance]] in brain activity. That is when the forms of the mind are hallucinated into mental existence. The synchronous repetitive or repeated firing of the same or similar pattern means it is hallucinated or lucinated into consciousness; a pattern becomes lucid, lucidated, or lucinated. To play with the words hallucination and lucidity, that is when [[consciousness-persistent-rendering|rendered information becomes conscious information]].

Then we have Distributed Muscle Output: learned and highly coordinated muscle movement is also stored as a [[sparse-distributed-memory|Sparse Distributed Memory]] that projects when activated, and via [[oscillatory-synchrony|oscillatory synchronization]] the projections of many sparse distributed muscle memory predictions are bound together. I refer to this process as [[neural-tomography|Oscillatory Tomography]], and it defines how many independently activated muscle reactions in the brain send signals to modify central pattern generators in the nervous system to guide [[actions|movement]].

This is similar to how the accumulation of electrical charges via [[graded-neural-firing|synchronized firing]] results in [[motor-cortex|muscle movement]].
...
that is to say that the form of knowledge of redness or of broccoli, or of a cup might be a variation relative to the brains [[tonic-oscillation|tonic oscillation]] it will also be comparable in terms of its information properties to the knowledge form of redness, of broccoli, or of a cup in some other brain

I am arguing that your inner representations are somewhat subjective and somewhat objective simultaneously, inner representations & inner renderings of the the world, of persons places things and trajectories or [[actions]] and choices, the renderings of nouns and verbs, these things are rendered relative from a baseline of [[tonic-oscillation|tonic oscillation]] and they can be distorted with modulation to that baseline, but they are partly also translatable & decodable such that they could be recognized by other tonic baselines rendered by other brains,
...
Imagine that we could breakdown the etymology of consciousness into something new consisting of parts like context, rendered contextual comparisons, [[gh-a0206z|self]] being a rendering in the context of other renderings in the context of visual renderings in the context of auditory renderings, in the context of feeling renderings, in the context of touch renderings, 
...
but imagine the signals in your mind that make up the renderings of what you are focused on are loosely like clothing tumbling in a dryer, the clothing fundamentally maintains its form, its informational structure, even as it is tossed around in a cycle, the dryer that is tumbling the clothing or the informational forms that the conscious mind is focusing on would be the feedback loops of the neocortex, of the cortical columns, the cortical thalamic loops, and the hippocampal entorhinal loop, the fact that signals are tossed around in loops is the comparison to the dryer, and the the fact that the tossed forms, maintain their essential structure, is the significance of the brain passing soliton waves or information containing waves, that are both stable waves, and waves that are distinct from the [[tonic-oscillation|tonic oscillation]] of brain activity

consciousness is context referencing context, [[gh-a0206z|self]] referencing [[gh-a0206z|self]], where [[gh-a0206z|self]] is a rendered pattern that is a distinct information/energy configuration, that oscillates inside a feedback loop that is made up of brain state elements that alternately render & detect renderings, 
...
[[gh-a0206z|Self]] referential thinking: think of phenomenological consciousness as a cycle of contexts (that are reach rendered patterns)
...
- Source file: `a0319z.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0319z.md
