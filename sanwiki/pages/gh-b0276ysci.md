...
This version of the document includes the original audio, an AI [[gh-b0049y|Summary]] & Key Points by SciSummary, and a Whisper OpenAI Transcription.

Original Audio: https://recorder.google.com/69fad460-3a0f-42c6-a764-f8602c6067e9

Note: I don't agree with parts of the [[gh-b0049y|Summary]], and parts of the Key Points. It's a rough [[gh-b0049y|summary]], not exactly correct, but enough to help me remember the general content of this note.
...
It's an abstract pattern, a temporal spatial pattern. So it's either all stuff stored by dendritic recognition, spikes on the [[dendrite]], spikes on the [[synapse|synapses]], spikes on the tongue.
...
So you have a pattern, okay, so you could have a network of neurons, a [[3d-neural-network-brain|neural network]] of pattern detectors.
...
So each neuron takes a [[gh-a0206z|self]]-out and becomes a neighborhood after firing, and so if they fire in like 10 milliseconds, if they fire, like if you don't fire in 10 milliseconds, then the signal keeps passing, so now the signal is traveling, right?
...
you go back in layers, the visual one [[visual-cortex|cortex]], the visual two cortex, the visual six cortex,
...
detection layers in the eye, and then there's the [[visual-cortex|visual cortex]], and then there's the [[thalamus]],
...
music, and if you play the high level representation in the [[visual-cortex|visual cortex]], it's going to be made
...
in the [[visual-cortex|visual cortex]], it's going to feel like a pattern that you're feeling, or smell like
...
and transmit stuff, so that means [[neurotransmitter|neurotransmitters]], neurotransmitters, neurotransmitters sometimes.
...
representing the same object. Right. So where is the [[gh-a0206z|self]] representation. Well the [[gh-a0206z|self]]
...
- Source file: `b0276ySci.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0276ySci.md
