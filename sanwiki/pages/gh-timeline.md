...
- **Context**: The earliest drafts of concepts for "[Self Aware Networks](./gh-a0001z.md)" and "Quantum Gradient Time Crystal Dilation" were made in private notebooks.  
...
- **Pinned Article on SVGN.io** (Date unknown, references older videos):  
  - A pinned article on [SVGN.io](https://www.svgn.io/) contains links to older YouTube videos allegedly recorded around 2017 (and possibly earlier). These focus on AR/VR and early thoughts on neural networks but **do not** explicitly mention "[Self Aware Networks](./gh-a0001z.md)" or "Quantum Gradient Time Crystal Dilation" by name.
...
- **Assorted Medium Articles** (Dates vary, 2017–2018):  
  ...
  - These do *not* mention "[Self Aware Networks](./gh-a0001z.md)" or "Quantum Gradient Time Crystal Dilation."
...
- **Medium Bio**:  
  ...
  - Provides background on neuroscience and programming but **does not** specifically mention "[Self Aware Networks](./gh-a0001z.md)" or "Quantum Gradient Time Crystal Dilation."
...
- **GitHub Repository: `selfawarenetworks`**  
  ...
  - The repository is made public on **June 17, 2022**, explicitly referencing "[Self Aware Networks](./gh-a0001z.md)" and "Quantum Gradient Time Crystal Dilation."  
...
- **SVGN.io Launch & Articles**:  
  ...
  - Some articles mention or expand on "[Self Aware Networks](./gh-a0001z.md)," "Quantum Gradient Time Crystal Dilation," and upcoming AR/VR integrations with the [Self Aware Networks](./gh-a0001z.md) Institute.
...
- **YouTube Upload**:  
  - Titled *"[Self Aware Networks](./gh-a0001z.md): Theory of Mind, by [Micah Blumberg](./micah-blumberg.md) aka Death Star Robot"*.  
  - Posted on **October 23, 2023**, further discussing "[Self Aware Networks](./gh-a0001z.md)" publicly.  
...
3. **SVGN.io Pinned Article**  
  - References older YouTube videos from ~2017 or earlier, but they do *not* mention "[Self Aware Networks](./gh-a0001z.md)" or "Quantum Gradient Time Crystal Dilation" specifically by name.  
4. **Earliest Verified Key Mentions**  
   - GitHub on June 17, 2022: "[Self Aware Networks](./gh-a0001z.md)" + "Quantum Gradient Time Crystal Dilation."  
   - YouTube on October 23, 2023: "[Self Aware Networks](./gh-a0001z.md): Theory of Mind" video.  
...
The original lineage for this timeline is the GitHub source file listed below. This primary lineage is separate from, and precedes, the later wiki import metadata.

- Original source file: `timeline.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/timeline.md

### Secondary Wiki Import and Maintenance Metadata

The following entries describe the wiki import or maintenance process, not the original source chronology.
