...
[00:22.000 --> 00:33.000]  That's almost an example of a science fiction film where it shows the positive aspect of having a certain kind of [neural link](neuralink.md).

[00:33.000 --> 00:49.000]  I'm optimistic about that idea. I'd like to say that I am sometimes, I'll read a book, a current book that I'm getting through, for example, is [Rhythms of the Brain](rhythms-of-the-brain.md).
...
[01:05.000 --> 01:15.000]  If I could have a [neural link](neuralink.md) that would sort of predict when I'm about to get distracted and pull me back in and help me to focus on the book,

[01:15.000 --> 01:22.000]  basically by creating a [stimulation](non-invasive-brain-stimulation.md) that countered that distraction before I became aware of it.

[01:22.000 --> 01:27.000]  I'm sure the [neural activity](gh-b0131y.md) of the distraction is happening before I become conscious of it.
...
[02:33.000 --> 02:39.000]  I'm sorry. See, there's those cognitive difficulties again.
...
[02:56.000 --> 03:05.000]  And personally, to me, there's a lot of hype about the [neural link](neuralink.md), but I really don't think that it's very far.
...
[03:18.000 --> 03:27.000]  Right now it's just [reading data](brain-computer-interface.md), right? Just like signal, you can see where what's happening, we can see positioning, stuff, things.
...
[03:39.000 --> 03:44.000]  The device was built with the intention of being capable of doing [closed-loop therapy](brain-computer-interfaces.md).
...
[04:02.000 --> 04:10.000]  There's been so much research on reading [neural activity](gh-b0131y.md), so that's come a long way already.

[04:10.000 --> 04:15.000]  They're kind of on the shoulders of giants, as far as [brain-computer interfaces](brain-computer-interfaces.md) are concerned.
...
[05:07.000 --> 05:11.000]  So that's never been done before in science, and that's pretty cool.
...
[06:57.000 --> 07:08.000]  Like obviously we can do a lot of utahri, which one thing I don't think people are pointing out enough is that what it seems that [Neuralink](neuralink.md) has been able to do

[07:08.000 --> 07:17.000]  is things like [neural prosthetic manipulation](braingate.md) like we saw with the chimp recently playing pong,
...
[07:50.000 --> 07:57.000]  and that's one of the advancements that I'm seeing with Neuralink that's extraordinarily impressive.
...
[08:06.000 --> 08:13.000]  or I was calling it the [BrainGate](braingate.md) device earlier, and that's just a 10 by 10 contacts.
...
[10:04.000 --> 10:13.000]  if the brain had only excitatory neurons, or basically if there was no [inhibition](inhibitory-interneurons.md),

[10:13.000 --> 10:20.000]  then it would just like excite itself endlessly until it became exhausted,

[10:20.000 --> 10:29.000]  and so the way that the brain is able to sort of orchestrate its rhythms,

[10:29.000 --> 10:39.000]  or basically to have cycles of activity that are not out of control is through the process of [inhibition](inhibitory-interneurons.md),

[10:39.000 --> 10:45.000]  and that involves a lot of [interneurons](inhibitory-interneurons.md), and this is stuff that I'm sort of just learning about,

[10:45.000 --> 10:57.000]  but it's like there's this [interneuron inhibitory system](inhibitory-interneuron-system.md) that is helping to sort of regulate brain activity,
...
[11:33.000 --> 11:45.000]  but it might change the oscillation frequency of your [brain rhythms](brain-rhythms.md), which would be interesting,
...
[12:22.000 --> 12:30.000]  the 20% of neurons that exist are [interneurons](inhibitory-interneurons.md), so interneurons are inhibitory, they express [GABA](gaba.md),
...
[13:05.000 --> 13:13.000]  so you may want to activate a neuron in the location of space that correlates with the left middle finger,
...
[14:02.000 --> 14:10.000]  to like an [acetylcholine](acetylcholine.md) cell, which is like an arousal, basically something that's completely non-related,
...
[15:11.000 --> 15:15.000]  you're basically recording for me the same cell or the cell right next to it, you know,
...
[15:38.000 --> 15:43.000]  like [artificial perception](artificial-perception.md) thing, and that's going to require the kind of stuff
...
[17:25.000 --> 17:30.000]  that it will become plastic if the decoder was really crappy
...
[19:13.000 --> 19:17.000]  where they put themselves in the queue for signing up for Neuralink,
...
[21:12.000 --> 21:34.000]  If you're concerned about specifically what health concerns, what Neuralink could do is sort of to question mark what Utah Array is, is not a question mark.
...
[24:55.000 --> 24:57.000]  Yes, thank you.
...
[27:48.000 --> 27:53.000]  And for stimulation, they're combining that with ultrasound.
...
[31:16.000 --> 31:26.000]  In terms of the long-term evolution question that Olivia was asking.
...
[34:06.000 --> 34:10.000]  No, not at all. I'm just saying there hasn't been any evidence for it.
...
[37:02.000 --> 37:05.000]  gave them the whisker stimulus that you trained them on.
...
[40:27.000 --> 40:37.000]  they begin, that person will begin to see through the camera if they're blind, they'll begin to see like a crude image, which is basically their brain converting the electrodes that are on their back or their tongue into an image,
...
[42:47.000 --> 43:02.000]  But I think you're making, not an argument, but different points there, but not necessarily disagreeing that we haven't really got into plugging anything directly into what's the human equivalent of the processor.
...
[46:53.000 --> 47:12.000]  or is it limited from its perspective for its effectiveness only from a cranium or the current set of neural base inputs, just curious, would love some thoughts.
...
[48:23.000 --> 48:31.000]  Is that how I need to understand? Because you were cutting off, maybe it's my network. Would that be a fair [summary](gh-b0049y.md), F?
...
[50:20.000 --> 50:31.000]  there's only big pathways that are disrupted. The vagus nerve is intact and hence we are in phase one or whatever we call it right now, the draft.
...
[50:38.000 --> 50:42.000]  Is that a good [summary](gh-b0049y.md)?
...
[53:16.000 --> 53:23.000]  you're probably going to get a more useful signal out of that and then be able to convert that into some sort of finer scale
...
- Source file: `original archived b0309ytimecode.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/original archived b0309ytimecode.md
