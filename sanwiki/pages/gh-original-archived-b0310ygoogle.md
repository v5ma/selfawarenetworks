...
Actually construction using do using like [[artificial-intelligence|artificial intelligence]] any kind of air AI techniques. And so are you at you're asking about the the the project from from 2018 that didn't did not evolve the use of neural networks yeah, that's different. So you're doing you. Know none not in that project now.

03:56

So I I don't yet have a project that I can refer to that combined [[artificial-intelligence|artificial intelligence]] with the brain computer interfaces in terms of [[artificial-intelligence|artificial intelligence]]. I've used that involves using basically like body tracking and that in body tracking is is is but body tracking that's not connected to a brain computer interface technology, but body tracking in the context of AR and VR applications.
...
Awesome, very cool. I will have some some questions myself later on. I'm just I guess I guess we're just getting warmed up right now. As you can tell if my I'm my voice is vibrating a little bit because I'm a I was standing on a platform just circulating my blood to.
...
I'm. So I mean, I. Be brought you brought too many questions in there at the same time so I'm just like okay, let's maybe if it's um, let me let me try to answer one one one thing and I think one part of the what the answer you're looking for.
...
Have gone through CBT and I think is pretty successful treatment compared to any drugs so you're are you I'm I guess I don't understand the question of being comparing CBT to medications in general, are you comparing therapy to CBT among therapies? I mean, I mean the brain the brain computer interfaces.
...
Yeah, absolutely thank you, you know so much and these are definitely fascinating topics. I mean, you know as as a you know, human evolutionist I guess if you will futurist, you know, just that just this this notion of augmented, you know humans I guess first is you know, the postulation of you know, [[artificial-intelligence|artificial intelligence]].
...
I experienced a bit more empathy right and and understanding I used kind of see myself in a completely different light right and I just interested in seeing what steps that should be taken to I guess understand that a bit more and it's not just that it's it's I I [[gh-a0206z|self]]-diagnosed with ADHD right so I've just kind of.
...
I'm just like what can we do right because you know, I I I want I want people who need rehabilitation, you know to have that rehabilitation but just from a like a human optimization and like a human trend transcendence perspective. I guess. I'm just curious like, You know, what can we do to optimize ourselves to maybe you know.
...
I'm a fan of of there's there's something called the ribose. Which is a supplement that that affects your body and a similar but slightly different way than then how creatine effects I don't think has been shown that it improves your memory, but but um. But of creatine doesn't I don't know maybe it does too.
...
And as many different I guess as many different versions of it so you might want to get your diagnosis validated and and also the possible treatments like you can you can it's possible if you're doing if you're trying to solve treatment and you're trying to do [[gh-a0206z|self]] treatment like you can really mess it up taking too much or too little of whatever you're doing maybe completely ineffective and without a doctor's guidance.
...
Patient if they're blood flow is not it's not it's not really good around the whole brain and then maybe some some. Some therapy would help I don't know but that's just you know, it's this is not real medicine what I'm doing I and it's just I'm just trying something so um.
...
Now, of course, it is called without warrant the course. I need it. It goes without saying that these focalized stimulations of the brain regions are very focalized that they're only like if you're only doing door slower prefrontal cortex that may be only moved or you're doing unlike if you're doing.
...
Let's see so oh look we got someone someone came up so let me just go ahead and pause and welcome to the stage go ahead and and tell us about yourself and what do you what do you want to talk about?
...
So I got a question there is another hypothesis that I ran across that in my actually also stimulate the vascular chirp because the infrared has also been known to student best return other parts of the body. I gather that hypothesis is not as popular now.
...
I'm done speaking. Ramseur or anyone else and welcome to the stationary you can you can talk anytime you want to serve interrupt me if you want and I'll let you know as you take over. The quick question that I had though was maybe someone can speak to the the big differences and between the stimulation you're getting from these machines and she comes to a lot of different frequencies and the red light you get from the Sun would you mind click if you know the answer?
...
Term the hippocampus is which is most important for memories, then it it definitely seemed it accumulates there's some accumulation in the other cortical area, so we're talking like speech motor reasoning planning and vision processing alt and all that sort of stuff but it's very little as people get older it definitely seems to accumulate over time.
...
I think we're referring to his decision time reaction time as definitely one of the early signs for dementia or cognitive impairment. So yeah, there's a lot in that space. Mel tool researchers are definitely working on that. Adam gasoline just comes to mind because I mean he was on clubhouse too recently.
...
Are the numbers easy to get yes so I can encourage people to google it because I am tired right now. I can't recall the numbers but the numbers are there because it you can just look at the rate of how many what's the population percentage of the people Alzheimer's in the US today over 65 boom it's it's a pretty it's a pretty well understood number and then we can get like five 20 50 how many people left what's the what is that percentage going to look like over 65 etc etc, and it's just it'll get bigger because we're more people on the planet.
...
All right. I guess I can reset the room people you can talk about anything you want the the general topics that are neurophysics brainwaves brain oscillations, neural circuits, nerve gear [[artificial-intelligence|artificial intelligence]], and ask any question or talk about anything that's been interesting to you.
...
Say that that is possible isn't possible with between two brains is it's just. I yeah this you know, we're always still learning about the brain and um, I think this is an area which has yet to have some deep research and into it to really understand but um, yeah, that was so interesting what you shared.
...
If you are if you're next to somebody long enough you can begin to learn their their circadian rhythm. Right. You can begin not just their circular. You could begin to learn their rhythms like they're behavior rhythms. Your mind will just remember the frequency at which they do certain things.
...
I also, Catch on people's vibes are very quickly and so that's what I had to add to that and I've done speaking thank you make a what do you have to say about Carl's course Carl's to say. Well you're both bringing up interesting thoughts right now because I am reading a book called rhythms of the brain at the moment and and that book talks a lot about the fact that we in order for our thoughts to in order for our thoughts and behaviors to be coordinated we need a we need a conductor with there needs to be like a basically like essentially like almost like a centralized rhythm maker that is like a like the conductor when orchestra that is is like, you know, okay this happens then this happens and then this happens and they have to happen at the Right time in order for it things to work and so there has to the brain has to be like, you know with its electromagnetic field basically not only it's not it's not it's it's not enough that we have one part of us that is generating thing and we have a bunch of different parts of us that are generating things, but all these all these things have to together sort of like have a sort of.

02:51:35

Have a there's sort of like a high level agreement or a sort of democracy of all these different components where at at the high the high level macroscopic behavior is giving feedback to imbalance to all the different microscopic behaviors across the whole brain and and so there's this there's a there's a micro there's really small behavior and there's macroscopic behavior and there's a cycle between them that they each or each acting on each other through each balancing itself the other the the macros bouncing micro and And and and the micros are changing the macro and and it is it is some it's sort of like well and then well and so we're talking about you know, the biofuel the which you know, I guess the that's that's that's that's this that's interesting and because you know, you would think that that and you know it maybe the the behavior of an electrical system within the brain in terms of and by the way, hello to IO, do you do you want to jump in here and in the middle of what I'm saying?

02:52:45

You can. And yeah yeah comments a little bit so like my team does measurements election next signals of genetic molecules like viruses and TNA RNA we found that they behave very much like fractal antennas so antennas can tune into fields for the distance and so this kind of idea of telepathy.

02:53:04

I don't think is that far off from antennas and signals and that's kind of you know, we just needed very precise and sensitive measuring equipment but there are basically fields that are emitted by people and you can actually characterize. Somebody and identify them from their electromagnetic signature alone, it's as unique as your fingerprint, in fact that signal contains the information from your genome it may be messy and very noisy but the signal is there so if these molecules behave like antennas then the whole system kind of resonates or oscillates and so that that would be my my contribution at this point.

02:53:49

I'm to you can put you plan on a paper to what you're saying so that there's profoundly interesting but you said the biofuel is identifiable you it exists and is unique to the underlying structure, so if you have a sequence let's say ECTG and then I have AC TT I can tell the difference between the two just by the electromagnetic signature in fact how they move and behave and so on can also be characterized in fact in a very similar way to radar we just got awarded a hundred thousand.

02:54:24

Dollar prize for our work and now we're racing to bring it to market so basically it's like a wireless GM sequencer or pathogen detector that uses these waves and we can tell the difference between you know, two very similar strains of a virus so wanting to trace the various variants out there of covered 19 as possible we can also extract the sequence information itself from these systems as well, so it's quite it's quite cutting edge so we don't have a publication out although we are getting ready to release a Publications, one of the more probably be an IEEE but on my Twitter, you can watch the little pitch video that we we had for our company so.

02:55:09

Um, but it's closer to like extreme x-ray crystallography it's not so much the communication information but just as the shape of the molecules know it's more of a resonance phenomenology, which is what we suspect so it's not only the weights like the, Spectroscopy it's not it's not similar to that it's a little bit different but it's like a you require an array of sensors to be able to detect these signals and then using something similar to a multi input multi-output array of sensors, you can make these kind of characterizations.

02:55:54

That was so fascinating Carl and IO, thank you so much for sharing.

02:56:02

Um, So my you can't see you can't see my face but my jaw has just been on the floor just listening.

02:56:15

I just like my jaw dropped I'm listening to to Eric is Eric oh oh so loose keys, yeah I now this is amazing. I I like I would like to if you want to talk about this for an hour the floor is yours. I mean, I just would you mind so I was a specifically how some can you dive more deep more deeply into how you said did you say bacteria was like an antenna it is is a neuron also like an antenna well the the underlying structure the genetic structure the DNA.

02:56:50

Already all these different molecules you hit them with an electromatic electromagnetic wave they absorb some radiation, they allow some radiation to promote through them, they reflect some radiation and from those kinds of processes you can characterize each nucleotide and if you have an array in the same way that a pixel grid on a camera can photograph something and tell you with a structure is imagine a being something similar to radar in the sense that we're sending out different magnetic waves.

02:57:25

And using something like beamforming which is present on the current star link satellite system, you see the dish there it doesn't actually matter where you point it because the dish is able to exploit phase what is it called phase phase shift temporal shift and spatial shift so you're able to accompany all of those parameters and using that you can extract a lot of the information and if you haven't wide enough.

02:57:57

A grid the more resolution the more accurate. And right now we're able to do it to about a single nucleotide which is more impressive than I ever thought was possible within my lifetime, okay so from what I understand from that you're you're sending you're sending something like an EM wave or a beam to to hit the and then and then it is something to do it with the the nucleotide material is is interfering with the the the beam and in such a way that that if you have that you can you can predict its structure if you have if you have like a like an array set up.

02:58:36

I that's that you know that reminds me a little bit of like electrical pedants tomography just a little bit because the electricity will flow through different materials or different speeds and if you take a lot of captures you can you can basically apply to grid and notice where the coincidences in slowdowns between electrical impulses happen and then from that you can you can apply it an image so it sounds like it's like a kind of democracy resonate in the 450 gigahertz frequency range and up and but you do have.

02:59:12

What is it called when you have harmonics but they go downwards instead of upwards so you have that kind of effect as well kind of spreads out in both directions and then you can make characterizations across almost the entire spectrum so depending on what kind of circuitry you have and what kind of signal you can send you can make certain qualifications of these signals quantifications, it's it's quite impressive it was mind-blowing to me that we could even do it and our goal right now is to do it for about 50 bucks, which is crazy because the hardware that we use on the lab is about.

02:59:47

A quarter of a million dollars so trying to break it down a few orders of magnitude is actually quite possible again through a bunch of tricks that are more machine learning bass, but basically doing something similar to computational photography where you leverage machine learning to increase the resolution or resolution capability of a low-cost sensor by training in tandem with a high resolution sensor.

03:00:16

Does the sample have to be crystallized form or can it be in virtual? It can be within the cell and it can be outside of the cells so we can have like so far we've been doing mixed samples and pure samples, so we're able to do both case scenarios which again is this kind of crazy so even if you don't have cells that have like been filtered out and you only have the virus isolate we're able to also identify them a mixed signal where you just have a bunch of cells and you don't know if they have the virus or not and we were able to tell the difference between cells that have.

03:00:52

A particular virus versus another one in fact work done at Purdue University also showed that they were able to use something like Doppler radar to distinguish pathogens so you can look up doppler radar pathogens for two university and you'll find their reference oddly enough they wrote in their article that oh it's so exciting because we're the only ones doing it in our team was chuckling because we didn't publicize it because we're racing to market not racing publications, so.

03:01:22

And good so that was the favorite was if every 24 scientists use doppler it appear inside cells. But yeah probably a protein university it's a guy who standing in front of a table. I think that's kind of the image that they have yeah. I genomics with the hand-held DNA sequencer.

03:01:42

Researchers develop handheld sequencer the case standing in front of table, there's lights. Integrated circuitry oxford nanopores sequencing so that's you so they're concept is is vaguely similar to what you're going to do tonight yeah somewhat yeah, okay, um. The so but you mentioned that the the DNA is like is so the DNA and you're not so you're not referring to well.

03:02:08

I guess you said viruses too if you take viruses but so but then you met you mentioned a sad satellite dish, right? I did sell a dish exploits phase shift temporal shift and what was the other one? Facial temporal and phase shift so spacial temporal and phase oh okay so that's kind of what they use for like reception if you look Google memo am Imo that's kind of the principle that they use there so your phone can actually have reception and areas that are noisy so how do you pass a signal through a noisy or perhaps shielded region and that's how you do it, you kind of modulate these different parameters.

03:02:50

Okay, so okay, can you explain it's a super primitive question because I usually think about the brain is just having like temple and spatial frequencies but but but maybe someone else can argue the brain has temples facial and phase frequencies, but what is what is phase in this context it's shifting the frequency so instead of sending like 450 gigahertz you spend you send 451 or you modulate between 400 and 451 and you do it in increments of 20 megahertz and as you do that.

03:03:25

Generate a data set that is this curve and then you shift that within the space so you move over one pixel or something and then you can also do two of them simultaneously but different positions and various combinations thereof so that you can actually get your signal through and kind of extract as much of the signal as you can.

03:03:48

Yeah, okay, that's possible. My understanding is that when you shine a coherent beam to a sample the the beam would actually be reflected under the the reflect the signal would be in mixture of the original signal in phase and some component that's going to be phase shifted relative to the original phase of the beam that was shined upon it it's just the general behavior of anything that anything that you see.

03:04:26

It's a general phenomenon, so I think that's what you mean by phase shift and you can actually clean some information by looking at the degree of phase shift in the refractive signal or refracted the signal. I think that's what you mean not like as well using a beam like any sort of optical system using just radio waves so I would just say it's more like radar and the phase shifts it's kind of like throwing an orange ball from the left hand side and throwing a blue ball from the right hand, so.

03:05:01

High and if you throw the left one then the right one or the right one then the left one you sort of the both you throw one or not the other and vice versa you do those all those kind of measurements or those kinds of signals and reflections and transmissions allows you to cut away a very nonlinear way at what the signal is, so in the signal is what we claim has the information about the structure encoded in it, but the main principle relies on this resonance phenomenon.

03:05:34

We presume it's a residence phenomenon, but you know, that's just the simple claim that all matter has electromagnetic properties and so it's basically just molecular radar if you want to think about it. Yeah that was that's just reminding me that there is actually discussion of doing phase shifting in an affner that I had blanked out on but basically yeah, they all they're alternating different frequencies to get it to construct an image with with functional air for a spectroscopy so yeah, it's like well I had that information in my head but I hadn't connected it together anyway.

03:06:14

I but do you have more so chica was talking about like okay, so if you have a bunch of, Maybe this Carl who said this but there's a bunch of human beings in the in a room and they all start yawning at the same time so it was brought up that human beings have a biofield and that and then and and then the idea is is that well our DNA and maybe maybe our viruses.

03:06:44

I'm not clear maybe our viruses, maybe our bacteria can act as antennas that can pick up the signals of other people's biofuels, is that correct do believe that I'm in and maybe how how, Might that work just interested. Yeah yeah that is kind of how it works, they all tend to exhibit different properties bacteria have a peculiar property of having a thin film which kind of shifts the frequencies you get a phase shift at the membrane and then the other phase shifts upon reflection back through the the same membranes or transmission through the membrane, but they're able to see enable or they're able to see with inside of a cell to be able to even characterize whether it's pathogenic so work done by darker with the radio bio program.

03:07:35

Also sought to understand the relationship between organic or living matter kind of like DNA RNA and its relationship to the spectrum in the house certain therapies and other thing it basically sounds like you're building an energy weapon that can like give you cancer from far away or virus from far away and that's actually not that far away from the truth of what's currently capable or possible with the technology so I can do everything called water memory, it's a controversial documentary by or.

03:08:10

About a French scientist who actually discovered that days was caused by HIV when the Nobel Prize for this and his lab actually discovered that HIV itself LTR 104, h for whatever it was had a unique spectral signature and they were able to reconstitute it using just the PCR process so a ribosome a bunch of letters a few primers and then all you're doing is you don't actually have the virus as a source, you're just stimulating the sample with the signal and the ribosome was able to.

03:08:45

Read. Construct 97% of this virus and even though it's very controversial the unfortunate thing is is in the naming of this paper in this work that was the only controversy because they called it DNA teleportation which is already a keyword in physics, so they were just laughed out of the room and for the longest time.

03:09:05

I was like is this possible is this bullshit was this guy lying people told me that like, you know, there's no glorious stuff to distortion field that's they say everything they say ridiculous things and people disagree with them because they have nobel prize and then we actually did the Experiments and I was like holy fuck I can't believe that it actually works I can't believe this is possible what the hell's wrong with these people turns out that you know.

03:09:29

Shanghai genetics genomics institute, I think higher pin so they were like yeah, yeah, yeah come work in China, don't worry about it, the Russians are also working on this I know because I know some people work in the Russian Academy of Sciences and we wanted to collaborate with them and our government here in Canada did not allow us because of that Chernobyl incident we were told that if I tried to apply to Russia, I would be arrested at the airport here because I was also, Trying to bring like VR technology and do all these other things and have a technology transfer so that our university can also collaborate with collaborate with them and there was so much political friction that it became unfeasible and impossible.

03:10:13

Wow. I'm sorry I'm like looking up right now the effects of a electric magnetic and electromagnetic fields on on bacteria, but but and so and you've you've also confirmed that this is is the electromagnetic fields are affecting DNA and RNA correct by changing their changing the phase shift, so this is so this is research.

03:10:37

I can look up. I guess is what you're saying. Yeah.

03:10:44

It's fine but I think there's an episode of voices from DARPA where you can hear them talking about a little bit about this but it's it's very difficult to find any information about this because it's a branch of radar technology and that kind of technology is heavily regulated kind of like nuclear weapons, so the knowledge is kind of very restricted or very like access is someone difficult so.
...
I may or military bases so I was like, what is this kind of weird like you guys are hosting a book about radar technology in the server near a military base in the US. I was like this seems like some sort of like, I don't know any pot or something but using those texts and, Reading about it more allowed me to advance closer to this problem.

03:11:54

So the very weird almost conspiracy like journey that I've had. Yeah I mean I noticed that like I have a tremendous amount of knowledge about different brain computer interfaces and companies but but the experience of you know, people like I'm in a bubble somehow because like I realize when other people want to know about brain computer interface is you don't have the foggiest idea and they can't find out like they're they can't find information about it.

03:12:20

I don't know why but it's like they're they're experiential reality is is different and maybe that's because they're personal Google search habits or something. I don't know but Yeah always doing an anonymous Google search. In fact, I never just use one source so you know, you have to use a few sources but it's it's it's definitely difficult.

03:12:43

Some things can be shielded like sometimes my partner is able to find something that I can't and only after I go into incognito and anonymous mode and all these other things on another search engine I end up finding it. So other times the results don't even show up. So, I'll know of a website that has this information but you can't get to it.

03:13:04

For a Google search. There's definitely something fishy going on but I don't I don't fault them for it because it is quite dangerous. Like if you if you pay [[attention]] to Haiti go two years ago, there was some sort of energy weapon acoustic or electromagnetic that resulted in the ambassadors having brain damage in their.

03:13:27

Was it white matter in their brain coherent or congruent with? Concussion but they didn't have concussions And so it's not beyond the scope of this kind of technology to do those kinds of things to hurt people. So it's quite dangerous like the joke that I have about our technology is you know, you have a movie like twelve monkeys or the guys walk around the airport in the airplane with the virus in his pocket.

03:13:53

Well, I could be walking around with a transceiver that is emitting this kind of viral signal and the virus will spontaneously form within your own body because you have all the building blocks to do it. So it's it gets kind of crazy like your body is. Always having these components of RNA DNA broken the parts of cells flowing through it your body's filtering this but if we have the right kind of signal at the right time and the right place and we repeat it for long enough statistically these molecules have a higher probability, if you can bias the field that they're occupying.

03:14:32

That's such a mess I mean like now like okay well, how do I walk around as a some sort of, you know fair day cage from now on? Yeah, yeah basically like that's that's what that that's actually the first thing that we actually addressed was well, how can you develop a countermeasure for this?

03:14:49

Can I now develop a device to the you know, a frontline worker or warfighter in a new theater of war is able to wear on their person and not only detect a new pathogen and an environment but also send out the correct carrier wave or signal that prevents. Them.

03:15:08

From becoming infected from this virus so there's there's all sorts of things that you want to work on there. Wow, so the implications of this is is that you could you could you could wirelessly detect a virus in an environment just by like leaving a device and if it if the virus appears in the doorway or something you you'll you might detect it precisely.

03:15:34

That at like like a hundred like a hundred thousand dollar investment why wasn't your company given like a tent that your company is gonna be $20 company that's like why it wasn't a 10 million dollar investment, it might be a hundred million dollar investment in if there's a few months so we're working on this story there's also a lot of like bias, you know, those with homes the kind of friction that she created with her bullshit about look our sensor can do this we've had we like responsibly we've done the responsible thing and kind of gone through and done the science and kind of estimated things very carefully.

03:16:09

And we've been very you know very determined in fact when we contacted some places like DARPA of all places who inspired us to work on this and they even when I reached out to them, they said yeah, come on send us your application. I sent in the application they said you can't do it, you don't have the technology you can't do it and it's not possible and then my approach to that and this is kind of a testament to how stubbornness can sometimes play a bigger role than talent or persistence, my response was well, you know challenge accepted.

03:16:42

I'm gonna show you some. Of what we worked really hard and our team was able to have non-trivial results that were quite impressive and now we're trying to move forward because it basically presents the future where you'll have a device the size of a thermometer infrared thermometer that we call up the domometer that you can put to your head or put to your skin or even aiming in the area and be able to characterize the pathogen content or other aspects of that area, so it's a it's quite exciting.

03:17:18

So this is an infrared thermometer, well no like lichen into it infrared thermometer revolutionized the last century we have something that we're calling upon and we're aiming to the same kind of form factor so handheld device 4050 bucks max that can tell you within a second whether you have covet or not and you can measure yourself many times a day kind of like you do with the thermometer because right now the rapid testing that exists is limited by the very nature of the consumables that are required which during the pandemic.

03:17:53

Can become quickly consumed what's the what's the etymology of the word pathometer what it was a constructed from.

03:18:02

Pathogen meter so it tells you it's able to neater or measure how much of a pathogen there is if you have a better name please I'm open for suggestions, but that's kind of the easiest way to think about it that's super quite super cool. I just wonder what it wouldn't happen.

03:18:18

You were too pre-programmed the signature that you're looking for yes, it's not a skin for all is it is able to scan for all so the whole point is that you are able to extract sequence information, although we can just very quickly you give me the signal or you even give me just the sequence I can synthesize the virus measure or estimate its signal just from that information alone, so there's some theoretical calculations we can perform in some empirical calculations and then that could be sent out if this device will.

03:18:53

Be integrated let's say into every cell phone everyone all the sudden could know whether they have covered or not, in fact the recent pixel 4 XL and pixel 4, non-XL had something known as the solely sensor which is a small little radar chip and in fact the team that we're working with helped develop that radar chip and so that's kind of the technology that we're building on something that already exists in a phone and integrated into the pixel 4 because the millions of dollars were already spent on the development of this chip the refinement of the Se kinds of technologies the estimated like $12 per phone you're able to integrate it so it's it's quite interesting very low cost so so in I just I came in a little bit late but to be clear you're developing a technology that is able to measure the let's call the biological oscillation or the vibration or frequency of what you pre-engineer design as the frequency that corresponds to the genetics that people represent as.

03:20:03

The first COV2 virus or what causes covet. We just detect the virus using its electromagnetic signature in a similar way to how radar is able to bounce some radio waves off of a plane and characterize which planet is yeah, okay like spectral information or spectrographic technology now how are you characterizing the signature frequency that's specific to the star COV2 virus has it has yet to be isolated when?

03:20:38

So what are you using as your reference point to let's say okay. I have every we have the virus yeah well. All the CDC articles that I've read and the peer review journals that I've read how what are you referring to yes, we have the viruses that a morphological petri dish that is grown and then you're using that as the reference point is it something that corresponds to this specific CDC related genetic information that is represented as corresponding to the root cause of coven infections by I don't know we mean by root cause but what we're able to do is take various forms.

03:21:24

Of. Event so it could be a mouse swab it could be a swish it could be a sample of cells that are collected and we can identify within each of those whether the pathogen is present or that or which pathogen. And do you have to do a similar like an RT PCR do you have to do a exponential growth do you have to no concentrate it or expand it so you're no able to have a level of specificity and accuracy of metering that you can put this on the skin is that the the yeah, it's it basically works like you can put your finger on the sensor and we can detect with the high degree of confidence between.

03:22:11

Or of this whether the virus is within your finger or whatever so you've mapped the signature frequency of covet to a level of specificity or tolerance. That you can put something on your skin and then that is pre engineered to receive whatever you and you organize it to have or engineer it to have it can read that highly highly highly highly specific signature frequency.

03:22:44

Yeah, it is very convoluted way of saying that but yes well, I mean, I'm pleased I might so I have I'm extremely familiar with biological oscillation units and vibration and metering and monitoring systems and you know the star COV2 virus and covet and etc just I this is I mean, I'm excited this is the first I've ever heard of that level of accuracy and specificity being available as far as.

03:23:17

Being able to specifically pinpoint. I would assume it's tied to the genetic. The genetics of the virus that's why yeah it's the nucleus right molecule itself that is giving this signal and that signal I would say like this the signal exists so that's the first thing that we checked does that exist and then we checked for unique this and once we had unique this we were looking at specificity and how low can we go with that specificity of genetics and we were able to bring it down to a nucleotide single nucleotide level, how are you using as far as the are using well, so there's poor nucleotides and how those obviously, Are in order right it's they have certain residences in the 450 gigahertz range and about so in terms of radio waves that's kind of where they're responses live.
...
That. Order of nucleotides in that specific order 3 under the. Perspective assumption that that is corresponding to covet in the peer review journals. I read that wasn't conclusive so to speak yeah so some worked on by Israel actually have a lot of money behind them and they were actually using antibodies other people were using nanoparticles and just our differences that were able to do it from the signal alone and then using some you know, fancy combination and geometric configurations of these sensors.

03:25:15

I would you know to describe it as like an array of sensors not just one sensor and this array of sensors is able to. Take certain measurements of these nucleotides, so let's say have like ACTG ACT and then they're in this weird kind of shape what happens when I paint the A's what happens in sensor one one one happens to sensor one one two and one one three and so you see them all on this grid and we're able to make certain measurements and certain resonances come off each of these molecules and if you're very very careful you can extract some information about it how close does the the, Transmitter and and the device the transmitting and in detection device have to be to what your measuring and yeah right now it's a you put your finger on the sensor that's the nature of what we've been pursuing but you're able to focus these beings and all sorts of ways.

03:26:20

Because I mean this the second part about how like how you could just detect a pathogen in in a room, that is a tall it seems like a bigger problem if right. Yes or no it depends on the relatives energy and so on it's it says it's just a different problem like one of the other things that we were working on was something like a smoke detector where you have passive airflow and instead of having it on the ceiling you have it on the floor and eventually it comes across one of these final products and so how that kind of system as well, so there's all sorts of ways you can do it long range you can do it short range right now, we're just focused on close range settings to be more medical Apple.

03:27:10

Location anything else in my opinion would be a little bit more military focused if it was but I guess I guess in the in the room sensor you're waiting for the the virus to fall on the sensor in a way through event some sort of ventilation system. Yeah, that's that's one way that this little smoke detector thing yeah, but if you had something like you could also have continuous monitoring so something like on your on like a smartwatch you can you can have a set up like that as well and in fact, that's.

03:27:42

That was one of the applications. I mean, my tile was a you know, I has been a discussion, you know in the room but I was a you know, I'm running around so didn't get chance to come up and so I heard the Iowa sharing the very exciting technology there working on and now that you know today I just had interest in this, you know mems and so yeah MIT, there's a group that worked on shrinking the ramen.

03:28:21

Spectroscopy down to say can be incorp in the cell phone so basically coincides chip that's just you know, to me, that's a fascinating revolution. I mean programs right so for what you're trying to do. I think if it's can be made into already, you know at the level of.

03:28:48

Product level that that's really fascinating right, so I mean in terms of a, Sample preparing there's also a I worked with we were trying to help a group also not MIT but a related to their startup programs one of the price winners, they're they're doing the MEMS basically the ASIC level of you know, carbon nanotubes so chemical sensors, so that's I mean, it it it has you know, they have they had one through the you know, IP and pattern all that preparation but still it's turned out to be very hard for that technology to to go to the market, of course, they they'll have a lot of advantage being people and also can low-power and without so again for for me to understand your the product your development is high.

03:30:02

I mean on the line of some mica's question, yeah. I mean there's the noise. I mean, there's so many pollutions right so so it has to be a very pure sample so that you know, okay, so it's it's not we've shown that even with mixed samples we're able to detect this in I'll just refer you to the technology fundamentally already exists in cell phones.

03:30:26

I'll direct you to the pixel 4 solely sensor, which is a compact radar sensor already on the market and in fact we're working with the team that helped develop that sensor so we're already working with the team, that was a Good Google so it's it's a much easier undertaking when you have already this product that is out there and you're just trying to develop this new application and new IP.

03:30:51

Can you I didn't miss the earlier discussion, can you repeat the keyword to search for the radar the the Google SOLI SOLI yeah so many censored by Google a tab advanced technology something so um, I was wondering I don't know if you've heard of race in the race machine but I'm wondering if you could potentially target the frequency and I think it was like from the 1930s and the idea was that you could find out the frequency of the like molecule that.

03:31:26

Looking for and then like essentially use resonance to yeah yeah, like a wine gross yeah yeah that's that's basically like it's like the movie Elise and with that tanning but there where you can like lay down and it not only can detect these aberrations maybe these cancer cells and then selectively cook them because you can know the exact sequences responsible for that mutation and kind of like you hone into a bridge with the correct gust of wind at the correct rate you can actually destroy some of these things without actually exhibiting ionizing or with.

03:32:01

Without imparting ionizing radiation, so it's quite like the numbing linear effects are very counterintuitive.

03:32:13

Are you sure you also working on that your DC that in the long term is like practical application or no, it's something that we are exploring in fact we're going to be doing a. Proof of concept study with the London Health Sciences Center here in Canada. Ourselves and seeing yeah what kind of what kind of things are possible and that's one of the things that we'll be exploring to see if we can actually target these things much more specifically because personally that's my guess as a physicist.

03:32:45

I'm like yeah, that's an easy problem. I mean while everybody else is like rolling their eyes saying that holy shit that's very difficult so it's my hope. I believe that that's possible theoretically and the only question when I first got into this problem was does the technology exist in my time kind of like that iron man father, his father was telling like, you know, Does it unlimited by your technology my time and so I was very curious to see if the technology of my time is limiting in this because when I first thought of this about five years ago, the computational power was not there to process these data sets the sensor sensitivity was not there yet and so a lot of things culminated together very quickly during the pandemic and coordinating between two labs accelerated programs and a company was was quite stressful, but somehow we did it.

03:33:41

Would you maybe share again you said you said we need to first thought of this five years ago or are you the the key and the inventor and on the patent is that what you meant yeah yeah, yeah. I'm good chief technical officer. Wow cool Vegas, that's like we were already honored to have you with us and now we're like even more honored.
...
Is it the pattern out already or is under your name so we have a provisional patent and a few other things it's not under my name here, but some of the work that we will be releasing and filing will have my name on it, so. It's not the on the Google cannot be searched by Google yet right so that's right yeah not yet, we just incorporated.

03:34:35

I think in January it's a lot of paperwork is still going through so. As I mentioned so the keyword will be I think my class a good question that I've noticed and like type of a meter is that if you go if you go on my on my Twitter, you can actually see the pitch video for the accelerator program where we presented this work so you can go there and see kind of how we've called it you have alternative suggestions on what kind of keywords we should use but no existing terminology that.

03:35:16

Describes the technology in that way, it's very much like people who just been calling me green fields because there's no existing etymology to identify it. Great thanks. I'll do yeah, thank you. Yeah, if you have any further questions, please feel free to reach out or if you're curious to join the team, you know, we always need more people to work on this problem and that's in fact what we're ramping up to do so we really think that this could be released to market very quickly and a lot of the magic does happen with software, so I'm fascinated.

03:35:54

I mean, I I I'm a career and have a consider myself a have a problem and I mean, especially interested in developing tools, you know as, Spectroscopy and all that and helping in you know, a special life science and stuff, you know, I'll probably follow up with you then I'm pretty sure yeah I followed you on a Twitter you can follow me back and you can chat more there but a big part of this was actually in frustration when I was diagnosed with cancer it took me 10 months arguing with seven doctors before they finally believed my diagnosis and got me tested properly, unfortunately by that time the cancer had already spread from my mouth to my throat down to my Neck and my lungs and it was a very difficult journey a lot of invasive surgery part of my tongue was removed both left and right sides of my tongue removed.

03:36:52

I have reconstructive surgery on my tongue that's why I'm kind of the mumbling sometimes as that's hard to speak with only a third of your tongue remaining but yeah, it was very motivating and in fact, you know, kind of like the joke. I was by some people it's a yeah you can't cancer but this must have been the piece of cake or walk in the park kind of thing it was not it was very difficult and I was very.

03:37:17

Fortunate. To have a lot of teams come together that we're able to leverage this technology and it was amazing because I didn't even know that the team had worked on the solely sensor and I brought to them the concept of look. I want to get their raw data from the Soviet sensor because I think this is possible.

03:37:36

So if you want to look up a another paper, there's one by Purdue University about pathogen and detection using Doppler radar and that's probably the early the most recent paper that you can find about similar work to this but the the object. Ation that I have about that article is the guy says always exciting because we're the only ones doing this so we're the first ones doing this oh you're the first one's talking about doing this you want necessarily the first ones so that's kind of something to keep in mind and I'm very aware of that as well because there was work being done instilled by DARPA that was worth being done in this direction from the Russian Academy of Sciences, so there was a lot of teams around the world are racing towards this.

03:38:25

Thank you for the pointers, but I I'll do my goodness read up done, so you you mentioned they the Doppler radar is this is this works on the different physics right so from the your EM proposal, right? Well, they're similar they're related technologies. I'm not gonna go into too much detail because that would be discussion, but if you're willing to sign in on disclosure agreement, I can show you whatever you like.

03:38:58

Okay, okay, thank you yeah, okay. So going back to the so when when you're using the so for example, if you're using the solely device and you're you're sending out something to you know to to. Detect you're sending out the your your signal to detect the nucleotides and and then you're getting something back and you're in your solely sensor is has a sufficient enough array that it's able to decode the the sequence in that correct order but but the question then is is was your measurement do your measurement cause phase changes to to the DNA did it change the DNA or the RN answer in the case of viruses or any virus?

03:39:54

I'm and yeah in desert does measuring itself with this technology change the phase shifts of bacteria and viruses. No no but they do kind of exhibit a lensing effect so if they're alive they kind of respond and it's a dynamic signal so it's a time-dependence signal and it's a deceased of the molecule only itself resonates a little bit but they're decibels of the signal or not sufficient to allow these jumps that's the next step of our research to see if we can make these selected changes ideally it would be amazing if you could like, you know aim a signal circle kind of like cowboy aims a gun you would not.

03:40:40

Have. That one letter that's causing the cancer without having to destroy the cell. It's not clear to us whether you have to destroy the whole cell or whether you can impart energy that can change the internal structure of the DNA of the cell. Okay what you just said was super interesting on a tangent Well what's the difference between a live RNA strand and a dead one.

03:41:05

In terms of one that reacts to one that doesn't Could you say a lot? It's a population. So it's like if it's within a cell and it's able to interact with other molecules and all these gradients then yep, but if it's on its own, it's a little bit different so it's kind of like taking a picture of a city you want to make a movie because then you can see what the city's all about in the same way it's hard to learn to dance if all you're doing is looking.

03:41:31

At pictures of other people dancing. You actually need to look at a video of people dancing. So that's kind of the intuition that I would give but from a first principles perspective, it's a time dependent signal in some cases that is more important.

03:41:50

Yeah, I mean, I'm like still processing that but anyone else wants to jump in time dependent signal that's more important. I'll just pause myself anyone else who wants to talk go ahead.

03:42:02

Again coming back to the earlier question being. So did I encourage using the colder virus as example? That's definitely not a thing or as you mentioned the smoke. So basically a swap or something and if so if there what would be the minimum like signal noise level a you can.

03:42:30

You're asking what the relative noise is or yeah, so again, it's so so for example for the it is it's a so for using the earlier using what I'm a little bit knowledge of this so when you eat and say if it's a smoke detector it someone mentioned there's a the wind issue that if it wind doesn't blow your voice so there has to be you cannot say take it out.

03:43:01

I'll do or just do you know, what life like, you know, A laser attempt temperature is not that robots, right? So there has to be some some sort of condition here. I mean right now you're in a concept profile concept level so so my questions in the way when you you're part of the thing is the cancer protection is that people concepts the viral stuff is already going through the proof of concept.

03:43:35

Oh, okay. Yeah, so so again, this is so so so I guess I know mixed the things together so for for the for the nucleotide but what is the sample again a swap of the sliver? So it can be survivor. I can just swap even the observite sample the mix sample.

03:44:01

So like saliva represents a mixed sample, you can also do detection through the finger so there's I'm sure you're familiar with. Was it non-invasive glucose measuring? It's similar to that. Then that's given that using LEDs, right? So that's true. No, so if you look up the pitch video and you look up the lab that we're working with.

03:44:31

You can find more information about it there. It's the center for intelligent antennas and radio systems at the University of Waterloo Canada. It's okay. I see us. So it seems like you're familiar with arithmetic machine and I was wondering if there's anything like there's you know books of frequencies associated with different, you know diseases and what not I've no idea if it's there is no there is no such database we're in fact building such a database that's one of the exciting things about this.

03:45:04

Awesome, yeah, that's what I was wondering if there was like anything to the yeah once that exists now. Yeah, like our goal is basically to sequence everything on the planet give everyone a wireless genome sequencer and turn the world into like Pokemon with the Pokedex where you can just have a kid.

03:45:22

Put the sensor up to an ant and we could know the sequence information of an Android beef or whatever and then the possibilities are quite profound from a public health perspective with respect to the next pandemic that instead of having to go into this very expensive lockdown, we can just say every day just skiing yourself a few times a day or in fact have passed the scanning in a smart watch and be able to tell you whether you have a certain pathogen or not as you do please stay at home contact health officials, if you then you know, all these things can just be automated and and really stream.
...
It was kind of what I was asking. Oh, I don't think yeah. I know I don't think it is unfortunately in genomics the rule is everybody's gave us sucks make your own data. And so that's kind of what we have to do and we're going to be partnering. I think with potentially calc as well to build this up and you know, my hope is that everybody builds on this together and eventually it becomes as synonymous as an MRI machine.

03:46:48

Except it's not millions of dollars it's maybe twelve dollars thirty dollars fifty dollars. Hopefully integrated into every device and then that way we can have a much better chance of fighting these things but the database is quite literally the most important parts like Andrew a standard talks about how we're moving from a model centric industry and machine learning to a data like quality data.

03:47:15

Perspective and so that's kind of the model that we're trying to emulate so on the data so if the database was missing or particular pathogen, then this machine would be able to register it as a pathogens if we can extract the sequence information we can extract what it is, so even a novel virus if you just tell us the sequence information we can extract what signal we predict would be from it.

03:47:48

Of course but if it's if that's sequence was not available it was not known for us and therefore it's absent from the database then you wouldn't be able to detect yes, it's not fair to me, whether that's the case because there are certain patterns that pathogens seem to have in terms that they are characteristics, you can look at work done by.

03:48:11

What's his name? Demos Christopher Dumas CEO MAS from Patel Memorial Institute he was examining how to extract structure or predict structure from random bit information, so Jeff Con 26 s 86 back door. I think it was on cryptographic instruction sets so how can you tell if there's a compromise hardware backdoor within your process or you have to mind this space but how can you tell from the structure alone that there is a problem?

03:48:49

And so by mapping some of these signals to something known as a space filling curve you preserve locality in that locality allows you to make certain estimations and extrapolations of the patterns that emerge so that that's that's what I would refer you to Defcon 26 Christopher Demoss X86 architecture.

03:49:16

I can also put the link into my. Bio here. So deep the other awesome location of this is like you're noticing the situations I think and so this would be yeah completely certainly change the game. Yeah, that's so yeah. There is no like the defaults negative false positive words is very well, it's kind of like if you had a shitty camera sensor you're not gonna take good pictures, so we're just focused on taking really good pictures, but using this of radio waves instead of the physical spectrum.

03:50:04

Yeah, like I blind disease in the test for that like it's it's almost like a 50-50 it's just awful so yeah the people just be so cool for the so many people yeah most of the viruses why disease. Care there is you know some viruses because it's not a clear weather line disease is caused by just one virus or bacteria or combination or confidence or whatever the case may be but some viruses retreat into your lymph nodes and then they only come up or flare up in certain immune response situations that's kind of the the hope or the the thinking that will be able to even make measurements on lymph nodes themselves and be able to tell you.

03:50:55

Kind of what virus data bank you're carrying around so that's the next focal yeah so um, so I the lime inspired you use one thing but there's also the like I had poor co-infections and there's a lot of theories circulating like around biofilms and I'm wondering like when you said an example, if this is something that could also pick up biofilms which is like either these things have a bomb ready together and it's like a shield from your immune system basically yeah so we can actually penetrate the Able to make these kind of sections where the immune system is unable to identify chemically so because these sorts of cloaking technologies that these viruses develop in these bacteria developed sometimes are able to be chemically resistant to a robust but the spectrum never lies as it were so that's the that's the upside that no matter what these things are doing that we'll be able to help you in the system by seeing things that it can't so um, I want to ask.

03:52:05

You more going back earlier to the very beginning of when you jumped in what with with human the human bio rhythm that extends outside the human body or the body with a human violin and maybe that's not the the word for it, but the the biofield. Signature that. Dependence and other things like that, okay, so the time the time depends and in that time dependence may might reveal our DNA.

03:52:36

And but but so in that DNA so what I'm wondering is so that biome I'm also wondering that that bio magnetic field well yeah essentially that's what you're talking about you're talking about DNA RNA right and in in the field itself right yeah yeah, that's the smallest signal that we're kind of pursuing you could pursue smaller molecules, but that's the ones that we're currently focused on.

03:53:01

But the better so you're detecting but so that's that's different from detecting like nucleotides now you're talking about detecting an electromagnetic field and decoding DNA from that that's that's right is a molecule right like a nucleotide chain is just a molecule where each of the chain each of the balls on this chain, let's just say it's a bead to chain each of the balls has a different resonance, so it's basically like it's like how cell phones work that's the best way that I can describe it.

03:53:37

All right so so what we're broadcasting to other people do you think that is so is that enough to actually be causing changes in in the I guess the spatial temporal and phase shifts of other people's DNA what we're what human beings broadcasting.

03:54:01

Rephrase the question sure so so one person's biofield is is being broadcast within the frequency range of another person's biofield are each of those persons biofields powerful enough to change the phase temporal and spatial patterns of of the other part of someone else's DNA and someone else's biopia field.

03:54:27

I would I would estimate that yes, but it's not clear to me because we haven't done those kinds of experiments but I would suspect that there is a certain interaction distance. But it could also be the kind of training that happens when you're with somebody you're both interacting simultaneously you're viewing the other person's responses and in that capture of that sensory information there's some sort of entanglements that occurs in that entanglement allows you to both have the same kind of information perhaps, it's the signal that both you and I share.

03:55:07

Is encoded and then later on one of us accesses that signal that may infer some sort of entanglement response from the other person who has that information encoded but that's that's very speculative. I would say that's kind of along the lines of Sir Roger. Penrose is orchestrated reduction model.
...
So I don't know if they detected pheromones yet that humans are giving off in it because something about like the way that women's cycles line up if they live together and would the mechanism is there. I'm wondering there could be something like that with the fields are overlapping or they're putting up certain energy well every time we're breathing we're trading viruses, like I think famously for every hour that you spend with someone else you're trading about 10,000 it viruses an hour at the lower end in fact.

03:56:02

I would say it's probably every 15 minutes you trade 10,000 viruses, so in a conference everyone is sharing all these virus. Es and if you think of what's actually triggering or what's the result of this kind of sharing is that when the E coli gets into your body and your body raises the temperature equal.

03:56:21

I kind of opens the door for viruses or phages to come in and offer information that can perhaps allow it to modulate its metabolism to stay alive at that higher temperature to continue living and that's kind of I think what happens with viruses in general, so not only would it be electromagnetic, but it's kind of like biochemical warfare that were each of us.

03:56:44

Sent. Thing viruses and other things and these things are allowing our systems to evolve and it's counterintuitive because you would think that you would want to isolate from viruses but viruses are actually what allows the system to evolve. So like damage from ultraviolet rays helps the system evolve damage from viral infections and other things helps us gain information, the classic example is a virus from our very early history for I think brain structures on Earth had a specific function.

03:57:19

Of pruning synaptic connections and in fact the remnants of that virus have become integrated in our genome and in fact we can identify that. Oh look here's the remnant of this skeleton of this virus. It's now part of us and it helps us prune our synaptic connections which if out of whack if there's too much of this kind of activity or not enough represented in our genome you may be you may succumb to what we call schizophrenia because not enough connections are being pruned and you're beginning to make false connection.

03:57:54

S that perhaps diverge some reality so the nature of how information travels between the systems is not only electromagnetic but also via particulates. And is that the art neuronal gene that you're mentioning because I know that was one that's now thought to be viral and it's like integral to memory of I don't remember whether it was synapse pruning but it was definitely associated with higher functioning cognitive ability.

03:58:21

I know it would be I think I know the author or someone's callus at a MIT discuss this. So, Is that the same person the navy but yeah it's the same kind of idea that you know work. What is our DNA it's just the collection of generations of evolution where we even collecting this information and in fact whenever biologists talk about how does an information or how does a system gain information if you know physicists say that entropy is always increasing or how do you reduce entropy to allow for complexity?

03:58:55

It's through these kind of viruses and some estimates put the population ratio of life or complex life to viruses or phages for every one complex. Living organism on earth. We have a hundred trillion viruses or phages to that one. So most of the activity on earth is set to be phage like our virus like so.

03:59:17

Just think of it like if you actually like opened your eyes, you would just see viruses everywhere. That's that's kind of my imagination.

03:59:30

So they also include in the upper atmosphere and I wondered if you've any theories about like the relation between a electromagnetic events in the like the earth's magnetic field and the viral like I've heard theories that like but there were old papers that looked at sunspots and potential correlations with fire says in the theory was that a significant enough magnetic pulse would force those upper atmosphere particles closer to humans.

03:59:59

Um, yeah, yeah, there's all sorts of I think situations like that where the mineralization energy or some sort of standing wave or some sort of stimulus from an electromagnetic field elsewhere can bias certain molecules to form or emerge or whatever like I would think that the cosmic migrated background radiation itself produces certain bias on planets where you know, in addition to the gravitational field of that planet.

04:00:28

In addition to the radiation from its local star and in addition to the, Background radiation you get a certain set of possible solutions for life and that's kind of how I would think about it that it just changes the bias a little bit. So, maybe instead of leaving a billion years, all you have to do is wait a hundred million for these kinds of events to emerge so that complex life for multicellular life to emerge but definitely there's some sort of mechanism there where they played.

04:00:58

It's all basically coupled. I would say that.

04:01:05

Awesome. Thank you so much. Not totally dear all this but do you think that the Moulin controversy is anyway related or like in terms of the yeah the standard bottle being incorrect and I keep going back to the fact that I think our electromagnetic model is poor. I think the electromagnetic model is fine just needs some expansion.

04:01:26

I would say that it's a nice to see some new physics but one in 40,000 is not the sufficient bar for particle physics. They usually demand like one in a billion lights. It just basically a ridiculous amount of standard deviations and the only symmetry with our project is that we're also trying to go for very very high confidence with these sorts of measurements so that you know, you make an announcement but you're saying so far we think this will work.

04:01:56

Now, We're going to perform, you know, several thousand hundred thousand maybe measurements to make sure that what we're saying is accurate so it's kind of an interesting and never thought I'd be performing these this many measurements in a biophysics project.

04:02:21

All right, so I let me just invite everyone else up here and one by Kyle and by Daniel. And invite Sir Ruthy and so I'll reset the room quick. This this room you can you can talk about anything you want but the veins of the main topics that we're floating around are narrow physics.

04:02:43

Brain waves oscillations neural circuits nerve gear AI and I've really enjoyed the last last hour talking to. This talking about the the the technology from I guess I guess let's just say IO from IO, right? And it's a you know, super super cool to speculate about about not just the the neuro oscillation and not just the the brain wave oscillations and neuro circuits on a microscale and within the brain but also what's happening outside of the human body and that's sort of like where we went and in the last hour and and devices basically devices can detect this information and I I am kind of like curious about it.
...
To coordinate things but definitely something that will be looking at right now it's been kind of easy to make these sort of distinctions but in general like if we wanted to focus on what the differences of the background or ambient field of the human being little pathogens or other molecules.

04:04:38

I'd have to look it up just to tell you just I don't have the graph in front of me, but I'll look it up so that. Next time I have up into you. I'll have the answer. Sweet yeah. I mean just occurs to me there might the answer might be online.

04:04:52

I could probably just google but human bio field or something and. And and then compare that to the solely sensor. Yeah, but we're not necessarily using the solely sensor that's just the the team that we're working with. I don't I don't want to necessarily say that it's the solely sense of those it gets a little bit more complicated but I was I just got like not that not the best look from one of my colleagues a little bit and they were you know, please be careful about what you say, so I've gotten a sperm warning even though I'm, Right yeah.

04:05:32

I mean that yeah, no worries.

04:05:38

But I will say I kind of have like an Elon Musk kind of answer when people ask me like well, you know, we're ready to think of this and why do you think this will work I say like like, you know mascot this story about you know, it's aliens come to earth and they fly in with this little hot thing bouncing off the atmosphere then they parachute and land somewhere in the ocean and they open the hatch and they say there's nothing to fear we come in peace, that would not be really reassuring.

04:06:07

And along those same lines I say, you know aliens come to earth they abduct a bunch of humans and then they get their little chemistry set up and start studying us. I don't think so if they're gonna be traveling they're gonna be traveling lightweight and they're probably gonna be using or modifying or manipulating the spectrum to perform these sorts of measurements or abductions, so I kind of have achieving answer for that and so far at least a lot of the people who are in the field or military related chuckle and And and find it funny but it's it's I'm also half serious.

04:06:45

So yeah so it sounds like researchers like yourself talk a lot to the military about certain projects and military's interests are gonna be a lot different from from you know, civilian interests in terms of terms of what you what you're gonna what you're gonna sell and so any marketplace in a way with the military is just gonna want to buy.

04:07:04

Yeah yeah there is a big difference I am happy that we are focused on the medical aspects at present I did reach out to a lot of my physicians who actually treated my cancer and I asked them what they would I would I asked them like what do you think of this project you know, what if we worked with the military what about this what about that they said, you know, whatever you choose please give back to humanity don't make it something that's locked away that covered somewhere and some warehouse like in the end Jones, do make sure that you know, it's not used to harm people either and in fact, that was one.

04:07:39

Of the moral kind of. I don't know conflicts that have internal conflicts about hey, you know, if I develop this technology that's used to hurt people and I respond to and some people said, you know developed a technology to somebody else's job to regulate it but you know, I went above and beyond to try to get make sure that I wasn't stepping on any toes or fisting off the military we reached out to all of the appropriate government people we notified everyone of the experiments and everything so we've been very open and and explicit about these projects.

04:08:17

And so far the wow it's remains civilian and medical oriented but I suspect there are programs that are doing things differently so in terms of you know, so you may have the ability to mass market as this product they may be in everyone's cell phone it may be distributed all over the world and and people in every country may have this technology and and you know, so I imagine that they there's gonna be a lot of company.

04:08:52

Foreign companies will be trying to reverse engineer what you've done and and and violate copyright laws and patent laws and just you know, try to try to sell this at least you know, at least on the black market. Or just outside US regulation. I mean these kinds of things has happened and but but that's not the point so the point is like okay so so so the other companies illegally reverse engineer and in and and in duplicate and figure out the technology eventually what are what kind of potential risks are we looking at in terms of how how other out basically how foreign military how?

04:09:43

Could they hurt us. I don't want to get so many ways, sometimes it's your responsibility as this would be categorized as so just claimer we're on the watch list now because I said bioterrorism online. I don't know but one of the people. Buying terrorism in a you know talk somewhere and then the next thing I think the same day the FBI showed up in this house and they won't like talk about bioters and new so there are some things to keep in mind but in general a simple scenario is you have a sensor that can tell you what a pathogen is or what a certain sample has in it will constitute that sample just through the process of variability people could find viruses and other things so there is obviously an element of regulation that goes.

04:10:39

Along with this technology and so I've reached out to scholars physicians academics regulatory agencies like the the normal approach is asked for forgiveness, not for permission, well I've gone and done my due diligence to kind of tell everybody about the risks and other things that pertain to this and how I would.

04:11:03

Generate counter measures and things like that, but if a kid samples their grandma saliva and they see that it's some sort of, you know exotic virus grandma here spin into this test tube and now all the sudden somebody has a sample that they can cultivate and that's actually what happened with Ebola and a bunch of people who had Ebola were kidnapped by terrorist groups and there was a lot of concern that they were running these solo camps or Ebola funds where they would have people in this tent and you would just keep.

04:11:38

Bringing in new people to become infected and as you brought in more people the virus who would mutate more and so you were able to accelerate the evolution of this virus to a very deadly scale so that's kind of one of the scenarios that emerges and therefore regulation and surveillance is one of the things about this technology that's necessary so first applications will probably be to be we would trust physicians and dental offices and schools and airports and things like that and then eventually somebody would have.

04:12:13

Some. Thing in their hand but it wouldn't tell you. You know, what kind of viruses is that would be more love to a professional somebody who is accredited and follows regulation, but of course once a genie is out of the bag then it's hard to start to control that so it's the only hope is that you can develop countermeasures.

04:12:36

Yeah but like just to be clear you're building a detector not like a you don't even like it's it's it I like your idea it's attended like a thermometer or something because I already wanted like I have deep concerns already about the way the genetic database is so open like somebody on reddit just like, you know handed out the entire like, you know DNA covet and it's like or whatever that you know, it has a few intentional stones mistakes in it, so it's very difficult to synthesize it so that's kind of something that's scientists don't talk about but they put an intensive spelling mistakes that it can.

04:13:11

Not compile oh so interesting yeah because I worry about like this 3D printing of you know, um, yeah, like really came printing organs and stuff and as that takes off if we have all these like public databases of you know viral yeah, yeah, but like I could take I could take your straw from you thank you you're drinking outside and sequence it right now and know your genetic information that's actually what happened with the CEO of Marvel and somebody known as something timing bombed from Toronto a head hunter and there was this entire controversy.

04:13:46

EDITED

The sensors in your phone and do physics related to type of phone measurement how it's called a PHY PHOX. So I just fired up just see how how many sensors you are carrying around, right? So okay, the manual says acceleration without G with GE gyroscope light blindness in lots measures.

04:17:48

Her momrometer yeah, it gets ridiculous and say they have the you take a measure the echo by the conclusive button echoes. For distance. So it's it's with characters the type of verbs then it can tell so not very yeah accurate but it's proof of concept demonstrate at the education kit is quite cool, right?

04:18:10

So so all these things is I mean, the the one you mentioned that it can you know measure using the router to measure activity and even to the sensitive video the the pulsation is, you know, we are all connected. So, there's no [[choice]]. So, that's what that's a no escape.

04:18:30

Yeah, there's no escape but, So, I think this doesn't write off the So they're so constantly discussions on this clock house. It's fascinated by the collective. You know, what is the do we have three wheels, right? So I think I still insist that we do. It should I mean the world I mean tell sign and we are here in a few of us discussing this topic is specifically assigned indicator of that there is a you know, there's a water they're supposed both rises, right?

04:19:03

So it's that's that's the interest is the chase. I mean if, We need to I waste a lot of time, you know back then when I was you know started to to try to escape but I know I just so go with the flow and the yeah anyway, so that's a very fun discussion topic but before you I just look quickly is looked up assaulty videos the it's a very short video.

04:19:28

It's about three minutes, right? So here even though there's a one you showed a technical graph. I saw it as actually the frequency is that about 3G 3G hertz and there's the, You can you can have a very talk. You have a slight not area of difference of the two virus you can discriminate right?

04:19:51

Yeah. Yeah, so so okay, so that's a limited picture of the frequency range though, so that's that's only part of the slide that we were instructed to show we wanted to show more of the slide but we wouldn't allow us to show more of it. Oh sure. So that duck gives me a rough, you know, what what what you're you know trying to do is it's a fascinating can already, you know be able to get a noise ratio signal to noise ratio that it can enable you are able to make it a product but that's that's that.

04:20:27

I think that's you have to overcome a lot of you know work. Yeah, it could be I would say that that's the debatable but that's from last year, so there's we have new measurements that kind of show that the signal is surprisingly robust so consistency of measurements. There is very little variance, so it's it's quite consistent.

04:20:56

Yeah. That's that's all I would say, I don't believe in privacy though. I think it's a human construct. I think we need to move on to a better constructor better idea but privacy is very poorly understood. It is merely the ability to do something autonomously without being interrupted. Secrecy is what most people confuse privacy for.

04:21:22

So secrecy or the ability to conceal information that is up to the person to be able to do. In fact, the NSA has a cheeky answer. They say you're not being spied on. There is nobody watching you because they don't classify a computer passively recording everything as a person.

04:21:42

So there is nobody spying on you because everything is being recorded. That's kind of the the future. So unfortunately more of these things are going away but the only the consolation that I have or the solace that I could find you is that. Regulation and legislation laws. Senators governors members of Parliament all of the world.

04:22:09

These people have to change the laws so that for example your genetic information if it's acquired possibly through the systems cannot be used against you. And in fact, that makes the world a little bit more equitable overall.

04:22:26

Yeah, I'm pretty much love with you on that and so the so ahead of thought yes, so the in terms of the, The terminate around if you look at this way I am I'm a big fan. I spend a lot of time reading up the you know, work actually working collaborating on these history of science, right?

04:22:50

So the history of science is I think this should be a required at a undergraduate level from all the subjects. Many good teachers, they actually going to add the first few lecture have a good [[gh-a0403z|introduction]] of the history of this object which we should wish is very good. So right now, We are given that we are in the mobile mobile.

04:23:15

What an internet connected all connectedness, right? So the level of connectors the the web. So to I I tend to visualize CE metaphor. So all the artificial technology goes the the social construct always the EM waves the radiating through my you know, all the walls of my room and the all goes, you know, all the standard industrial standards and all that turn it around.

04:23:42

So in the for historians, he used to be a very challenging. Work to dig up what this you know original thinker how they actually came up come how do you recall a moment hit up on them and now I mean the work supposed to be soon should be easier, right?

04:24:05

It's we're going into a page or a simple approaching that age that everything is recorded digitally. So, I mean as a matter of seconds you can search and look up what you know restore that and you know, What would happen That that's for me is possible. Thank you. Yeah, I agree.

04:24:30

It is nice that we can record that stuff. Personally, I would have wished for people like Einstein or Fineman to abuse like oculus and have been in the lecture explaining something because then if we had this three-dimensional afford-dimensional recording, you know, space plus time this movie that you can be inside of and move around imagine you could be over the shoulder of Richard finding these explaining something or or situations like that would be very phenomenal.

04:24:58

Right? Eureka moments actually came as a result of participating in the big data of your challenge hosted by welcome trust and epic games back in 2015. So this is an idea what? Can you slowly or challenge and then welcome for us the second largest biomedical charity in the world?

04:25:24

Yeah, they invited my wife and I to visualize and represent genetic sequences and virtual reality and that was actually where a large part of this idea came from when we were trying to understand these sequences and in fact, we stumbled upon tools from the Russian Academy of Sciences. Formed genetic sequences into signal and then did they use what is it had a marred and.

04:25:56

Yeah had more matrices and had about transforms to understand these systems and that naturally led to the question of well, hold on if we're using tools from signal analysis. What if it is a signal? So that was kind of if you want to understand that you read the moment from it.

04:26:12

So that was kind of how simple it was to begin with but it was because we were already involved with all these researchers from Tangerines to from all of the world, so it was it was not as isolated as perhaps the teens, but yeah. The previous thing you were mentioning was that why five can allow for monitoring people and treat their vital signals?

04:26:42

Yeah. Yeah, so technically you can hack a router and start doing that whatever you get it will have the road it is that correct? Uh, you can hack a road or to do that. Yeah, the paper is wifi W. I and the subsequent work shows other aspects as well, so yeah, there's a lot of information with radio waves.

04:27:05

In fact, the way that they trained it was they had a connect camera with a router next to it and the router was sending signals signals were bounced loss, but then they connect cameras also sending signals and getting information back from the first iteration of this technology just stopped to extract skeletal information and so they were able to see skeletons through walls based on these radio waves and then when they, Removed the connect camera so not behind walls but they were able to see like the person in front of the camera and the person on behind the wall and then they took away the connect camera and the machine learning system that they built was sufficiently robust to be able to reconstruct the skeletal form just from the partial signal information from the radio waves along so that's kind of the tricks of the trade as it were.

04:28:00

Wow, that's that's very very interesting. I mean for his buying or monitoring. People that's incredible all right, thank you, thank you. Yeah, my my advice is almost dead. I'm a two percent so if I if I get taken offline or whatever don't think it's the government that came after me, so.

04:28:23

That's a joke just so that people understand yeah we know but we won't we're gonna keep an eye on you, don't worry, okay?

04:28:33

Call stamits who does like mushroom research and he talked about a crazy instant where the heat submitted for a patent that involves, you know, specific, you know medical applications and they didn't approve it and then at some point like black helicopters came and he the you know people in the lab called him and were like there's helicopter circling and he was like, okay innocuently yourselves the fungal spores and like scattering the experiment by that that was so crazy because it's like, you know, he was not intending anything, uh, it only good intentions so just be careful yeah, yeah.

04:29:08

I do try to keep it in in mind be responsible. I'm always like no, no, please no. I'm on your side yeah. I love Canada yeah, so I do try to be told the line as it were in terms of. Message of the allies or the western world but it's also something that I believe in full disclaimer understand now you're listening so there's no reason to go after me, in fact it's better to enable such work and work with scientists, although I do suspect that some of these applications will be classified as it were so some of the things that I did talk about you probably never hear about ever again, so.

04:29:51

I haven't gotten that order to not talk about it so because I feel like I'm mortal in terms of my cancer it could come back and things like that. I would much prefer the technology to be out there so that if I don't get to be able to build it or whatever reason let's add die in a magical car accident tomorrow, at least some of you can rebuild it in fact the cyclical nature of these kind of discoveries is very fascinating because it came up in the 30s and in the seventies and then two thousand and each time people tried to make certain progress in this but were limited by the technology of their time.

04:30:26

And so that that's kind of also it's it's a very fortunate coincidency. I mean, there's a there's like a broad sort of. It's like a it's like a bright so like this is like general advancement of technology but there but but in terms of imaging technologies we're we're that we're having simultaneous innovations in medicine technologies and every industry in every science is it's not like you you're just talking about like today this is we're just talking about one thing but there's so like there's so many advances happening simultaneously in terms of imaging.
...
And it's causing this massive innovation everywhere all at once and it may be people were thinking about this a hundred or two hundred years ago, maybe sounds like it but but but now the the technology is allowing all the different possible variations to and even stuff like that was never imagined before to start to happen.

04:34:14

Yeah I mean we talked a little about the difference of the history of science and one of the like larger arts that I see I think in terms of the advances in optics and the way that that's impacted us is a species. There's like this weird relationship there with like um, so you can I don't think because you, you know the invention of the telescope and then of the microscope and now the like screen and the way that we're basically like we've changed the way that we view the world and the like spectrum that we have access to and like that every time that's happened that's like fundamentally revolutionized like all the rest of our technology.

04:34:55

Yeah, yes point the the we we're I mean, it's just dumb funny. It's you know, one one thing and reflect on that think about it also. In terms of you know way of what I mean, this was all how I see you know the ancient thinkers how I mean, I start to appreciate them, you know.

04:35:24

Even more you know, given that they are so rudimentary in a way now so so promoting Elena, I mean, it's a better hopeless recipe. So stole them later able to point to the way, you know, it cannot be perfect and no one is name mistakes and many places but still.

04:35:55

I mean a human evolution in the evolution enabled that the human much more than our close relatives with a new coordinates and stuff. I mean, we're the potential lights still. I mean something in the air and people like nowadays come contemporaries like. Alamosky and you know all these leadership will use Microsoft and on the Apple phone and then it's really up to so this is it's it's ice for me.

04:36:30

I mean, it's still open always, you know, I wide open and see to touch on the connecting back to Earth. I'm already an early sharing bye. I'll data. I I had a similar. Worries before but I mean even right now, I mean, I'm for different and for me, I mean the way I visualize the you know, the the insured I think I wouldn't worry that much because so there's no it doesn't.

04:37:08

I mean for me I try to become more vigilant of you know, what the boundary of [[gh-a0206z|self]] versus the exterior, that's right. Now, that's what we can do, but that there's a maximum limit of. Do otherwise we cannot find time to work, right? So the different cultures is like a different pyramids, right?

04:37:29

This type of tolerable adult. But so I mean, There's a common language when we call mathematics and science, right? So there's so if so for me, I mean, yeah, I see it that's supposed to be one. I'm not saying anything religious but I think like Einstein said when they ask in you know, if you're religious he says, I have some sort of a god but it's I wouldn't call it a really religion.

04:37:58

I eat certain natural.

04:38:03

Anyway, so the, So the,

04:38:13

So it's also I mean, I think it's exciting and right now I mean, there's a knowledge in the digital divide somehow. For for a few of us here. I mean student. S lean on the luckier side. So what contribution I mean with a clubhouse, I think it's definitely contribution right so vibrations that we.

04:38:41

On the similar frequency to resume and maybe something will come out of it. So making a positive contribution. So I think that's a what I'm you know, in terms of spectroscopy, I mean, the high energy physics just recent days there's a so there's some you know new experiments from the formula.

04:39:03

So it might be new particles to be discovered and this for so it's never ending so so if but, Also the other day. I mean for me I I think the I don't know what the so I will your in water do I think while I do is it's great.

04:39:23

Has a great computer science and I think physics. Group and that's so the what? So many of the recent days of Nobel like a work physics and chemistry most many of them can connect back to any I should convey the contribution to. Biology, so be it tools of a new measurement for the.

04:39:55

Sequencing. I think this year probably is not a. Is probably good. What was her name? Sorry. Tip the family for the MR in the vaccine, right? Yeah the lady, you know.

04:40:23

We're making group programs. I think. Yeah it's surprising how many scientists will like things together more than Apollo and Manhattan Project combined so it was really weird to see like every lab that could pivot to covet do so and the only thing that I've been saying for some of these innovations sometimes it's for surveillance or persistence any reasonable any reasonable person would have long ago quit and that's kind of what I would say about my project that any cell like I even got last out of the classroom saying that I'm crazy and all these.

04:41:03

Things that thankfully I went back recently and you know, I did like the good hunting thing. I was like, how do you like them apples and? Stuff like hey look I got some results that we're not trivial who's laughing now so good but unnecessary but that's kind of the the friction that you get when you're doing crazy things and it's difficult sometimes to get people to take you seriously even now people like on Clubhouse outright called me like a liar and I'm like yeah, okay.

04:41:36

I'm telling you the data is there and you know, there's money behind this and it's not just me drinking my own Kool-Aid, so but the thing, Is like um, like. It's like to even even like think about this right this is like this is there's there's some. You know, it's just like this like there's there's.

04:42:01

What you've what you've described has a level of complexity to someone who was who I I think that that someone who was a messing around, you know wouldn't wouldn't you know, I hope wouldn't have wouldn't have the that much knowledge that you have so it's just. You know at it's like what you're you're you're talking about things are like novel concepts, you know and you're in you really understand what you're talking about that's that's what you know and in that you just like you that there were in in your like the you've got to ask me anything happening right whereas like, you know, if someone was making up a story they would be pushing back against, you know questions and stuff like I think but I you know, I'm not an expert but I just, Thank you.

04:42:49

I think itwould be hard for for I mean, I guess because I guess you should at the beginning you had your fear was that you would be compared to. To thrown out so whatever whatever her name was yeah, yeah, what do you think it's gonna is gonna be um, the way that you're gonna.

04:43:07

Show people that you're you're because I mean I guess so like you're saying there's gonna be a small percentage of people who are gonna say well if someone has a new a new technology that's really amazing we should automatically be suspicious well what what's the strategy yeah to get a competing lab to evaluate it, so we've talked to investors who already have affiliations with counts that can once we finalize some of the designs and aspects of this device, we'll be shipping it off to them to give us a grading like to give us.

04:43:43

The mark. Or whatever you know to evaluate the device and that's kind of how we're going about it to be very robust very open and collaborative because this project isn't possible if you just want to build it on your own the very instruments that we use now are quarter of a million dollars just to be able to capture the signals and the question of can we miniaturize and reduce the cost of these kind of circuits that's just an engineering question, so it's it's not even a question of of if but when and we've been very open about the the time.

04:44:18

S between one and three years you can expect some sort of consumer product and in fact, we hope to have a prototype done by the end of the year that is [[gh-a0206z|self]]-contained and not using industrial grade equipment, so that's the that's the hope that the first device will cost anywhere between 300 and 3000 dollars and that will be the cost of the prototype itself, so when you mask manufacture something like that, you can reduce the cost and that's kind of what I'm focused on now, it's kind of weird that you have the hustle very similar.

04:44:53

To how Elon Musk kind of started Tesla so that's kind of been one of the inspiring things or the things that I've been following is how Elon Musk went about creating a Tesla stuff even though I don't agree with a lot of things they said about Coventry but yeah, yeah.

04:45:08

I'm okay so so that's a fair enough point but I'm the that was the whole like that that was that was the promise of magically basically that they that they they said we have this device that it's super expensive and it produces amazing [[augmented-reality|augmented reality]] holographic experiences and We're gonna we're gonna shrink it down and and you know from being like a multi-million dollar device and into being something that that is affordable to the everyday consumer and that was basically their proposition to it, you know to investors is that they're gonna do the deliver this magic and a portable package and of and then everyone got really mad at them temporarily because for a while because the device they delivered that was portable didn't have any of the capabilities the big of the big, you know, multi-million dollar machine that they were showing off before it was is very much like a copy.

04:46:03

Of the Hollands and and then but that but now I guess you know, we're waiting to see what they're they're coming out with a new one this this winter and maybe though have showers that they've made some advances but but it's very it's very much complicated you you promising to turn something that costs millions of dollars into you know, something that is is $50 or whatever and you say it's just an engineering problem, well, sometimes those engineering problems are a little bit harder than than you know, the new then you might expect but So anyway that that I think that that's where you'll hit some some some people will be wanted to raise that point but anyway.

04:46:44

Yeah so various intellect like areas of variation of this sense that we have now that is about $500 we have variation that's about $250,000 but we want to make one that's in this range so that we can actually scale things down properly in the way that we want so some design decisions change but we're already in the ballpark and just reducing that by by 10 is is not that it's not that big of a leap it was a huge leap to go from 250 k to about a few thousand but the, Ta thousand to maybe tens of dollars is.

04:47:24

Surprisingly feasible. I was not expecting it to be this feasible so. Yeah.

04:47:33

Okay these I just can't see where like you're part of the long tradition like if you want to think outside of the box you'd be kind of outside of the box and like I think Tesla's professor told them that um, you know, his devices were impossible perpetual motion machine right and and I had the same instinct that you did like, um, once I recovered I you know went back to my doctor and wiggled my fingers which he said, I'd never be able to do you know, so yeah, yeah fundamental about like if you're gonna make something that's outside the norm it's because you're already free-thinking, you know, so yeah good on you.

04:48:07

I did have another question. So earlier someone said that they basically saw that your device was in terms of the potential harms that your devices the potential harmony device could detect the one of the things he said it could detect make it too easy to detect harmful viruses in the environment and then and then that that could be a big issue but but but basically, it was a detection mechanism and and so what I wanted to drill down on is basically is it more than just the detection mechanism are is it is a trike is it a tricorder that can.

04:48:43

I make some DNA changes to you know itself not the current model, so the energies are purposely only for imaging or detection identification not for modification that is the harder problem but in essence I think the modification and editing is not impossible it's just a matter of the relative energies like if you look at the movie Elysium or they have that tanning bed and people laid down and it's scanned your body and all that stuff that's like one of the first presentations.

04:49:18

That I did to the engineer so I was like this is what we're aiming for this is this is the goal everyone but right now we're here and so it was kind of a fine thing because everyone chuckled but then they were like yeah, but that's true we're actually not that far away from it, but it is a matter of like regulation so even if you were to detect like a pathogen, there would probably have to be some sort of coordination with the government that okay when the sensor goes off and it detects this thing that it pings the local public health agency that you know is able to at least keep.

04:49:53

Track. This stuff. So unfortunately, the monitoring is is one mechanism that's going to erode privacy but privacy and exchange for peace of mind. I don't mind. So, Quickly. I already did the movie ELI SIUM is other one. EELY SIUM. Yeah. Alicium are the medical bed or met day. Met bed little video on YouTube, you can watch that so that's kind of how I get the engineers.

04:50:32

So, okay, I'll meet to do but away go ahead with a yoga but the after that I I would like, To ask the room and also Eric that a what the what's what's your comment on, you know, your technology fall in a category of spectroscopy, but a what do you think the material wise you know, say in nano or macro that if what's your what's what's your?

04:51:12

Comment on the you know, the fast-paced progress on the Indian situation well contribute to to the field that you're interested. Yeah, you know, I tried and gallium arsenic contributed to the expanded spectrum capabilities for detections so without those advances of those substrates this would not likely be possible.

04:51:40

Okay, so that's the LEDs huh. Going I tried is a replacement for silicon that oscillates in the terahertz range, so. Oh, tell your talking about a three and five. Okay, so some some some people will call it the three three five. Yeah, I mean third generation but those are mostly for power right so high temperature high voltage sensitivity, so.

04:52:15

If there's also sensor that you can look up colder rights sensor RYDERG and it's an RMI variety yeah so that sensor came out last year US Army infectious. The US Army communications division developed the sensor to cover large band of the spectrums that are able to do up to I think a hundred gigahertz with only one antenna or one sensor, so that's quite impressive and they can expand it to about it.

04:52:50

So you don't need multiple sensors or modules to cover the entire spectrum. So there's been a lot of advances that have. And helps okay so if we're talking about we're talking about you know, so there's the account of 3d printing and the concept in Star Trek there's the the concept of basically the replicator right where you can make any food right so so let's say that let's say that theoretically you've got you've got the you know, it's it's 50 it's I don't know if it's 20 years from now or 50 years from now 100 years from now.

04:53:25

I've got the the next the next generation version of your technology that you're working on right now and it's and it is good. We're not just detecting anymore we're changing things and so like we we can we can point this this at at a dish and into and change and maybe change the flavors of dish change the smells of the dish change that but then we're talking about DNA, you know, maybe you could you could like instead of a drug therapy you could just enter you could introduce the the you know, some sort of some sort of, Effect which is equivalent to the to the drug right yeah, yes there's actually a famous episode of Star Trek Voyager where to go take brings like this little device over to show captain Janeway and he says my ancestors used to used to take psychedelic drugs, but now we can just do it with this device and he'll just hand over the device and it allows him to start tripping with her and so that's kind of ugly enough a lot of these science fiction things have inspired a lot of these scientific advances, so I suspect that is also possible.

04:54:34

And but so like um in if we're gonna like if we're gonna if if I if we're talking about like just a matter of like so I guess my question is like just in terms of using the EM frequency range theoretically to just change the the amplitudes and the the the frequencies and the in the phases of RNA and DNA how what's the upper bound on the kinds of changes we can we can cause what what what can we change exactly and maybe the limit?

04:55:09

S of that. Yeah, I think we can make like we can just we can obviously destroy the the the sequence the modifications. I suspect are in line with the sensitivity of the detection so if we can detect single nucleotide or single letter changes, we can probably make single letter changes but that's just conjecture at this point.

04:55:34

Okay what I'm saying is like so like a single so type of single letter we're talking about a like if you know a nucleotide could be like the letter the letter G right and so how would you so are you talking about change in the letter G to like the letter C is that the kind of thing changing you're talking about yeah yeah and and so that removing a completely or whatever at or removing it completely okay, so basically like like destroying just that one part of the sequence.

04:56:03

But then repair mechanisms within the cell can allow the DNA to be reconcile reconstituted, so there's a bacteria that they discovered in the arctic something. It's a very ratedviation resistant or radiation tolerant organism that they bombarded with the ionizing radiation the genome gets like splattered across the inside of the cell, but within 24 hours the DNA spontaneously reconstructs itself.

04:56:33

So there's something about the lining of the membrane and all these other things that allow, S the structure information to be preserved within the confines of the cell wall and or the bacterial wall and that allows it to rebuild itself. So similar mechanisms that if you only make small little changes here and there those can be fixed almost similar to run time.

04:56:58

I suspect or what I would call like at fixing at runtime. Well, I mean, like so like the polymerase right is like a spell checker. Yeah, and it fixes errors that happen but um. Okay, so I so this question is like okay, so the difference between a GFC and a C in terms of nucleotides is that is it really just a matter of like.

04:57:27

Like a like a difference in in phase or difference and like a temporal pattern like I don't know, how would you how it or or is it like like the because yeah converting one to the other so I'll go ahead and pause. Yeah yes So anything not only differ a little bit but the actual shape of the curves across the entire spectrum are quite different.

04:57:55

They're almost orthogonal sets so you can almost make a wavelet set from the different shapes meaning that they're very amenable to orthogonality and a particular kind of space so you could set up a certain kind of metric where these different signals could be considered orthogonal and then you can perform very quick calculations to know whether you're listening to Guanine.

04:58:20

A cytosine or uracil or whatever. So we're talking about like with with EM frequencies, we're changing the we're changing the shape or the orientation or both. Just just the the shape of the frequency response changes based on the different molecules, so the guanine lava different response from agony. I'll try to pull it up tomorrow if you're on here or whatever next time on I'm on here.

04:58:50

I'll make sure to have a screenshot of the different shapes of the nucleotide so you can kind of see how oddly similar and oddly weird they are. But but at the root of it, we're changing one type of molecule to another type of molecule with an electromagnetic because they're exchanging so they're always there's always letters floating around.

04:59:13

So all you're doing is creating a preferential. Gradients that wants to have this letter instead of that one, so first you set up a gradient that knocks it out and then you set up a gradient to replace it just that that spot so it's. Okay and so a gradient is we're talking about an ionic gradient like an EM field gradient.

04:59:38

Water both they both react to one another right so depending on the ambient. Depending on the whole solution you can have certain so it is kind of specific sometimes but you can tune in kind of like how you tune in with radar but I am getting a really tired now so I'm gonna have to call it a night it was actually down to one percent now so if it's actually it's actually midnight so we're so where I'm also signing off and I want to thank everybody for coming and we'll do this very often so have a good night everybody thank you very much.

05:00:14

I owe and good night everybody yeah, thank you make a thank. You so yeah everyone else take care of everyone see safe have a good night.

## Source Provenance

- Source file: `original archived b0310yGoogle.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/original archived b0310yGoogle.md
