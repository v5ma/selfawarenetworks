[[neural-lace-podcast-ep2-blaze-sanders|Neural Lace Podcast 2]]
...
So, welcome to the [[neural-lace|NeuroLace]] podcast.
...
SpaceVR is a dream to allow all of us to go up and see what it's like to be in space via [[virtual-reality|virtual reality]].
...
who also works at SpaceVR, and he had just been awarded an NVIDIA processor for [[humans-as-metal-robots|robots]].
...
about building a [[humans-as-metal-robots|robot]] for [[artificial-telepathy-via-oscillatory-synchrony|telepathy]] on the satellite.

Exactly.

It's a full humanoid [[humans-as-metal-robots|robot]] about one and a half meters tall and is controlled by a [[virtual-reality|VR]] suit, remote control.
...
So we're going for some Earth-based use cases in the labor market that we think we can solve with [[humans-as-metal-robots|robots]].
...
NASA has the Robonaut 2 right on the space station now, so we're going to use some of their tech for the [[humans-as-metal-robots|robot]] in space.

But right now we're focused on ground-based robotics and the [[neural-lace|neural lace]] has an important part to play in that.

Wonderful.

So let's talk about connecting [[neural-lace|neural lace]] to SpaceVR or [[neural-lace|neural lace]] to [[brain-computer-interface|telepresence]].
...
So you have a true sense of presence, [[brain-computer-interface|remote presence]], as if you're actually there,

but then you'd have a different body if you'd have to get used to that.

It'd be amazing.

Right now there's a lot of gloves that you can wear for [[virtual-reality|VR]] that give you a little bit of haptic feeling

and there's other input methods that let you move your arms around.

But with the [[neural-lace|neural lace]] you could think about doing something or if you were making a video game,

think about turning on your shields and they would turn on.

So in the [[neural-lace-podcast|previous podcast]] I laid out what I think are the two steps we need to achieve in our lace.

I'll just recap this real quick.

So one of them is we need to take a computer that's this [[inside-out-vision-model|computer vision]] that, you know, like the [[gh-a0206z|self]]-driving clock

or like [[virtual-reality-neuroscience-convergence|mixed reality]] concept where the computer is learning the concepts of everything around it.
...
so that we can have this [[deep-learning-neural-networks|neural network]] that's doing [[inside-out-vision-model|computer vision]].

That's part A and then part B is you need to have another [[deep-learning-neural-networks|neural network]] applied to live [[3-medical-imaging-technologies-2018|medical imaging]]

and then you need a live [[3-medical-imaging-technologies-2018|medical imaging]].

It could be a chip that's implanted in your, close to your [[thalamus|mid-brain]] and it's for several chips

and we just want to focus on that.

It's [[3-medical-imaging-technologies-2018|medical imaging]] even if you do it with another type of medical imaging.

That's part B because now you have a [[deep-learning-neural-networks|neural network]] dedicated to what's going on inside your brain.

And then you have a third neural network that's at the apex of the two of my side.

So above A and B which is [[inside-out-vision-model|computer vision]] of objects and [[deep-learning-neural-networks|neural networks]] of brain life data.

You have a third [[deep-learning-neural-networks|neural network]] that is looking for the similarities between the world that you're seeing

and the activity of the [[cortex|brain]].

So that means that if you're seeing a car and the [[inside-out-vision-model|computer vision]] is seeing the car

and the computer vision is seeing the [[cortex|neural cortex]] of your brain activity while you're seeing the car
...
we really have to go beyond [[eeg|EEG]] and beyond the fusion tensor imaging of [[fmri|MRI]].

It's about, it is about getting chips to focus on the data in the [[thalamus|mid-brain]]

and the reason for that is because all of our incoming senses, you know from our eyes or ears

they collide at the [[thalamus|mid-brain]] first before they connect with the rest of the [[cortex|cortex]].
...
and then I move my hands together and where they come together is like at the [[thalamus|thalamus]]

or somewhere in the [[thalamus|mid-brain]] and then they connect with the rest of the [[cortex|cortex]]

which is, you know, for the eyes they're going to go to the occipital lobes and the prideal lobes

and then you've got a whole bunch of information coming back at the same time back towards the [[thalamus|thalamus]]

which is, anyway, so the point is if we, so the idea is if you tried to study from [[eeg|EEG]]

which is on top of your head, at that point everything is scattered.

It's all over the place. I mean you have, there are [[semantic-cortical-mapping|maps of the brain]] that have been done

in places like Berkeley where they say, you know, you're a concept of a cat and a dog

has [[neural-distinction-consciousness|neuro correlates]] over in this region of the brain which I'm doing another hand gesture.
...
It's all scattered and distributed, [[distributed-phase-representations|sparse and distributed representations]]
...
when it comes back together to the center of your brain, to the [[thalamus|midbrain]], to the [[thalamus|thalamus]]

where your senses are coming in, maybe that information is coming together there.

When it's in the [[cortex|neocortex]] it's all over the place.

So the place we want to put our sensors is in the [[thalamus|midbrain]] and if we do that then hopefully we can capture

a photo when it's coming together before it scatters across the [[cortex|neocortex]] or the sensor image

and the sensor image that we want to capture is electromagnetic.

[[brainwaves|Brainwaves]], we'll see there's neurons that have electrical synapses and neurons that have [[chemical-synapse|chemical synapses]]

but they're all generating a lot of [[brainwaves|brain activity]] and the cells of the neurons have,
...
and those, you know, the classic example in any neuroscience or [[computational-neuroscience|computational neuroscience]] textbook
...
and in the brain you have an [[action-potential|action potential]] but unlike the sky there's a path of least resistance

that is the axon body itself, the middle of the cell body.

And unlike, you know, the standard neuroscience or [[computational-neuroscience|computational neuroscience]] textbook

the [[action-potential|action potential]] doesn't travel directly between two neurons.

It's not, it's actually, it goes along the body of the cell and you can see this in the illustration

but then it goes to the axon terminal or the [[chemical-synapse|post-synapse]] and inside the post-synapse

the synapse is so complex, it's like a little micro-computer

and so we used to say in [[computational-neuroscience|computational neuroscience]] that you have to summarize whatever goes along the axon terminal
...
because you can't just summarize it as a [[neural-code-transmission|1 or a 0]].

It has a [[brain-rhythms-in-cognition|wave]], it has an amplitude, it has, you know, it has the charges count
...
but if it's a [[chemical-synapse|chemical synapse]] what happens is it triggers a bunch of neurotransmitters, ions to pass through
...
and this synapse is like a computer and it's, and the [[dendrite|dendrite]] itself, so is, here's the real question, okay?

So this is like one of those things, because I study like the dynamics of [[neural-sequence-representation|neural circuits]], for example.
...
So when you see a [[neural-sequence-representation|neural circuit]] in the brain, which means the same group of neurons light up in a sequence

but it's also a [[agent-phase-sync-feedback-loop|feedback loop]], like it's a [[neural-sequence-representation|repeating sequence]],

how is it that sequence ever repeats more than once?

And the weird thing is that the neurons in a [[agent-phase-sync-feedback-loop|feedback loop]] are not necessarily directly connected
...
and that's what we call the [[neural-sequence-representation|neural circuit]].

But why would that ever happen? And so there's a lot of different network theories about why that might happen

but the most obvious possible solution to that is it's fundamentally about [[magnetic-phase-field|electromagnetism]]

and it could be that the [[dendrite|dendrite]], which is the receiving terminal of the synapse

it could be that the [[dendrite|dendrite]] is, dendrites are, you know, like more than 80% of the brain
...
and so the [[dendrite|dendrite]] could be doing a lot of interesting [[dendritic-computation-pattern-detection|computations]]

and we'll really analyze this. The [[dendrite|dendrite]] itself could be like a sort of [[dendritic-computation-network-detection|mini-computer]] or a micro-trip.

It's very fascinating and so, but the [[dendrite|dendrite]]

does that whole [[agent-phase-sync-feedback-loop|feedback loop]] a discrete step then in some sense

or is it still analog in that [[agent-phase-sync-feedback-loop|feedback loop]] as well?

It could be a discrete step.

Each part of it could be a discrete step where the [[dendrite|dendrite]] itself

could be like, so imagine you have a bunch of [[dendrite|dendrites]] that are competing

like 10,000 or 100,000 [[dendrite|dendrites]] that are competing for the signal that's coming from the neuron

that's in all the [[computational-neuroscience|text books]], right?

Well, it could be that the [[dendrite|dendrite]] that receives it is the one that has the most negative charge in [[gh-b0049y|summary]]
...
so the [[dendrite|dendrite]] on the past, the post terminal is receiving
...
so if the brain is operating sort of like in terms of [[magnetic-phase-field|electromagnetism]]

that would make sense because we capture all these [[brainwaves|brain waves]]

so what is a [[brainwaves|brain wave]]?

A [[brainwaves|brain wave]] is a wave of ions that's flowing throughout the entire brain
...
so we measure, we can see these with [[eeg|EEG]] caps
...
yeah, the [[eeg|EEG]], I had an EEG business once
...
anyway, so [[eeg|EEG]] still hasn't even reached its full potential

especially when you start applying the power of a supercomputer

that goes in a [[gh-a0206z|self]]-driving car to your EEG analysis data

I mean that just hasn't done yet

so there's a lot of exciting things for [[eeg|EEG]] and for [[fmri|MRI]] and [[neuroimaging-next-generation|DTI]]

and for new brain computer interfaces

things that could possibly, potentially revolutionize medical neuroscience

but one of the great... there's a lot of great new concepts around [[eeg|EEG]]

is that you don't have to only study [[eeg|EEG]]

you can also study the eye movement

or what they call it, you know, it's [[eeg-xr-neurofeedback-bci|eye tracking]]

but also [[eeg-xr-neurofeedback-bci|pupil dilation tracking]] and heart tracking

you can put all of these on a single sheet

there's a software called [[neuropype|Narrow Pipe]], it's open source
...
so the [[deep-learning-neural-networks|deep learning]] can, you know, it's great for observing
...
like, let's say that someone, you're wearing [[augmented-reality|augmented reality]] glasses

and you've got [[eeg|EEG]] and you've got a heart rate monitor

and you've got [[eeg-xr-neurofeedback-bci|eye tracking of pupil dilation]] stuff
...
and you at the same time, you've got all the [[inside-out-vision-model|computer vision]] stuff

going on as categorizing objects

and so then you have [[deep-learning-neural-networks|deep learning]]
...
at the same time your [[brainwaves|brain wave]] had a spike in some region
...
and so that's a way of, you know, when we do [[3-medical-imaging-technologies-2018|medical imaging]]

it doesn't, it should be [[multi-modal-sensory-array-geometry|multimodal]], it's not

let's only do [[eeg|EEG]] or let's only do [[fmri|MRI]]
...
because you know the [[fmri|MRI]] machine obviously is magnetic
...
a voice recognition API for your [[humans-as-metal-robots|robot]]
...
but it's also your [[eeg-xr-neurofeedback-bci|eye tracking and pupil dilation]]

and the computer is figuring out, okay, so this pattern

of working on the voice recognition API for your [[humans-as-metal-robots|robot]]
...
of Blaze working on the computer on voice recognition for his [[humans-as-metal-robots|robot]]

that'd be sweet

I think some of the first use cases for the [[neural-lace|neural lace]]

will definitely be in the [[3-medical-imaging-technologies-2018|medical field]] like solving [[gh-a0340z|Parkinson's disease]]

like that seems like a great first use for it

absolutely, we have to, so the first step to solving [[neural-lace|neural lace]]

is to identify those [[brainwaves|brainwave patterns]] of decode

what brainwriters mean, the second step

is to identify the [[neural-code-transmission|communication protocol]]

like a [[neural-code-transmission|network communication protocol]]

so imagine if our brain was organized like a [[self-aware-network|network]] or like the internet
...
you need almost, TCP is like a [[agent-phase-sync-feedback-loop|feedback loop]]
...
so the question is, if we can figure out the [[neural-code-transmission|network protocol]] of [[magnetic-phase-field|electromagnetism]]

and we can create [[artificial-cortex|artificial neurons]] or chips

that can send and receive [[neural-code-transmission|electromagnetic information]]
...
and one of those is reconnecting the [[path-integral-neural-connectivity|spines]]

because what happens is the [[path-integral-neural-connectivity|spine]] is severed

and so the neurons between two points are no longer communicating

and if we know how that works

if we know how neurons [[neural-code-transmission|talk to each other]]

we can reconnect the [[path-integral-neural-connectivity|spines]], it's very practical

we're not in the realm of science fiction anymore

this is just bridging a physical gap

and then also the same idea applies to [[body-ownership-statistical-matching|artificial limbs]]

so if you had your arm chopped off

and now someone gives you this really great [[body-ownership-statistical-matching|artificial limb]]

you can physically connect it to your [[brain-computer-interface|nervous system]]
...
is let people with [[gh-a0340z|Parkinson's]] go back to work

by working through a robot

and also like vets that have had an arm blown off

like letting them go back to work through a [[virtual-reality|VR]] [[humans-as-metal-robots|robot]]

so what your telepresence [[humans-as-metal-robots|robot]] at SpaceVR means

is that when we have a [[neural-lace-brain-port|brain port]] that allows us to convert electromagnetic waves

into something the computer understands

that means someone who's sitting in a bed who can't physically move

can teleport into your [[humans-as-metal-robots|robot]] and have the presence to walk around

and sort of like, you know, do business through that [[humans-as-metal-robots|robot]]

and their brain would function as if it was their [[body-ownership-statistical-matching|body]]
...
it's not just [[brain-computer-interface|brain-computer interface]]

it's also, I mean it's [[brain-computer-interface|brain-computer interface]]
...
the whole [[cortex|neocortex]] potentially

that's what many people believe

so that might be a little bit hard to edit

but what you might be able to, through a [[neural-lace-brain-port|brain port]]

that is connected to your [[thalamus|thalamus]]

or pointed at your [[thalamus|thalamus]] from somewhere outside of you

like with wireless, e.g.

with, you know, there are ways to [[non-invasive-brain-stimulation|non-evasively stimulate]]

like with [[non-invasive-brain-stimulation|ultrasonic sound]]
...
to [[non-invasive-brain-stimulation|stimulate]] that core part of a person

the [[thalamus|mid-brain]]

and instead of actually putting a chip on there

and so now we have [[non-invasive-brain-stimulation|non-evasive]] possibility
...
injecting [[humans-as-metal-robots|robots]] into their bloodstream

there's so much cool things [[humans-as-metal-robots|robots]] can do
...
if you have [[humans-as-metal-robots|robots]] that are concerned about your health

but one comment was

if your [[humans-as-metal-robots|robots]] get hacked
...
- Source file: `nlp2.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/nlp2.md
