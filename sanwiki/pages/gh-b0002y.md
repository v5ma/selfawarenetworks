b0002y.md 5,238 words 29,799 characters
...
Alec: Yeah.
There are kind of, okay, so what you're thinking of is like [[ionic-magnetic-fields|ionic]] and [[bridging-molecular-mechanisms|covalent bonding]], right?
...
The balance between the number of [[bioelectronics|protons and electrons]] is now unequal.
...
[[biological-computation|life]] are bonds that are covalent and what that basically means is it's a little bit
...
One way to think about it is also like saying [[free-energy-principle|kinetic energy]] is actually a way of stabilizing
...
[[3d-protein-receptor|biological macromolecules]] that we care about and the drugs that we care about.
...
[[bridging-molecular-mechanisms|covalent bonds]] we typically find in biological systems are where we associate with life and
...
And then there's many different ways that you can share [[bioelectronics|electrons]] between atoms.
...
things like [[bridging-molecular-mechanisms|polymers]], which are basically, you can think of, you know, you have even
...
[[three-dimensional-protein-structures|proteins]], they can make RNA, and these different configurations all end up leading to different
strings, which all, because they're all arranged differently, lead to different 3D architectures.
And then it's those [[three-dimensional-protein-structures|3D architectures]] that actually allow all of these molecules, which
...
atoms, oxygen, nitrogen, carbon, and [[sit-hydrogen-part1|hydrogen]].
...
So just like in [[biological-computation|life]], in nature, nature arranges all of these different strings of atoms together,
even though they're all the same types of atoms, it's that arrangement of those atoms
in [[three-dimensional-protein-structures|3D]] that actually allows them to do complex functions.
...
also the fact that they're in a [[cell-as-chemical-neural-network|cellular environment]], in an environment that actually pushes them
into a [[three-dimensional-protein-structures|structure]].
...
All from the fact that it's governed purely by physical law, saying that it's of [[free-energy-principle|lower
energy cost]] to go down this hole to basically make a bond.
And then when you break a bond, you release a bunch of [[free-energy-principle|energy]] so you can do work somewhere
else.
...
Memo: So just to conclude the whole group, what is so special about amino acids and [[protein-synthesis|proteins]]?
...
in.
But yeah, I mean, the real special property is that the [[three-dimensional-protein-structures|protein]], at least proteins, again,
...
But [[three-dimensional-protein-structures|proteins]] in particular are particularly masterful at moving protons and electrons
...
[[free-energy-principle|energy motion]], you think about it for your car, for like combustion, or you think about
...
units of [[bioelectronics|charge]], protons and electrons, and amino acids, and because they have the ability
to move electrons and protons around and their [[three-dimensional-protein-structures|3D architectures]] dictate how they can do that,
...
Alec: No, no, no, no.
So protons are everywhere and you can think about it like [[sit-hydrogen-part1|water]].
So on [[sit-hydrogen-part1|water]], there's this property known as pH you're probably familiar with, so acidity.
...
This is known as a hydronium atom, or you can remove a [[bioelectronics|proton]] so it's just an oxygen
...
are actually driven by the fact that in [[membrane-potential|membranes]] on cells, there are these things called proton
pumps and what they do is they actually take protons off of molecules or off of water and
then drive protons from one side of the [[membrane-potential|membrane]] to the other.
...
We're just talking about water inside a [[cell-as-chemical-neural-network|cell]], like you can think of it just like a...
...
Alec: Yep.
And the movement of charges to particular locations is what allows [[biological-computation|life to exist]], right?
The controlled motion of [[free-energy-principle|energy]] from one place to another and then that energy's ability
to do work, which are all basic [[periodic-physics|physics principles]], right?
...
Alec: That's right.
So there's nothing special about the [[bioelectronics|electrons or protons]].
...
into different locations so that this [[biological-computation|work]] can be done.
...
is sculpted.
And I think there are some [[every-cell-chemical-neural-network|cellular mechanisms]] that actually employs Van der Waals force
...
And like you may be alluding to, right, thermal, this is a big thing from [[periodic-physics|physics]], right?
...
But [[bridging-molecular-mechanisms|hydrogen bonds]] and van der Waals forces, because they're so weak, they can be broken
...
very, very difficult to model because they are [[quantum-field-theory|quantum mechanical]] in nature.
...
to break the [[bridging-molecular-mechanisms|hydrogen bond]] and Van der Waals forces are substantially lower.
...
[[quantum-field-theory|quantum mechanics]] to accurately kind of make a picture.
...
So more or less, it's a [[bridging-molecular-mechanisms|weak attractive force]] between neutral atoms or neutral molecules.
...
- Source file: `b0002y.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0002y.md
