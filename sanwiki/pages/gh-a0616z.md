...
Computational Rendering aka Computer Graphics in the Brain: [[gh-a0206z|Self]]-Aware Rendering

Cycle 1: [[gh-a0206z|Self]]-Aware Networks
##### Brain
...
* [[gh-map-intro-fractal|fractals]] (princeton mri study, eeg, meg, furaxa microwave imaging, cavities (skull, eyes, ear), sensory arrays (dendrites, circuits, columns, default networks, thalamic bridges, interneurons, corpus callosum, rich clubs, major brain network junctions.)
...
Mental Relativity: Phase Communication
        3b Phases not spikes. Spikes to Brainwaves, Phasic, Tonic. Peter Tse,
            * Phasic Firing ([[criterial-causation|criterial causation]] theory)
    ...
    * Inhibition
    ...
    Coincidence patterns as bits
        3b2 Oscillations: Rhythms of the Brain: György Buzsáki & Sync by Steven Strogatz 
...
Grid Graph
        ...
        3c Synaptic Spikes, Backwards Dendritic Spikes, Forward Dendritic Spikes, Dendritic Branches Apical & Basel Summarization, [[action-potential|Action Potential]], Types of Neurons (Pyramidal, Granule, Excitatory, Inhibitory), Microvesicle Release. Neurotransmitter & Soliton wave transmission.
       ...
       3g Spines to Synapse Memory, [[path-integral-formulation|Path Integral Formulation]], Oscillation, [[dendritic-computation|Dendritic Computation]], LTD, LTP
    ...
    4c. the hippocampus as a specialize cortical column, 
...
1 Neural Codes & Network Protocols:
    ...
    1c. [[attention-schema|Attention Schema]].
    1d. Phase Precession.
    1e. Predictive Coding: How Memories Become Predictions
    1f. Grid Cells & Place Cells & Reference Frames (Numenta)

8 Neurophysics: Addressing the Measurement Problem aka the [[observer-effect|Observer Effect]]
...
* bad points & exceptional points
    * bad points: spacetime has no real area in [[gh-b0049y|summary]], but rather area is relative to time
...
0001A [[criterial-causation|Criterial Causation]]/Choice
...
Philosophy of the [[gh-a0206z|Self]]
...
[[neo-mind-cycle|Neo Mind Cycle]] 2012-2014
...
##### Numenta's theory of a thousand brains,
    ...
    1. Phenominally Conscious & [[gh-a0206z|Self]]-Aware Machines
    2.  From 2D classification to [[3d-semantic-segmentation|3D Semantic Segmentation]], including the object recognition of which points in space belong to which semantic classification
     Pointnet ++ and [[3d-semantic-segmentation|3D Semantic Segmentation]]
...
8 From Graph Neural Network to [[gh-a0206z|Self]] Aware Neural Networks (rendering screens to itself) 
...
##### Action Perception Cycle: Prioceptive Movement: COIN Contextual Inference AUTOLNK_MASK_5

## Source Provenance

- Source file: `a0616z.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0616z.md
