...
This audio note frames the question of "who am I?" through [[actions|action]], [[artificial-perception|perception]], [[attention]], [[attention-awareness-consciousness-triad|attention-awareness-consciousness]], [[awareness-as-predictive-myth|awareness]], [[background-awareness|background awareness]], [[brain-as-memory-prediction-machine|memory-prediction]], [[brain-as-rendering-engine|brain rendering]], [[brain-as-self-watching-movie|self-watching]], [[brain-as-sensory-processor|sensory processing]], [[brain-as-spectral-graph|spectral brain]], [[brain-rhythms|brain rhythms]], [[brain-state|brain state]], [[brainwaves|brainwaves]], [[cellular-oscillating-tomography|cellular oscillating tomography]], [[coincidence-detection-neural-bit|coincidence detection]], [[competitive-neural-pattern-dominance|pattern dominance]], [[conscious-access|conscious access]], [[conscious-awareness|conscious awareness]], and [[consciousness|consciousness]].

Its self-development thread connects [[consciousness-as-high-bandwidth-choice-mechanism|high-bandwidth choice]], [[consciousness-as-oscillatory-feedback-loop|oscillatory feedback]], [[consciousness-as-persistent-rendering|persistent rendering]], [[consciousness-as-prediction-determinism|prediction]], [[consciousness-as-temporally-active-loop|temporal activity]], [[consciousness-canvas-wave-differential|wave-differential canvas]], [[consciousness-multimodal-rendering-loop|multimodal rendering]], [[continuous-neural-rendering|continuous neural rendering]], [[cortex|cortex]], [[cortical-column|cortical columns]], [[cortical-column-oscillatory-collaboration|column collaboration]], [[cortical-column-oscillatory-synchronization|column synchronization]], [[cross-scale-oscillation-communication|cross-scale oscillation]], [[default-mode-network|default mode network]], [[dendrite|dendrites]], [[dendritic-coincidence-detection|dendritic coincidence detection]], [[dendritic-computation|dendritic computation]], [[dendritic-pattern-detection|dendritic pattern detection]], [[distributed-consciousness|distributed consciousness]], and [[distributed-observer-vs-consciousness-module|distributed observer models]].

The whole-brain pattern argument is also a bridge to [[distributed-phase-representations|distributed phase representations]], [[four-dimensional-phase-tracking|four-dimensional phase tracking]], [[gh-b0049y|summary]], [[inhibitory-interneurons|inhibitory interneurons]], [[memory-prediction-as-intelligence|memory-prediction as intelligence]], [[neural-array|neural arrays]], [[neural-arrays|neural array systems]], [[neural-circuits|neural circuits]], [[neural-code-transmission|neural code transmission]], [[neural-coincidence-patterns|neural coincidence patterns]], [[neural-ensemble-phase-reset-communication|phase-reset communication]], [[neural-functional-fractal|neural functional fractals]], [[neural-oscillation|neural oscillation]], [[neural-oscillations|neural oscillations]], [[neural-phase-pattern-propagation|phase-pattern propagation]], [[neural-rendering-of-qualia|neural rendering of qualia]], and [[neural-sequence-representation|neural sequence representation]].

The later discussion of synchronized larger circuits belongs beside [[neural-strange-loop-self-referential-consciousness|self-referential consciousness]], [[neuronal-global-resonation|global resonation]], [[oscillator-level-awareness|oscillator-level awareness]], [[oscillatory-binding-problem|oscillatory binding]], [[oscillatory-computational-agency|oscillatory agency]], [[oscillatory-convergence-memory|oscillatory convergence memory]], [[oscillatory-memory-invariance|oscillatory memory invariance]], [[oscillatory-neural-coupling|oscillatory neural coupling]], [[oscillatory-synchrony-multimodal-integration|oscillatory synchrony]], [[oscillatory-temporal-memory-window|temporal memory windows]], [[pattern-neurons|pattern neurons]], [[predictive-coding|predictive coding]], [[pyramidal-cell|pyramidal cells]], [[recursive-neural-array-perception|recursive neural-array perception]], [[self-as-learning-loop|self as learning loop]], [[self-as-motor-sensory-rendering|self as motor-sensory rendering]], [[self-aware-network|self-aware networks]], [[self-aware-networks|Self-Aware Networks]], [[sensory-stabilized-volumetric-rendering|sensory-stabilized rendering]], [[thalamo-cortical-information-flow|thalamo-cortical information flow]], [[thalamus|thalamus]], [[theta-wave-reality-generator|theta-wave reality generation]], [[tonic-oscillation-as-predictive-reference-frame|tonic predictive reference frames]], and [[wavefront-collision|wavefront collision]].
...
Like, it's like synchrony temporal synchrony and if there's not then it so it's like, it just is a matter, like, you know, the whole idea is if you just have like the maximum number of nodes that are part, if the, if you have the basically arguing, like if you have like who you are, is the [[gh-b0049y|summary]] of all the connected nodes.

13:56

And if you connect the second brain and it has more connected nodes, then by virtue the fact that has a greater number of connected nodes, you're going to be your. You're going to be identity is going to be the [[gh-b0049y|summary]] of all those nodes. And so, I didn't need no longer to be localized with the original circuit, but with the larger circuit, and the larger circuit could trend over multiple lines.
...
- Source file: `b0183y.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0183y.md
