This is the transcript of the original [[neural-lace|Neural Lace]] Podcast Monologue

The original audio was published to youtube in April 2017 and contains the root concepts from both the [[gh-a0001z|Self Aware Networks]] Theory of Mind and the Super Information Theory that unites physics. The articles on this page are also evidence that my work on [[gh-a0001z|Self Aware Networks]] and Super Information Theory traces back to 2017 at least. https://medium.com/silicon-valley-global-news/the-neural-lace-journal-talk-show-a-compilation-of-articles-and-links-ae3fbb0d5d5a
...
[[augmented-reality|augmented reality]], and mixed reality. It's also an umbrella topic that includes

deep learning [[artificial-intelligence|artificial intelligence]]. Some of the topics that come up in this podcast
...
before. So welcome very much to the Neuralace podcast. Your host is [[micah-blumberg|Micah Blumberg]]. The reality

is that Neuralace is a [[brain-computer-interface|brain-computer interface]]. It's not the same as the EG because it's bi-directional

because we're reading and writing. So the first step is we need a supercomputer, like a [[gh-a0206z|self]]-driving
...
which is all these lines, but we can also predict which way the car is moving. And the [[gh-a0206z|self]]-driving
...
right? But if the same sort of like spatial computing of a [[gh-a0206z|self]]-driving car can just figure,
...
the idea here is that if we can, you know, at the same time, have this [[gh-a0206z|self]]-driving car type of
...
after the reason I'm, I'm really interested in giving me a [[neural-lace|neural lace]] is because I want it to

happen. I want it to happen faster. I want everyone to, I want to democratize. I want everyone to have

it. And, and beyond [[neural-lace|neural lace]], the, what I'm, what after I'm building [[neural-lace|neural lace]] first and happy to

work with anyone who wants to work, tell me, build it. But after we build [[neural-lace|neural lace]], the idea is to,

um, uh, build artificial neocortex and then artificial brains. We have, there's a lot of great

ideas on how to achieve [[neural-lace|neural lace]] and a lot of people want to keep their ideas a secret. And so

we were talking about that in terms of if we give away how to make [[neural-lace|neural lace]] on this podcast,

um, what is our objective then? And should [[neural-lace|neural lace]] be democratized so every company can know

how to do it. And my thought there is that we should democratize [[neural-lace|neural lace]] because we really want
...
to get on board with, um, helping us to create [[neural-lace|neural lace]] as possible so that we can have neural

lace in our lifetimes. So someone remarked to me recently that in order to achieve, um, the kind

of [[neural-lace|neural lace]] we're talking about or brand computer interface we're talking about, you'd have to have

a number of like Nobel prize winning discoveries that would happen. It's pretty much simultaneously.

Um, and the, and so one of the positive outcomes that, um, of [[neural-lace|neural lace]] is, is we'll be able
...
of [[neural-lace|neural lace]], but there's a lot of practical medical applications to being able to connect a,
...
can come from pursuing a direction of research towards [[neural-lace|neural lace]] about, uh, new, uh, ways to
...
[[neural-lace|neural lace]] products. But I just wanted to say that, um, I, I'm really interested in creating
...
actually could do sort of a noninvasive, um, [[neural-lace|neural lace]] that gets at the core of our brain
...
for [[gh-a0206z|self]]-driving cars, that's a really mean and serious machine and they're still figuring
...
your car for, for, for driving. But if we could take for women, if we could take those [[gh-a0206z|self]]-driving
...
[00:18.040 --> 00:24.920]  [[augmented-reality|augmented reality]], and mixed reality. It's also an umbrella topic that includes

[00:24.920 --> 00:29.940]  deep learning [[artificial-intelligence|artificial intelligence]]. Some of the topics that come up in this podcast
...
[01:43.200 --> 01:49.700]  before. So welcome very much to the Neuralace podcast. Your host is [[micah-blumberg|Micah Blumberg]]. The reality

[01:49.700 --> 01:55.920]  is that Neuralace is a [[brain-computer-interface|brain-computer interface]]. It's not the same as the EG because it's bi-directional

[01:55.920 --> 02:03.240]  because we're reading and writing. So the first step is we need a supercomputer, like a [[gh-a0206z|self]]-driving
...
[03:17.520 --> 03:24.000]  which is all these lines, but we can also predict which way the car is moving. And the [[gh-a0206z|self]]-driving
...
[03:58.740 --> 04:04.400]  right? But if the same sort of like spatial computing of a [[gh-a0206z|self]]-driving car can just figure,
...
[07:08.360 --> 07:12.280]  [[gh-a0206z|self]]-driving car type of computer figuring out the environment, and it's watching you, it's watching
...
[26:52.400 --> 27:00.980]  because we can, because your whole reality can change once, um, once we have [[neural-lace|neural lace]].
...
[27:10.380 --> 27:15.700]  Um, and, and beyond [[neural-lace|neural lace]], the, what I'm, what, after I'm building [[neural-lace|neural lace]] first

[27:15.700 --> 27:20.400]  and happy to work with anyone who wants to work, tell me, build it. But after we build [[neural-lace|neural lace]],

[27:20.540 --> 27:27.900]  the idea is to, um, uh, build artificial neocortex and then artificial brains.

[27:27.900 --> 27:32.580]  We have, there's a lot of great ideas on how to achieve [[neural-lace|neural lace]] and a lot of people want

[27:32.580 --> 27:37.060]  to keep their ideas a secret. And so we were talking about that in terms of if we give away

[27:37.060 --> 27:42.400]  how to make [[neural-lace|neural lace]] on this podcast, um, what is our objective then? And should [[neural-lace|neural lace]]

[27:42.400 --> 27:48.880]  be democratized? So every company can know how to do it. And my thought there is that we should

[27:48.880 --> 27:52.980]  democratize [[neural-lace|neural lace]] because we really want this technology to exist in the world. And we do not

[27:52.980 --> 27:59.040]  necessarily know. Um, cause it's, it's a very complex thing that, uh, to try to solve. And so

[27:59.040 --> 28:04.380]  we, we want to encourage as many people to get on board with, um, helping us to create [[neural-lace|neural lace]]

[28:04.380 --> 28:09.060]  as possible so that we can have [[neural-lace|neural lace]] in our lifetimes. So someone remarked to me recently

[28:09.060 --> 28:12.860]  that in order to achieve, um, the kind of [[neural-lace|neural lace]] we're talking about or brand computer interface
...
[28:22.960 --> 28:28.960]  that, um, of [[neural-lace|neural lace]] is, is we'll be able to do, um, it's on the way to discovering it,
...
[29:06.580 --> 29:11.860]  as the science fiction concept of [[neural-lace|neural lace]], but there's a lot of practical medical applications
...
[29:26.000 --> 29:32.020]  really positive outcomes that can come from pursuing a direction of research towards [[neural-lace|neural lace]]
...
[31:11.920 --> 31:18.160]  yield some really awesome new [[neural-lace|neural lace]] products. But I just wanted to say that, um, I, I'm really
...
[31:42.220 --> 31:47.480]  actually could do sort of a non-invasive [[neural-lace|neural lace]]. It gets at the core of our brain by using a variety
...
[32:07.220 --> 32:12.700]  at the, uh, supercomputer that NVIDIA is doing for [[gh-a0206z|self]]-driving cars, that's a really mean and serious
...
[32:52.800 --> 32:58.460]  for driving. But if we could take for women, if we could take those [[gh-a0206z|self]]-driving cars and apply

[32:58.460 --> 33:03.940]  them to the task of, of neuroscience, we could probably create a revolution in neuroscience.

## Source Provenance

- Source file: `nlp1.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/nlp1.md
