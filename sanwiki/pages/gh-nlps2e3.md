[[neural-lace|Neural Lace]] Podcast Season 2 Episode 3

Optical imaging with Kyle E. Mathewson ~ [[neural-lace-podcast|The Neural Lace Podcast]]. Corona virus COVID-19 Special!
...
Kyle Elliott Matheson and we're going to talk about a little bit about [[fnirs-brain-imaging|FNIRs]], just a little

bit, but the topic is about [[neuroimaging-next-generation|optical imaging]]. And so let's just dive right in. Kyle, do

you want to share your computer? Well, usually I like to start with maybe a short [[gh-a0403z|introduction]]
...
learned how to record from [[brain-as-memory-prediction-machine|human brains]] in a number of ways, including electrically,
...
Okay, go ahead. Oh, well, yeah. So there's many ways to try to measure the [[neuroimaging-next-generation|activity of the brain]].

And one of the oldest, of course, is [[eeg|electricity]]. So you can measure the changes in electrical

potential that [[pattern-neurons|neurons]] create as they depolarize and hyperpolarize, either adjacent to them or

on them or in them or nearby. But it happens to be... And you can also measure changes in blood

flow in different ways, maybe with [[3-medical-imaging-technologies-2018|magnetic resonance imaging]] or with [[neuroimaging|ultrasound]].
...
flow in the [[cortex|brain]] to estimate which areas were active in a given situation.

And how detailed can you get? Can you get down to the single neuron in terms of...

Right. So with [[fmri|fMRI]], which is sticking someone in a big three and a half Tesla magnet
...
millimeter of the [[cortex|brain]] is 10,000 or more neurons. So you're measuring the [[brain-as-memory-prediction-machine|human brain]] at quite a

coarse scale using these [[neuroimaging|techniques]]. Right. So is that the same for [[fnirs-brain-imaging|FNIRs]]? You're talking about [[fmri|fMRI]].

Yeah. So with [[fnirs-brain-imaging|FNIRs]], you'll see today, I guess, that at the limit, as we get more and more light

[[sensor-transmitter-array|sources and detectors]], you can approach that kind of resolution in noninvasively in a human.

Okay. That's interesting. So we're talking about like when a [[graded-neural-firing|single neuron fires]], it expands and...

Oh, sorry. Yeah. I don't mean you can't get down to the resolution of a neuron. You can get down

to the resolution of about a square or cubic millimeter. So a group of 10,000 [[pattern-neurons|neurons]].

Okay. So we're not yet at the [[graded-neural-firing|single neuron]] stage with [[fnirs-brain-imaging|FNIRs]].
...
something that could be imagined in the [[sensor-array-consciousness|consumer realm]] were kind of at this level of groups of

[[pattern-neurons|neurons]]. So that being said, 10,000 neurons is a very small subset of like the 10 billion neurons

that there are. So these are localized groups that generally are doing the same thing.

Well, you're deep into this niche of [[fnirs-brain-imaging|optical imaging]]. And so I'm sure you've heard of all
...
Say that there's likely some physicists that understand the limits of some of these [[neuroimaging|technologies]].

And I wouldn't be surprised if they can be improved on further and especially with new

technologies and expanding on the current [[neuroimaging-next-generation|technologies]]. And so I'll talk a little bit about

like different types of light that you can shine into the head and what this new [[neural-tomographic-lightfield-rendering|time of flight]],

it's not new, but what the [[neural-tomographic-lightfield-rendering|time of flight optical imaging]] that kernel is using,

how that differs from the [[fnirs-brain-imaging|techniques]] that I use in my lab or the F nears techniques that are more

common and [[sensor-array-consciousness|consumer devices]] right now. Let's do that now. So yeah, like the,

well, let's at least go one slide further. So as I said, when [[pattern-neurons|neurons]] receive messages from

other [[pattern-neurons|neurons]] nearby, they receive those messages by neurotransmitter chemicals binding to the

[[coincidence-pattern-neural-bit|synapses and channels]] or gates opening up and ions rushing into the post synaptic cell. And

when those ions rush in, two things happen that we can measure with [[fractal-brain-optical-system|light]]. One we've already

mentioned is that the neuron uses energy to create some of those gradients over which those ions

flow. And so to recuperate from that use of [[criterial-causation-atp-neurons|energy]], it needs to recruit more ingredients from the

blood glucose and oxygen to make more [[atp]] to power the [[coincidence-pattern-neural-bit|pumps and gates]] that let things in and out.
...
more blood to that part of the [[cortex|brain]]. And that blood absorbs [[fractal-brain-optical-system|light]]. And so at the very

course of scale, you could think of it like a little localized shadow. And so parts of your

[[brain-as-memory-prediction-machine|brain]] that are more active are absorbing more [[fractal-brain-optical-system|light]] even from the lights in the room and the
...
because of osmosis and the [[cell-as-chemical-neural-network|membrane of the cell]] expands and gets stretched out. And it becomes

less wrinkly and it apparently becomes more transparent and therefore it interacts with

[[fractal-brain-optical-system|light]] differently. And so then in theory, you can use light to measure both of these things,

how much [[fractal-brain-optical-system|light is traveling through tissue]] and how fast the light travels through tissue.
...
Yeah, so this is a common [[gh-a0069z|technology at the hospital]], a [[fnirs-functional-near-infrared-spectroscopy|pulse oximeter]].

And it uses the same technique in that maybe we can't even see it, it's hidden in here so well.

It has little [[fractal-brain-optical-system|light sources]] inside this cavity that shine through your finger and then it has

[[sensor-transmitter|light detectors]] on the other end of here. So this is actually called [[neuroimaging|transmission optical imaging]].

So the light's transmitting through my tissue as opposed to going in and coming out,

which is [[fnirs-brain-imaging|diffusive optical imaging]]. But yes, so you can, if you have two wavelengths of [[fractal-brain-optical-system|light]]

and you're shining them into anywhere into a [[body-as-chemical-neural-network|human body]] and they are the right wavelengths

by knowing how much light you're shining in and measuring the amount of result light coming out,

you can estimate the [[fnirs-functional-near-infrared-spectroscopy|oxygenation of the blood]] because hemoglobin has four spots for oxygen to
...
light and absorption. And if you zoom in right around 800 nanometer light [[near-infrared-action-potential-detection|near infrared light]],
...
can do, um, recently shown with [[fnirs-brain-imaging|optical imaging]] is you can measure, you can estimate the [[fnirs-functional-near-infrared-spectroscopy|pulse wave]]

velocity. So how fast the pulses of blood are moving through the [[body-as-chemical-neural-network|body]]. And that is an estimate of

your vascular elasticity or how kind of hardened your arteries are. And it turns out you can [[neuroimaging|measure]]
...
have you ever seen some of these therapies? Maybe if you hurt your knee, were they shining [[fractal-brain-optical-system|near
...
Um, the [[mitochondria|electron transport chain]]. And one of the steps of that [[mitochondria|electron transport chain]] is,

um, uses a molecule cytochromoxidase. And it actually absorbs, I think it's,

that it, there, something about that step, the [[near-infrared-action-potential-detection|near infrared light]] can make it work more

effectively. So in theory, [[fractal-brain-optical-system|near infrared light]] can boost the production of [[atp]] locally in the

[[brain-as-memory-prediction-machine|brain area]] or in a [[body-as-chemical-neural-network|body area]]. Huh. And so not, I think there's also, um, helmets that you can get
...
you could boost the [[criterial-causation-atp-neurons|production of energy]] for the same input molecules. And so maybe your idea that
...
this. So we, we've been testing if you could locally enhance one side of the [[brain-as-memory-prediction-machine|head]] and not the

other. So you shine [[fractal-brain-optical-system|near infrared light]] in one [[cortex|hemisphere]] and not the other hemisphere. And
...
Britton Chance, who was the first to use near infrared, to use kind of [[neurotechnology|non-invasive optical

imaging]] in humans here on himself, had a single [[fractal-brain-optical-system|light source]] and a single [[sensor-transmitter|detector]]. And he was
...
done to look for known distributions in the [[brain-as-memory-prediction-machine|brain]], what you would expect to happen, say if you

illuminate the whole right side of [[visual-cortex|visual space]], you'd expect there to be activity in the left

visual hemisphere. And so you see that in this kind of test of that [[neuroimaging|technique]]. So you see this

boost of activity in the left [[visual-cortex|visual cortex]] when you stimulate the right visual field and vice
...
The [[virtual-reality|VR application]] that I helped develop in 2018 at Noisebridge, we brought [[eeg|EEG]] into [[webxr-bci-integration|WebVR]],

we used a [[brain-computer-interface|brain EEG device]], and what happened was we created a local server, we used Python,
...
point we could just use our JavaScript and our 3JS and our A-frame and our [[webxr-bci-integration|WebXR]] to take the

incoming stream of numbers divided up into our [[eeg-frequency-bands|delta beta]], our right channel betas, left channel

betas, the whole [[eeg-frequency-bands|EEG spectrum]], and we could define what our [[alpha-wave-sensory-suppression|alpha]] was exactly, which was nice,
...
[[neurofeedback|biofeedback application]], and if you can get the noise out as much as possible and have a real

signal there, then people might find that to be useful, but when you're in [[virtual-reality|VR]], you move around

so much, and so I thought, well, the next biofeedback application, maybe we'll get a better

signal to noise ratio with this F-narratives versus the [[eeg|EEG]], but then I'm listening to,
...
but when I saw, you're talking about doing [[fnirs-brain-imaging|optical imaging]], [[3-medical-imaging-technologies-2018|medical imaging]] with F-narratives,
...
begins to maybe map out an image, and I don't know how to describe that [[3d-neural-network-brain|3D image]],
...
recording the [[eeg|electrical activity]] of the [[brain-as-memory-prediction-machine|brain]], and the skull smears the electrical activity,
...
what's going on inside the stadium, and so that's like what [[eeg|EEG]] is, and so the idea that instead

you could get at least a fuzzy [[neuroimaging|image]] of what's going on actually inside the [[brain-as-memory-prediction-machine|brain]] is appealing,

and especially from like a feedback perspective as well, that it gives people not just like a

[[brain-state|state over time]], but kind of an object to imagine. One thing you could try, I guess,
...
into it. I mean there's so there's this with [[eeg|EEG]], you probably you know a ton about [[eeg|EEG]]

because you were doing that first, right? So you know about all about [[neuroimaging|source localization]] and that's

something that I've heard Morgan talk a lot about. One of my questions to Morgan was why can't we

you know use you use basically you know if you have a cap to 256 [[sensor-transmitter-array|electrodes]] on it and you're

doing [[neuroimaging|source localization]] so that you know you know basically you can predict where that

[[brainwave|brainwave]] may have come from within the [[3d-neural-network-brain|3d volume]] of the [[brain-as-memory-prediction-machine|human brain]]. Then you know what's what's

why can't you at that point build like you know sort of like accurate [[3d-neural-network-brain|3d models]] of [[neuroimaging-next-generation|brain activity]]?
...
but the best people in the area now are making really which is the same thing we do for [[fnirs-brain-imaging|optical

imaging]] is they're using the subject specific anatomy from an [[fmri|MRI scan]] and they're delineating

different structures in that object and how those different structures would transmit [[action-potential-magnetic-phase-field|electrical

signal]] and so they're using like really complicated models of the electrical conduction of the head

to try to estimate sources and it takes two different [[neuroimaging|modalities]] it takes the structural [[fmri|MRI]] and the [[eeg|EEG]].
...
light is it's not you're not measuring the [[action-potential|action potential]] you're measuring the the the in in rush
...
interior space of the cell and you're right that as you see an [[action-potential|action potential]] in that cell you can
...
the brain is working so one thing you can do is um that the brain picks up on [[brain-rhythms-in-cognition|rhythmic frequencies]]

out in the world okay and so you can flash uh one frequency on the screen like four or six hertz this

is the way some [[bci|bci's]] are are used now that they'll flash different parts of a an interactive display

at different frequencies and you can attend or look to some of them so this is showing how

these time of flight techniques could be used for that kind of [[bci|bci]] i guess that it can pick out

the peak frequencies of the things that you're attending to um in the display

um and then you can also record multimodal imaging so you can have [[eeg|eeg sensors]] built in
...
larger slower changes in [[eeg|eeg activity]] and and there at the current i was talking about uh

[[neural-magnification|MEG]] as well yeah so there there are other imaging technique is using these um
...
in python into a [[webxr-bci-integration|web socket]] and bring that into into the web page and then apply javascript
...
like the low-cost [[augmented-reality|augmented reality]] device would be like the [[oculus-go-standalone-vr|oculus quest]] it'll be four hundred
...
where's my hand the the thing to do with a lot of data is to apply [[3d-neural-network-brain|neural networks]] because that's
...
but have you know do a lot of hard work to get to figure out how to apply [[3d-neural-network-brain|neural networks]] to
...
like you know I've heard people you know what why does [[cognitive-privacy-xr-bci|blockchain]] come up in the in this context
...
- Source file: `nlps2e3.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/nlps2e3.md
