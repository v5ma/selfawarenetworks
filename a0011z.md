...
Sometimes Potassium channel receptors are bound by Ankyrin Repeats and that makes the receptor surface area larger so the cell becomes sensative to mechano-scale waves, in otherwords now the cell can react to touch.

In a sense that Ankyrin Repeat is allowing the cell to detect the coincident features of a mechnical scale wave (acoustic scale wave or sound vibration scale wave)
