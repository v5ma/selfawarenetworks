b0195y Google Recorder (This version was auto transcribed by Google Recorder, there is a better AI transcription in another version of this document by OpenAI's Whisper.)
...
I start out describing my [[eeg|eeg]] experience where I saw the beginning of time, but I dive deep into cognitive model making including [[predictive-coding|predictive coding]].

I talk a lot about my psychedelic medication experiences through out, starting at the 37 minute mark,

I talk about [[oscillatory-neural-coding|neural coding]] from fingers to dendrites, pointnet++, 3D neural network in Unity, rhythmic playback in a strange feedback loop, patterns in a temporal feedback loop, ink & canvas metaphor, different patterns from the [[inhibitory-interneuron-system|inhibitory interneuron system]], stages of perception, from a looping pattern to sculpting the looping pattern, always ready tonic patterns, phasic is a difference, and I make an argument that we are virtual beings, as if played across a piano, with our location being in different parts of the brain at different times

[[oscillators|Oscillators]] Oscillation Neurons
...
Next Generation series. He was, he went to the future, his his version of the future, and then he went to the past and he was traveling back and forth between the past and the future to try to fix some catastrophe. And and his future [[gh-a0206z|self]] has some sort of terrible disease.
...
Clap your two hands together loud. Bam, that that's like a soma firing event. That's a big event, okay? And that event is when the big that's, that's the real [[action-potential|action potential]]. And in see the thing is, the thing is, I think was not, clearly explained, sort of, as a temporal reality of action potentials in it.
...
But all of that, like basically it could fly, it might flyer and it might change the firing rate of that. Neuron, the fine rate could increase the decrease, but even if that happens, the rest of the oscillation of that neuron pulls, that neuron back into Austin, but back into [[tonic-oscillation|tonic oscillation]] with the rest of neurons.
...
Where's the observer works little man in your head deserving. All these patterns well I just so happens. The [[predictive-coding|predictive coding]] gives us a sort of gives us a distributed man inside your head. It's it says okay well you have neurons that are listening. You've interns it don't come in contact with the outside world, but they are listening to other neurons.
...
From from, from the points received from your sentences so your brain can learn 3D planes. Now we still haven't got to the part of like how this becomes conscious information or what the [[observer-effect|observer effect]] is.
...
So they're making predictions we have this knowledge set. Basically when you're, when you have this prediction of how the bottles may feel that representation, it may be consisting of sort of like dendritic forward potentials towards biking potentials but not the [[action-potential|action potential]]. So it's like the neuron is collecting all those data for a long time which is predicting what it's going to fire, okay?
...
Okay? Because they recognize well hey it's my time to fire and I'm going to represent what this person is experiencing right now. Okay. That's like a louder sound than a neuron. Can make when the [[action-potential|action potential]] fires from a soma and someone bursts. Okay. That's that said, in the moment representation of something that's happening right now, baboon.
...
And, and so the, so my argument is also, the brain is, brain is a finite state machine. And that the total the finance state machine is, the total [[gh-b0049y|summary]] of all the patterns between point zero zero to hurts and six hundred hertz that could possibly happen in the brain and in all spatial regions of the brain.
...
If in the rest of the brain wouldn't be able to be used or anything. So patterns have to be able to travel. And that's why the concept of [[soliton-mechanical-waves|salts on waves]] is really interesting is a kind of wave like a mechanical wave or a magnetic wave that can contain information.
...
So, the the [[tonic-oscillation|tonic oscillation]] is the ground of being or pure awareness or consciousness. Just obviously just being the observer and the patterns that arise in that place of your observation are the physic firing. Those are the distinctions from nothingness. Those are the distinctions between you know, if you if you have if everything in your brain was firing simultaneously, there'd be no distinction between anything distinctions like the desert between light and darkness.
...
I think there's sort of like, you know, there's a, it's a [[global-workspace-theory|global workspace]] component that is, it's, it's you get you. I don't want to think it's not an integration of information theory, but it is an association of information in sequence patterns, or, and also touring and, and it's a [[gh-a0206z|self]]-aware also for a network or a, so, for network and oscillates.
...
But thankfully there are intern neurons that link different brain regions together so you can have part of brain that creates representations of lightning [[visual-cortex|visual cortex]] starting the opposite of loves. And those representations have to connect with the representations of the thunder, which is where your [[auditory-cortex|audio cortex]] is going to be representing because, but it's like, piercing, it's like what's happening though.
...
So that means that you can have 10 spatial and temporal synchronicity in the firing of lightning and thunder that you can consciously notice. And and so the [[apical-dendrites|apical dendrites]], especially in the sixth layer of the upper layers of the neocortex are going to be really part of the key of sort of like integrating information, from multiple lower level data collections.
...
Then the the brain isn't able to create those like high level representations that are integrating lots of lower level representations and so the sort of like the integrating the apical neuron is that the point in which information becomes integrated into large-scale, conscious representation from the surrounding [[global-workspace-theory|global workspace]], of [[cortical-column|cortical columns]] and and individual cells, and dendrites and enter the branches.

02:05:32

So so, so that's what I'm saying is like we have the, you know, the the [[global-workspace-theory|global workspace]] is the whole brain but the integration of information is into consciousness is through the, the rich clubs that that are represented by the apical neurons, in the super, in the rich in the rich club networks that cross multiple reasons of the brain.
...
The brain is a general learning algorithm, that all the basically, all the areas of the brain are capable of representing anything. And if you take one sort of like, you know, David talked about this to Hawkins talked about this. If you if you, if you take, if you take and I out of a rat's eye socket and you plug that I into [[visual-cortex|visual cortex]], the rat's visual cortex will learn to see because because the brain is really a general learning.
...
- Source file: `original archived b0195ygoogle.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/original archived b0195ygoogle.md
