y0031 Conversation about Gravity
...
Create the ultimate [brain-computer interface](brain-computer-interface.md) (BCI): This involves developing a device or system that can read and write to the human brain like a hard drive, allowing for the downloading and uploading of experiences and memories.

Create an [artificial cortex](artificial-cortex.md): The speaker envisions this as an extension of the human brain, essentially functioning as an external neocortex that could increase intelligence and alter the perception of time.
...
The concept of an "[artificial cortex](artificial-cortex.md)" as an external extension of the human brain, enhancing cognitive capacity and changing the perception of time.
...
The concept of a [brain-computer interface](brain-computer-interface.md) leading to a feedback loop where the mind extends into the computer and the computer extends into the mind.
The notion that a [brain-computer interface](brain-computer-interface.md) could lead to the feeling of having a larger mind or more thoughts per second.
...
Creating the ultimate [brain-computer interface](brain-computer-interface.md) (BCI): The speaker envisions a system that can read and write to the human brain, allowing for the downloading and uploading of experiences and memories.

Creating an [artificial cortex](artificial-cortex.md): The speaker proposes this as an extension of the human brain, functioning as an external neocortex that would increase intelligence and alter the perception of time.
...
The discussion of a [brain-computer interface](brain-computer-interface.md) leading to a feedback loop where the mind extends into the computer and the computer extends into the mind.
The notion of an expanded consciousness through the use of [brain-computer interface](brain-computer-interface.md), described as the mind becoming "larger" or having "more thoughts per second."
The suggestion that artificial brains could potentially be disconnected from a physical body.
The argument against Nagel's theory: by downloading a bat's memories, one could potentially have some experience of what it experiences.
The concept of "digital schizophrenia," where multiple personalities or information sources could exist within the BCI context.
The idea of an artificial brain evolving over time.
...
Creating the ultimate [brain-computer interface](brain-computer-interface.md) (BCI)
Creating an [artificial cortex](artificial-cortex.md)
...
The first document provides a more succinct [summary](gh-b0049y.md) of the speaker's ideas and goals, while the second document offers a more detailed and expansive discussion on these topics.
...
"Yeah so I'm imagining like um in the case of [3D semantic segmentation](3d-semantic-segmentation.md) you have a volumetric video."
"[3D semantic segmentation](3d-semantic-segmentation.md) yeah that's when you what? That's when you uh basically are trying to get the computer to look at a volumetric video which is basically volumetric."
...
The text appears to be a dialogue where one person is explaining the concept of [3D semantic segmentation](3d-semantic-segmentation.md) and volumetric videos to another. The speaker describes how [3D semantic segmentation](3d-semantic-segmentation.md) is used to get computers to interpret volumetric videos, which are 3D instead of just 2D. The 3D perspective is typically achieved by combining views from multiple cameras.
...
To create the ultimate [brain-computer interface](brain-computer-interface.md) (BCI) that can read and write to the human brain like a hard drive, allowing for the downloading and uploading of experiences and memories.

To create an [artificial cortex](artificial-cortex.md), which would function as an extension of the human brain, enhancing cognitive capacity and changing the perception of time.
...
The concept of creating an "[artificial cortex](artificial-cortex.md)" as an external extension of the human brain, which could double one's intelligence and alter the perception of time.
...
[3D semantic segmentation](3d-semantic-segmentation.md) yeah that's when you what?
...
I'm glad that you guys can, because sometimes stuff, [Micah](gh-resnote04.md) says, Quantum gradient.
...
Oh shit dude, I don't know the level, okay so you're like doing that, [self](gh-a0206z.md) experiment I'm pretty sure this is not like a tolki like guidance thing this is just like a [self](gh-a0206z.md) [self](gh-a0206z.md) brought up before that I started a business in San Francisco where I was um trying to do I was trying to do like alternative itfeedback therapy type of thing, right?
...
There's, if this can, you have, you'll have, um, yeah, so basically you're trying to quantify, like, what [self](gh-a0206z.md)-improvement means or what optimizing your brain means.
...
Partially probably because of all the like in-depth like [attention](attention.md) that's been more time with it, more time out of it, but.
...
One was to create the ultimate brain computer interface, or the brain computer interface that's like nerve gear, or [neural lace](neural-lace.md), which means that we can read and write to the human brain like it's a special kind of hard drive.
...
The second one was to create [artificial cortex](artificial-cortex.md).

So like, um, like artificial brain tissue.

Okay.

So like, so the, um, [artificial cortex](artificial-cortex.md) could lead to like an external, like you have a neocortex.
...
Ultimate [brain-computer interface](brain-computer-interface.md).
...
So the first step is just the [brain-computer interface](brain-computer-interface.md).
...
- Source file: `y0031sci.md` in `github.com/v5ma/selfawarenetworks`
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/y0031sci.md
