...
This note is very disorganized at the moment. Skim downwards to see the parts about [Cellular Oscillating Tomography](cellular-oscillating-tomography.md).

[Protein Oscillation Tomography](gh-a0280z.md) has been moved to note a0280z

There are a lot of links you can skim past before you get there.
...
[Cellular Oscillating Tomography](cellular-oscillating-tomography.md) related search: [Cells can detect when multiple receptors](cells-as-pattern-recognition-devices.md)
...
# [NAPOT Theory](napot-theory.md) Framework: Activity increases or decreases are phase changes, phase changes in temporal patterns and spatial patterns across the brain.
"Decision-Making: A New Distribution of Tasks in Our Prefrontal Cortex?"
"ventromedial prefrontal cortex (vmPFC) in assigning a value to the different options presented during a [choice](choice.md). Thus, the activity of this region increases according to the value of the promised reward and decreases according to the cost of the effort required to obtain it."
https://neurosciencenews.com/decision-making-pfc-20947/

# The following is consistent with my theories on LTD written about in other notes in this repo, [Long Term Depression](synaptic-computation-ltp.md) or Long Term Forgetting is described as stemming from Oscillatory Decoupling in [NAPOT theory](napot-theory.md).
...
What I want to know more about the interaction between the plasma membrane and the endosomes. To understand what makes it possible for vesicles to move so quickly through the membrane, when receptor-ligand complexes dissassociate to be carried to the membrane inside an endosome do they become a liquid like liquid liquid phase separation?
...
Okay so it seems
# "Proteins with prion-like domaines can form viscoelastic condensates that enable membrane remodeling and endocytosis"
doi.org/10.1101/145664

Can I connect
"Viscoelastic phase separation"
with
Synaptic exocytic pathways
...
# [Astrocyte](astrocytes.md) Calcium Signaling Leads to More Brain Complexity
"The astrocyte network signals with (complex) calcium fluctuations" "gliotransmitters" "[astrocytes](astrocytes.md) Are Half of the Brain" "[astrocytes](astrocytes.md) take up potassium released during neuron action potentials to maintain ionic balance and pick up neurotransmitters like glutamate and GABA that are secreted at synapses."
...
# Extracellular Matrix critical to neuroplasticity" Jon Lief M.D. AUTOLNK_MASK_12

# Using a Supercomputer to Understand Synaptic Transmission
https://neurosciencenews.com/synaptic-transmission-20875/

hebb [synaptic memory ltp](synaptic-computation-ltp.md) Review Article
...
# [Cellular Oscillating Tomography](cellular-oscillating-tomography.md): Cell Signalling
Connect the following with Jon Lief MD Map and [Cellular Oscillating Tomography](cellular-oscillating-tomography.md) map
...
# Cellular Oscillation Tomography: Bacteria moved to [note a0283z](gh-a0283z.md)
...
Every cell in the human body is an unconscious "oscillating tomographical memory pattern prediction" machine with "generative behavior or function outputs" and in a multi-cellular system it is analogous to an Entity-Component-System in the context of a game-engine, where the body is the game engine, and the cells are individual entities that have their own set of components for reacting with system level [oscillatory binding](oscillatory-binding-problem.md) of learned reactions, learned & novel pattern sensing, and novel behavior/function/response generation.
...
Evolution gives us two big concepts, random mutation & natural selection, inbetween those two concepts the concept of "[Cellular Oscillating Tomography](cellular-oscillating-tomography.md)" allows single cells & multi-cellular organisms, from bacteria to the entire animal kingdom including human beings to compute their future biological structure.
...
The same principles of [cellular oscillating tomography](cellular-oscillating-tomography.md), coincidence & pattern detection, being stored in the physical configuration of receptors applies to [dendrites](dendrite.md), the soma, & whole neurons & oscillating groups of neurons, and clusters of neurons with oligodendrocytes, microglia, and other cells.

# "Single Neurons Detect a Sequence of Events"
() Even more recent research shows for the first time that single neurons can detect and respond to a [sequence of events](neural-sequence-representation.md).
()Individual [dendrites](dendrite.md) also can distinguish these sequences.
...
Functionally, the morphological distinctiveness of a neuron's [dendrite](dendrite.md) is analogous to the distinctiveness of cellular receptor and protein configurations that allow a cell to have distinct behaviors reacting to distinct signal patterns. This is why [Cellular Oscillating Tomography](cellular-oscillating-tomography.md) leads directly into [Neural Array Projection](neural-array-projection.md) (Signal) Oscillation Tomography.

[NAPOT Theory](napot-theory.md) suggests that high phasic spiking inhibits the exit terminal array, delaying an oscillating group relative to the larger oscillating group. In other words, delayed expression of the exit terminal of the activated neuron sets the new timing of the inhibited group by the decay rate of the fired [action potential](action-potential.md) in the previous array. The [tonic oscillation](tonic-oscillation.md) absorbs the burstlet, distributes it, and creates a synchronization pattern that dissipates the impact of the signal that group of neurons has received. This results in the temporal binding of learned internal representations that are displayed to subsequent arrays that also embody learned internal representations.
...
These phase changes are detected by neural arrays and via neural arrays are observed by oscillating groups of cells, as physical changes to their baseline [tonic oscillation](tonic-oscillation.md) activity.
...
https://www.cell.com/neuron/fulltext/S0896-6273(19)30567-7?_returnURL=https%3A%2F%2Flinkinghub.elsevier.com%2Fretrieve%2Fpii%2FS0896627319305677%3Fshowall%3Dtrue&fbclid=IwAR0yUTZqUli6_s0GNWB09aIRSljY7tZxV1TDfb8KL3mEM613hNUTxEfyU38#.YoP0_gZTLOM.faceobok
...
Primary original source lineage, recorded before any wiki import metadata:
- Original source file: `a0270z.md` in `github.com/v5ma/selfawarenetworks`.
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`.
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0270z.md.
