...
NAPOT Revision 4 is essentially that patterns sit in our minds as active synapses between neurons that are firing tonically at the same frequency, and these mental renderings are also defined by the inhibited synapses between neurons that are not firing at the same resonate frequency.
...
This basically shapes the wave path of phase wave signals as they travel through the brain, it shapes the path of voltage cell by cell, and going back again to the concept of phase wave changes being like tensors in a Taylor Series evoking shapes that your neural network can trace.
