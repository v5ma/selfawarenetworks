...
And they do that because they do that with the help of, there's actually, there's a process where the dendrites will fire before the [[action-potential|action potential]] fires.
...
So, can I ask a question? Hanson, this is, I would say, your work [[gh-resnote04|Micah]]. Dendrites are all throughout the folds of the brain, correct?
...
The name of the book is The Neural Basis of Free Will, [[criterial-causation|Criterial Causation]].
...
And the other is [[gh-a0206z|self]]-inhibiting.

The [[dendrite]] is going to [[gh-a0206z|self]]-inhibit when it sees an excitatory firing that is not what it's looking for.
...
so that should then, [[neural-oscillations|neural oscillations]] in human beings should have more...
...
But a neuroscientist was explaining to me that the [[action-potential|action potential]]
...
So separate out the [[action-potential|action potential]] idea,
...
And that's the [[action-potential|action potential]],
...
and at some point that's going to trigger the [[action-potential|action potential]] to start.
...
bike or an [[action-potential|action potential]].
...
It does two things. One is it's a key part of this [[action-potential|action potential]] process,
...
trigger the down regulation of the [[action-potential|action potential]]?
...
of the [[action-potential|action potential]].

And so I'm trying to figure out, okay,

well if the duration of the [[action-potential|action potential]] is varying
...
and that affects the duration of the [[action-potential|action potential]].
...
you know, once you trigger the [[action-potential|action potential]], does it?
...
it's changing the shape of the [[action-potential|action potential]]
...
But [[gh-resnote04|Micah]], if you want to look for how many of these
...
- Source file: `b0268ywhisper.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0268ywhisper.md
