Archived out of date note: formerly was the table of contents

c0000x/ **[[gh-a0001z|Self Aware Networks]] IO**

c0001x/ SAO Slide Deck Key Backup

[[gh-c0002x|c0002x]]/ [[gh-a0403z|Introduction]]

[[gh-c0003x|c0003x]]/ [[neo-mind-cycle|Neo Mind Cycle]]: In the ever present beginning of spacetime.

The Ultimate Brain Computer Interface

c0004x/ Entropy & [[gh-map-intro-fractal|Fractals]] : [[gh-map-intro-fractal|Fractals]] in Medical Imaging: Functional Isomorphisms at Multiple Scales
...
c0011x/ mechanical waves are [[gh-map-intro-fractal|fractals]] of other types of waves, like electromagnetic waves, a different scale of wave activity
...
c0051x/ [[neo-mind-cycle|Neo Mind Cycle]] in 2012-2014 the scope

c0052x/ [[neo-mind-cycle|Neo Mind Cycle]]: Nerve Gear the ultimate Brain Computer Interface

c0053x/ My experience with EEG with the Emotive, Transparent Corp

c0054x/ 160. 2012 Dedicated my life to solving how to build [[neural-lace|Neural Lace]] or Nere Gear first, then\

c0055x/ [[artificial-cortex|Artificial Cortex]], then Artificial Brains, this book represents a small [[gh-b0049y|summary]] of the
...
c0059x/ ###: Reading & Writing your thoughts and internal representations. Connecting the human brain to [[artificial-intelligence|artificial intelligence]].

c0060x/ Fractal Concept of Cosmos as a neural network including the brain

c0061x/ [[neo-mind-cycle|Neo Mind Cycle]], Scaling Fractal, The Fractal Dissipating Cosmos

c0062x/ Fractal Vortices

c0063x/ Chaos [[gh-map-intro-fractal|fractals]]

c0064x/ a fractal is a [[gh-a0206z|self]] repeating pattern, in a sense the universe is a functional fractal, with broad functional similarities at different scales such as a galaxy being a vortex, a planet being a vortex or dissipative system, life being a vortex or a dissipative system in a functional way, every particle

c0065x/ the universe is a fractal of clocks, a fractal of computation, a fractal of neural networks, or basically like each unit of the cosmos at each scale is [[gh-a0206z|self]] similar in that it's cyclical progression over time includes state changes at each interval of time that increase the information complexity in some area, and increase the overall entropy in another area.
...
c0082x/ the retina, the cortical column, the entorhinal-hippocampus, and the gray matter are each functional [[gh-map-intro-fractal|fractals]] of the same pattern at different scales, with jeff hawkins building slow 
...
c0088x/ in a thousand brains theory you have many [[gh-a0206z|self]] similar copies of the same brain activity distributed in many areas, this idea is supported in link to study about memories "A SIngle memory is stored across many connected brain regions " paper "Brain-wide mapping reveals that engrams for a single memory are distributed across multiple brain regions"

c0089x/ the brain as a series of fractal sensor arrays to magnify their inceptive fields onto other sensor arrays that de-magnify the incoming signal to focus -[[attention-schema|attention schema]] fractal
...
c0126x/ Protein Synthesis for Spine to new synapse to encode [[tonic-oscillation|tonic oscillation]] wave

c0127x/ Memory Reactivation as phase change to a synaptic connection changing a [[tonic-oscillation|tonic oscillation]] to a phasic similarity to how holography encodes wave patterns, and when you shine light through the patterns re-emerge
...
c0131x/ Hebbian Learning Physics: [[path-integral-formulation|Path Integral Formulation]] for LTD, LTP
...
c0148x/ Phasic, Tonic. Peter Tse, Phasic Firing ([[criterial-causation|criterial causation]] theory) * 0.2 millisecond firing for sound, 3 millisecond firing
...
c0150x/ Graded Potentials: Synaptic Spikes, Backwards Dendritic Spikes, Forward Dendritic Spikes, Dendritic Branches Apical & Basel Summarization, [[action-potential|Action Potential]], Bifurcation,
...
Oscillations: Rhythms of the Brain: György Buzsáki & Sync by Steven Strogatz
...
Oscillation Dissipation Cognition Theory: Strogatz, Prigogine, Hofstadter, György Buzsáki
...
Inhibition maps (György Buzsáki) the brain as a neural network signal processor

Grid Graph, György Buzsáki
...
Conscious Sentient Computers with [[artificial-souls|Artificial Souls]]
...
2. Artificial Neurology: Conscious Sentient Computers with [[artificial-souls|Artificial Souls]]

1. Phenomenally Conscious & [[gh-a0206z|Self]]-Aware Machines
...
Maps of Reality: Thresholds of the Mind, Chaos, Reorganization, Philosophy of the Brain, Mind & [[gh-a0206z|Self]], Spiral Dynamics

Rashamon Effect: two people see different versions of same evidence

## Source Provenance

- Source file: `c0000x.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/c0000x.md
