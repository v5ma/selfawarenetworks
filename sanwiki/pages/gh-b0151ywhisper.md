b0151y Transcription by OpenAI Whisper
...
And it's going to amplify them to the medial scale, which is when the [[fractal-pattern|fractal pattern]] has an isochronic vector soliton pattern that is a fractal on the microscale

of what the gender is receiving, mirrored at the cortical column scale or the narrow oscillator scale.
...
It's entrained by visits, it's entrained by society, sort of like to have [[gh-a0206z|self]]-driving, [[gh-a0206z|self]]-seeking patterns and all the different levels.
...
to a model of yourself and your muscular behavior at the same time.
...
that are correlated 100% with [[action-potential|action potential]] firing.
...
So you have the ionotropic brain, you have the metabolotropic brain,
...
rendered and watched at the same time,
...
and so predictions of how the model of this thing called the [[gh-a0206z|self]] or this body of movement
...
So Michael Grasio thinks that the next step to global workspace theory is going to be the [[attention-schema|attention schema]],
...
So the [[attention-schema|attention schema]] actually isn't the next step.
...
and recycled in the building of other models for other people or other kinds of life forms,
...
which is correlated with the sensory representations of yourself.
...
he says that the central idea of [[attention-schema|attention schema]] at a high level
...
- Source file: `b0151ywhisper.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0151ywhisper.md
