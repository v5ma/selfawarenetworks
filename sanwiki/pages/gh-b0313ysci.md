...
make it clearer that the other ways of learning are better and so not going and																									
...
and so far it seems to have like okay result I think the more important things that we have to ask is like what are these machine learning algorithm that's using these device are analyzing and like outputting and affecting our behavior I think sometimes																									
a company put a machine learning algorithm in certain devices and claim that they do certain things but then like does it really do that like is it really a valid result like that's debatable and but we're using these to changing our daily behavior which I think that's something that should be that we should be more alarming about so yeah sorry sorry I took the order so much time I'll pass the mic to you [[gh-resnote04|Micah]]																									
...
and in addition I write software if you just look at my bio I brought EEG into VR so basically [[gh-a0069z|medical imaging technology]] I brought it into virtual reality and there's more but so what I want to share with folks																									
...
the reason that this technology is almost unstoppable is that the potential for healing there's so many people with traumatic brain injuries of invisible brain injuries like post-traumatic stress disorder so many people with problems like depression and																									
...
now that's the downside the the upside is not only will be able to help people but you could do things like when you write to the brain you could experience [[augmented-reality|augmented reality]] and virtual reality experiences through direct brain stimulation																									
...
I'm sorry the defects like how do you know when something's going to rise and then what happens. Have you looked into that.																									
...
you may want to enjoy virtual reality via direct brain stimulation you may want to enjoy [[augmented-reality|augmented reality]] via direct brain stimulation so you so you could walk down this the street and you could interface with your memories basically is you know like virtual reality																									
...
link is actually just replicating what we did and what other people have done since then and they're the main major major difference which is very significant is that they're making it as a commercial project like that is going to be similar to like a lazy eye surgery type of implant whereas ours was like																									
...
I guess sorry so yeah so I was personally I think we're regarding like the ethical guidelines. I think it's also important to differentiate this like just because you're doing a neural interface doesn't it's not that different.																									
...
There's a technique where in order to target the exact location of the DBS electrodes you can use electrodes that they normally put in deep in the brain to find the exact spot where you want the DBS implanted.																									
...
Very cool, so one of the things, I think what I'm getting may be very specific, I am looking, I'm seeing like there's some attrition, so like if maybe we want to get more general, I don't know if people are interested in this level of detail, I mean I like talking about it.																									
...
Every neuron has a different pattern of the [[action-potential|action potential]], so you can actually see multiple neurons around the tip of an electrode.																									
...
The second or third time, I think he started to degrade the description and start calling it like an archaic system, an ancient archaic system.																									
...
and what are these guys doing right? And what do you think is going to happen in the next two, three years?																									
...
I mean, [[gh-resnote04|Micah]], maybe you didn't know something, but like on this, on this scale, I mean, it's the one thing that for me in my,																									
...
And that's what they're doing with control labs.																									
...
this is stuff that is way below the capability of Neuralink in the long term.																									
...
and there's not as many restrictions, and then you can get that for like an augmentative purpose or something like that.																									
...
So the political party can exactly track that person down and persecute you or prison you.																									
...
Well, I think what you might be talking about is associating the activity with an action or with a thought.																									
...
without decoding brain signals. We could do it with basic behavioral biometrics, whether you're typing on the computer,																									
...
This is all available because you don't need a [[brain-computer-interface|brain-computer interface]] to do that.																									
...
Is that a fair [[gh-b0049y|summary]] of that?																									
...
So the resolution of decoding matters a lot																									
...
and, you know, yeah, so go ahead.																									
I would say the scale, you know, the scalability of the product																									
because I think most of the technology, like has been mentioned by [[gh-resnote04|Micah]]																									
...
but not only that but kind of, and [[gh-resnote04|Micah]] touched on it earlier too																									
...
The first is, I think I looked at [[gh-resnote04|Micah]]'s point of, you know, how much resolution are we getting																									
but there is a very different ethical dilemma based upon how fungible a learned model is,																									
how replaceable the human is, that is, if I train a model on, say, [[gh-resnote04|Micah]]																									
...
and use them to interrogate out the entire view of the enemy's military formations																									
...
is designing in the approach of [[artificial-intelligence|artificial intelligence]],																									
...
then everybody's approaching it from the standpoint of [[artificial-intelligence|artificial intelligence]]																									
and everybody's using all the data and however they see fit																									
and you have a land of confusion.																									
Now to Kev's point that you were,																									
...
which is neither the [[gh-a0206z|self]] nor the imagination?																									
What keeps us from going down this like weird schizophrenic out of touch with reality thing																									
once some things exist within our own minds which don't pertain to the [[gh-a0206z|self]],																									
...
That's pretty much just like they couldn't move their arm																									
...
and they, I think, it's transcranial magnetic stimulation and they might see like a light.																									
...
And if you actually run fMRI and other type of brain imaging data and brain imaging techniques on these patients,																									
...
because I can split it into two parts based on congruences.																									
...
So if I'm not mistaken, the considering the despite the depolarization and hyperborealization of a neuron, you're looking at two to five milliseconds.																									
...
It's different biophysical properties, I guess, if you will, because the average [[action-potential|action potential]], even for a very, very fast spike neuron,																									
...
And that's very much within the capability of picking up most, if not the entire [[action-potential|action potential]] itself.																									
...
what the neurons are individually doing in different parts of the body,																									
...
in order for them to repolarize, to fire for the next [[action-potential|action potential]], so if that makes sense.																									
...
and someone, I think, [[gh-resnote04|Micah]] mentioned it earlier.																									
Donna Roberts?																									
She brains on life.																									
...
My thought is on the computational, is sort of like on the computational side of things.																									
...
There's one called TCP, which TCP is an old one,																									
...
well, the next step is building [[artificial-cortex|artificial cortex]].																									
So let's say a person gets a pull through their brain and they survive, but they have missing brain tissue, right?																									
So we can put some [[artificial-cortex|artificial cortex]] in there that replaces their old cortex and now their brain isn't suffering any deficits.																									
It might be working better.																									
But we can go a step further and say, okay, well, what if we took up a completely healthy person and we gave them another cortex.																									
We call it the external cortex, right?																									
We just put it right on top.																									
It's like a hat.																									
You wear this hat and it's full of artificial brain tissue.																									
And it's networked to your actual brain, but it gives you like a second neocortex, right?																									
You just have another layer of brain, but it's artificial.																									
And it works the same way as your original brain.																									
And what's cool about it is that now instead of having like, let's say that you have 160,000 thoughts a day and let's say that you just made that up.																									
But now you have 10 times as many thoughts per second because of your [[artificial-cortex|artificial cortex]].																									
And so for you, one idea that I had is, well, maybe if your brain is processing information 10 times faster, what if that means that your experience of time changes?																									
What if that means that relatively speaking, if you're able to perceive your world 10 times faster, that time for you slows down.																									
And that experience basically means your days are 10 times longer.																									
Now, before you say, well, that's a bad thing, I don't want, but wait a second.																									
Think of all the things you could do in one day if your days were 10 times longer.																									
That is like getting 10 times more life.																									
That's like getting 10 times more time on Earth.																									
That's the kind of thing that I'm excited about.																									
Basically, [[gh-resnote04|Micah]], I was really freaking, yes, I'm very happy I met you, man.																									
So my main concern was, yeah, initially I was thinking there is an up about to how much information you can encode in a given time frame.																									
And if there is, there's an up about to the usefulness of any system that allows a direct input to the brain to circumvent the senses and to connect us perhaps to the internet.																									
Now, and so thinking about that, I started to consider whether there are workarounds.																									
And the best workaround I can think of was a, we can pre-process the data that is instead of sending what is, you know, the sense of a banana in your mouth or the taste of banana,																									
we can send the information of how does the brain react after you've had the banana.																									
Secondly, there's a case of parallelization because I think quite a few of you mentioned this, I'm forgetting who all mentioned this,																									
that it's possible to train one cortex to function as another form, like the [[auditory-cortex|auditory cortex]] can process visual information.																									
And as you know, when we, we can smell something, taste something, feel something, feel something and see something at the same time.																									
That means we have five different strands by which we can get information.																									
So say if you were to parallelize how fast we can see an image and have all five processing them at the same time,																									
it would be very interesting to see how much faster humans could perhaps say, find the difference between two different pictures which have subtle changes.																									
And to [[gh-resnote04|Micah]]'s point, I find what is very interesting because I looked up the model, you suggested the Huxley model, the Hodgkin-Huxley model,																									
and it describes in terms of limit cycles and attractors, I think, and that is basically the vocabulary we use in nonlinear dynamics and chaos,																									
which, by the way, is how I first learned about this stuff because one of my best professors, I love this man, is looking into how the human brain is essentially a model on synchronization.																									
And we have found that with oscillators, very often of the electro or optical kind, that these graphical networks or networks of interconnected things,																									
they have, you can infer the geometry or connectedness of the network based on how they oscillate and vice versa to a decent extent.																									
And also that the geometrical setup enabled these oscillations to create a network-wide memory.																									
And I'm kind of curious where that leads in terms of, say, human memory being a product of network dynamics over time.																									
I think you might be making assumptions, though, about the limits to the interface.																									
I mean, I don't think there's necessarily limit, like, technology, there's nano-technology already, you know, let alone MEMS and micro.																									
I think it's going to be possible to get, you know, hundreds of millions of real-time input and output directly to neurons and whatever else is going on in the brain.																									
I don't know, I'm just saying if we're talking theoretically here, like, we're not necessarily limited on that front.																									
Yeah, I don't know. In terms of, like, the information, yeah, go ahead.																									
I was just going to say that, you know, a lot of these physics, the folks from physics, they're really asking questions that are a little bit disconnected from reality,																									
like, completely disconnected from reality. No offense, Keshav, but this is sort of normal.																									
So, like, in theory, like, in theory, like, there is a potential, like, ultimate limit.																									
It's just whether we reach that in this lifetime, I don't know, maybe not.																									
Can I ask you a quick question? Can I just have one quick question?																									
So, I had to leave for another meeting. I've learned a tremendous amount from [[gh-resnote04|Micah]] and Abe.																									
Keshav, you guys, my brain is stretching. I'm a layman. I just have a quick question that I'd like to take a pulse of the room,																									
which is basically for all of those of you who are in this industry, the original question was neural link is a revolutionary or a tragedy.																									
I'd love to hear your personal breakdown, like, what percentage do you think it's going to be revolutionary?																									
And what percentage do you think is going to be a tragedy? So, just, like, okay, it's going to be 50-50.																									
It's going to be 40-60. I would just love to hear from your perspective, because you guys are deep, deep, deep, deep into this tech.																									
And for a layman's perspective, I would love to get that kind of pulse. That was my question.																									
I'm Sam, and I'm done.																									
Can you be more specific? What percentage will it be revolutionary? What percentage do you think it's going to be a tragedy?																									
50-50. Well, I mean, I guess I can try to be more specific. I think in terms of the technological and kind of human,																									
I think we might be approaching a new era of human development, which is going to include, like, direct interfaces with...																									
It's not even about direct, because I think... So, it's important to, like, differentiate what is happening here,																									
when we're talking about, like, okay, first of all, there are two major aspects to narrowing. One is the medical treatment aspect,																									
which is just, like, alright, a person who is paralyzed will be able to, like, move a cursor on a screen or, like, move their arm.																									
And then there's, like, augmented, or, like, a person who can't hear better, and things like that.																									
But then there's, like, augmented aspects, which it's sort of assumed, and it's, like...																									
But that's a really big one, in my opinion. So I think that's where it can be really revolutionary,																									
because, you know, just making people hear better, that is amazing, but it's already being done.																									
So I think the augmentative stuff is, like, okay, is it possible that we're going to have new capabilities as human beings																									
with this type of technology? And I think that is possible. And I think it's kind of important to differentiate, like,																									
where, like, what are those types of new capabilities?																									
Yeah, and then in terms of tragedy, you know, I mean, like, yeah, if you have an implant, you know,																									
you might not have as much control over your thoughts and your interfaces with, like, reality,																									
and with the internet, like, as you do on a computer, you can stop using it if you want to, or use a different platform.																									
And in that situation as well, I don't actually think there's a huge difference,																									
and we have to learn to, like, differentiate between that tragedy and that problem																									
and the kind of mechanism that it's happening on, because right now, we already have the tragedy of, like,																									
you just don't have privacy on the internet. These companies own everything you do, and you don't even have a [[choice]].																									
If you want to use the platform, you're handing off your personal life. It's kind of like,																									
if you wanted to buy a dishwasher or a washing machine in your house or, like, plumbing,																									
you have to have a microphone and a camera in your house, just because that's how plumbing works.																									
And it's just, that's pretty much what we're dealing with on the internet. That doesn't matter.																									
You don't have to have an implant. You just don't have privacy, and you don't have any control over your personal data.																									
So, I don't, a lot of people will say, like, oh, Neuralink is going to prevent us from having control of privacy.																									
Like, no, that's already happening. So, yeah, that's my two cents.																									
I'll add just one perspective here. I do think that's worth heading.																									
And, I mean, there was a time where there were multiple sub-human species, I guess you can say,																									
derivative from apes. Neanderthals and homeosapiens are just the more commonly known ones,																									
but I feel like we're heading towards a period where, because there's so many moral dilemmas																									
and various ways that our tribes can organize around, you know, decisions relating to Neuralink,																									
but also genetical engineering and all these advancements that we might have, like, you know,																									
just like today, like there are tribes in Papua New Kimi that are completely disconnected from the rest of society.																									
Then you have the Mormons who try to avoid tech, tech in the, you know, I guess the electrical sense and internet sense.																									
But, you know, if you pick up a tool, I mean, at one point when humans first picked up their first stone tools																									
and made those tools and harnessed them, that was a form of tech.																									
So, I feel like there's, like, a spectrum and we're just going to continue along that spectrum																									
and maybe have, like, a period similar to that period where there was various types of, you know, homo-species,																									
not just homosapiens, and where we would basically have some folks who are cyborgs with Neuralink implantations																									
and genetic engineering upgrades and some who basically, you know, are opposed to some of these concepts																									
and might try to avoid it altogether.																									
I do think in general it's a good idea to have diversity just as a species.																									
Anything could happen, but I think it's like swimming upstream.																									
It's just going to force most people to opt into, you know, whatever progress is kind of heading towards.																									
And ultimately the vast majority of us are going to probably have, like society's going to have technological implants,																									
if not in the next 20, 30 years, maybe in the next 50 years, whether we like it or not.																									
But I do think, yeah, it's going to come with its tragedies,																									
but I do think we're going to have, we're probably going to go through a period where there's, like, many,																									
what might feel like many different types of species because of our relationship with tech.																									
So, again, I guess, like, I also agree with what Abe said for the most part.																									
So the revolutionary part for Neuralink for me is the miniaturization,																									
that they are able to miniaturize a device that small and can be linked to, you know, the brain																									
																									
# Part 13																									
																									
and their electrode designs has also certain some novelty because it can detect on a discrete level of microcolumns.																									
But the tragedy part, I think, like something that really worries me, and I don't know if this is actually mutually shared																									
by everybody that has gone through the neural implant is that the implants don't stay long.																									
Like, the electrodes actually degrade through time because the brain is actually highly corrosive environment.																									
It has, like, rich sodium in it. It's like, you know, implanting something into an ocean.																									
It's not to say that the Neuralink electrodes are metal,																									
but there is also the risk of, you know, electrodes being breaking																									
and the immune system kind of attacking these electrodes, eventually reducing the signal strength																									
and also raising some kind of cytokine storm that would cause severe damage to the brain.																									
So I would see the tragedy part in that, but this is my opinion.																									
I don't know if it's mutually shared by others on your scientists here in this group.																									
It's interesting the regular maintenance aspect of it.																									
I wondered about, we're really worried, I guess, that the conversations we've brought up due to the topic at hand																									
about, you know, the revolutionary or tragic aspect of it.																									
Regarding the bioavailability of all of these implants																									
and the issue that you just brought up regarding maintenance,																									
I know you had actually studied this and actually gone through an experiment																									
where you implanted something in a human being and you talked about the scarring being minimal																									
and it's fairly insignificant repercussions from the damage to the brain																									
similar to existing brain-surgent applications.																									
But I'm wondering about what you just brought up with.																									
If we're constantly upgrading these additions,																									
I don't want to call them cybernetic additions, but essentially that's what they are,																									
what does that look like for when they break down?																									
I guess to try to form a thought, or to summarize this a bit better,																									
earlier on we were talking about parameters that we could put in place to protect these things																									
and what happens if you have a mouse or if you're dependent upon this tool																									
to actually utilize something, a computer or interface with something or not																									
and the system breaks, what sort of repercussions do that have?																									
And I was thinking at that time about a security option, a hardwired kill switch that you could implement																									
if in the event that something did malfunction you could simply turn all of these things off.																									
Has there been any discussion about implementing like an actual physical or as best you could get																									
physical kill switch for these implants to simply cut the contact it would have to the brain if they are implanted?																									
So Neuralink is powered by, you have to stick something behind your ear in order to power Neuralink.																									
There's no battery inside your brain.																									
That's actually, I don't think that's true anymore.																									
So I don't know if they changed it, but that was what I saw in the original demo.																									
I don't know if maybe that's not true for the monkeys, but I imagine that for human beings it would be there.																									
So if the connection is severed then it simply simply turns off if that's what you're saying.																									
If the device can't receive power, because imagine if you take this home you're going to want to do surgery to replace your batteries																									
so it makes sense that if you're not a monkey in a laboratory that you would stick a device behind your ear																									
and that's how you would power the device and if you needed to take it off, like in an emergency way																									
then pull the device off from behind your ear and what it's just going to do is remove the power from the device.																									
Something tells me humans generally tend to migrate towards Wi-Fi capability more than hardware though.																									
So I would assume anyway that at some point in time they would try to figure out some sort of wireless capability																									
or wireless functionality simply from a convenience play, but that's really interesting.																									
My question, it came out a bit weird, but it was actually around the security around everything																									
so we were talking about the tragic consequences of having manipulation																									
and it could even be the case of people sending signals to these transmitters to cause an auditory hallucination																									
or some sort of a man-in-the-middle attack if you will inside the brain.																									
And I was thinking like the easiest solution to prevent that in the event that some signals were getting stimulated																									
inside the transmitter would just be like a kill switch similar to what we have on high security computers																									
or cell phones now where you can simply press a button and it actually severs the connection between the camera or microphone, etc.																									
and the computer so that it can't be accessed in the event that it has been breached by a significant actor																									
who can maybe turn it on without notifying anybody or using the lights or whatever.																									
So that was kind of where my train of thought was going with it and then I thought regarding the maintenance issue																									
if these things are malfunctioning it would make the most sense to simply just be able to turn it off																									
but it goes back to that question about regular maintenance and everything.																									
What happens if you have a significantly misfiring something inside your head																									
and needs to be taken out rapidly?																									
If I could throw a wrench in the conversation here																									
it's the idea that future attacks might be so sophisticated that you don't know that there's anything wrong.																									
And so you wouldn't have any reason to hit a kill switch or to pull the power																									
and no one else around you would have any reason to either.																									
You just think everything is fine.																									
So I'm probably going to answer at KShift's point because like you raised a very good question earlier																									
and it's time for me to turn it anyway so I just wanted to answer that before I leave.																									
So there is a floating theory that a memory can be encoded in the network itself																									
instead of simply by strengthening the synaptic connection between neurons																									
and the theory is called connectome so it's gaining wide popularity																									
and there have been some computational neuroscience,																									
aspects trying to demonstrate that it's possible to encode some kind of memory in a higher dimension manifold																									
and this was done by the Blueprint project I think it's in Switzerland.																									
So it's a very interesting idea to see that the network itself is capable of storing information																									
instead of like I said by merely strengthening or weakening the synaptic connections in the brain.																									
So I just wanted to mention it out there and this has been a great discussion.																									
Thank you guys.																									
Thanks for joining us Abis.																									
I had a question and Matt's offered to continue the room if anybody wants to continue																									
but I had a question for dropping off or for Mika, Abe, Nick and anyone else who thinks they could sort of help																									
provide some insight around this.																									
So I mean Abe you had mentioned obviously the work that led up to Neuralink the precursor																									
and your involvement in it maybe you might be able to comment on this																									
but like what like specifically because a lot of folks when they think okay Neuralink commercialized something																									
you know like they might overly simplify what that means you know it's not simply you know putting up a billboard																									
and saying hey we want we have something we want to sell you there's likely a series of																									
maybe smaller engineering problems or problems in general that they have to have gone through																									
and solved to achieve economies of scale to achieve you know some of the efficiencies that they have																									
could maybe some of you guys maybe chime on some of those recent things that they would have had to have solved																									
in the last few years to get to where they are.																									
I know this sounds pretty in some ways ignorant because you've already mentioned that they a lot of what they've done																									
has been done in labs today.																									
So what I'm really speaking to is you know just along the steps of like outside of the core things																									
I'm convinced they haven't invented anything new and we've actually had that discussion offline earlier this morning																									
my question is more around like what are the specific problems that they did they solve you know that helped us get to																									
the current technology that they have today.																									
I imagine there was at least an handful of engineering or other types of problems.																									
Could anyone comment on that?																									
I haven't answered but I'll let anyone else who wants to go first go first.																									
Okay I guess it's me.																									
So Neuralink they created a microsurgery robot it implants these microfibers with their each one has like a 16 electrodes																									
with such precision it does like really microscopic imaging you know it's they're able to have pictures on it																									
if you look at the Facebook group [[gh-a0206z|self]]-aware networks of the Facebook group neurophysics these groups that I've been running for 10 plus years																									
and in some instances there's pictures up there on the cover photos that show you the basically Neuralink's																									
what it looks like through the camera they're basically imaging the blood vessels at really high resolution																									
and then the robot is using a neural networking algorithm to plot to identify areas where there aren't blood vessels																									
so they can pick areas that are good targets for surgery and then a neurosurgeon is supposed to approve																									
to say I agree with what the machine is saying these are excellent targets to implant electrodes																									
and then the machine has to do it because the needles are too delicate for human hands to handle																									
and the precision required is I believe it's too much for the hands of a neurosurgeon so the robot has to do it																									
and this way like imagine so I don't know if people saw the movie Prometheus but then the movie was interesting																									
because it's not the first movie to have this but it's maybe the best reference																									
the movie has a robot in it actually it has like a capsule machine that does surgery																									
so at one point the character has an alien in her stomach or something I might be messing up the story																									
she has something she wants to get out of her stomach and she goes to the surgery machine and it's only calibrated for men																									
so she's really upset about that but she says okay I want to remove this thing from my stomach																									
and then the computer does the surgery automatically so the idea that in the future we will have machines that do surgeries																									
like a vending machine that does the surgery that's sort of like a big component to mass producing medicine																									
in the next 100 years is basically to have the precision of surgery so well done by a computer that is better than a human being could do it																									
and then you could eventually put it in a vending machine and mass produce surgeries																									
so that is an incredible innovation																									
Can I chime in? Can I make a comment? My name is George Zavala, I am a neurologist so obviously I don't do research in this area																									
but I am familiar with technologies that are currently being used for clinical practices																									
and these modalities have been standardized and tested and they're pretty safe																									
so what you're telling me with the grids of electrodes placed on the surface of the brain																									
this is something that is done currently and you are right there are several types of machines or robots if you want to call them																									
they help people not only to place these grids in the surface of the brain but also to find out where you're going to put them																									
so this is used mostly for people who have complex type of epilepsies where medication is not working																									
and you want to localize where the seizures are being triggered so you can maybe remove them through surgery																									
and this technology is broadly used obviously not in country side hospitals but in the major centers where you have a comprehensive epilepsy center																									
and this type of procedure is performed and I am assuming that there is some type of collaboration between Neuralink and companies																									
that already do these devices because it would be silly for one not to use this technology that's already available																									
and try to reinvent the wheel so I'm pretty sure that there will be some collaboration there																									
and another aspect that I think is really interesting to notice is that there is another company that produces this thing called Stentrode																									
probably some of you in the audience have seen this before and are familiar with it																									
but this is a technology where the electrodes are not being placed by neurosurgery but they are being implanted in the brain																									
in the blood vessels of the brain they've done a few studies with shapes and I don't think they used monkeys																									
they used mostly shapes but they are starting to do this in humans as well																									
and the goal of this technology is obviously very different from Neuralink but these electrodes are being placed in the motor cortex																									
so the part of the brain that controls movement and they are using these electrodes to control artificial limbs																									
and people who have been victims of amputations or war mutilations and so forth																									
there is an older technology that's already readily available but that requires neurosurgery																									
but Stentrode is doing a similar thing minimally invasively so they just go the same way people have a catheter put in their hearts																									
when they have a heart attack it's a similar concept where the stent goes into a blood vessel in the brain																									
and that's how the process starts and obviously everything is transmitted wirelessly																									
now just taking a step back when I think it was Matt who was talking about malfunctioning																									
obviously we do have a lot of brain devices that are available																									
I don't know if you guys know anything about deep brain stimulation but this is also a technology that's used for modulating brain activity																									
not for cognitive functions like Neuralink is planning to do																									
but for people for example who have intractable Parkinson's disease or also people with epilepsy																									
people with various types of neurological conditions																									
so these devices they're very safe they are made of material that do not cause any inflammatory reactions to the brain tissue as was mentioned before																									
and I'm assuming that this is the type of material that also Neuralink is planning to use																									
because again you don't want to reinvent the wheel if there's something that's already very safe to use																									
now these devices deep brain stimulation they are probably the ones that are most used in the medical in the neurological community																									
and what's interesting about these devices is that once implanted very deep in the brain																									
there is a wire that comes externally and under the skin out of the skull and under the skin																									
and ends in your chest under the skin in your chest and through there so there is a battery there that operates the machine or the device																									
but also through there wirelessly with something like a tablet or your iPhone																									
you can control the amount of stimulation or inhibition that you want to the structure of the brain that's causing trouble																									
so all these technologies are there obviously not for the purpose that Neuralink is using																									
but things that are safe things that can be used quite widely and it's very doable																									
so I want to believe that these guys from Neuralink are talking to people or manufacturers who are doing these known devices																									
just finally the main problem when these things stop functioning is that most of the studies that are done																									
for example one day in your life you will need to have an MRI scan of your brain and as you know an MRI is a giant magnet																									
so a lot of these devices they are MRI compatible provided that the battery is functioning																									
now we probably assume that if the battery is flat it is going to be safe as well																									
but all the studies were done with patients with full batteries so this is always a problem that if someone has a device like this																									
and they are needing an MRI for other reasons and the battery is flat nobody is going to go ahead and do it																									
and once you have a device implanted in your brain there is scar tissue that forms around it and getting rid of it is going to be very difficult																									
if not impossible without causing any damage thank you																									
okay can I, I'd love to respond to what George, did you say George or Jorge?																									
you guys I got it, whatever you prefer man call me anything																									
I'd love for you to respond to the mods, Abe and Mika I'd love for you to respond to George																									
but just one question like the applications that George has Abe Mika are you guys very familiar with some of the technologies referring to?																									
yes I am top off but thanks so much to the mods and have a great night																									
take care Abe																									
twice I'm heading out just wanted to say thanks Dan this has been fun																									
okay thank you																									
so in fact if anyone else is leaving go ahead and say so I'll just be quiet for a second																									
sounds good																									
so in fact I have written the best [[gh-c0004x|intro]] tonight interviewed Dr. David Petrino PhD at Mount Sinai																									
Tom Oxley																									
okay																									
right so Tom Oxley he's an instructor and a director of innovation strategy for the department of neurosurgery at Mount Sinai																									
and he specializes in vascular neurosurgery and interventional neurology																									
my article is if you go to sdgn.io and you type in the word stentrode you can read the article and includes a recorded audio dialogue that I did with stentrode																									
so stentrode does not require brain surgery																									
it's amazing so you can inject it into your arm																									
and then you push it up through the blood vessels into the brain but in the blood vessel somewhere above the motor cortex as it has already been said																									
and then what happens as you withdraw the device that what happens is after it reaches where it's supposed to be and you withdraw your implantation device																									
what happens is the stentrode expands inside the vein so that it basically presses outward against the walls of the vein																									
and basically it allows the maximum amount of flow through the vein it's not going to block the vein at all																									
and then the electrodes are basically in the wall of that vein that's above your motor cortex																									
just quickly there [[gh-resnote04|Micah]] this is the same technology that's used for unblocking a blood vessel that caused a myocardial infection or heart attack for example																									
or if someone has a big stroke keep going																									
wow so I didn't know that but that makes perfect sense but it's like yeah it's like they did that																									
and then they just say hey not only are we going to put this in someone's brain to open their blood vessels but we can stick electrodes there at the same time																									
the application [[gh-resnote04|Micah]] so this is fascinating because you're also heavily in this and you're learning from George as you speak as well																									
which is really fascinating for me am I hearing this correctly [[gh-resnote04|Micah]] so [[gh-resnote04|Micah]] yeah																									
in George is this the application was initially used or as you said to unclog blood vessels and other sort of applications like that																									
and these guys have flipped it and used it to now insert wires is that correct																									
can I tell you the story how this started because I was there when it started																									
so Tom Oxley was a neurology trainee in the hospital where he used to work in 2011 and always a very fascinating clever guy																									
so this is a technology that back then for neurology was being used for retrieving clots that were causing strokes in big blood vessels in the brain																									
and this is a technology that's been available probably since 2014 or 15 I would say																									
sorry 2005 2006 but it really became a hype in the late 2000 first decade of the 2000s and early 2010s																									
and this technology now is amazing so this is pretty much a state which is a device that goes flat into a clot opens up																									
and then when it opens up clot gets attached to it and they pull it out very sophisticated way of doing this																									
so Tom was he actually was a military doctor before he became a neurology trainee																									
and he took a year off and he went to the US and one day he sent an email to the guy who was one of the directors of DARPA																									
and somehow he got a meeting to see this guy and he said now I have to come with a clever idea																									
and he had this he tells me he had this light bulb moments and he thought why don't we do this																									
I'll tell this guy that we're going to use this for putting a recording electrodes trying to maybe in the future																									
use this technology for moving artificial limbs so it was pretty much a combination of two technologies that were already available																									
the unblocking of the blood vessels plus the recording electrodes that I used for monitoring people with epilepsy																									
keep going [[gh-resnote04|Micah]]																									
I don't know that I have a whole lot more to say except I just I just I shared the story																									
you wanted to add to that or but this is so what exactly did Neuralink where did they step into this story																									
like well this technology existed I know when Dave was here earlier like they were talking about a different type of technology																									
that was being inserted in the brain he had a picture of it on his profile earlier																									
and so what exactly did Neuralink do with these things [[gh-resnote04|Micah]]																									
hey sorry I was having a little trouble with my mute button there																									
so I what I want to say first of all is if you if you click on my profile right now and visit my Twitter																									
and look at the the latest thing that I shared not my pin post but the latest post that I just shared																									
that is a link to the story about Centrode so that will be basically the best starting point is to read that story and listen to the interview that I recorded																									
but so what was also brought so Centrode is you know we so I I'm kind of like I'm a little bit at the at the end of what I can say about Centrode for right now there's more in the article																									
but I sort of like want to get back to to DBS and Neuralink that's for my this is right at the moment maybe maybe we can go back to Centrode later																									
so when Neuralink first																									
[[gh-resnote04|Micah]] can I ask you one quick question before you leave Centrode is it just for clarification arteries or veins																									
so the the stents goes the the use the the original stents designed for retrieving clots was going into arteries																									
but these arteries they are of a certain caliber and the stents that had the electrodes were too big for it																									
so for Centrode the technology is slightly different because it's going into big veins that you have in the surface of your brain																									
so one of them goes from right in the midline from front to back on top of your of your brain right below underneath your skull																									
and then there are two other ones that go at the back of your head to the so coming from the midline to the to the sides and then down your neck																									
so so what I what I heard which is not not going to be as accurate as what he what which is said but what I the the story that I wrote down was that																									
the Centrode is inserted via a catheter into the jugular vein and then maneuvered into the brain via the vasculature and there's no there's no																									
basically the I just wrote that there's no need to drill through the human skull the sensors are built into a [[gh-a0206z|self]]-expanding stent that expands into the wall of the blood vessel																									
and in time it's expected that cells will grow over the sensors and incorporate them into the tissue and then the signals would be transported out of the brain																									
through the vein to a unit implanted in the chest and from there the signals from the brain would be sent to the computer																									
I don't know if it's still up to date but the Centrode records brain activity in a way that's I guess similar to EEG or or ECOG																									
which are like surgically implanted electrodes and but the advantage of being inside the skull is is is massive																									
I mean that's just basically the field of ECOG research right and just skimming skimming my article see if there's anything other here that I wrote down																									
but yeah so check out check out you can check out pain pain medication reimagined was wasn't was something that so David Petrina was talking about the																									
the he's a PhD but he was talking about the work by																									
you said his name earlier																									
by by Tom by Tom Oxley who Tom J. Oxley MD and PhD																									
part of the cerebral cerebral vascular center																									
yeah anyway so I mean I think that it's just like I think that you know																									
so a lot of people this is this is interesting because a lot of people who have been studying COVID-19 and effects on the brain have been like																									
what we don't get how COVID-19 could get into the brain we don't understand why why it's affecting the brain like what what is it how is it																									
where are the are the ace two receptors and well																									
I guess maybe it was overlooked but the brain has a lot of blood vessels and it has a lymphatic system and throughout the blood vessels and the lymphatic system there's there's there's a there's a lot of																									
what's that you know there's a lot of cells that have what's called an endothelial lining and that endothelial lining has ace two receptors so																									
I I don't know why it's it's it's a big mystery but but but but yeah it seems pretty obvious																									
hey guys just want to quickly jump in and kind of introduce the dent to everyone																									
always a pleasure co-hosting our disruptors then sessions we had a lot of new faces today and lots of new speakers																									
a lot of our topics including this one today are sponsored by audience members like you also if you're interested in contributing or have any feedback																									
please reach out to myself or Ravi we're always looking to expand our group of disruptors																									
we're building this great platform for you to share your thoughts and introduce yourself what you're working on and also finding like minded amazing people that you can connect with																									
in more depth offline and I observed a lot of connections being made live as the discussion was running so that's amazing																									
we do do this every Monday to Saturday 9 to 10 p.m. Eastern time so everyone in the room right now hit that disruptors then icon at the top																									
and hit that fall button bring a friend invite people that you think would be a great addition and yeah let's continue this discussion sorry for interrupting there																									
sounds great thank you myra is that hey yeah well I wanted to add that so George also brought up DBS																									
and so when Neuralink was first announced they made a lot of comparisons to DBS and they pointed out that their device is much smaller																									
DBS the implantation of DBS can can rupture a lot of micro micro vessels micro blood vessels that's part of it's part of the I believe that's part of the reason that there's a long term sort of scarring issue																									
the device is really big compared to Neuralink the idea here is that Neuralink is going to cause far less scarring that the you know I don't know that the materials are that different																									
but there's far less of them there has been some research which was sort of pre Neuralink which suggested that if you make your if you make the devices you put inside the head made out of graphite																									
that the immune system would not react to them and there's also so Neuralink came out with one of their announcements was that they had implanted the devices into pigs																									
and the pigs are you know they like to bang their heads together they're little rock stars and so far the devices were not breaking																									
so I guess they're thin enough and small enough and light enough that the pig could bang its own head against other pigs heads and it wasn't causing these really light and small hairs																									
which contain the electrodes to break and that's interesting because you know the brain is basically like it's really soft it's almost like jelly or butter																									
it's painful to think about how delicate the brain is but yeah so if you put something heavy in there and it gets knocked around then the potential for scarring like with the DBS																									
the big DBS system seems pretty like a big deal and just putting it in there could cause bleeding and other problems in fact like the first 10 years of brain surgeries																									
in history of medical neuroscience and this is a true story the first 10 years of brain surgery not a single patient survived because they couldn't figure out for the long for 10 years																									
they couldn't figure out how to cut into the brain without killing the patient because there are literally blood vessels everywhere everywhere																									
it was extremely it took 10 years for humanity to figure that out so																									
[[gh-resnote04|Micah]] on that point it sounds like there's a bit of material engineering work that was done in terms of the advancements they did with the actual material but how did they advance the technology so that they can minimize scarring and cutting into blood vessels																									
was that a bit of software engineering like in terms of you know analyzing the topology of the brain before they did the insertions what sort of stuff was going on there in terms of advancements																									
I don't know if George or [[gh-resnote04|Micah]] can answer that																									
so without working there I can just answer that in a very general way that very fast basically to make surgeries better and less traumatic on a patient you have to make them less invasive less impactful you have to make the surgical the surgery has to be smaller the cutting area has to be smaller																									
you want to stick as little as possible into the human body or human brain and you want to you want to do really good imaging ahead of time to figure out exactly where you need to cut and what you need to cut and with and so in a sense the																									
micro surgery robot that narrow link builds does two things one is it does really high resolution microscopic imaging of the brain area where it's going to be implanted so you can get you can get a look at the blood vessels but then to also like figures out where the the you know what areas are the best for implanting the electrodes																									
and then it implants them so that that's basically the general idea and then of course you know there's a long history of materials design and and and trying to try to find stuff that's at least offensive to me being I think that answers a question without specifics																									
yeah I mean this this this is incredible this has been really really helpful folks who some of the folks who are contributing left but you know I initially walked into this whole like when I started observing your link I it looked at you know in the realm of R&D and I																									
had no idea that this there's this in this much prior work that has led to led up to their their their I guess contribution to the overalls you know advancement of this of the stuff you know this is you know if you look at Tesla like that there was																									
an electric car that Elon had acquired and obviously there was a lot of work that had to be done to get to where it is today but the concept of you know the strategy and the concept of you know starting with a luxury car working																									
really towards an economically feasible one that was baked into the initial vision I think of Tesla was first started and in many ways like when I when I'm listening to the various domains and the prior applications that have already been tested including the monkey example																									
including now the surgery that George is talking about here and you [[gh-resnote04|Micah]] it's like yeah it's it's it's a cradle to me that a lot of a lot of people don't know just how much work has led up to this moment and maybe partly due to Elon's popularity																									
and you know recognition but and also their contribution to commercializing this I don't want to under you know value that but it's it's I'm just shocked at how much prior work and invention and application and even understanding these use cases had already																									
existed and been discussed before New Orleans showed up to the party and you know it's really impressive stuff but just as now blown away but all the work that you guys are have been involved in and thank you for for you know sharing all this																									
so I think there's there's there could be a big perspective shift for everybody if you just think of this this isn't this is not Elon Musk's company just just imagine that he had he he's he's the guy who's funding it																									
and not the reason I said that I say that because what what what I'm getting at is like you know there was someone who basically you know it I forget his name but there was a neuroscientist who was the first to measure e.g. signals																									
and he he thought that you know basically he read this letter where he heard that a woman had written about like her boyfriend she had the stream that her boyfriend fell off a horse and at the same time she wrote a letter her																									
boyfriend had fallen off the horse and so he thought well well maybe our brains maybe there's maybe it's telepathy so he wanted to measure to see if the he wanted to measure electrical signals in the brain to see if if he wanted to																									
detect them and analyze them and he did and he was he was basically the like the grandfather of e.g. because he wanted to see if telepathy was real and it turns out that he also he did he did really good work and it turns out that he was able to																									
to do his own disappointment realize that that e.g. signals don't travel far enough there's not enough power in them that they could leave one person's brain and and and travel to another person's brain through the air it's just not it's not it wouldn't work that way																									
but you know that so but in a real sense e.g. and also you know just measuring electrodes there's another guy who was was famous for he he was a famous he was the guy who a neuroscientist who came up with																									
I'm sorry I'm not being very good with names tonight but but he basically was implanting electrodes into cats into their brains and he figured out that neuro columns he was the first guy to say well neuro columns have a function and and																									
and at some at some point the idea that different parts of your brain had different functions what was unheard of and in human history and so he's like yeah so your neuro column does something special it's different from what the rest of your brain is doing and it's organized it's																									
somehow it's organizing what you know the cat's reaction to to being petted or something like that right and it's organizing this this this mental activity and so so so that so so we so then we had lots of you know we had many decades																									
of people sticking electrodes in cats and mice and and rodents and monkeys and human beings and and we had the of course ecog and we had the Utah ray which was mentioned earlier and dbs and and so so all of these																									
technologies so if you look at who's hired by narrow link you can see that that one of the one of the guy one of the guys who's hired was a djco and he was the co-founder of neural dust and neural dust I wrote about																									
the other co-founder so I didn't know I didn't I missed the I guess I need to write another one about djco but I wrote about his co-founder and then this was before narrow link sort of like																									
had their big reveal and and shared who was working there but if you look at the people who worked there and there's been a lot of turnover but the people who worked over time so I think it was George that brought up he says I hope that something																									
like I hope that that they're talking to all the companies and the scientists who have worked with dbs and all and and and and stent road and and the thing is for a fact many of the world's leading scientists are working at at narrow link and have been working at																									
narrow link or previously worked at narrow link I mean it's been a long narrow link has been around for years and inside and people have come and gone but in great numbers but the thing is like there is a vast amount of communication happening between the																									
leading minds and in neuroscience for a neurology and you know cognitive cognitive neuroscience and and and it's just so yeah so to George's like question this it's not it's only yes they ought to be doing it yes they have for a fact																									
been talking to you know the leading minds and the leading companies this has been happening these people have been working at narrow link so that's just what I wanted to say																									
I I think it's it's can you guys hear me I think it's worth mentioning as well that everything that you in plans on the body needs to go through approval from regulatory companies																									
but not companies entities like the FDA in the US TGA here in Australia so every country has that so I'm pretty sure that if you want to take shortcuts and make your your implants work quicker you probably use substances that have been approved to to be implanted																									
rather than again trying to invent something that might or might not work if I can ask where you mentioned something about the scarring regarding implants being a factor earlier on I think we had some some previous discussion around																									
this evening and people were talking about how it's not going to be so critical but how in your opinion as a neurosurgeon like how critical is it or what is the impact and is there a difference between the age of a patient based on their neuroplasticity and their ability to recover from that																									
scarring so obviously the the age is very important the younger the person the more likely that there will be effective and less damaging regeneration of brain tissue that's no doubt obviously once once you reach a certain age there is virtually no																									
no chance that someone can have a 100% guarantee that their brain tissue is going to regenerate so the what happens is that when you put in a device like this I think I might I might have misused the term scar tissue																									
what happens is that some tissue from the body organizes around the structure so for example the stents that we were mentioned before the stentrodes and cardiac stents and kidney stents and everything has stents in the body these days																									
once you put inside a blood vessel there is a lining inside the blood vessel that's called endothelium which is a lining of cells so this endothelium grows on top of the stent and the stent gets incorporated into the vessel so if you if you are small enough to go into the vessel																									
or hey you have a camera that's small enough and go into the vessel and you and you look at the vessel from inside you're not going to see the stents because it's been endothelized as we say so it's going to happen with these																									
with these devices is that probably there will be tissue that will grow on top of it and make it part of the body so you're not going to be able to see the device in its entirety but the problem is that as someone was mentioned before if you want for some reason get it out of your body																									
then you're going to create a lot of problems it's like it's easy for you to build something with concrete and put it on the floor or on the ground but when you remove it a lot of dirt comes out with it so the same concept would happen in the brain																									
but the brain is so delicate that any additional or any damage that you do to your brain tissue it's going to cause trouble and particularly with these devices like Neuralink for example you're stimulating the probably the most important part of your brain which is you right your intelligence																									
your sense of [[gh-a0206z|self]]-being and I don't think that this is the type of device that will be able to come in and out very easily so once it's implanted well prior to implanting the decision needs to be made very carefully and the person needs to be aware that for whatever reason this should stay with them forever																									
is that clear? very very thank you very much for that																									
I'm sorry one thing to mention too is that I'm a neuro radiologist and I see what it looks like after electrodes have been implanted and also for epilepsy surgery trying to figure out where the seizure focus is																									
electrodes get implanted for like just a few days at a time and then taken out but these electrodes and also deep brain stimulation electrodes and I don't know the numbers but are much larger than the type of electrodes that we're talking about here with Neuralink being the size of human hair																									
I mean the electrodes that are put in for epilepsy surgery mapping I'm always amazed when I see these and they go you know going all the way across the brain and then they're taken out and don't leave scarring so I can't imagine																									
well can I interrupt you the reason why there is no scarring is because they're there only for a limited time right so when you do these monitoring for epilepsy you keep the grids for what two weeks three weeks and then it comes out because these patients when they are being monitored for epilepsy surgery																									
they need to stay in hospital you can't take the grids with you home be monitored home and then come back so they usually in hospital for a certain number of days so they can have a seizure captured																									
and then the biggest number of seizures captured so you can be sure that they are all coming from that foci and then you can act on it through surgery or whatever method you're using																									
right no I didn't mean to imply that that the electrodes do come out within a few days but still you've sliced through brain you've displaced brain as these electrodes are being placed so you're displacing brain tissue and they're much larger than the electrodes that Neuralink is going to use the size of a human hair																									
I find it really fascinating I had my father was a like a type personality high functioning individual like a director of cybersecurity for an energy company and he was in his mid fifties and suffered he started having some symptoms regarding his motor control																									
and he went in and he was diagnosed with cavernoma and had to have some some fairly significant brain surgery to remove some some malignant tumors so they were non cancerous but it was a it was you know significant impact																									
primarily related to his motor control functions and that was back in 2018 and he's been in rehabilitation since and trying to recover from it and he it took him years but with his older age there was a significant impact on his state I guess if you will																									
now his intelligence was it did seem to be impacted thank goodness so he's he's cognitive but it's it's the motor control and when you mentioned I guess when I was kind of probing around asking around the the damage or the potential for damage for these plants																									
it was more or less like what happens when a person who's younger gets one and like you said or hey when you they might have to live forever how what happens if the technology you know certainly frogs and a more or better implant comes out 10 years 20 years down the road																									
you know what could you apply a different one or would you have to take the chance of removing it and risking I have a I have an answer to this and I'm pretty sure that our radiologist colleague also knows all about this as well but in medicine everything that's prosthetic or foreign to the body does not last forever																									
so and just to give you an example for example so if you have severe arthritis of your hip and you need a new hip we try to delay the operation for as long as possible because we know that even the most modern prosthesis they will last for what 15 years or so in your body and then you have to change it again																									
so I am and also with if someone has an aneurysm which is a like a blister on the side of a blood vessel and it bursts into the brain they can have either coils or or neurosurgical clips applied to these to these aneurysms and we do know that the clips they only last for so long as well																									
so obviously the coils they do last for longer but they are much smaller structures so it's going to be very interesting to see how long and only time will tell how long neural link is going to stay in the brain without causing any trouble																									
and and also what certain age will be the age where you can will be able to implement these devices into one's brain because I'm pretty sure that I wouldn't want a adolescence or a teenager to have this implanted to their brains because we don't know what's going to happen in the longer term																									
and not only that our brain obviously all the cells are there when we are born but the connections they keep on happening up until you are in your mid 20s and so the structures of the brain they only finish maturing when you are in your mid 30s																									
so you don't want to get anything that's going to interfere with this process if you don't know that this is going you don't know how it's going to behave if this is giving you a benefit and giving you better connections yes but how are you going to be able to prove those fights probably impossible isn't it																									
well as a neurologist I'd have to ask right if you had a you know the original use case of neural link is for people who are paralyzed right to try to give them some sort of communication point to the outside world if you had an adolescent patient who would significantly benefit from a life																									
lifestyle change by implementing neural link what would you how would you weigh out the benefits or the drawbacks of providing them this this you know device even though what you just said right you may significantly alter their neurological																									
growth of the years yeah well then it's a different question because if someone did you say someone who had a brain damage and then they had a paralysis of their body is that what you're saying whatever the whatever the current use case for your neural link is now right																									
I believe it's for like paralysis or brain yeah so if you have if you have someone who has a brain lesion that has already caused irreversible change to that area of the brain and you want to try to compensate that lack of function by implementing something																									
that's artificial and is going to work I don't see any harm in that I think that this is a medicine is all about risks and benefits every medication every vaccine every procedure has risks and benefits so I think that in this sort of situation																									
where you have even someone with a cerebral palsy someone who has a damage to their brain tissue because of lack of oxygen when they're being delivered by their moms if someone is has paralysis in one side of the body because of that then there's nothing to lose I totally agree with the																									
with the concept of implementing things to make their lives better and have a near normal life but if it's something just to enhance functions that you have now and that are considered normal I think still a little bit risk I think to be honest with you I think																									
that in the future we'll have that opportunity but I think that we are very far from that that time we'll have to prove in people with brain damage that this works prior to using this as a brain enhancer that's my point of view																									
and in that situation that you mentioned that if you if someone was paralyzed and and there wasn't this artificial stimulation replacement then what would happen anyway is that brain tissue would wear away																									
it's called wallerine degeneration because it's not getting stimulated so in fact you would be enhancing retaining that tissue and I think the thing that happened perhaps with your father is that when the surgery was done they could that there was perhaps																									
some because of how deep the cavernoma was there could have been injury to the white matter tracks in the motor area and perhaps that's what's causing some of his weakness but in the case of neural leak again the the electrodes are going to be so small the size																									
of the human hair that they would not disrupt the white matter tracks and I think what he was saying earlier was whenever it is time to upgrade in 10 to 15 years you're just going to have to leave the ones that are already there there and get new ones in addition																									
so I want to I want to share something that I want to share two points one is that you know so so the white matter tracks that some that's there's two things happening one is you have a ligodendrocytes that are covering those are cells that those cells are covering the axons or the body of neurons that are																									
covering the axons and and those run those run great lengths they in some cases they might run from your head to your toes right they're really long but but what's interesting is that the the the																									
white waxy stuff that is covering the neurons it's not like it's just it's not like one a ligodendrite and one neuron it's like they're going every different direction and you might have you might have a thousand different																									
ligodendrocytes touching one neuron it's it's it's a it's a little bit chaotic and so going back to George's point it's like imagine so imagine you've got a wire in there that's about the length of the human hair and then what happens is a cell a cell just randomly grows around																									
that wire now now sell it imagine the cell is like a bubble it's basically a lipid bubble or a bubble of fat it's got it really matters if that bubble is is has any punctures or holes in it that that's a big issue for that cell																									
and so if you just if you if it grows around a wire and you just pull the wire out no matter how small that wire is now there's a puncture in that bubble so you see the problem there																									
and so if you look at in the case of you know what is what is SARS-CoV-2 doing to the body well it's it's it's it's the viruses is invading and it's causing these cells to burst and and I can maybe just having just just pulling																									
that that's the hair out of the cell might might cause it to burst I don't I don't know exactly but that's just a picture I wanted to paint for you another thing I think Travis said that he believed that maybe we were moving towards a world where everybody has these																									
impossible devices my my thought is a little bit different in 20 years I think that will have basically will have optical technology that will be integrated with basically like like open water technology but it'll be laser fast it'll be																									
it'll be like something like laser optical holographic technology that's integrated with ultrasound and and microwaves and it will non-invasively do do effectively the same thing that their link does without surgery outside your brain you'll have to worry about it																									
yeah I can I can I comment I have two comments about this number one I agree I agree with you and I think that this is probably the ideal way of this happening and I don't know whether you guys are familiar with the technology called																									
transcranial magnetic stimulation but this is a technology that's a through through waves or radio frequency you can stimulate certain parts of the brain and and and it's something that's being used for actually treatment of																									
of depression because we do know so the centers how they cause or are responsible with the physiology of depression or how depression happens and we do know that if you stimulate these centers patients can have temporary relief of their																									
depressive symptoms so transcranial magnetic stimulation is probably the closest we're getting to what you you're talking about the problems that the that the few disease to the coverage of TMS is very wide and you can't have a																									
stimulation of a very very small or even a microscopic area so obviously I think that if we can get a device through laser beam or optical stimulation that'll be ideal but I think that this this subject is so complex and sorry I don't I don't																									
I don't mean to to sound very unreasonable here or or to too much of a dream but I think it's probably going to be easier for us to think about computer singularity and sharing our brains with the hardware devices																									
than having a structure like Neuralink that's going to be able to control a biologic body the way they are thinking about so I think the way singularity is is evolving these days is so much faster than the way biological enhancement is evolving																									
that I'm not entirely sure whether when Neuralink or the equivalents become available we won't have something far superior for silicon bodies I just want to say that I'm very familiar with TMS but I do believe it's oversold and it's not appropriate in all cases of depression																									
especially cases where the depression is caused by a metabolic disorder because if basically the idea is you know you're blasting the brain with a bunch of energy that's that is it is a you know that there is a previous version of that in the like 1960s I think in psychology where they're called electroconvulsive shock therapy																									
which turned out to be a really big disaster there's a huge differences with transcended magnetic stimulation compared to electroconvulsive therapy it's far more it's far more targeted and it's like very precise in terms of the frequencies that it's stimulating your brain with																									
so it's it's different in many respects but the idea here is that if a person is suffering from depression because their cells are not able to to to process enough you know addendo triphosphate addensity and triphosphate you know or [[atp]] if they're unable to make enough energy then giving that person you know a TMS treatment is not going to really help them in the long term																									
that it may actually make things worse.																									
I'm sorry again I might not express myself appropriately I was just giving you an example in like most things in medicine there's no such thing as one size fits all right so there is depression and depression there is stroke and stroke there is all conditions in there																									
several types of presentation so yes I didn't mean that this is a magical solution for depression sorry.																									
And one other thing I am I'm actually funded by NASA and we're using TMS to enhance enhance cognition and and so we're applying that over the frontal lobes and and and I think one of the biggest drawbacks about TMS is the depth that doesn't go deep enough to get to																									
deeper structures like limbic structures in other areas I think that's one of the biggest drawbacks of TMS and one other thing [[gh-resnote04|Micah]] is that is that electric convulsive therapy.																									
It can be a disaster but it can also be a lifesaver and it still is in use today and and very severe cases of depression but in those cases it can really be a lifesaver.																									
Yeah I mean I there's there's yeah I can't disagree with you at all that there's and I think I think the idea behind behind DBS or deep brain stimulation is sort of vaguely similar.																									
If you have someone who whose depression or or other PTSD isn't related to a metabolic disorder and they really just need more stimulation then then everything we just mentioned might might potentially including what wasn't mentioned TDCS those all might be helpful depending on what the patients needs are.																									
KKJ you wanted to say something.																									
Yeah I was kind of curious.																									
To Donna's point I think she mentioned at the very end of one of her remarks.																									
Where if you sort of have a version two of Neuralink you can just sort of like leave the version one in there and I guess just let it sit there dormant and then install the version two.																									
I'm wondering what the like upper bound is for like version updates in that manner at some point to sort of lock the pathways that you need to accurately detect like neural activity or is this something that can be done essentially like indefinitely.																									
The other comment that I had was is it possible if the goal is merely to move a cursor around a computer and click so very just like minimally viable output to a computer.																									
Could one conceive of instead of installing a Neuralink or a stent road type device in your brain could you use some other points in the nervous system like your fingertip or your your arms and just have less long term like																									
upgrade ability risk to sort of like monkey with your brain and then the other idea that I had was you know we're talking about use cases.																									
I wonder to what extent this technology could be used in the following way like imagine a patient who is on life support.																									
They're on a ventilator they're intubated however they still are not brain dead.																									
I wonder if you know being hooked up to a Neuralink and being able to use the internet is like preferable to death.																									
And you can take this one step further where you know maybe one day we have you know extra corporal brain life support like a brain bag and you know maybe after you sort of live your corporal life you kind of just get thrown into the brain bag																									
and then with Neuralink you can kind of live a productive second life kind of connected to the computer or about lockdown so essentially we are just essentially brain bags connected to our computers contributing a lot to society anyway.																									
I was curious what everyone thought of those ideas.																									
I think one of the important keys that as far as I understand when people try to develop these quotation mind control technologies what they're trying to do is improve speed of action.																									
And I think that if you like you said I'm moving the cursor just by thinking can we use some other parts of the body.																									
I think that if you you probably can but you want to go straight to the source of the information so you can make it as quick as quick as possible.																									
And I think that if we have a good interface moving the cursor and you compare the speed or the velocity that it takes or time that it takes for you to move the cursor just by thinking or by thinking																									
and then using your hand I think that just thinking that you're moving the course cursor without or bypassing your limbs is probably going to be much quicker.																									
And I think that this is probably the main goal of this technology.																									
It's going to be used for tasks that require quick response and precise response and and if you think about your hand if you get your brain to get a small object.																									
Obviously you will be somewhat precise but like I was mentioned before you're not going to be as precise as a robot for example.																									
That's why Neuralink is developing these robots that are very precise for implementing these devices in one's brain.																									
So I think that that's the goal and I think they're trying to do it some other way would be sort of futile and it would defeat the purpose.																									
Now coming to the last point of your question.																									
And he had a stroke never had any never knew that he had any risk factors and he had a stroke in a part of the brain called the brain stem in a transition between a part called the midbrain and the pons and that's a part where all the connections that go to your brain and come out of your brain travel through.																									
So there was a as if someone cuts with a knife that parts that communicates your brain to your body and this guy had what we call and you probably heard about this before what we call locked in syndrome.																									
So he could only move his eyes up and down and blink and that was all he could do.																									
And this is a very clever person who's a surgeon highly active and very fit.																									
So if you if you ask me 10 years ago what would you offer this patient I would say look this is there's no quality of life there.																									
I think we should probably just offer comfort measures and let him die let nature takes its course.																									
But now I am at a point where I still don't have I still don't think we have a solution for the problem.																									
But when I was discussing this with the patient and with the family I was thinking should I offer these guys to keep him alive for five years hoping that Neuralink or whatever is available is going to help this guy in the future.																									
Or should he just pay the penalty for not being born in the right time in the same place and let him die knowing that at any time we can have a technology that will be very helpful for him.																									
And at the end of the day the guy was a very proud surgeon and he decided with his family that he wanted to die and we actually let him die.																									
But what a waste of brain tissue letting someone die just because they have no communication to their bodies knowing that their minds are intact and they're cognitively they're fine.																									
Please help us Mika. So I understand the point that maybe a brain interface has higher throughputs and would be more performance than something that would replicate the signal of moving your hand moving your limb.																									
But isn't that what we have now. I mean like when you type on a keyboard those are essentially that's neural activity that's being fired through your arm.																									
So if the goal is not to create like the super interface if the goal is just to have a quality of life that's commensurate with that is a lot better than dying.																									
That is you know closer to what we have now. I mean like with that that's risky in terms of what if you're able to extract or having the unintended consequences of putting something in your brain.																									
I mean the downside there is just like if you take your arm or something in the worst case scenario rather than you have to be left with a lot of features.																									
I suspect that if we can actually interface directly with our brain it's not just going to be an incremental optimization from just typing on a phone.																									
I think there's going to be opportunities to evolve language potentially even anticipate someone who's trying to communicate a certain thing.																									
It might even potentially lead to helping them string the right words together. I suspect that there's probably some demands from there.																									
This is just again this is just one example of so many stories that we hear every day and we live every day and like the person who was mentioning about their parents before.																									
And look there's always hope that technology will be able but I was thinking also that maybe an interface that might be able to control an exoskeleton that supports this guy's body and at least give him some opportunity to walk around and do minimal things that would make his life a little bit less boring than just sitting or lying in bed and watching Netflix all day long.																									
You can only watch so much Netflix right? Yeah yeah exoskeleton I can think of that but that's the other aspect of it as well.																									
I was going to say this one thing like you guys are all familiar with like how Tesla started with luxury cars trying to you know demonstrate that there was a market for this and then eventually use that to fund and create economies of scale for the Model 3.																									
The folks who are likely to benefit from this like the patient that you described if they can get experience if they can get advantages that clearly you know leapfrog ahead of us and you know that's I think where the tipping point would occur.																									
Where we see them having benefits. They were once paralyzed but now they're communicating and you know being productive in a way that's far more efficient than we currently are.																									
Without Neuralink I think that would be the tipping point that could occur in the coming decade and that could be where others would want to.																									
I think it was called medical tourists I think Michael was talking about earlier but medical tourism. The idea of going around to places where perhaps you can get your own Neuralink implanted that sort of thing.																									
I definitely if you think just think about like hunter gatherers like you know we today like you know I'm sure back then if you were a certain size a certain physique a certain strength that was you know an advantage for survival.																									
Today you know like that's not the case and I can only imagine that how some you know just in general technology and other investments allow for many folks who perhaps were not biologically necessarily the most suited for survival.																									
5,000 years ago today I think you know because of technology because of all these investments we are all part of the sort of modern civilization and I think perhaps Neuralink could do something just as similar by beating the charge with folks who are paralyzed																									
and other types of issues near degenerative issues giving them an edge over the rest of civilization and then causing that to be the tipping point for wanting to pick up these tools as well.																									
I think there's a couple of big things to think about that maybe haven't been mentioned I wasn't here from the very beginning but one of them was I wish I wasn't drawing a blank right now so one of them was connecting your brain to																									
Okay so back in 2012 I opened up a business in San Francisco that was a neurofeedback business alternative therapy and the goal was to use EEG to drive light and sound to goggles that you would wear to LED glasses and headphones.																									
Your brain would be immersed in light and sound patterns that were being driven by your own EEG patterns and the idea here was in my experience with it was that by feeding these signals that your brain was causing changes to back into your brain through your eyes and ears																									
that you might begin to sense your own brain activities and also sense how your thoughts and feelings were becoming brain waves and were then changing the light and sound which was then so basically my hope was at the time that this would allow me to understand to a greater extent																									
basically to become [[gh-a0206z|self]] aware of my brain activity of my brain waves and how my thoughts and feelings were brain waves.																									
And you know I know a lot more now about the brain than I knew back then and there's huge sort of problems with maybe it doesn't help that much to go into it but the basic idea is that maybe with the greater resolution and definition of																									
neurolink if you could send that activity back into your own brain maybe you would have a much higher resolution understanding of your own brain like sort of like the way meditators																									
so there's all these stories about I guess the big story is Siddhartha Gwattama sat underneath the tree just for a very long time and then he realized he was one with the universe and then the Buddha right it's the Buddha story																									
but there's all these stories like well if you become somehow more aware of your thoughts and feelings and you could have transformational growth, you could have happiness, you could have peace, you could have more control over your own choices and you could make better choices and you'd have enlightenment																									
and so like what if we could mass produce enlightenment where people become very in touch with themselves, very [[gh-a0206z|self]] aware and very at peace they find very like imagine think about all the unhappy people in the world																									
well what if you could just create a device okay well hey you're unhappy but there's a way try this device in a short order you'll become enlightened you'll gain great insight into how your mind works and how you're doing the things that are not working for you and how you can do the things that do work for you																									
and that's one thing so the other thing is [[artificial-intelligence|artificial intelligence]] so when Neuralink was first discussed two ideas sort of seemed to emerge one was telepathy and one was [[artificial-intelligence|artificial intelligence]]																									
telepathy yeah if you can connect your brain signals to a computer and then send them to someone else it's sort of like an [[artificial-telepathy|artificial telepathy]] and [[artificial-intelligence|artificial intelligence]] is different																									
so I had this dream one time that I was the dream is interesting because it's like one possibility out of a million possibilities you know a lot of different possibilities but in this dream I went into a cafeteria and I sat down and I accepted this chip and the chip was a little AI																									
and I could put it either on my waist or my neck and the idea is that it would tap into my nervous system and begin sending and receiving messages too much to my brain and then I got up out of my body now I was basically in a lucid dream																									
the computer induced the lucid dream the AI was managing my brain so that it looked like I looked at so it looked managing my brain in my body so that it looked as if I was sitting in a cafe in a normal way drinking a cup of coffee and just sitting there																									
but then in the lucid dream that the computer created for me sort of like virtual reality but it's like it's like an induced dream and I was aware it was a dream and I was aware that the computer was creating the dream																									
I got up and walked out of the cafeteria and then I began to play sort of like an [[augmented-reality|augmented reality]] game where I was in the world but now there was like angels coming out of the sky and they had like axes and swords and medieval weapons and I had to fight them and this was one of the things that I imagined the future would be like in the stream so I just wanted to share that and maybe with AI and VR																									
I'll just teach you a very cool experiment so if you want to be somewhat aware of what your brain activity is like so obviously the brain electrical activity works in frequencies, hurts																									
so one day try if there's a bright light or even I think the best way of doing this is light down outdoors on a sunny day and close your eyes but make sure you focus on your vision and you see like an inverse ripple effects the circles coming from the periphery to the center of your vision and their circle after circle after circle																									
that is the frequency of your occipital lobes or the frequency of discharge of electrical activities from your occipital lobes which is where your vision is controlled																									
and this is one of the ways that people use for starting their meditation just by looking at these circles and trying to disconnect from the outer world and going to their inner world if you do meditation try doing that and you'll see how cool that is																									
so I have a question maybe Jorge or other neurologist neuroscientists might have some insight on this but my understanding is that the current like the demo monkey or whatever the neural link had is essentially using the neural link for like brain output right																									
they were controlling the pawn game or whatever with their mind but their input was still sort of you know their eyes does neural link based on what we know of the current technology have a solution for the input or is the input we're sort of banking on																									
sort of like a prosthetic eye or prosthetic ear technology or is this not relevant is output essentially the is there a reason why output is the only method that is being focused on right now																									
I can answer that so so neural link has read and write capabilities these electrodes that can read your brain can also you can also transmit electrical stimulation through them and so what they're talking about is creating closed loop therapies where you send some stimulus and then you read to see what the stimulus did																									
and then you send some more stimulus and then you read again to see what the stimulus did then you figure out if therapy is helping or not helping that's in a nutshell that's the most simple way to explain a closed loop therapy																									
but yeah but in addition to that there's nothing that stops scientists then who's using a neural link to also use the eyes and ears in addition to the electrical stimulation provided by the device																									
right so that's used for therapy but I'm saying that like if I just wanted to like project an image to my brain without using my eyes or ears is that something that is like certainly that wouldn't be in the category of the therapy right that's																									
the other technology now the other consumer technology now I know that's that's that's how that's when you start using psychedelic drugs because this is projecting an image into your brain is not that that's simple the pathway is so complex that having a structure																									
that's by not using your vision is going to be able to stimulate different so many different parts of your brain to trigger that image is I think sorry never say never but I think it's virtually impossible it would have to be something																									
super sophisticated and and unbelievably complex but I think yeah that's that's when psychedelic drugs can can help you with that and there are lots of places and studies that are showing that you can do this in controlled environment																									
very safely and the experience that people get our mind blowing and they help for number of medical conditions and even just to improve your performance improve your your levels of energy and healthy people are doing it because it																									
works but that's not a solution to the brain the computer interface really we're trying to the computer is trying to project no it's never but I that's what I'm saying I don't think we have that sort of solution but would that just sort of be then an artificial eye that is like you just plug your																									
eye into a computer and it's just sort of projects the image through your eye pathway or maybe an artificial year is easier to create I guess we have these intercontinental plants already but so I so I have reasons to disagree																									
if I can share so so I mean look if you consider David Egelman's work he he you know and in the work that he talks about done by others they they you know for example I brought this up earlier that they can plug a camera into an																									
electrode strip that they can put on your back of your tongue and then your brain can work out with the images they can also take an eyeball out of a rat and plug it into the audio cortex of the rat and your brain and their the rats brain can begin to see that way																									
so what that tells us is that it is possible to make the brain see through through electrical stimulation whether you're stimulating the brain or stimulating the skin or stimulating the tongue it's possible to make the brain see things in addition our TMS																									
expert left but but you know she said she had also experienced that if you stimulate the brain sometimes if you stimulate the brain with TMS people see a light that's not there all of this points to the fact that with them with brain stimulation it is possible to make people see things																									
but I don't know if I okay I'll pause well I was going to follow up with what Jorge was saying about psychotropic drugs or psychedelic drugs my understanding of how LSD is actually affects the brain is similar to synesthesia																									
right where I believe that's the right term where it's essentially remapping the neural connections between the different senses and that's why people see they'll taste color or they will feel sound or something like that																									
their neural pathways are basically not interchangeable but can be remapped inside the brain and to your point Mika about having the sort of interoperability between the different sensory inputs I think that's I think there is a lot of research to still be done to really understand the availability of these																									
neural pathways but I think that to sort of answer KKG's question I think there is a good opportunity to reimagine the input interface and how it correlates to the how neural link actually provides the output to control a separate function																									
like if you can imagine maybe if the visual recovery isn't available maybe there's a sensory one maybe there's a hearing one where you can actually control the neural link using some other sort of sensory function rather than simply relying on a single one																									
sorry guys I'll just quickly I have to leave it was great talking to you and I hope we can catch up some other time thank you																									
great conversation already thank you very much for your participation																									
I think I need to go to bed so I'm going to head out too thank you goodnight																									
thanks again Mika again it was great great to hear your perspective on everything thanks you so much																									
yeah guys it's been really great I think it's uh

## Source Provenance

### Original Source Lineage

- Repository: `github.com/v5ma/selfawarenetworks`
- Source file: `b0313ySci.md`
- Source commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Source commit date: 2025-08-30T22:40:07Z
- Source blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0313ySci.md

### Wiki Import and Maintenance Metadata

- Imported into this wiki: 24 Apr 2026 by Lane F (bulk file-driven import)
