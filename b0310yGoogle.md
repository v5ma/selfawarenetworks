...
So the history of science is I think this should be a required at a undergraduate level from all the subjects. Many good teachers, they actually going to add the first few lecture have a good introduction of the history of this object which we should wish is very good. So right now, We are given that we are in the mobile mobile.
...
I mean for me I try to become more vigilant of you know, what the boundary of self versus the exterior, that's right. Now, that's what we can do, but that there's a maximum limit of. Do otherwise we cannot find time to work, right? So the different cultures is like a different pyramids, right?
