...
In order for the Action and Perception Cycle to work the patterns between the corresponding areas (like what you see, hear, and touch) have to be connected and simultaneous (they have to have a temporal & spatial connection in the brain I meant). 
...
Dynamic coupling of oscillatory neural activity and its roles in visual [attention](attention.md) https://www.sciencedirect.com/science/article/pii/S0166223622000157
...
In this situation the tip of the [dendrite](dendrite.md), called the distal tuft, it had its own depolarization event, this was in the first layer of the mouses motor cortex which is called vM1, and then that connects to L1
...
In the large [pyramidal cell](pyramidal-cell.md) the Apical [dendrite](dendrite.md) is the Exit Terminal https://en.m.wikipedia.org/wiki/Apical_dendrite

# Review
Synaptic Connections between Layer 5B Pyramidal Neurons in Mouse Somatosensory Cortex Are Independent of Apical [dendrite](dendrite.md) Bundling
...
coincidence pyramidal tuned [dendrite](dendrite.md) pattern
...
2021 Neurogrid simulates cortical cell-types, active dendrites, and top-down [attention](attention.md)
https://iopscience.iop.org/article/10.1088/2634-4386/ac0a5a

Synaptic Potentiation at Basal and [Apical Dendrites](apical-dendrites.md) of Hippocampal Pyramidal Neurons Involves Activation of a Distinct Set of Extracellular and Intracellular Molecular Cues
...
Thalamic Input to Distal [Apical Dendrites](apical-dendrites.md) in Neocortical Layer 1 Is Massive and Highly Convergent 
...
This page comes from the original GitHub source below; that lineage predates the later wiki import and maintenance metadata.

- Source file: `a0213z.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Commit timestamp: 2025-08-30T22:40:07Z
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0213z.md

### Wiki import and maintenance metadata

This wiki metadata records the later import workflow and is separate from the original source lineage.
