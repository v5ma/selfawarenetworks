...
(In my other notes I talk about the inhibitory oscillation as magnifying the neurons recalled memory in the action potential neuron to the exit terminal via inhibition. The idea being that the brainwave is the thing that is seeing your memories become activated, and its phase changes from that action potential represent your mind being changed, your mental world being updated with new information.)
