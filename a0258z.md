...
*The threshold in the synapse, in the dendrite, and in the soma, is in some sense the bias that is modified when synapses are inhibited or excited because of agonists or neurotransmitters of some type. The weight is when additional synapses (spines) grow, or are removed.
...
# "Cross-attractor repertoire provides new perspective on structure-function relationship in the brain" https://www.sciencedirect.com/science/article/pii/S1053811922005183?via%3Dihub
Essentially this story above about cross-attractor's is remaking the argument about oscillators affecting other oscillators in the human brain.
