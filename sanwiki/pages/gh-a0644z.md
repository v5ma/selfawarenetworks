...
Book Chapter Outline ([[optogenetics]], [[cortex]], [[synapse]], Graph, [[ltd|LTD]], Perception, perceptron, oscillations, [[phase-field|field]], [[neuralink]], [[dendrite]], emotion, vector geometry, [[fourier-transform-in-consciousness|Fourier]], [[qualia]]) [[gh-a0001z|Self Aware Networks]]

A real goal of this book is to highlight the excellent work that others have done to investigate what human [[consciousness]] is.

I'm 41 years old, and my journey into [[neuroscience]] began at the age of 16 when I took LSD, "lysergic acid diethylamide," during a class in high school. From that point onward, the "Doors of Perception," the name of a book by Aldous Huxley, had been opened for me, and I became a student of the mind dedicated to understanding its mysteries. I think human beings are still far from understanding every mystery of the human mind, but we may have enough knowledge now to understand, at both high and low levels, what [[consciousness]] is, how we could create artificial sentient human-level machines, and how [[brain-computer-interface|brain-computer interfaces]] or nerve gear might both decode what we see and hear and stimulate the human mind to create [[augmented-reality|Augmented Reality]] and [[virtual-reality|Virtual Reality]] experiences without glasses. The long-term consequence of this could be a merger between the medical system and the justice system, alongside a global government system that provides stronger education to all of Earth's citizens to help protect lifeforms and our collective habitat.


Chapter 1: History of the Perceptron and the [[gh-a0403z|introduction]] of the Metatron, a new artificial neuron.
My thesis is that humanity has already done much of the work needed to understand how [[phenomenological-consciousness|phenomenological consciousness]] works; we need to connect the dots so that we can understand how it works.

The point of this book is to provide a hot take on science that has been available to all of us for years. The goal is to attempt some novel functional metaphors about what human thinking is, how we might interface with it as a computational system, and how we might create robots that are sentient and [[gh-a0206z|self]] aware, like animals and human beings.

About [[gh-a0206z|self]]
ethos
pathos
logos
...
4. the [[thalamus|thalamic]] bridges and the corpus callosum at higher levels
...
This is a book about how the human mind might work, how we might approach hacking the human mind, how we might make conscious, sentient, [[gh-a0206z|self]] aware machines with [[phenomenological-consciousness|phenomenological conscious experience]], and how we might connect those machines to the human brain through [[brain-computer-interface|brain-computer interfaces]].

I'm digging through all the concepts I have learned to share the best conceptual gems and to share my prediction for what human [[consciousness]], [[gh-a0206z|self]]-awareness, and epiphenomenological experience could be through a mechanical and computational analogy.

Chapter: The [[gh-a0206z|Self]] in [[gh-a0206z|Self]]-Awareness? A concept? A direction? A driver? An orchestrator of a symphony?

Symphony of the Brain what year?

In Rhythms of the Brain, the discussion of how [[inhibitory-neurons|inhibition]] can change the firing patterns of a neuron points toward the moment when a change in experience, or the canvas of [[consciousness]], happens. Eventually, that change may be overridden by the group [[brain-rhythms|oscillation pattern]], so the change in phenomenological experience is overwritten, or in a sense reset, and the network can get ready to represent a different pattern for the next moment in time.


Long-range interneurons with myelinated axon collaterals facilitate temporal synchrony across terminals, as discussed in Rhythms of the Brain. The critical role of these rare long-range neurons involves facilitating the timing of distantly operating oscillators and the firing patterns of large numbers of neurons that are not locally connected to one another. If what you are seeing and hearing comes from the same source, such as a dog's bark coming from what looks like an animal, recalling the image and sound of a dog barking may require long-range coordination between the [[cortex|visual cortex]] and [[auditory-cortex|auditory cortex]] that raises the sound and sight of the dog in memory at the same time. That temporal synchrony is thought to involve long-range [[inhibitory-interneurons|interneurons]], so it can be argued that [[attention]] across multiple sensory modalities, including sight, sound, and touch, is coordinated by interneurons that bind diverse sensory representations together.

Imagine that the brain's principal excitatory cells collectively create a large marble block, and that the [[inhibitory-interneuron-system|inhibitory neuron system]] is Michelangelo carving that marble block into David.
...
I AM A COMPUTER SYSTEM: THE [[gh-a0001z|SELF AWARE NETWORKS]] THEORY
...
[Phase locking, Phase modulation](private dated source archive://note/203b8950-304e-429f-aedb-d3d002a5c12f)
...
Artificial Brains ([[gh-a0001z|Self Aware Networks]])
...
[Notes including the term dendrites](private dated source archive://note/d694c243dd8a472dae21c9cb61d4fa47)
...
Paper Title:
Enhanced [[dendritic-compartmentalization|dendritic compartmentalization]] in human cortical neurons
...
- Source file: `a0644z.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0644z.md
