...
[[neuroscience|Neurophysics]] [[nervegear|NerveGear]] Happy Hour Vibrations & Oscill

00:00

Is other than just really excited that this technology is finally arrived on the scene after waiting for decades for something like this. Probably one of the neatest. Advances because it really helps to improve the automated detection of non-convulses status epilepticus, which is a real problem that goes undetected often in the hospital setting for [[eeg|EEG]] and [[brainwave|brainwave]] monitoring.

00:25

The web at the web address again. Sean was without [[eeg|CEREBL.com]].

00:46

I think this is actually put together buy a neurologist in Southern California and it addresses the the current problem that we have in the hospital sending of the unmet need of rapid expedited [[brainwave|brainwave pattern]] detection. You know, if you look at the current mode of or the current model if you will the business model for getting [[eeg|electroencephalography]] in the hospital it is.

\n 01:13

Fought with obstacles there are probably literally a dozen different things that can get in the way of of actually acquiring [[brainwave|brainwave signals]] quickly. You know, you can do blood pressure you can get a pulse ox you can get somebody's temperature within seconds but are most important organ in the body can be.

01:33

Clocked away underneath the surface of the skull seizing away with no external manifestations and we may be oblivious to it. So to me, this is a an absolutely groundbreaking disruptive technology that is going to change the paradigm's moving forward for getting expedited [[eeg|EEG analysis]] in the hospitals setting. Oh interesting.

01:59

Yeah, so it looks like you've got a headband with. 10 [[neural-arrays|electrodes]] and. They just wrap it they just sort of wrap around. So, it's not a cap. I mean, it's not like a traditional [[eeg|EEG]] setup. Yeah, so at least seems very interesting. I just googled it. So what do you guys think about wearable new row devices?

02:22

I know cardiac devices are very end right with Apple watches and ECG algorithms. I recently saw these ads for durable which is like a [[eeg-xr-neurofeedback-bci|device or headphones]] you wear and I don't know how accurate they'll be but they'll give you [[eeg|EEG signals]] and kind of show when you're working whether you're in like good [[brainwave|PWaves]] or when you need a break or it'll kind of alert you okay, now your [[brainwaves|brainwaves]] are changing you need a [[neurofeedback|break]].

02:49

I know how accurate it's going to. Be but what are your or everybody's thoughts on that and if somebody's tried like a wearable device before in the [[neurofeedback|neurospace]]? Well, um, I just want to say that sir cerebral is also a wearable device that that we're seeing I'm sort of like, I think so.

03:11

I think it's of interest everybody because it's the same sort of the same topic that both of you just write up and I guess I was on meet what I was trying to say that I'm noticing that Sarah Bell CER. I BELL is a 10 channel or 10 sensor [[eeg|EEG]] headband that wrap that is it looks like a regular man.

03:32

I guess it wraps around like a swipe like a like a sweatpant what makes it different. I'm just curious what makes this stand out. Good question they might get I agree with you it is technically speaking a wearable. I mean, if somebody were really motivated they could get their hands on one reason and track their own seizure potential if they had epilepsy for example, so what makes it different and stand out well for one thing just the ease of use, you know, a standard [[eeg|electroencephalogram]] requires a technician and a lot of messy glue that smells really noxious to apply the [[neural-arrays|electrodes]] to the scalp they can fall off easily, you can get a lot of [[eeg-limitations|electrical artifact]], it's just different.

04:17

Very cumbersome thing to get an [[eeg|EEG]] and the fact that requires a technician means that it's not always available 24 hours a day many institutions don't even have an [[eeg|EEG]] technician there's a lot of noise that can come from the system just countless variables barriers that get in the way so this is very convenient the electrodes pop on very easily it wraps around this scalp in a minute and before you know it anybody, you know can can can put this on a patient so a doctor who's not a, Physiologist or a nurse at the bedside could put this on in the ER and the ICU so really you don't you don't need a technician it uploads the signal to the cloud where a neurologist can read it from home or in Geneva wherever he or she is.

05:12

So instant access and then another aspect of it, that's really intriguing is that it's it has [[artificial-intelligence|AI algorithms]] built into it that have a very high. Degree of positive predictive value and high sensitivity high specificity for detecting electrical electric graphic seizures in [[brainwave|brainwave signals]]. So even in the best of circumstances normally if a patient is seizing it will require the technician to get a the [[neuroscience|neurologist]] on the phone describe what's going on the neurologists will have to leave clinic or wherever he or she is and come take a look at the machine.

5:49

And make a determination here with this [[artificial-intelligence|AI algorithm]], it will actually set up an alarm right there at the bedside that of the seizures taking place again, you know, you don't need a [[neuroscience|neurologist]] necessarily to read. Yeah this it looks like this devices is intended for for the point for the point of care for for like a hospital or specifically a nurse.

06:16

Alright. Okay. Yeah, so it's a bit different I guess in in in terms of what you might expect from something like open [[bci|BCI]] which I guess you wouldn't expect to see something like open [[brain-computer-interface|BCI]] in a hospital. It being used for the [[eeg|EEG]] detect. I mean for for Caesar Caesar detections.

06:42

So I would agree with you on that. I think you know, this is an FDA approved device. So the company's obviously invested a lot of time and energy in demonstrating it's safety and effectiveness and. I think we're still a ways away from [[bci|BCI]]. You know, hitting mainline [[clinical-bci-applications|clinical productions]] other than in very specific instances such as for correction of Parkinsonian tremor or people cervical dystonia, and those are quite involved in and specialized service lines of delivery.

07:20

So in terms of, You know [[brain-machine-interface|BCI wearables]] that you're probably at Buju's question. I think you're gonna see those to be a more popular wellness oriented market that you're looking at there. Okay, did you have more thoughts on on that?

07:46

No I love all your coins seems a thing which is describing this more for hospital-based thing, but I agree that variable neuro devices are gonna become more commonplace because there's this big fascination to know for everything for most people to what's going on in your body like heart rate heart break variability, which somehow like ties to [[brainwave|Euro coherent coherence]] and then [[neuroplasticity|neuroplasticity]] so I think there's just going to be a lot more things coming out and I'd be excited to hear if you guys have seen.

08:21

Something or in the pipeline that's coming out. I saw this durable device which was just [[eeg-xr-neurofeedback-bci|headphones]], but have you guys seen something else and the pipeline?

08:35

I I could also ask because everyone seen that that [[neuralink|new video]] that nearly put out with with the monkey and the,

08:48

Talking about the one with the [[brain-computer-interface|pong]] where where the monkey is playing himself with pong? Yeah, yeah that one. Yeah, it's quite striking and. Reminds me. 35-40 years ago longer than that when uh hung first came out and held my brother and I were just in trance as kids it.

09:08

Almost brings back that feeling now to see him playing himself with this [[bci|BCI]] but I think I put you there's there's a number of different devices that are working the way through the. Wellness market that don't require FDA approval using you know, electrical conductance to. Gently stimulate portable function and maybe take advantage of [[neuroplasticity|neuroplasticity]] in neurogenesis probably where you're gonna see more of the really exciting advancements are in the FDA-approved market where we're using [[transcranial-magnetic-stimulation|transcranial magnetic stimulation]], [[non-invasive-brain-stimulation|transcranial direct current stimulation]].

09:49

To elicit specific changes in the lateral [[prefrontal-cortex|prefrontal cortex]] and people who are suffering from depression OCD schizophrenia. [[oscillatory-ptsd-therapy|PTSD]] a lot of a lot of really exciting [[neuroscience|research]] going on there you may want to check out brain's way brain's ways got a pretty good product model delivery system for that modality.
...
Weber and the freshener is essentially says our senses be a vision or other, you know, touch vocals in like logarithm right is the linear so then the net natural question to what is the? All newer updates or the newer [[neuroscience|science scientific base]] of the slot, right apparently there's some apparent there's some research one on like in this direction recently recently, you know, 15 years I believe so if if the room is the expert in the room can come and not and also can someone explain the [[neuralink|neural link]] the the the [[brain-computer-interface|pong game]] the what's going on.
...
Else and the monkey moves the cursor to it it gets a little bit more milkshake and while it's happening the the [[neuralink|neuro-link device]] that has been implanted in the head is is recording signals and sending those signals to the phone and so after a while they it the device has has has has trained on on the the data coming from from the from the [[cortex|brain]] from the device in the brain and what they do it then is the um as they unplug the, The joystick so that the monkey will continue to play the game and it will continue to use the joystick as if as if the you know, basically moving the cursor to where the to where the to where the light is on the screen right but but but now the only way for the cursor to get there is because the [[neuralink|neural link]] because the [[brain-computer-interface|signals from the brain]] in the [[neuralink|neuralink device]] are being transmitted to the phone and that's the only way that the monkeys able to interact with.

14:47

The computer but the monkey still moving the hand and still moving the joystick because it doesn't know that this is this transition has taken place but you can see in the video that the joystick has been unplugged at that point and then that's so that's stage two is the joystick was unplugged and in the monkeys controlling it with with its [[brain-computer-interface|brain]], it doesn't know it stage three is they they take the joystick completely away from the monkey so it's not even in the picture anymore but the monkey continues to play the game with with justice with justice mind and it's um, and and we I guess we don't know if the monkey thinks that somehow the It by holding on to the straw that it's somehow able to to cause the.

15:31

To cause the like it's not it's not clear for me if the monkey really understands it that the [[brain-computer-interface|mind is what's controlling]] because it maybe the there's some confusion with whether the straw is helping the monkey to control the cursor on the screen. I don't know but it's but it's really interesting.

15:58

So so it's an early link you can see on the monkey there the the part of the head with shaved and nearly cuz the [[neuralink|wireless device]] so it it has a what happens is you is after the the sensors are implanted there's a wire that runs over the surface of the [[cortex|brain]] and it runs down to the the area behind the air and then that that is connected to a Bluetooth device somewhere behind the ear and then and then there's a, There's a device out the outside of it that that would be where you might put like a battery.

16:41

I think it's sort of like attaches behind the ear and then and but that but at that point it's it's transmitting to the phone wirelessly so you're not gonna say cable with an early [[neuralink|device]] it it's using bluetooth. Just.

17:03

Enhancement of spatial and temporal resolution of detectors that track the neural urans firing and where is this [[neuralink|neural link]] in terms of [[neuroimaging-reliability-critique|spatial and temporal resolution]] in relation to [[fmri|FMRI]] or called? It's way beyond those two it's evacuated at it's in a class of it's own so so like so ecology is you know, putting like a [[neural-arrays|grid of electrodes]] on the surface of the brain but but this but this is putting this is putting sensors this is injecting sensors into the [[cortex|brain tissue]] between blood vessels with with the kind of precision that only only a robot can handle surgically and and it's using.

18:01

Oh and let me so the main bite. Scott up here and so again, we're just so that's. So the the electorals are like smaller than the human hair there's about I think I think there's like 10 I forget but I it might have been something like 10 [[neural-arrays|electrodes]] per per thing and like 10 gosh.

18:33

I have to look it up but um. But it's like let's see how many lectures. I'm just gonna type this in my computer real quick see if I get a fast answer. Like a trose on an early link. So okay, so the so of it so. So I guess um, the initial [[neural-arrays|arrays]] were we're thought maybe you could have a close to like 3,702 electrodes per array in the first versions let's see if I can alright is the question how many are on the monkey and the mindblowing thing especially resolution and the number of electrons.

19:20

I don't know the [[neuroimaging-reliability-critique|spatial resolution]] but I just saw a video that said it was 10-24 electric swan each atmosphere.

19:31

Where sorry the, That's not shanks because there's 16 [[neural-arrays|electrodes]] on each on each shank. There's 16 electrodes on each channel each chain. I just like shank so for each penetration. I think there's 16 contacts for a total of 1024 contacts per hemisphere, okay? And the depth of penetration is somehow calibrated beforehand and then desired.

20:03

I don't know yes yeah the death of calibration is calibrated ahead of time it goes several millimeters in into the brain the level of the [[cortex|cortex]], they're working out models now where they're going to be able to take it deep to the subcortical structures. Part of the advantage of using the robotic approach is that they can avoid the major complication of deep brain stimulation which is bleeding these these [[neural-arrays|electrodes]] are a tiny fraction of the size of most deep brain stimulator electrodes and being very tiny and filamentous, of course, you can imagine they would break very easily and so the [[neuroimaging-reliability-critique|spatial resolution]] is incredible it's like nothing that's been invented before and, The idea here is to get a very high fidelity reading from [[cortex|cortical]] neurons so that very closely approximates real-time signal processing.

21:07

I want to like agree with that in terms of like it's far beyond, you know [[fmri|MRI]] and it's it's it's far faster than MRI and it's far more it's high. I'm much higher resolution, you know, it's like [[neuron-electrical-firing-threshold|individual neurons]] but but I think that there was a project the nerve that was called neural dust where they injected and and also [[optogenetics|optogenetics]] right like we're in in both cases, they're they're manipulating they're they're manipulating their modifying [[neuron-electrical-firing-threshold|single neurons]], so they can manipulate [[neuron-electrical-firing-threshold|single neurons]].

21:42

And. I. Don't I mean, I guess yeah, I don't know if you I don't know how to compare it compare the resolution to [[optogenetics|optogenetics]], you just can't you can't really do object genetics and human being right but um.

22:00

Technically you could might the problem is that from an antical perspective it's a little challenging or requires a viral vector to transfect neurons to start with and. With [[optogenetics|optogenetics]] you're looking more at a control feedback, you know, modifying behavior using input of light into the [[cortex|brain]] as opposed to sensing so much what's going on so the really different modalities the the neural dust idea is very very neat idea.
...
Um, click comment on the [[optogenetics|optic genetics]], another thing were worth bringing up is optimized for it's great in mice but all my sur basically almost clones of each other in the ladies the labs that we're trying to get up to to work in monkeys starting like 10 years ago or so you get way more issues due to genetic variability because monkeys are not all clones of each other and so some monkeys it would work and some monkeys wouldn't I think immune responses were a big issue there?

23:44

So in humans with even more genetic variability than monkeys you're gonna run into stuff like that. That's good to know um, yeah, I'm you know, man, I guess one of the the things that's been tatted about an early like was that the size of the [[neural-arrays|electrodes]] and the fact that they're designed to miss blood vessels and that maybe that could reduce scarring and and and make make it possible to leave leave it in longer and it had us still be effective for a long time.

24:20

Reflections echoes from different layers, possibly [[non-invasive-brain-stimulation|stimulation]]. Like that.

24:38

Anyone else. I sort of missed a question would you rephrase it maybe a little louder? So I come from instrumentation background and every time I joined [[neuroscience|neurophysics]] rooms I get frustrated because a lot of stuff that people talk about are very indirect and then people say I feel like I feel that because I just want to see it.

25:01

So I've been looking for different progress in instrumentation and so this this room is up great great thing and thank you very much for setting it up. And I guess the ultimate goal is to be able to understand the other granular level. How the individual [[neuron-electrical-firing-threshold|neurons firing]] gets all gets into a larger group and then turns into a certain things that we can actually experience and so and there's a lot of problems working invasive detection and we it seems like we also have a problem with a temporal resolution or this detector or something.

25:49

So, so two fold one in, Is either any [[neuroimaging-next-generation|nine invasive detection research]] going on. That's number one number two is am I just totally off envisioning my time maybe ten years from now maybe 50 years from now when we could actually, you know point a telescope type of thing to the person's head and then be able to actually see.

26:20

What's going on at the neural? Level. So it shines you wanted go ahead it's got if you want to. Alright, can I just clarify like are you asking what are the current cutting edge [[neuroimaging-next-generation|not invasive techniques]] to read out neural activity? Is that the question? Yes. Yes. Um, I could name a couple I'm sure other people could I I think so one thing that's using like sound or or something or is optical coherence tomography.

26:52

I mean that there's not like that hasn't picked up much. You know, I mean, I'm excluding like [[fmri|FMRI]] because you have to be in like a big magnet for that but like, you know [[eeg|EEG]] has been around forever, but just just the electrical noise is what I'm sorry. I'm just incorrectly [[fmri|FMRI]] that's not give you.

27:15

Dessert like a one second latency and doesn't give you [[neuroimaging-reliability-critique|temporal resolution]] that's necessary because these things are fire on your head hurts to like 20 minutes. Yeah, yeah. So so as if we're the high temporal resolution, you're gonna have you could have like [[eeg|EEG]], but now you you lose your [[neuroimaging-reliability-critique|spatial resolution]].

27:33

So there's always a trade-off. But I went to a talk by Mary Lou Jepsen who was kind of touting this new thing with they are getting like could get possibly high resolution by using perhaps. I think it's [[near-infrared-action-potential-detection|infrared]] that's coming out of like, That it should put it simply like a little like a hat or like a beanie is the idea and that they have fine spatial resolution because of the how many pixels you can get due on like LCD using LCD technology the how flat screens have so much more pixels than they used to so if you shape this into sort of like a hat and and you use [[near-infrared-action-potential-detection|infrared]] and and in some cases combining it with with a with with sound they're able to sort of pick up a resolution, but that's that's like a private company called like open water.

28:29

I think that coincidentally know a lot about the head company. I don't know if people want me to share but I'll let you keep talking and keep going yeah. I was just gonna say that and there's more but yeah like there's nothing great that has great [[neuroimaging-reliability-critique|temporal and spatial specificity]] that I at least that.
...
Um, Sean Abbott, I bet you have someone to yeah, I actually uh helped to launch a company out of Israel back in 2014 that used a combination of [[near-infrared-action-potential-detection|laser light]] and doppler to image brain blood flow so I think Carl kind of what you're getting at here is is the trickiness that that.

29:21

We face when you're trying to interpret seasonals, you know electrons one modality that we try to use to infer what's going on at the [[neuron-electrical-firing-threshold|neuronal level]] [[fmri|functional MRI]] is another but [[fmri|functional MRI]] depends on blood flow. So we have something called the neurovascular unit where the idea here is that when a neuron becomes more metabolically active a sensibly because it's engaging in more firing activity that activity requires more consumption of glucose and oxygen which then of course requires the greater amount of blood flow to that neuron so the neurovascular unit is the coupling of the blood flow the blood vessel blood flow and blood vessel to the neuron itself in [[fmri|functional MRI]] can take advantage of that.

30:13

Increase in essentially glucose and oxygen delivery to be able to represent indirectly electrical activity but there's there are [[temporal-undersampling|temporal limitations]] the advantage to laser doppler is that we can get almost instantaneous signal representation of brain blood flow changes probably it's greatest limitation is the depth of penetration into the stalling the brain tissue is somewhat limited by power if you increase the power of.

30:48

Doppler too much, you can actually damage underlying [[cortex|brain tissue]] and blood vessels but. In terms of trying to get very high [[neuroimaging-reliability-critique|temporal resolution]], it's almost instantaneous feedback and closely at parallels that what we see on the electron suffering. So that helps. Thank you. And then Sean if you want to list some of the other devices that you were you're gonna list earlier I can I can write them down as you go ahead.

31:18

Yeah sure. I think you know from the therapeutic standpoint in addition to [[transcranial-magnetic-stimulation|transparent magnetic stimulation]], we're also seeing transparent. I'm sorry transparent or direct current stimulation as a [[non-invasive-brain-stimulation|therapeutic modality]]. It's probably let's study but the idea here is pretty much the same and that is that if we pass electrical currents.

31:42

Through the skull into the underlying brain tissue, it's stimulates neuronal activity. And so there's a principle of of the brain that most many people have heard of and that is [[neuroplasticity|neuroplasticity]] and [[neuroplasticity|neuroplasticity]] is the ability of the brain to adapt to changing the circumstances and alter its [[spatiotemporal-neural-firing-patterns|connections]] so [[neuron-electrical-firing-threshold|neurons]] that fire together wire together as we say and if there's a demand on [[neuroscience|brain function]] that requires us to learn or to adapt [[neuroplasticity|neuroplasticity]] makes that possible.

32:20

So we can take advantage of that principle of. Disease and kind of hack it for a good reason using PMS in PCBS. Sorry PCS which are two different [[non-invasive-brain-stimulation|stimulation modalities]] that are now currently available on the marketplace. We can look at other forms of. Therapeutics think that [[brainwave-entrainment|cerebral entrainment]] to their number of different devices on the marketplace and you'll see this if you go to to.

32:56

Physical medicine or rehabilitation conferences where they try to use [[near-infrared-action-potential-detection|infrared]] or [[near-infrared-action-potential-detection|near infrared]] lights to stimulate the optic nerve in synchrony with auditory stimulation the idea here is that if you have somebody who's suffering from depression, you know, they may be neuro adapted to a rather low level of energy you can.

33:24

Again kind of hack their system by introducing a higher level frequency. So alpha or low beta frequency waveforms to just improve their [[neuron-electrical-firing-threshold|neuronal excitability]] and increase the mood and. There's some evidence that you can definitely stimulate increase levels of [[dopamine]] and stereotone and using this this idea of [[brainwave-entrainment|cerebral and trainment]].

33:54

So those are probably terms of at least what's available in clinical production from the therapeutic standpoint those are available. Only one day it looks like Carl left the group, but if he comes back he can let him know [[gh-resnote04|Micah]] that Magneto electrode cephalography probably is where he would be interested.

34:14

This is a setup that combines MRI with [[eeg|EEG]] at the same time using ferromagnetic components in the [[eeg|EEG]] leads that are compatible with the MRI and do not interfere with. The. Image quality. So we can now actually image the brain using MRI at the same time that we're also getting synchronous.

34:39

Information from the electron supplegram. So much higher tighter [[neuroimaging-reliability-critique|temporal resolution]], and so it's a very interesting modality. There's something I ask a questions if you if you know the answer um, what what do you lose when you when you start you I guess what do you lose when you mix the tutor together is it just like the cot the [[eeg|EEG]] part of it the contacts are a little less specific or?

35:13

Frank. I don't know that I was just frankner Scott sorry Scott, I I don't know that you necessarily lose anything. I think the I you know before these specific setups were created it was essentially technologically not possible to do an [[eeg|EEG]] inside a conventional MRI machine. And I don't know if you've ever been in an MRI machine.

35:41

I'll I almost personally lost this stethoscope into an MRI bore one time and that would have probably ended my career. As a budding young [[neuroscience|neuroscientist]] to make such a casual mistake, but any anything that has a ferromagnetic quality to it, essentially can. Impair the quality of the signal that's coming from the MRI.

36:04

So yeah, I've heard the horror stories from grad students feel like they help careful you have to be I was just curious maybe like materials person would know this like if you're not using magnetic metal [[neural-arrays|electrode]] are there. I'll not magnetic electrodes that are as conductive or or not I guess as right.

36:26

Yeah, no good question. I see what you're asking. So basically with the magnetoon subflography, the the leads are are usually titanium. They're not as conductive as you know properly for example, but usually you get about the same quality of information. So it's not not even close to the kind of fidelity of [[eeg|EEG]] signal that you would get let's say from [[neuralink|neural link]].

36:52

I mean the, Well that's that's extraordinary but that's penetrating though that yeah right yeah. So, you know, it's I think you could probably say making people like to support our confused good enough to get some really interesting answers. You know, but I don't know. I kind of feel like we're poised for you know, disruptive jump in [[neuroimaging-next-generation|technological innovation]] here.

37:17

There's a new. Brand that have to look it up a we now actually have the ability to get [[fmri|bedside MRIs]] the new device just rolled out last year that. He can put in an ICU. It's a it's basically an MRI in a box which is something I've fantasized about for 20 years, so it's really exciting to see that come to fruition.

37:40

And in terms of the quality of [[eeg|EEG]] signal, we're just seeing improvements, take place all the time so. Yeah, I think we're we're poised to probably see convergence of a variety of different technologies and you know, when you throw [[artificial-intelligence|AI]] in there and [[artificial-intelligence|machine learning]]. I just envision or [[brain-computer-interface|capability to do things]] in the IC setting is put it for the hospital settings to jump dramatically here soon.

38:11

You were talking about mixing AEG and [[fmri|FMRI]]. How But but uh, what for my understanding Magneto electrons. Sethography is the it is like if that's the one where so with [[eeg|EEG]] it's better with to pick up signals from the sulcai I think and then with MEG it's better to pick at picking up signals from the gyri or admit it could be vice versa because once directly reading out the electric field and the other ones reading out the [[magnetic-phase-field|magnetic field]], but I think, [[eeg|EEG]] makes it applies.

38:49

It that's something else right? That's not related is it? You're correct. Yeah. I I don't know that we really have the ability to to. Co-locate [[eeg|EEG]] with [[fmri|FMRI]], I mean, they're maybe there's somebody who's doing it. I'm just not aware of it, but you know a [[fmri|functional MRI]] is essentially a traditional magnet.

39:14

And really what we're looking at there is what we call blood oxygen level delivery which is something that's very susceptible to ferromagnetic interference. You know, somebody has a small hemorrhage even into the [[cortex|cortex]] of the brain the hemostitter and that's left over in the brain tissue can interfere with the [[fmri|signal acquisition]] for a functional law.

39:36

So, We would not typically do any [[eeg|EEG]] at the same time as a [[fmri|functional MRI]] with the magnitude of encephalography really we are mapping out brain activity. And we're we're reporting magnetic fields largely that are occurring throughout the brain and so you know, we're trying to do is is challenge a participant with a particular perceptual or cognitive challenge and localize where in the brain is that challenge mapping to with the most activity electromagnetic activity.

40:18

So really is a an interesting a different way of. Looking at looking at the [[brainwave|signals]] and we're getting from from [[fmri|functional MRI]].
...
Yeah, so anyway so I maybe look up this article. I don't know if I should list it on Twitter or something so he's been finding it but in fact I'll be back it's good to be balanced because you know, anytime a [[non-invasive-brain-stimulation|new technology]] is deployed in this environment we are.

46:45

In a way experimenting with with something that's very new relatively speaking, you know, and so who who knows you know, it's not for everybody and the problem here is that with the new technology like [[transcranial-magnetic-stimulation|EMS]]. We don't really have a way necessarily predicting who's gonna be a good responder, who's not.

47:08

You know, I think it gets challenging because when you think about, You know behavioral health and mental illness many times people who are suffering from let's say depression especially treatment resistant depression, they have something else that's going on there may be an autoimmune [[neuroscience|neurological disorder]] that's taking place, it could be undiagnosed multiple sclerosis and it can be dealing with a you know, some other you know, a neurotransmitter deficiency random b12 deficiency probably b12 deficiencies the most common thing that I see in my clinical practice that leads to a wide range of neurological symptoms that also have mental health.

47:49

Implications so you know, you can imagine that somebody who may have an uncorrected underlying a physiological abnormality that then goes through a physiological stress relief may get worse because they have an underlying problem that hasn't been addressed so I really feel like these these [[non-invasive-brain-stimulation|therapies]] have to be done in a comprehensive holistic approach.
...
Or a [[transcranial-magnetic-stimulation|TMS]] may actually be the wrong treatment for some depression for some patients with depression and those pay those patients would be experiencing depression because they're basically they're having a metabolic disorder where their cells are not able to produce enough energy enough [[atp|ATP]]. And so like so for example like there's a book that book that I read that it was just a layman's book but it was about how people who have fibromyalgia and chronic fatigue syndrome and depression, they they might be able to like basically there's like 20 different things they can try and one of those things was like the ribose because the ribos is if you take it like I think it was like five grams a day many patients saw like an improvement in their energy and in their happiness and reduction in their fibromyalgia and reduction in their chronic fatigue syndrome and in.

49:50

And. The explanation was that it was helping the body to to produce more energy more [[atp|ATP]] and forget how to I always forget how to pronounce [[atp|ATP]] with addendosine triphosphate yeah, that's it and that's yeah. It's not you're definitely on the right track there might you know, if you think about.

50:19

Think about [[sleep-spindles-sharp-wave-ripples|sleep]] why is sleep so important to us, you know, and we you know can get weigh into the weeds talking about rem and dream interpretation center but from a functional standpoint asleep is when our brain turns on the [[glymphatic-system|glimphatic system]], so you know until 2014 we did not think that the brain had its own [[glymphatic-system|lymphatic drainage system]] the just couldn't see it you could take a biopsy of muscle tissue for example and under microscope you can see these small little lymphatic tubes that will help to drain.

50:54

Muscle tissue of you know lip lymph tissue which is really waste products and immune complexes, so but to run 2014 researchers in Virginia were studying patients using [[fmri|MRI]] when they would sleep and found that lo and behold when they would go to sleep this whole [[glymphatic-system|lymphatic system]] would turn on the brain.

51:19

And we discovered that that lymphatic system was made up of [[glial-cells|glial cells]] which are supporting cells in the brain so they were given the nickname the [[glymphatic-system|glimpatic system]] so the implication here is that we have enough energy in our brain to do one of two things we can either be awake and doing and taking action or we can switch to the sleep mode where our energy then is devoted to open at these lymphatic channels and removing debris from the brain.

51:50

And that debris is basically the byproducts of oxidative metabolism so oxidative metabolism if you think of an internal combustion engine in car it consumes oxygen and fuel the combines them to generate energy and a waste product so our [[mitochondria|mitochondria]] inside of our cells in the brain the rest of the body, but especially in the brain do the same thing they combine oxygen with the fuel source which in this case usually is glucose and the combustion yields energy in the form of [[atp|ATP]] and NAD and then there's this.

52:23

Byproduct of oxidative metabolism that builds up and that's free radicals and beta amyloid and tau protein and other things that accumulate in the [[cortex|brain]] and we can tolerate that to a certain point before we get exhausted and fatigued or cognitive performance that climbs and we go to sleep and we remove all of that junk from the brain during sleep, so when you're talking about depression in metabolic function, you're definitely on the right track there.

52:54

Probably for fists of the time people who we see in the clinical environment who are suffering from depression do so because they simply just don't have the right metabolic set up to support adequate metabolic function of the [[cortex|brain]]. So if the ribose is a really nice way of helping the supply more energy to the brain.

53:15

So as methylcobalamin which is a hormonepapolate and literally we could talk all day about all of the different components that the piracy. Tuning and searing the go into the formation of [[neuron-electrical-firing-threshold|neurotransmitters]]. And then when you think about the metabolic stresses that occur during increased allosteric load, then the demands on neurotransmitter formation go up and we also generate more oxidative metabolic byproducts and so they need to clear that out increases.

53:48

So, I mean, anyways, yeah, my my thought is is that the team has clinics and the and the [[non-invasive-brain-stimulation|TDTCS therapies]] that are being proposed there ought to be like conversation like a global conversation with these folks just to you know, the brakes to bring up the What you just said basically that that some patients if they're having a metabolic issue that's that's the cause of their [[long-term-depression|depression]] adding a bunch more stimulation which they're which just which makes their brain work a lot harder.
...
A short the journal is here, but the title is the the system I've beginners guide. So give us a kind of lays down the basic principles here, but in a nutshell energy production in any cell, but. Definitely in the brain is sustained by the [[mitochondria|mitochondria]] and the [[mitochondria|mitochondria]] are specific specialized organelles or tiny organs inside of the cells in the brain and there are different kinds of cells in the brain.

01:08:34

There are [[neuron-electrical-firing-threshold|neurons]] and there are [[glial-cells|glial cells]] which are supporting cells that do not specialize in the transmission of electrical signals, but they support the cells that do transmit electrical signals. And so those [[glial-cells|glial cells]] could be oligodendrocytes or [[astrocytes|astrocytes]] their number of different. Kinds of cells they have different functions, they could enter sites create myelin that insulates the electrical conduction of neurons associates have an inflammatory role and they modulate the fluid that veins the brain.

01:09:10

So when they [[mitochondria|mitochondria]] are generating energy, they do it by combining oxygen with glucose in through the crimp cycle create [[atp|ATP]] and NAD, so this is the two primary forms of energy that are our body uses and so [[atp|ATP]] stands for density and triphosphate and it is. Nicotinamide nucleotide and they both have such a form of currency that are shoveled around the body and used for energy to create new proteins or to generate function at a cellular and organic or organ system level.
...
So the [[glymphatic-system|glimphatic system]] runs, right? Along the outside of the capillaries in essentially they're a virtual space that are created by what we call podocytes or these are essentially the foot processes of the supporting [[glial-cells|glial cells]]. So you'd have to imagine the [[glial-cells|glial cells]] have these small projections that essentially come and wrap around the capillaries and avials and act as though they are an external insulating.

01:11:05

Membrane that. Is creating a potential space around the capillary. Now as enough metabolic activity takes place inside the [[mitochondria|mitochondria]] and we're generating waste product part of that involves water and water is very abundant throughout the brains. Makes up most of our brain actually and so that water dissolves different solutes and ions in it and can traffic different [[three-dimensional-protein-structures|proteins]] like albumin for example.
...
In your brain all the way down to your toes and you know and in one possible instance but then but then I but then if you look if you say well what are what are [[glial-cells|glial cells]] and and people say well so glio cells are or glia are and it says like if you've liked the heart of gray matter in the brain which is made up of cells named called neurons, but unless we don't type of brain cells what makes up bite matter and so now that they're like and they're like saying, okay, no glio cells are the white matter and I'm like what wait what like wait is it at our white matter the axon or is white matter glial so it's could you clarify that yeah.

01:14:25

And so there's like [[astrocytes|astrocytes]] oh look at your sites microglia. I'm forgetting one I think but the at least in the central nervous system that what makes up biblia is the oligodendrocytes so one of those types of. What makes up the myelin is those oligodendrocytes one of those types of Guilla?

01:14:48

So Milan is the in sheep as responsible for the in sheep thing of the axon. So if you think about like, A regenerative signal amount. So myelin allows sort of the the [[action-potential|action potential]], you know, this is all within like one minute to milliseconds or so that this sort of [[action-potential|action potential]] conduction velocity is increased in most cases by by having that mile and around it.
...
It's so it is. One type of wheel, so let's just restrict this to the in the brain. One type of wheel saw the o logo [[dendrite|dendrite]] is literally in the axons. So so that's the white matter. So the if you're looking at a white matter tract, you're looking at axons and sheets by [[glial-cells|glial cells]] and it it's I guess whiter because there's the [[glial-cells|glial cells]] wrapping itself around it the the axon making it more insulated.
...
I you may have cut out they're looking for any pathology, but just. Cut up yeah just for a minute and if you want to repeat your lessons. Yes, so some of my patients are interested in using. [[eeg|EEG]] to assess their own cognitive performance not looking for any pathology, but just understanding how well they're frontal loads are functioning at any one time, so I'm excited about that product there.
...
I mentioned is in the the the [[glymphatic-system|lymphatic system]] is. Has cells that have endothelial lining so it's it might not be like because it's like a new sort of like a new thing I guess since it's 2015 that we're talking about the the role of the anothelial of the lymphatic system in the brain maybe that hasn't yet been kind of connected sort of broadly in the the the fact that the India that targets to might be in that in the lymphatic system in the endothelial lining of the cells and that's how the virus is getting to the brain and causing information the brain it was interesting as we we missed a you guys.
...
So at it thank you thank you yeah that's interesting and I'm sure he and so I'm sure with no because yeah brain inflammation is a classic consequence of brain injury right so insults to the brain from traumatic brain injury generally lead to a cascade of release of inflammatory factors and that's very often why you have the first one of the first things you do with a patient with severe brain injury is yeah you are.

02:57:28

Often just actually the effectively drill a hole in skull basically just to release that pressure because it's yeah a lot of patients die just purely through the brain inflammation but the interesting thing there is but that level of damage and that kind of inflammation there were certain kind of very common symptoms which are present when you have profound brain information which are things like seizures and the like and there has been.

02:58:03

Teachers reported in coded 19 for sure, but there are other rare and so hmm. I wonder I I wondered yeah to the extent to which that can be a sort of you know, this is the one thing which is always there which do you you know just regulates everything else that's kind of interesting to think about can it really be?

02:58:35

Yeah but but in case I think yeah wait till Monday, but you're saying it's really the fact that the it's really limp node and the the old damage which is in trading most of the effects is that right well just do not have that so that is just like a brand new hypothesis that I just came up with because there's a big question about how but you know how the virus can affect the brain, you know, besides creating recreating information somewhere else and information traveling to the brain or actually, you know, finding is.

02:59:10

To. After is in the lymphatic system in the brain and that's where it's attacking. That's I think that is the most likely case but it's this is like new territory.
...
If you look at the, Well you can look at the translation of it but if you look at the update that was given on November 13 by the what amounts to like the CDC trying to CDC they basically warn of this pandemic pneumonia and one of the symptoms that they signed astonishingly is a necrosis of yeah, neurological microvascular.

03:00:32

Which is very very interesting because that's not something that you you generally put in a flu manual but yeah nevertheless there it is. Wow. Wow. Yeah, that's what that's what I said the IEM was just the same as you right this was like I spent like a month and a half an April and yet there was so few sources, right?

03:00:58

I was still called when I started looking at the store called End calls 2019 and so I was having to look at like Chinese sources. I have a few Chinese friends were translating stuff for me. And yeah but I yeah, it's that was like a lights on moment like oh my goodness and so I began yet to look at it as being at least you know, at least we can say this it's not divorceable from the infractions to the vasculature and the vascular endothelium but yeah, it's very curious to find that in that's the data they updated the nationwide manuals that is a kind of like a update to the seasonal guide.

03:01:42

Lines and they've worn the pandemic influenza of unknown origin and they talk about yeah micro vascular necrosis in in the brain the very odd thing but yeah that's um that would explain a lot of the loss of function and also you were talking about anti-oxidants right and particular in particularly it's like that handles 15 and also glutathione peroxidase, right?

03:02:15

So basically, that's what, Any. He does is basically raised GS GSH levels so interestingly for patients with chronic fatigue syndrome you often get my brain fog in these sorts of conditions and one of the treatments have been sort of for quite a while to sort of gold standard treatments has been to raise intercellular through sothion using there's a kind of microfilted denatured way but also yeah NAC was.

03:02:52

Thought to be one of the treatments but this notion of antioxidation in some way relating to brain fog has been the thing for a long time so yeah this notion of like that's been a damage which is infracting the ability of the microvascripture to deliver, you know to basically, you know, entrain the efficient chemo dynamics and oxygen transport on which you know, neural processing relies seems these things seem to be the same.

03:03:27

One has been trained by just opposite stress and aging and the other may be by the fire so I speaking to guy from Yale a couple of days two three days ago and his view was basically one of a sort of a you know, having sauce got two is like having your vast literature, you know aged and accelerated great that was his you everyone has a view right that was his.

03:03:59

Yeah. I don't know enough about the process of aging to to immediately understand the amount the analogy.

03:04:10

I had basically observations so that there is a not that it's like settled science right but there's an oxidative or an oxidation theory of aging which is essentially that you know, the human body kind of rusts is the idea and so that's where observation fits in that picture where especially where the vast matures concerned.

03:04:35

03:05:22

Yeah, I kind of tied those things together just knowing about it. So, yeah. Are you writing books and papers? I hope so because I keep this knowledge needs to be preserved and shared. So, I hope you're writing. Oh, I'll tell you I'll tell you. I'll tell you what to do.

03:05:39

I basically spent a month and a half on this and I just happened to know some people at Columbia who are you know, kind of like they were one person in that group worked originally on isolating stars and helped set up like part of China's CDC. The infrastructure of the CDC with the head of the CDC in China George Fugel and so yeah, I just I I did what you did, right?

03:06:07

So I just wrote stuff up say look this is not my field but you know, if you think if you think paragraph one doesn't make total nons, you know, it isn't total nonsense you might want to keep reading and so yeah, I basically package this up there and sent it off and get just fired friend who was.

03:06:32

Yeah yes sort of whatever kind of mediating that being sent put together so yeah, it's all it's all basically there. I have the original sort of sort of lights on sort of insights from from April but I dropped it in. May basically because there was so many competing you know, that's two I'm sure if you looked at it there was so many theories of what this was and and I realized that though.

03:07:00

What I was sort of burgling on seemed to make a sense like I'm not an expert in that field. I sort of rapidly became one and just over the last two months. I have had a lot of questions back about you know, what were you saying and and what were the references so is funny that we're talking about this but over the last two or three weeks.

03:07:19

I have just been going over my sort of not rambling that you know, it's pretty pretty well laid out and yeah, it's it basically has a causal sequencer explains lots of things about the following pathology. I thought But yeah just the request for like, you know, what is the underlying evidence and what's too much since what papers and what research findings what clinical findings and what drugs support your view of the pathology, which is how I know about these three emerging therapies.

03:07:51

So yeah, I mean it's I was finally done with it about two days ago, but yeah, it's um, it's written down but I mean, it's not I don't know that it's gonna be sort of published anywhere but yeah, it explains a lot about all sorts of different oh yeah just one thing.

03:08:10

Is kind of an example. Do you know that UV has turned out to be I think this only came out maybe like a day or two ago UV light has turned out to be quite an effective predictor of where you get major outbreaks and coke 19. I don't think that.

03:08:30

What's the what's the story behind that UV light or yeah you're sorry sorry yeah you'll be like basically ambient light has turned out to be an effective geographic predictor of where you get major outbreaks and major clusters of outbreaks in code of 19 and so I basically predicted that this was a result of the two things of course latitude, but then also pollution pollution can attenuate ground UV inert.

03:09:05

Polluted city by up to 40 percent. I looked at Athens sorry up to 70 percent I looked at Athens and also some cities in China some really polluted cities but in Athens I think ground level attenuation of UV and Athens even in summertime is something some around 40 percent but in I think it was like Guangzhou or yeah some particular city in a in a problems they had done a study of ambient UV and they found a 70 percent attenuation what what's important?

03:09:40

About this is of course everyone knows that UVB is involved in the synthesis of vitamin D right and so there was this sort of vitamin D sunshine theory which is actually tied to nitric oxide but the important thing is is that in addition to UVB both UVB and UVA actually release nitric oxide precursors so nitrous ovals and nitrites and nitrate precurses from [[cell-as-chemical-neural-network|continuous storage]] upon.
...
Imactivating or yeah basically nitric oxide isn't is extremely effective in inactivating bacteria protozoa and viruses it's used by macrophages and the primary by macrophages in viral clearance, so I reasoned just be lack of bioavailable nitric oxide would. Basically potentiate, you know, a great your massive disease vulnerability, so if you Google covered 19 and UV and if you just include not vitamin D.

03:11:36

I think it's a search you should come across some research that came out a couple of days ago from Edinburgh University hmm but yeah, it's a process which was has only recently been discovered that nitric oxide is stored in skin what am I supposed to? Say. I'd say what let me just I'll just tell my mic off and I'll just try a Google search and then I'll tell you exactly what to look for.

03:12:02

Okay. Hey Mike and the texture it's such a information overload for me and as they they personally just a generally interested in frame but I learned a lot and think thank you so much for running this okay, so I just say Frank just played mine I think from Mike about like I this is just some research that I did I did with some confidence and capable people but who are you know have years in the field but I'm not one this is just the some research that I did and on my decide none of us are experts.

03:12:40

In code. 19, just to be clear. But sorry go ahead.

03:12:51

I think that was for your frank what were you saying? Frank? Yeah, so so yeah still I mean, very interesting. So it doctors young or like mentioned what time on Monday the 2 gives a? He'll run the clubhouse on coded prank. He might have but I I forget so what I did was I went and and and looked and I looked him up and and sent him a message and said can you can you tell me more deep more details and so he may reply back and not that I'll be able to post that on Twitter.

03:13:34

Okay, just so that for a rep and pointer. I you know. Googled of irrelevant article title is a effect of Kobe 19 on the nervous system. It's a radio article. I think the pointing to the pathways and is to to what was some of the in those associative related.

03:14:01

So, maybe I you know, hopefully that before it's a talk tomorrow, but yeah, I just throw it. Out there, just go. But but I I'll you know, I I need to sign off and hope you know to to I will have the this meeting. So again next week, yeah.

03:14:23

Thank you very much. Frank thanks for coming. I want to encourage more people to come up on the stage and just hang out with us. You don't have to answer [[neuroscience|neuroscience]] questions if you don't want to but we would love that as well. And. And then also if folks want to invite if you want to invite someone a recommend someone I think you need to be a moderator.

03:14:49

So just let me know if you if you want to advise someone and I'll. I mean just makes you feel a moderator. And so I don't know if if if the moderators can take a minute to just invite some some people who are would be interested in a talk about neurophysics nerve gear the brain vibrations and oscillations, maybe we can get the group to keep going and up so I mean, I guess I can't do that.

03:15:19

So I'm just gonna take a minute to invite some folks.
...
And and also and this is like this it does a double purpose so it's like while I'm inviting folks. I'm actually giving my brain a little bit of a rest because the it's this is not an easy conversation for sure. Let's see. I'm fighting. There's so many people who follow me, oh shit you.

03:15:59

I guess there's a fun there's a lament you'll see. I'm trying to just click a bunch of people. I don't know. It is a past 11, so I guess some of these people might not. Be around it's. Okay. Hang on. And we'll resume talking in just a minute. Just I'm just gonna exhaust my invites out if folks want to to send out a bunch of advice for it.

03:16:28

You don't have to be specific yeah. Mike you just say I have some search terms for you when you're done you'll be able to find this article. Okay, go ahead so let's let's type let me type in article, so it's gotta do that, so I'm done. I've maxed out my invites for now, so anyways.

03:16:46

If you search for a if you just search for some might so my um covered and then just sci t e c h s cite it's a kind of like popular science article but it links to the study study from Edinburgh University they've been tracking this for a while trying to figure out why UV had this effect and they originally reasoned which I didn't think was right, but they've converged on.

03:17:21

Nitric oxiders yeah possible possible cause and the interesting thing about this is just they non-cononical means of deriving magic oxide which is yeah fairly recent and it's within the last 10 years that it was discovered that basically heat and light in trade the rapid release of nitrous affiles nitrate and nitrite anions from your storage.

03:17:56

Direct. You into blood where they're reduced to nitric oxide in blood cells and that this is basically a likely well no. I hypothesized that this is one of the reasons that body temperature is elevated in in disease state is one of the things it does is releasement nitric oxide which basically kills, you know, bacteria bacterial infections and viral infections and the like but yeah.

03:18:31

That a little bit of it's a it's an interesting prediction it's interesting to look at something when you're looking at a very small kind of bit of the kind of vascular architecture and thinking just like where on earth is all this nitric oxide come from like where is it stored and so when I thought that way I realized it must be some massive store we don't eat reliably massive amounts of microscopic side, so yeah, it's basically taken in and stored for current as needed and then, There's a cyclical process it's kind of reduced back and since the skin is the largest organ, you know in the body made perfect sense that that was a place to look and so yeah, I discovered that that is a recently observed phenomenon that you can basically, you know on call trigger massive amounts of the release of nitric oxide which was yeah interesting and it was a very odd way to stumble upon it, let me add just um, I do have a question that I want to drilled in deeper, but I also want to give Cecile.

03:19:42

Chance to talk welcome to seal.

03:19:54

Bleeder and then cutting okay, so it sounds like this this is gonna decease those gonna talk later because the signal is bad, it's okay, so um, I would like to then oh but this is ours in it in the down there. I mean invite. Um, and then anyone else who wants to come up and talk just let me know and I'll invite you up just if I.

03:20:23

And okay. All right, so let's keep going um, so the question I had for you Dexter was what do you think the precise mechanism is for for nitric oxide to attack the source curvy to and specifically? Oh you mean the means by which it disables it precisely yes, it's it's I I don't know when a kind of like very deep biomolecular sense but not nitric oxide is broadly toxic so yeah, it's if you like it is.

03:21:05

Used in just about every instance where not just about everything but in many many instances where a broad range of as I said persons that bacteria and viruses are attacked so there's no particular kind of yeah for the purposes of kind of my inquiry the exact method of that action.

03:21:26

I didn't need to investigate right it's just well characterized and we already knew in 2005. I that end nitro supplyles were capable of reducing the replication. On hope so of was one of the few agents found reliably to do it and the thing about magic oxide is that it's basically inherited to the body right so you're not you're not using any sort of, you know foreign many of you treatments which have been tried are incredibly expensive have really nasty side effects profiles, but are yeah, they're essentially modulating immune pathways in very unorthodox ways in some cases, it's not even clear.

03:22:15

Exactly how they do work, but they but you know, they're they're efficacy is very very low so you know like red desert beer and the line car yeah but nitric oxide is basically native there's one thing interestingly. I don't know whether you heard but maybe in around mmm ginger lifetime there was a kind of breakthrough reported about which related to dexamethasone so basically good accords anti-inflammatories.

03:22:48

I don't know whether you heard about that, but there was something like a, Dance cover yeah so so the story around that is basically that that's well the story as writ around that is a dexamethasone basically is an anti inflammatory and so you're trying to fly fight information but that's a double edge sword because the sort of classic, you know, as the royal anti-inflammatories anti-inflammatory medications reduced, you know, they suppress the immune system, do you really want to be doing that and so the effective dexamethasone is interesting because, What decks actually does is under conditions of hypoxia, it actually conserves the production of endothelial metric oxide so I think the method of action is to wide that particular due to [[cortex|cortical]] turned out to be so effective and others have turned out to have moderate or actually deleterious effects is actually because of the specific action of decks relative to endothelial magic oxide that's that's my thought.

03:24:00

Yeah I you know so I the downside the decks which can so dextromethon which can be abbreviated as dx that I read was edit increased oxidative stress and and that is basically the core issue with what so it addressed information but the the core issue was it was oxidative stress index actually increases it so it could be effective in a late maybe in the late stage of kobid when when when the patient is is primarily dealing with inflammation and less so with the cause of the disease in the first place so I but on the whole on the whole I think it's just it's, A.

03:24:35

It's something that treats a sort of a symptom that of a cause but that symptom of a cause is a cause of another symptom and so it's it's it you can see that it's being effective but it's not treating the root issue which is so dexus is really the wrong idea but I I had of something else so I'm gonna throw in there when we got yes, oh, oh yeah, so okay, so okay, so okay, so nitric oxide.

03:25:06

And hydrogen peroxide are they both they're both toxic to germs right they both killed bacteria they both they both kill a viruses and just like, you know, just like rubbing alcohol right but the thing is like I think that in the body the that, um, you know, they're both the way the way that they're acting is different so in the body.

03:25:32

I think that both hydrogen peroxide and nitric oxide are as we've been talking about this entire three hours they. Are vasodilators primarily and they're improving the exchange of of gas in the lungs for for one example or improving the the blood to better oxygenate oxygenate because it did because the blood vessels are the because okay, so, you know the aim to your system or the ace to receptors or degraded right and and so you have too much faster constriction and so I what I think is it that the nitric oxide and the hydrogen peroxide is being vaseline dilators are allowing the the the blood vessels to.

03:26:16

To consume oxygen to help your blood to consume oxygen because the the the otherwise the blood vessels are too constricted and in oxygen can be consumed right that's just a hypothesis and so hasn't it so it may have nothing to do with killing the virus the reason my nitric oxide might be useful in the battle against Kobe 19, maybe really just about one thing that's vasodilation, so you're body can uptake more oxygen and in which case you could substitute nitric oxide for any kind of a facet dilator and you would have a similar.

03:26:51

Benefit if that's true. Yeah, I can see why one would be that to that conclusion but the effects of nitric oxide so there's basically nitric oxide of courses involved ambassador dilation but it's also involved in the inactivation of you know viruses and the like but it's also involved in the down regulation of platelet activation and also platelet adhesion so the catastrophic clotting that you see in coveted.

03:27:29

Can't be explained in quite the same sense by super oxidation right but it can be when all of it can be explained theoretically by a lack of bioavailability of magic oxide and also a biofasic switch to inducible nitric oxide so massive production of nitric oxide from macrophages, which yeah in the end, you know, it becomes one level the production of endocrine nitric oxide and a production in.

03:28:04

Macrophages is great, but once you get this cytokine storm which leads to an upper leg regulation both these cytokines and also entrains the massive production of inducible magical site you get something which is yeah extremely basically yeah in trains barrier function comprised of barrier function the point about this is actually more than anything.

03:28:30

I can say is that there are two things which are absolutely kind of staples of the endothelial comorbidities. Which potentiates severe cover 19 disease or mortality and all of them basically feature as a general feature vitamin D deficiency or insufficiency, but also a lowered nitric oxide by availability and so that initial bioavailability is kind of like a lowered viral defense but also is a kind of diagnostic of a pre-existing endothelial.

03:29:14

So the the the the reason that I hung it on nitric oxide because it just explains so much right the nitric oxide explains why you see the geographic distribution

enhanced synthesis of endothelial nitric oxide something like that basically protects endothelial.

03:29:50

Nitric oxide production under hypoxia and they're just so many facets of the disease which were complete mystery when you look at them from this angle it begins to yeah explain them but who knows so I you know there so when it comes to thrombosis factors or blood or the blood clots right there, there's a lot more to then so so the the lot the loss of ace to receptors and the the loss of nitric oxide is going to contribute to the constriction of the blood vessels, but, In and also the the the degradation of the blood of the tissue is going to release a whole bunch of thrombosis factors or blood clotting factors like like von Willebrands factor, it is an example and.

03:30:42

So I mean so like I mean, I see that I see nitric oxide is is is a big part of the story but but the blood clots are explained by more than just that the release of the the the construction is is is not just nitric oxide it's the ace to receptors and the in the in the the blood clots are not just the lack of nitric oxide it's it's the final element one vanilla branch factor and other other thrombosis factors that are released from the cell lining.

03:31:12

Idea. I'm not saying it explains everything but if you don't have nitric oxide to basically counter those thrombotic effects, they'll just run away from themselves right the whole thing about really sarcopto is that it trained in trains a series of vicious loops right one, which basically leads to the overproduction or the surface of sear and serum hang to right basically as the virus spreads you basically reduce or ablate the ability of this kind of like conversion of an.

03:31:47

Gered to hang one through seven right so you just get lots of ant to in the blood that entrains into Luca and six then increases oxygen oxidization that depletes endothelial nitric oxide that allows the virus to replicate unchecked and that's the kind of chain reaction which just begins to run away with itself and actually eventually doesn't need the virus to be there which will explain why in long covered you have people who have long recovered but they basically have a progressive degenerative endothelial condition but the point about nitric oxide relative.

03:32:22

To from what your relative to like hypothyroid hypo coagulopathy is that nitric oxide is yeah, it does two things it basically reduces cellular wall adhesion right there, so the kind of stickiness of clotting factors to the endothelial lining at the vast mature but it also reduces platelet activation so the fact that you have like one will abandon factor and thrombin.

03:32:57

It's the fact that these are basically in abundance without nitric oxide that basically yeah in trains that catastrophic clotting so I'm not saying that it's just your nitric oxide on or your on good or bad it's more complicated than that but I'm saying it's involved in all of the major manifestations of the pathology, even at the level actually of the, The the infractions to the heart and the like yeah it's involved there too and so I maybe kind of one of the place we're talking about the one of the features of covent 19 is a hypocalyptic hypercalenia and renal failure right so the vasculature of the renal vasculature is basically extraordinarily fine the innovation of.

03:34:07

Yeah, the renal system is exquisitely fine yeah yeah vessels and they are extremely susceptible susceptible to this kind of endothelial dysfunction uncoupling of enos and so it would make sense that one of the most vulnerable parts of the entire system rather than the liver or the heart would be yeah kidney failure renal failure, so I don't know, you know, there's a, As I come into previously, right?

03:34:43

It's like if you have a hammer looks like everything is an elf but it's just yeah, it's a it's effects are so apply tropics that you you begin to see that all of these things basically are connected to production of nitric oxide for instance vitamin D deficiency, so you were talking about vascular antioxidation and antioxidants right so the endothelium is richly populated with VDR receptors and vitamin D receptors big.

03:35:16

Ly act as the primary antioxidant which prevents the uncoupling of Enos. So basically if you like stops the degradation of the micro RNA, which allowed this synthase process to occur. So that that connects to to why it is that pre-existing vitamin D deficiency eventually results in the slack of bioavailable magic oxide.

03:35:48

So there are some studies done on. Basically umbilical chords like whovex treated with let's see treated with vitamin D and they were basically protected by vitamin D against superoxidation, so you could rescue endothelial nitric oxide if you had a pretreatment with the yes steroidal work well with them. Cowser trial basically the kind of.

03:36:26

End bioavailable component of vitamin D so these things tied together in a particular way vitamin D and nitric oxide which have kind of longing implicate vitamin D is now a well-recognized, you know prognostic indicator of poor outcome. I think it's really just an indicator that you have low nitric oxide by the bioavailability and likely pre-extent endocytosunction.

03:36:56

Yeah this is a really yes, I've learned an incredible amount today. I know I'm gonna I'm gonna shut up actually like it and we're gonna wait till our Sean's talk right because I'm super interested because his take is the causal arrow runs the other way, right? And I'm yeah a really interested to hear how that how that plays out is that's super cool.

03:37:17

Yeah. I mean, I would love to I shut up now. Yeah, no, I mean, I I was just I was just googling. I Shawn or and finding all sorts of astonishing things that he's been in the news. About which I won't mention tonight, but but people can Google if they want.

03:37:38

And so, I don't know exactly what to. I know what but it should be interesting, so I will.

03:37:53

Oh okay so so hey Dexter, what do you think about these like in terms of what these pre-workout like like our vassal dialers you can buy over the counter so there's like been posted and and like like there's a whole bunch of like nitrogen, you know, I guess nitric oxide boosters that that weight bodybuilders use do you yeah do you like any of those?

03:38:19

I don't take him because okay, um, well get showing the pandemic so. I just I really just couldn't comment. I don't I know you of course athletes take nitric oxide boosters just to boost the by their ability of nitric oxide specifically for yeah as you know, like vasodilation yeah, but one of the studies kind of been known for for quite a while but just if you increase the dietary intake of nitrates, they will be reduced to nitric oxide so a good dietary intake.

03:39:05

For the average person is is really all you need but there was a study done which was done with a concentrated beetroot goose which showed some performance increase. I believe it was in sprinters pretty sure it was but yeah, it was kind of like after some days of taking this concentrated feature juice which is in the end just the nitrates like it's just like increasing dietary nitrate intake they showed some yeah increased level of performance and it maybe actually one of the reasons why.

03:39:40

Me exercise has prophylactic effects against the viral infection because you are basically you are yeah if you like in training the release of these precursors from continuous storage, but yeah, I when it comes to stuff that athletes use they use so many strange things often just because companies have been able to make them sound scientific and expensive.

03:40:10

I just that really don't I yeah, I I don't know enough. To say so yeah, sorry okay so Carl's here. Carl if you want to talk for a little bit I I definitely need to give myself about 30 seconds to 60 seconds to recover so I'm just gonna meet myself.

03:40:36

I'm so did you advise guys? I still got my at some point you're not competition, but did you once say something?

03:40:54

Please. I know this one surprise you but I'm sick of the sound of my employees, please just.

03:41:03

Let me just invite everybody up. I hope somebody says yes. Invite yes.

03:41:16

Hi my name is Chris and thanks a lot. I am completely unqualified to comment on this discussion but I wanted to tell you how much I appreciate it and I especially wanted to commend you Dexter on the rigorous typography of your profile, it's really it's really beautifully laid out so I gotta say just as a retired graphic designer it's probably much good that's fun thank you just me too for my former yeah, well I sometimes still do graphics design but, Yeah, thank you so much if you're a graphic designer of a certain kind of band right you look at a profound you're like, ah this bothers me type outfit it's not right and yeah that's something that sort of never leads you alone to come from art school time, so thanks for noticing oh well, I mean, you're you're credential I'm really just been satisfied to.

03:42:15

Make decisions about what things look like but your profile is is much more impressive and and a wide range of interest and I just thought I'd comment that my own sort of amateur interest in neurophysics neurology [[consciousness|consciousness]], etc actually. I was cultivated in graphic design as I was. Obligated to have conversations about why we should do something why we should make certain choices and and you know, I used to laugh that being an art director is just being paid to be the most opinionated person in the room, but it was actually I was actually, I think the person who in the room who was the most interested in the sort of consequences of the subtleties the visual decisions, we were making had consequences and I was prepared to play with it so clubhouse has been wonderful in this regard.

03:43:17

I mean, I I've actually kind of shunned social media. I'm I'm not. You know, I'm not really all that conversant in a lot of the topics that are hot here, but I've been delighted to find so many highly highly credentialed conversations about neurology [[consciousness|consciousness]] the intelligence artificial and natural and I've been really quite inspired by the the clarity of.

03:43:50

Some of the language so that's that's that's what I got I can yeah I can really relate to what you're saying just say that kind of conversation about Sal's Club too not my speciality just like, you know, it takes years to really understand that sort of thing and I just yeah been working with people who you know know the subject much better than I do even though you know, maybe I had some yeah, I guess now I can say yeah.

03:44:24

I I know. These things fairly well and but yeah just to say that that discussion I wouldn't include in that category but um hundred percent yeah that's exactly the way that I might kind of inspiration for wanting to understand was unlike all the other kids at our school. I just seemed to be thinking so much more about like why why does this kind of like drops to position of things work so well and you know, whereas so many other all the, Yeah so many other of my contemporaries were just kind of do and either would have went is kind of hit or miss right they there was no particular process that they were could be explicit about if you like and it wasn't that I wanted some sort of rule set or system.

03:45:16

I just made many securus the first time I painted something I was like, I wasn't just interested to kind of duplicate what I was looking at. I wanted to understand light and I think that's yeah for anyone who is an artist or who's kind of played around with. Anything like that the sense an appreciation that gives you of the world kind of exquisite appreciation of the world at the level of perception and musicians.

03:45:43

I think experiences too and heard many musicians say it just like heightens your sense of all sorts of other things but yeah, that's what art did for me and it led to an eventual like wait a minute. I am really interested as much as I am in you know design and art and eventually film which is why I said most of my time creatively.

03:46:05

I'm interested in the same kind of understanding of just. How the world works how you know how does this all of this magic you know, which which which you know magic is kind of a romantic word but since since you know, we're both from my graphic design land let's throw that word around.

03:46:23

I became really curious about what is what is beneath it this rigorous and that isn't just sort of like talked about and sort of very metaphorical kind of terms of the kind of terms that you can hear an art critic use right which could mean almost anything. I wanted to know really yeah, there's so many.

03:46:45

Delays to the experience. I think that was the first fascination for me before I had any of these concepts or vocabulary I had this experience. In which I was just fascinated by. The the layering and the subtlety and how you know shifting one thing has a cascading effect and you know, this this looks better like that and and you know, just simple things like an art teacher telling me to look at my picture in a mirror and see it in reverse and how that changes things and then it was only later that I spent enough time with it and took on responsibilities and including the responsibility to converse.

03:47:29

Yeah, there was a. There were I'm sorry once again. I'm gonna mute for a minute. I have to take care of something. I'll be back in 30 seconds, okay, no worries take your time.

03:47:46

So have we heard from Hazel yet you want to talk.

03:47:57

Baby should wait for Chris to get back he's no problem. I'm I'm having on call function and I just have to deal with something of indeterminate time, so thanks sir thanks for listening and I'm complete.

03:48:18

Hazel, that would be okay if you want to speak. Oh yeah, um, thanks for inviting me. I am actually very interested to know more about vitamin D. I recently got checked got checked and my doctor found out that. I don't have enough vitamin D in my system, so she gave me like 50,000 units of of that and she answered this collide like.

03:48:58

Why because you know, it's covered. I live in New York City. I'm always endorsed. Recently. I've just been like forcing myself to go out there. I mean, I'm not a plant. I don't know just being humorous about this but I'd love to know more actually. I you know when you were explaining how it works.

03:49:20

I was like looking at it. I was like, oh my goodness, it has a lot to do with you know the heart and. You know, my my dad actually passed away because of a heart attack and. A stroke like three times so this is obviously like something that I have to be like very aware of so if you can just like, Operate on that and I'd be very grateful, thank you.

03:49:46

Okay just quickly and it's not really the subject of the room and definitely to underscore and not a doctor so it's yeah just these are kind of prompts for stuff that you might be interested in kind of looking into but definitely not medical advice and then kind and yeah I this is yeah just from research just related to some some some investigation I did into somewhat and skin covering and vascular health a while ago, but then, Yeah.

03:50:21

Code of 19 that's all became kind of yeah, this was just seemed like it was pressing to the syndrome so it just invoked this in terms the story around Bittman D is that it is common because you find common insufficiency of vitamin D in a whole range of different diseases, you know, it's associated with so many different syndromes but particularly with diseases of the vasculature and there have been as your study on.

03:50:56

Study upon study where it was thought that well, hey if you just put vitamin D back in then, you know, you're just gonna reverse the fact there is this deficiency and you know everything will basically just quote unquote return to normal the the system will you know, it's kind of like it's under some kind of arithmetic load that it can't kind of return from right it can't reach homeostasis because there's just this, you know, very low vitamin D levels just add between these supplements and you know this just like, Vast sway the health conditions should go away but this is actually the reason that so many people in the medical community were skeptical of this idea that vitamin D would have anything to do with coded prevention or a mediation of symptoms or even clinical treatment because vitamin D has failed time and time again, it's a failed and failed and failed and failed syndrome like young reliable diagnostic criteria vitamin D depletion, and then reliable failure of treatment putting, you know, vitamin, you know, Vitamin D supplementation, and so I personally opinion.
...
The experimental data suggests something which hmm which makes sense. I think and explains why between D is so good in a preventive role and but why it basically has this kind of failure to rescue, you know, all sorts of syndromes and again not medical advice and not qualified and just like a bunch of work.

03:52:43

I did with some people who are kind of virologists who are yeah far better qualified than I, But my my basic conclusion was this that it's important to maintain visibility supplementation or not supplementation vitamin D levels sunlight is best you obviously don't want to be exposed to too much UV but sunlight is best but also dietary supplementation is good it's basically when vitamin D reaches a state of depletion where it loses its antioxidant effect in this case.

03:53:26

Can be if you're talking about, you know, after sclerosis and cardiovascular disease and that kind of thing it's basically that you get chronic oxidative stress and once that occurs you get irreparable damage to the endothelial cells, you get endothelial cell necrosis and once that's happened putting vitamin D back won't help anything really any sort of antioxidant has don't have a limited effect so the important thing is to.

03:54:01

Just the maintain healthy levels that that's really the story and vitamin D in the vascular endothelium is as I mentioned kind of critical for defending endothelial nitric oxide production, which is important for just general vascular health for defending it against a superoxide oxidation and the kind of damage that I've been talking about and so the vitamin D deficiency that you see in class.

03:54:36

Decree in coveted it's a fairly reliable, you know, negative prognostic indicator doesn't mean that you can just like treat patients with vitamin D and they will you know, all will be well what that vitamin D deficiency is really telling you is that there is an increased likelihood of compromised vascular function and it doesn't mean that it is the case in your case, but it's just important, you know, Just to maintain healthy levels to prevent that yeah that oxygen of damage which over time over kind of life course is eventually very difficult to rescue so they go that's my unqualified opinion worth every penny you didn't have to pay for it so yeah just some things to look into and if you're interested but yeah just a triple underline.

03:55:35

I am not a physician but yeah just get some research on it. I think so much better. I really appreciate that and you know for me I am surrounded by doctors, you know, my closest friends are actually positions and right yeah, you know sometimes it's you know, not to.

03:56:00

Say anything negative, but I actually. Sometimes you know, some other people who actually didn't go to school have like a lot of knowledge so not I'm pretty aware that you know, some people that are actually don't have a diploma and medicine actually have a lot of knowledge so don't worry about it.

03:56:23

I mean, that's a double edge sold right there are people who yeah maybe haven't studied a particular aspect of physiology or disease and may have some useful things to say about it. I work with some people at the National Cancer Center. And who wanted the heads of labs there has he has just developed so many different therapies across so many different areas he's kind of fairly remarkable in that sense because you do tend to encounter a sort of hyper specialization not always but but quite often but just to say there are lots of people who don't have diplomas and also talk absolute nonsense, maybe very very dangerous, you know, people who have far too confident that they you know, that something is the answer to everything.

03:57:15

You know, and so I would just say yeah treat anything I said is literally some lunatic off the internet and if you do your own research and it concurs that's a good thing but um, yeah, I I definitely agree with you it's doctors often because you know, they are very often running on established knowledge and they are not necessarily reading the latest research nor should they because the latest research often turns out to be you know, then kind of walked back by something.

03:57:50

Could findings so they're using a kind of aggregate of information which is sort of known to be the case canonical knowledge which which has its pluses and minuses right they're very unlikely to kill you by you know, some crazy experimental treatment but they're also unlikely to be at the sort of forefront of an understanding of something so yeah, it's a double absorbed and so yeah, I've endeavored to get just give you sort of, you know sensible advice which is you know, fairly standard to the literature, but again, this is like my six on the line.

03:58:26

You know, not a physician so yeah just just say that but yeah cool thanks I'm glad you found interesting and you know hope it leads you somewhere to use I would like to say something about vitamin D, there's a paper you can you can look up it's called vitamin D and inflammation potential implications for the variative.

03:58:47

Copenhagen, it's a 2020 paper another paper you look up is vitamin D and inflammation in major depressive disorder, that's also 2020 paper on they're both on the PubMed. And there's there's a 2018 paper the anti-inflammatory effects of vitamin D and two more genesis. And and so the reason I point to those three papers is as you can look at them and and consider the role of vitamin D in reducing inflammation.

03:59:21

I just took quickly coming to the point of vitamin D use in. Inflammation it is restricted specifically in the upper respiratory infection where your. Sales started responding and you generate some cytokines and lead them in the actually chile tools that's how it will becomes anti-inflammatory the main point of this I think is the how determine the health so my research spins around this cardiac health and determine the sometimes it is really helpful in using the stress through various mechanism where once you.

04:00:16

Have generated stress so it activates specific pathway which we called l2 so that downstream helps capturing the Ross and and promoting some good genes who which helps us fighting against any any kind of stress and this is also in the the cardiac function how we supplement it with astronauts often shelled in challenge to it vitamin D.

04:00:51

6, they do have one loss and they are that the good supplement is vitamin D3 in the heart actually it helps pumping because one of the major element of carrier function is calcium and its supplementary and and soca if vitamin deficiency has been very prominent so you have to be regular with vitamin D supplements and of course this been found with covalent 19 that it helps really in upper respiratory.

04:01:26

Information, which is specifically we considered as. In the lungs when when the contracted with cognitive vitamin D place a very crucial road thanks so so just ah have a second just to be clear when you said um captures Ross would you summarize that as an antioxidant process?

04:01:52

Or directly it don't act as a roast cavender, however the wind d3 boils down and helps downstream expressing energy to pathway. I don't really know whether you've been familiar with how this process all works it break down through through a enzyme which is called the cytochrome cytochrome some enzyme number.

04:02:22

I am forgetting but cytochrome yeah like before 50 or so. We think some some variant of it and then it activates a couple of couple of rows preventing genes, which is mainly NRF2 and NRF2 is actually a very helpful gene reducing your cell. Large stress so that's our similar mechanism and we use vitamin D to some time reduced trace in the cells that's basically like pan special right that's not localized to any particular organ that's a systemic effect right absolutely absolutely okay that knows who mechanism will be done in D3, at least it's always been supplemented as given as supplement directly medicine effect in.

04:03:22

Mostly bone loss case, we came across we generate some kind of model to simulate, however vitamin did always add such as supplement. Yeah and also vitamin D has been implicated as a down regulator of the renal and terms of system as well and that's thought to play some part or at least a hypothesized to play.

04:03:50

I don't know whether you know, but there have been some studies which have observation studies they were predominantly out of Spain but there was one that was conducted somewhere else so one using one used basin. Degree metabolite so it used a calcified dial at high doses it was a study conductor and they had you know, an extraordinary results so claimed for high dosage administration and vitamin D like kind of mega dosage administration in yeah hospital in hospitalized and I think in I'm not sure it was incubation patients, but the theorized role there was basically yeah an anti.

04:04:41

-flammatory role, which was a hypothesis being a down regulation of the rest you do know anything about that. Not like I cannot play right now remember maybe it's morning and maybe if I really looking into but of course with MMD did she's very am for me I think crucial role in enthrallial like adiabaska and our modern system what we work is stem cell derived atomicides we extract and we expose them to different microgravity and then we realize the, That the the stress which has been marked and we try to chill with the couple of cross scavenger and with the supplement like vitamin E vitamin D and we really observe that vitamin D also very helpful in the like bringing back the stress down and bring a restoring the contractility functions, so maybe my work area spins around that so I don't really like cannot inside missing something so I cannot answer right now.

04:06:00

Until sorry about that. I don't know what I wanted to say welcome every second is I think it's that the correct ways to your name is um, would you I I've never heard of a gravitational biologist before but I feel like I should have could you tell me about your work?

04:06:19

I'm just so interested. Okay, so I'm currently used to some in Germany and we're working with German aerospace center. It's similar to NASA where Ms. Research Center people work with different kind of modal system and basically we our team is looking for [[gravity-as-information|microgravity]] and it's and it's usability what does it mean like we have to utilize the ISS or international speciation for some better cause and where we can very quickly as utilize for the production where we cannot.

04:07:05

Skip [[gravity-as-information|gravity]] when we do some science in the lab, so what we do, we simulate gravity by several devices on the ground, we have parabolic flight which goes and simulate. Gravity for couple of second and different other like satellites small satellite rockets, and and of course you have ISS for real and then how does this happens because in stem cells they they've been resource that when you grow [[cells-as-pattern-recognition-devices|stem cells]] on space basically if you look at the bioreactor it continuously spin, it keeps the the cells in a floating condition, which is free falling a free falling, it's means like you.

04:07:56

You go to a ride and I don't know what's like the big wheel, you know, then you when you come back you really feel that you are losing or you are you are your weight becomes 0 and you are falling down so so this is a kind of scenario where your.

04:08:16

Body doesn't act in the in the similar direction of gravity vector so that is the idea like if we consider cells on [[gravity-as-information|microgravity condition]], so we can produce a lot of cells compared to to ground, so these are the things which mostly me and my. Colleagues here we do so we do basically human biology to understand how we can simulate disease on on gravity condition in the zero, g or moon g or mass g then how it beneficial to to to the to the pharmaceutical here that the usability and second I would try to understand the biology being affected by gravity.

04:09:08

All by didn't take much time. Now, I I for me personally I I still would love to hear more but but it is anyone else have any questions about what they about. Gravitational biology.

04:09:29

We get a hand raise. I mean, bring this person up. Okay, so hi thanks for bringing me to this stage that's actually a very interesting enough like you are never heard of this before. I'm a neurologist. So I'm on the other side of the spectrum. I mean the clinical field.

04:09:48

So simple a couple of simple questions the first one is. What's your for the gravitational biology that you're studying. How much time of exposure to low gravity do you have by using these methods that you're around that you have at your hand? And then another question that must be it's probably very silly.

04:10:11

I just hope it doesn't sound inappropriate but how much money do you spend in these studies and who's funding it? Thank you. Hmm. Nice. The simulation studies did actually doesn't cost much. First of all that this simulations are ground waste where we create a rotation device. You can very quickly look maybe sometimes RPM random positioning machine.

04:10:37

So these are ground-based facilities which cost very nominal and your exposure time is on your hand depending on your expo experiments. Since it's a rotation so mostly the the exposure time limits to continuous exposure time limits for for our study or when we start when we expose the stem cell derived cardiomyocytes.

04:11:04

And the limits to forty hours the continuous exposure because since they are rotating and they are cells also generate some kind of gases and that's gases over the time accumulate and become very dangerous to the to the since the ones the cells produce the gas and the gas is bubble that bubble heats continuously so that brings another aspect of of physiological challenge than the gravity.

04:11:34

So before like because we studied 24 hour 48 hours. 72 hour. So then we realized okay 40 hours is very limited limiting time and pushing it to 72 hour we observe some some at a man's other bubble rated stress and scratch. So that that may be answered for the ground simulation and then we have parabolic light where you have only 20 seconds exposure, but that will be repeating for for 30 times.

04:12:08

So hyperbarity micro gravity, then hyper gravity is basically crazy flight which goes up and, Perform some maneuver where you generate hyperbarability then [[gravity-as-information|micro gravity]], but those are very limited like 20 second so which is very tricky to design your essay and perform something which you want to achieve during that time then you have then you have rockets sounding rocket which goes and stays up to 15 seconds to some 15 minute 5 minute to 15 minute and they are also you have to very careful design some experiment and perform and then, You send some satellite which is sometimes come back sometimes and then you design your study accordingly what you want to get out from the experiment or you want to retry sample for some downstream study like gene expression some [[protein-synthesis|protein]] look out or you send it to ISS through the so you mostly so use now specs is ramping up it's a exploit so all the the institute are line up for the species and then it usually comes in sometimes two months three months of.

04:13:24

Our day drop it simply without astronauts traveling back this is how the the experiments goes in a line so ground base and parabolic flight then then rocket science rocket sounding rocket then then satellite and then ISS and also the money also goes in the same proposal for ground-breast study which do not much investment users small instrument and you create moon or marsh gravity and then you expose yourself it's very dominant.

04:13:56

The parabolic light like little bit expensive compared to ground which is like because of logistic because you have to support your experiment with some hardware so and then then of course sounding rocket another little bit high and satellite, of course, you have to. Budget for the maintenance for the radio team so and ISS yes that's also another big chunk of money goes there when you design some experiment because of mostly because of hardware limitations backups all these things we have to keep in plan because often space experiments a fun win challenge to with lot of failures and this is not ground that you will repeat again, so we have to send with some backups that's how also money money trends.

04:14:48

And you modify ask you I hope I'm not taking too much of everyone's time so what are you trying to measure here you trying to measure muscle contractility or are you trying to measure sales survival functional efficiency, what are your outcome measures for this please that is a good video because the hazard last question about vitamin D deficiency, that's how I ended up here, so we when we expose the cells these are the very unique.

04:15:23

Kind of. Cells and symptoms cell derived we came across this this [[cells-as-pattern-recognition-devices|heart cells]] it's they've been when we expose we find a whole parameter. I am like movement change we find [[mitochondria|mitochondrial changes]], we find stress huge phase being on here, we did some all the parameter basically proteomics transcriptomics, then we saw some imaging and expressions there are lot of.

04:15:58

Things actually change calciums so this the basic function is if you stay long in floating condition or free flowing condition, so your heart needs to behave different way and we have to generate that signal just by quick example if I say this imagine the fees the fees is actually swimming in the river and you see they are saved changes why it is like that and how it cope with beyonds because that weight is less and they they do not have to pump.

04:16:33

Blood to their tail and that's how their tail is the the more compared to thinner compared to their belly but as case of human when we when the heart pumps blood so that we cope up with our leg when we are in ground the moment we go to space and try to offload our heart doesn't respond that way our heart becomes very slowly they try to pump blood and then often since astronaut fly they.

04:17:08

They they they develop a syndrome called chicken leg so that leg become thin because the pressure is no more they are and the blood supply become also no may not because they don't use it they don't use it neither there's something pulling factor and [[gravity-as-information|gravity]]. I have then this is why we have to understand why this and how we can help by understanding the hard physiology how we can if we are planning to.
...
And how they can go for with the aged heart. Mmm. I'm not taking much time now please so I kind of can I just say so I saw the reason I come to clubhouse and the reason I create groups like this is because I want to hear from the expert so if if if George who's a neurologist and Abby Saka who is a gravitational biologist want to spend the next hour asking each other questions.

04:18:40

I am fine with that if anyone else wants to ask them questions. I'm fine with that, so I'm just going to meet myself and listen. For my amazing my case is yes mica. Mike I guess Mike yeah, thanks Mike it's very hard to ask questions when you know, very little.

04:18:58

Objects obviously I can now I can ask open questions and let him talk because he sounds like a very interesting guy, but I think I I think if anyone has a more directed question I was thinking initially maybe this this group is studying this thinking about future colonizations of the outer space and that sounds very interesting but I I have read a lot about space and physiology and I I have learned before about muscle and bone did.

04:19:33

Degeneration and all these things but I don't think I I ever had anything about heart muscle so that's really interesting and I think so has a question.

04:19:50

Now that was it yeah thank you that's really interesting. I want I hope one day someone does the same with nerve cells with neurons that'll be very true they do they do because when the fluids sleep the the fruits sit throughout the the head it creates a tension in and the brain and it actually pushes the brain and it tried to to corner the brain the the fluid shift happens in the space and where the sensory been lost so people are.

04:20:25

Really doing lot of. CNA study and how they can help because I think I can remember which group I think rightly from amps and here in German also they are doing a professor professional and for getting his name professor Bunga probably they they have a good research team on the on the neural activities and how I think I'm if you don't mind me interrupting.

04:20:57

I think you would be very interesting to see what business to microtubule train. Ing sport and not the reason why I'm interested in this is because there are some fears because we don't know what [[consciousness|consciousness]] is and the sense of [[gh-a0206z|self]] is and there's a lot of people thinking that [[microtubules|microtubular function]] is key in this type of fun yeah function in the nerve cells so as wondering whether and I'll probably look it up whether this is something that might be pointing that in space or [[consciousness|consciousness]] has a different way of working do we get more biject or more sharp when we are in space and what sort of effects that would have enough cell transport yeah.

04:21:37

Yeah, I think this is a very interesting area forking. I think I'm sure pretty sure people are working on it, they they're pretty. I'm pretty sure it's. Some. And even when when we read reports from people who came back from space and they started having having different thoughts and maybe seeing things that they don't see not.

04:22:02

I'm not talking about hallucinations, but facing reality on a different way. Oh God, he might be sorry.

04:22:12

Cuz I'm accident on my part. Oh, no, that's okay. Excuse me. But that's fine. I don't I don't like the sound of my voice that much show up. I like when people talk with me but I think I wonder whether this is what causing the astronauts and people who work in space you have this sort of thoughts when they come back and they become very introspective.

04:22:33

Yes, yes, that means that is a club. I think a couple of. Nineties come from from the from the NASA Ames and who do real human astronauts behavior study and I think you guys probably know this twin study where Scott and Mark been thoroughly studied for the closely one year they've been in space and there are a lot of.

04:23:02

Skin sensories, they found been changed in Scott and they that was not been even published so it was been a good discussion in in class as well. I think you should follow Jim I think he is in the some some other club though their team is studying the the the entire.

04:23:25

Homemix and the physiology that you can get some good insight. I'm sure this is no I'm for me why this because when astronaut comes back they develop a syndrome called orthostatic endurance, which is like if it's simple terms I explain like if you are sitting for a while and you suddenly try to stand up you fall down because your [[cells-as-pattern-recognition-devices|heart]] doesn't really understand that whether how when we stand up your hat is to produce more place.

04:24:00

To pump blood to to brain and to your leg and that time your heart get confused and it doesn't. Doesn't pump that way the way you expect it. So astronauts are fall down. And it's a common feature in some of the neurological conditions like garnets because I was able to develop autonomicing sufficiency, that's why we call it.

04:24:26

Yes, he has that's why I say this and there were exactly we are trying to address at one part at least to boost the heart and, Make it somewhere we can able to address and and exactly their the the neural thing involved which not my area research. Sounds like [[gravity-as-information|artificial gravity]] is going to be really important for long distance travel.

04:24:56

Yes, they are creating their I think Boeing or Boeing is constructing one circular simulator, which will be continuously rotating and creating a gravity to help with the astronauts health. Yeah, that's the that's the right news you have.

04:25:23

Okay. I'm I said done if you anyone. Um, so I know I was I was just started. So Jen, welcome to the room. Did you want to tell us a little bit about what you do? Oh, hey, sorry about that by the way. Well right now I'm just a student and for electrical engineering and I just kind of do side projects for research like with other friends in different departments, you know.

04:25:51

And mostly just kind of like we're reading their paper and kind of rewriting it sometimes. So I kind of just jump into a random fields not really but yeah, I kind of switched over from the medical side. Which I did for my first degree and then I ended up deciding that kind of hate that so now I'm trying out electrical engineering, which is why I'm in this group.

04:26:21

Because it kind of coincides with me each other. I think. Yeah, that's that's a that's exactly right. So so you've got the you've got the medical side of things and then electrical engineering is you know at the point where we're connecting devices to our biology so that we can we can try to read and write to the biology but you're but you want to be an electrical engineering side of things that's very interesting.

04:26:46

Yeah, I just kind of want to. Think of honestly and kind of be in my own world instead of working with the people to be honest and well, I actually live in Oklahoma where Boeing is and so we've got Boeing Tinker Air Force. Yeah, quite a few programs around here for specifically that and what you guys were talking about as well because yeah, there's quite a few electrical and engineers around here this.

04:27:19

So, I'm sorry, keep going. No, I'm good. Thank you. I was gonna say can you speak to specific programs that that are happening around that happening or around the there are happening anywhere that's doing about in terms of combining electrical engineering with with biology with it with the brain or with the heart.

04:27:44

Just in Oklahoma, or just in general. I thought to first ask you about Oklahoma, but if but if you want to mention others is fine. Well, Oklahoma. He has a stepped up their game and with a robotic surgery.

04:28:03

Usually to be honest because of the fact that I was in the Farmersville pool side of things more like so I didn't really get to see more of the biological terms where it would with, uh, With with the networking that I've done. I'm kind of like I feel like a newborn which is kind of why I've been jumping around in these groups to kind of actually figure out a way through this with trying to work on different projects and see which one I want to actually work on specifically because we also have like [[brain-machine-interface|prosthetics]] as a huge thing over here the way it's like this one company that kind of done it for like decades or so.

04:28:56

It's asking feel free to mention these companies by the way. I'll write them down and clear my list later. I'm going to share um, I can tell you later. I'm not going alright. I kind of get a really flustered when I talk to you know, a lot of people.

04:29:12

The problems I'm sorry, maybe real. Maybe we have to run. That you've explained help us understanding your part of science and technology is a biggest part which I think slowly getting infused to to biology and nano sensors even if I think the way which we are seeing also you must been hard about [[neuralink|neural links]], right?

04:29:46

And then what did you say with that last part numeral links from your links? Yes, so that's happening in the implantation in the organ label but in cellular. Label also we are looking for some nano chips which can go into single cells and give us some output. So this is been also in a lot of already one been published but that's with the with the group of cells or we call it organoids, but we are trying to to to make some nano materials, which.

04:30:25

Can be can be good to the cell and then outside we can read their signals. So maybe we need engineering team which and they're who have knowledge about signal readouts out there and these are the facts also we are currently looking at at in a large scale so how you can do the future studies.

04:30:51

As really interesting. I am I actually have to read that in the next couple days and if you don't mind I would love to discuss it with you or you know within the group or whatever appreciate that. Thank you. Thanks. Jen, can you explain alternating current to me? I'm not kidding.

04:31:16

This is just like, To say something in any language. I literally go blank. I'm not lying. I couldn't even sit think of hello or get everyone. Everyone I meet who has any kind of qualified relationship to electricity. I ask them to explain alternating current to me, you know much like, You know in a certain type of restaurant there's a certain dish you want to ask for to find out how they do and I've actually I have not yet met anyone who really felt confident.

04:31:52

That they could explain it the most qualified people really as ignorant because I'm literally looking it up right now. Not my field but as I understand it ultimately ultimately current is to do with the efficiency that you achieve by switching. And with direct current there's an attenuation a loss over time and the basic thing with alternating current is the phase prevents the yeah, the loss of transmission has understand it.

04:32:25

Actually now I think about it. I do have a book that I haven't finished. I was actually that I had a graph about that. Oh as you sent me just left the room I just posted two studies to my profile which explained the importance of vitamin D receptors in the heart how it down regulates the arena and tense instances them and also if you knock out vitamin D receptors in the vascular endothelium, you get a drop in nitric oxide so I thought that would be useful to astronauts but I guess they'll have to get by.

04:33:06

You guys like to check on my gig thanks a lot. Michael thanks very much for the informality my ability to come.

04:33:20

Thanks Chris so you know some right on. Hey Dexter did you say that was on your Twitter? I'm like looking on your profile here Twitter, so I can get that link. I.

04:33:32

My profile. I've actually posted this study titles for both of those things. You should find it. Okay. I got it. I'm gonna I'm gonna write it down or maybe I'll screenshot.

04:33:50

Yeah, it's just the these things are so complex and there are so many different areas of research that you meet people who are often quite specialized in the field and there's just so much to know that as a I think that several people have said it's surprising sometimes what some people don't know it was just too much to know and also to figure out what's relevant to what kind of tricky Jen how are you doing on AC current?

04:34:19

I just I have. Yeah, just a vacant tuition that it's to do with phase and efficiency so that you don't get lost when you're transmitting energy of a long distances. Think that's the big thing about ACDC, but you may know better. I say you might be completely correct and it seems like with also it kind of does with the pulsating in the alternating yes and the current of that but um.

04:34:55

Yeah now I have learned that I forgot everything at the beginning, you know, all your general studies. I added. I'm actually having to start over entirely in the mathematics. You got quiet you became quiet. Oh, sorry. I don't know what happened there. But oh gosh, I lost my train of thought.

04:35:22

So something about starting over in mathematics and then yeah, it was I could think I'm just having a pork connection that's showing me that. So if you guys want to go ahead and talk. Oh. I think it's just my room. It's just like that.

04:35:45

Alright, well, I'm I'm getting pretty tired over here. I I guess I can leave the room and to you folks if you want or or I don't know what you want to do, but. Actually likewise yeah, I've got stuff by I'd like to get on with but um, I just want to say like it's just so interesting to me that you and I both sat down yeah as kind of expertise in different subject areas basically the same time and looked at basically the same thing and that's pretty cool.

04:36:19

It's really interesting to hear your perspective on that and especially to yeah, I mean, I think it's so great. It's a general phenomena of the pandemic that anyone. Who kind of yeah so many people wanted to help right and so it's just so interesting that you investigated these things and engage with them and it'll be yeah, especially interesting to hear a short noise perspective on it and just say do you have time for that yet course at school to be decided?

04:36:54

I will. I haven't heard back yet. So I'll I'll post on Twitter or I don't know. I'll probably talk to you before that. I guess if you're on clubhouse again. Yeah, that'll be great cool. Yeah, I'm sure okay or anyway thanks for the roof and yeah. I'll be on my way.

04:37:11

Thanks to everyone and yeah just to say super cool that you do that and really interesting and, Perspective on it and yeah to empty a chance could be super cold all righty catch you catch you guys later, okay. I'm just gonna say good night everybody. I think well we're probably close the room.

04:37:31

And all right goodnight, thank you.

## Source Provenance

- Source file: `original archive b0314y.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/original archive b0314y.md
