...
Title: Stages of Brain Development

## Concept Link Map

This transcript moves between [neuroscience](neuroscience), [concepts](concepts), [brainwave entrainment](brainwave-entrainment), and the speaker's broader [Self-Aware Networks](self-aware-networks) vocabulary. Its recurring technical terms include [brainwaves](brainwaves), [neural oscillations](neural-oscillations), [oscillators](oscillators), [oscillatory synchrony](oscillatory-synchrony), [oscillatory neural coupling](oscillatory-neural-coupling), and [traveling waves](traveling-waves).

The neuroscience discussion repeatedly names the [thalamus](thalamus), [cortex](cortex), [visual cortex](visual-cortex), [neurotransmitters](neurotransmitters), [acetylcholine](acetylcholine), [dopamine](dopamine), [action potentials](action-potential), and [synaptic connections](synaptic-connections). It also frames learning and perception through [Hebbian learning](hebbian-learning), [predictive coding](predictive-coding), the [self](gh-a0206z), and the general idea of an [oscillator](oscillator).
...
So, if you want to read more about fireflies and syncing, I read the book *Sync*, and that taught me so much about what it means when neurons act as [oscillators](oscillators). The whole brain is oscillating in a chaotic oscillation, and the book *Sync* helped me understand the computations of oscillations that informed the [self](gh-a0206z)-oriented book.
...
- Source file: `b0077y.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0077y.md
