a0104z
(graph, oscillat, field, decoherence, boson, observer, flavin, [atp](atp.md), dissipation) The idea of a bad point is that it has no area, it doesn't oscillate, it doesn't increase or decrease in charge
...
It suggests that [self aware networks](gh-a0001z.md) are fundamental to spacetime, not that we can't be dissipated, but that overtime we are natural to emerge from it, from the properties of vortices, oscillations, and neural network structures in physics. But also space itself which has been described as a harmonic oscillator, although I consider it to contain chaotic oscillators and resonators and all possible manner of oscillation, and that even chaotic dissipated space is only chaotic within certain boundaries that allow it to be predictable at some other scale
...
The idea of the past and future being co-created at the same time provides a new meaning to the [observer effect](observer-effect.md) and to spooky action at a distance
...
[atp](atp.md) process involves a flavor protein
magnetic field might interupt or accelerate the [atp](atp.md) process
might they increase [atp](atp.md) update
...
the neurotransmitters can cause vasoconstriction, but perhaps they are inducing neurons to fire faster, which is increasing [atp](atp.md) uptake, which is
...
- Original source file: `a0104z ctpr.txt` in `github.com/v5ma/selfawarenetworks`
- First public GitHub upload: 8 Jun 2022, commit `37da575ba33f85cef4239295be161066d8d39f4c` (`Add files via upload`)
- Rename event: `a0104z ctpr.txt` was renamed to `a0104z.md` on 10 Jun 2022, commit `f1d508911c0096e04bfb8b9717fe8ab5379db8a8`
- Latest source modification in extracted lineage: 21 Oct 2024, commit `4fe1cda99703a10b01eac1c0457c0b5240f0c97f`
- Current source commit: `d1c26a6fbf273695185a4036411215f53209eb71`
- Current blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0104z.md
