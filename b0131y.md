...
And on a macroscape on a mesoscale, the idea that the Temporal Parietal Junction would activate as a representation of the fact that you have stuff activating at the micro level in the touch area (somatosensory cortex), hearing area (auditory cortex), and the sight area (visual cortex) all at the same time.

So, you have simultaneous activity from multiple microscopic areas in the brain, multiple mesoscopic areas of the brain become activity, and thanks to pyramidal cells, the rich club network, and default mode network, and the thalamic connections the meso brain regions are activate major junctions like the Temporal Parietal Junction, enabling whole brain activity, or synchronized conscious attention.
