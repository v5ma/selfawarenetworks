...
the frequency of the transmission from one person's voice to another has an entrainment value, like listening to [[brainwave-entrainment|brainwave entrainment]], binaural beats, isochronic beats
...
- Original GitHub source: `a0090z ctpr.txt` in `github.com/v5ma/selfawarenetworks`, first uploaded on 2022-06-08 in commit `37da575ba33f85cef4239295be161066d8d39f4c`.
- Source rename: `a0090z ctpr.txt` was renamed to `a0090z.md` on 2022-06-10 in commit `b60809bcb4fd84cc1a3a86fbbbb8da11a78ee0d1`.
- Current source file: `a0090z.md` in `github.com/v5ma/selfawarenetworks` at commit `d1c26a6fbf273695185a4036411215f53209eb71`.
- Current blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0090z.md
