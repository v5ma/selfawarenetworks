b0328y (time code (Open AI Whisper transcription))
...
[02:46.000 --> 03:05.000]  So I think that the protein folding situation with AlphaGo, with using a [[deep-learning-neural-networks|neural network]] to discover, to basically create a map between gene sequences and the [[three-dimensional-protein-structures|3D shapes]] that can be produced by proteins is a big step forward.
[03:05.000 --> 03:21.000]  Obviously that has to continue to where we can understand what [[cellular-communication-graph-neural-network|cellular communication]] sequences at the genetic level can lead to the formation of [[3d-protein-receptor|specific receptor shapes]], specific cell types.
...
[03:47.000 --> 04:04.000]  what are all the messages that [[cellular-communication-graph-neural-network|cells need to communicate]] to go from basically taking the existing genetic code and building a person out of that code.
[04:04.000 --> 04:19.000]  Because all of that has to do with basically unlocking these [[cell-as-chemical-neural-network|cellular functions]] through the communication between cells.
...
[04:37.000 --> 04:49.000]  There are [[protein-synthesis|proteins]] that are being identified that link together cancer and neurodegenerative diseases and vascular diseases.
[04:49.000 --> 05:18.000]  There could be some really profound discoveries ahead of us in the near term by using [[deep-learning-neural-networks|neural networks]] to accelerate research in biology so that the computer can look for basically patterns in a way that is just sort of tireless compared to,
...
[05:53.000 --> 06:17.000]  And, you know, there's, there is, and the point of what I'm saying is like, yeah, so researchers identified this, but we can, but this took a long time and when we are using [[deep-learning-neural-networks|neural networks]] to help us identify proteins that are sort of broadly involved in a lot of different illnesses,
[06:17.000 --> 06:34.000]  that's like the search for new treatments and new targets for therapy is being accelerated by [[artificial-intelligence|computers]] and by advances in technology.
...
[07:11.000 --> 07:29.000]  And I'm thinking it's not necessarily mutually exclusive with what you're talking about. But if you have stressors from this sort of low grade infection, or call it microbiome, dysbiosis if you want, whichever, I don't know,
[07:29.000 --> 07:55.000]  that it could cause stress on the cells and, you know, cause different malfunctions. And I don't know what you think of the growing literature on on L form bacteria for one thing, or there's some research on both bacteria and fungi in the [[brain-as-memory-prediction-machine|brain]] of some of these conditions.
[07:55.000 --> 08:10.000]  Anyway, just some thoughts.
[08:10.000 --> 08:39.000]  Let me think. Well, I think that in terms of causes, I think that that's right on target that basically anything that can get in there into the brain to stress out our [[cell-as-chemical-neural-network|cells]] might cause malfunctions, right?
[08:39.000 --> 08:54.000]  So, so we could be talking about bacteria or fungi, or we could be talking about just [[immune-self-nonself-analogy|inflammation]] resulting from a virus resulting from physical injury resulting from.
...
[11:12.000 --> 11:22.000]  So they could more talk about the [[cell-as-chemical-neural-network|cellular scientific]] level of that. But for myself, I am, I'm more of a know more of the care management of a holistic approach.
...
[13:43.000 --> 14:02.000]  His name is Carl Morton, M-O-R-T-E-N. And he's having a collaboration now with this laboratory in Utah that's developed a an improved method of culturing L form bacteria.
...
[15:27.000 --> 15:47.000]  Okay, so yeah, so that's, I think that's where I'm sort of optimistic is that we can accelerate the work of studying the functions and misfunctions of cells with [[deep-learning-neural-networks|neural networks]].
...
[16:31.000 --> 16:48.000]  And the final stage is where the inflammation kind of takes over. And there's another drug that, but he's also interested in using those, I guess they call them organoids or something, where you make a little [[brain-as-memory-prediction-machine|brain]].
...
[17:35.000 --> 18:00.000]  Well, so is the thought of how the fungi is sort of causing a disruption of the cell, do you think that's linked directly with the misfolded proteins, like the [[alpha-synuclein-synaptic-silencing|alpha-synuclein]], do you think?
...
[19:58.000 --> 20:16.000]  And so he came up with this comprehensive approach and he's published on it. And he's doing another trial because he had trouble with the IRB because they didn't want to do a study that had multiple interventions.
...
[20:44.000 --> 21:02.000]  Yeah, I mean, I so I mean, I just started really digging into I was looking at I was I was looking at the brain in terms of trying to understand how how [[long-term-potentiation|LTP]] and [[long-term-depression|LTD]], you know, long term memory and and forgetting
[21:02.000 --> 21:23.000]  like work in a very precise way and and that sort of like led me to like looking at dementia and Alzheimer's and then and now Parkinson's and a lot of and now generally speaking neurodegenerative disorders and their causes and like the whole chain and the [[sync-and-memory|link]] and so like,
...
[21:39.000 --> 21:58.000]  misfolded proteins and with the [[3d-protein-receptor|receptors]] on the cells, malfunctioning and with the the the, you know, with neurons dying, the like, like the a neurons [[dopamine|dopamine]] neurons dying in certain in very specific places in the brain.
[21:58.000 --> 22:16.000]  And then and then, you know, there's like new research that that says that speculates that the reason DBS works is because it's it's there's a there's like a [[brainwave-entrainment|brainwave entrainment]] effect happening from the DBS machine and certain frequencies.
...
[22:41.000 --> 22:54.000]  biology on the on the, you know, to the tissue, it's leading to it's it's like a it's like a it's like a [[3d-protein-receptor|receptor]] disease, it's that's, you know, it's also killing neurons.
[22:54.000 --> 23:00.000]  And there's like all these different points of like, you know, it started with the misfolded protein and now the now the cells not [[action-potential|firing]] correctly.
...
[23:13.000 --> 23:24.000]  And they're not able to move their hands and arms the way they used to move them or, you know, in the case of dementia, they're they're not all they're not all there their [[memory-consolidation|memory]] is not all there.
...
[23:43.000 --> 24:02.000]  you know, becoming basically protein deposits like like like amyloid beta protein deposits right and like and where it's happening it's like it's like which which [[protein-synthesis|proteins]] are and where they're which part of the brain is being affected.
[24:02.000 --> 24:20.000]  And like why is this part of the brain being affected but then that's now like contributing to [[cellular-communication-graph-neural-network|cellular miscommunication]] or or or specifically like timing issues and the firing of neurons that is treated with things like DBS and and also they there there's
...
[24:36.000 --> 24:50.000]  entrainment where you're getting those neurons sort of like fire in the right [[neuronal-sequences-population-bursts|sequence timing sequence]] again. And that stores some functionality to the patient that they that they lost at least temporarily.
[24:50.000 --> 25:10.000]  And so I'm sort of like really interested in and in John Leaf's work, you know, he wrote the book the secret language of cells, because he sort of like says well let's move move the focus on biology to basically the [[cellular-communication-graph-neural-network|communication between neurons]] and and
[25:10.000 --> 25:30.000]  I'm sorry the communication between cells, not neurons, but any cells. Because there is sort of like that's where like maybe the point of study to where we can we can we can bring in the the people from from from the [[self-aware-neural-network|artificial neural]]
[25:30.000 --> 25:46.000]  [[deep-learning-neural-networks|network side]] of things that the computer engineers to sort of like do this biology work to to accelerate it by having a computer look for the things that we used to have neuroscientists and biologists looking for.
...
[26:01.000 --> 26:16.000]  And it needs to keep keep continuing and that's sort of like what I wanted to sort of like maybe start a conversation around. So thanks for thanks for coming Joyce. And everybody else.
...
[28:49.000 --> 29:10.000]  I think it was, I think it may have been ultrasound or how [[soliton-mechanical-waves|mechanical vibrations]] could basically cause nuclear deformations or basically they can impact the [[cell-as-chemical-neural-network|nucleus of a cell]].
...
[29:46.000 --> 29:58.000]  Maybe it creates a new protein and a new [[3d-protein-receptor|cell receptor]], or maybe it misfolds a protein, so we'll find out what that is.
...
[30:11.000 --> 30:35.000]  And basically we can say that, you know, we can start to describe, okay, well, now there's a similar pattern between the emerging from the cell if you stimulate it with signals from the fungus or signals from ultrasound or signals from some [[body-as-chemical-neural-network|chemical]].
[30:35.000 --> 30:45.000]  And that causes the [[cell-as-chemical-neural-network|cell]] to exhibit the same behavior because in some way, on the tissue level, there's an isomorphism between these different signals.
...
[31:17.000 --> 31:41.000]  like the way they're configuring, you know, T cells with immunotherapy to basically the T cell identifies the [[cells-as-pattern-recognition-devices|cells that are problematic]] and then it transmits the particular message that the [[deep-learning-neural-networks|deep learning neural networks]] have identified that will trigger the cell to behave in the way we want the cell to behave in order to cure the illness.
...
[31:59.000 --> 32:15.000]  but also compare and contrast to find out which way of interacting with the [[cell-as-chemical-neural-network|cell]] is going to be the most fruitful for the outcome that we want, for the outcome in terms of like either telling this, either instructing the cell to exhibit the behavior that we want,
[32:15.000 --> 32:39.000]  or to identify and destroy cells that are diseased beyond the point of fixing them if that's the approach that the doctor wants to go through for treatment.
...
[33:23.000 --> 33:33.000]  There's a kind of [[gh-b0049y|summary]] view of it because he talks about, you know, blood sugar, insulin is a big factor.
...
[37:18.000 --> 37:27.000]  Nice. Yeah, I'm interested. You said the name of a research group just now, and I was going to write it down, but I was...
...
[39:37.000 --> 39:42.000]  And so that's what led me eventually to have to go this totally different [[choice|route]]
...
[41:03.000 --> 41:07.000]  even though other people verified what he found.
...
[42:45.000 --> 42:53.000]  was to actually just have it like on the [[eeg-biofeedback-self-reflective-loop|activity tracker]] while you were eating
...
[45:41.000 --> 45:48.000]  and several meta-analyses showing that resting heart rate elevation is associated
...
[46:32.000 --> 46:40.000]  And if I could share some other ideas, it's any kind of [[sensor-transmitter|sensor]] that you can put into a watch
[46:40.000 --> 46:50.000]  that you can use to combine with the heart rate data to look for [[memory-prediction-framework|correlations]]
[46:50.000 --> 47:01.000]  that basically have the computer create a [[multimodal-biosensor-fusion|log of observations]] that might have medical value.
...
[47:21.000 --> 47:33.000]  And you actually said something very interesting one day that, see, I am using an [[eeg|EEG]] headband also, oftentimes during my meals.
...
[48:19.000 --> 48:27.000]  So we always have [[eeg-frequency-bands|delta and theta waves]] happening, but if you have a predominance of delta and theta,
...
[49:43.000 --> 49:57.000]  I really found so I did a lot of back in between 2012 and 2014. I did a lot of work with [[eeg|EEG]] and a lot of different experiments actually.
[49:57.000 --> 50:09.000]  And I think of it as if you do [[neurofeedback|neurofeedback]], if you just sort of like find a way to either visualize or listen to your own brain signals
...
[50:34.000 --> 50:45.000]  Like an actor studying their own face in the mirror has sort of become more aware of how what they're doing on the inside in their brain
...
[55:51.000 --> 55:58.000]  And I don't know if he knows about this other protocol that I did over the years that a number of people have done.
...
[59:20.000 --> 59:28.000]  My understanding of this is a little bit limited, but if you have a deposit of some [[body-as-chemical-neural-network|chemical gradient]],
...
[01:00:10.000 --> 01:00:20.000]  Sort of like emerging research and emerging mysteries around how [[cellular-memory|cell behavior]] is affected by a chemical gradient
[01:00:20.000 --> 01:00:28.000]  and how chemical gradients are sort of important for [[cellular-communication-graph-neural-network|cells to be able to communicate]] with other cells
...
[01:01:57.000 --> 01:02:01.000]  Yeah, the power of [[evolutionary-mechanisms|evolution]].
...
- Source file: `original archived b0328ytimecode.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/original archived b0328ytimecode.md
