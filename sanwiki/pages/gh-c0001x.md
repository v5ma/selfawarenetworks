# archived out of date note: Archived out of date note: formerly another version of the table of contents
...
[[gh-a0001z|Self Aware Networks]] Book Overview: Cycle 1, 2, 3
...
[[action-potential|Action Potential]], Bifurcation,
...
[[path-integral-formulation|Path Integral Formulation]] for LTD, LTP,
...
* bad points & exceptional points: * bad points: spacetime has no real area in [[gh-b0049y|summary]], but rather area is relative to time  * exceptional points: time dilation, and gravity, the surface area of a sphere like the earth represents and expansion of the number of possible directions that a particle can randomly travel towards, increasing the changes that it travels towards an exceptional point

Solitons: Neurons warping space * Neurons electric field * Neurons magnetic field * Neurons mechanical waves * Neurons chemical waves 
...
The concept of Brain Rendering Computer Graphics for Neuroscience: How neural correlations could render reality an examination of computer rendering, neural rendering, [[3d-semantic-segmentation|3D semantic segmentation]] & more Volumetric Video -> Virtual Reality - 3D Object Recognition -> 3D Semantic 
...
the Measurement Problem aka the [[observer-effect|Observer Effect]]
...
Cycle [[gh-a0206z|Self]] Aware: Hofstadter: Why I'm looking for feedback loops connecting the oscillating sensor-transmitter arrays. A Strange Loop by Douglas Hofstadter
...
[[gh-map-intro-fractal|Fractals]] : [[gh-map-intro-fractal|Fractals]] in Medical Imaging: Functionald Isomorphisms at Multiple Scales
...
[[neo-mind-cycle|Neo Mind Cycle]] in 2012-2014 the scope

2012 Dedicated my life to solving how to build [[neural-lace|Neural Lace]] or Nere Gear first, then [[artificial-cortex|Artificial Cortex]], then Artificial Brains, this book represents a small [[gh-b0049y|summary]] of the knowledge of I have gained since then

A special kind of hard drive

3. [[neo-mind-cycle|Neo Mind Cycle]]: Nerve Gear the ultimate Brain Computer Interface
...
Cycle 3: Thresholds of Artificial Neurology & Six Axis Oscillatory 
...
2. From 2D classification to [[3d-semantic-segmentation|3D Semantic Segmentation]], including the 
object recognition of which points in space belong to which semantic classification

3. Pointnet ++ and [[3d-semantic-segmentation|3D Semantic Segmentation]]
...
- Source file: `c0001x.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/c0001x.md
