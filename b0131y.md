...
So the key junctions between the sensory input areas like the temporal parietal cortex. So, a temporal pareital junction and other key junctions would plausible become more active. As a result of the bottom up influence of coordinated activity across different regions. The idea, is that a higher level is going to light up, when there's a, coincident pattern, at a lower level?

09:15

And on a macroscape on a mesoscale, the ideas that the Temporal Parietal Junction would activate as a representation of the fact that you have stuff activating in the touch, hearing, and sight areas at the same time.

So, you have simultaneous activity from multiple areas in the brain, and multiple brain regions are active representing multiple sensory input areas.

So, just the auditory cortex visual cortex, as madison's report texts.

09:45

And you know, with whatever's happening in here, you're parietal lobes or temporary or temporal lobes or reciprocals and

So simultaneous, sensory activity, bottom up, driven activity is going to cause a higher level of coincidence patterns: brain activity. And so parts of the brain that are more highly networked are going to become active.
...
"Neurons use various forms of negative feedback to maintain their synaptic strengths within an operationally useful range" https://www.biorxiv.org/content/10.1101/2022.06.18.496642v1
