...
Title: Neurons [Consciousness](consciousness.md) & Anesthesia
...
In b0235y Jaan Aru presents his paper in one of Paul King's talks, I did not speak during this talk but its a good one, it features J. Kevin O'Regan and Anil Seth asking questions about [consciousness](consciousness.md).
...
Jaan Aru (sounds like Yon aroo) from Estonia starts explaining how [anesthesia](gh-b0232y.md) separates basal and [apical](apical-pyramidal-neurons.md) compartments of Layer 5 cells, these cells send information globally in the [thalamo cortical loops](thalamic-cortical-loops.md), disrupting these cells disrupts global brain activity, resulting in unconsciousness

After 12:43 Paul King proposes that the [apical](apical-pyramidal-neurons.md) is the context for interpreting the basal signal
...
Daniel Dennit "fame in the brain" concept is referenced, "information is widely known" supporting [Global Workspace Theory](global-workspace-theory.md).

Contrasting with Paul King: My book aims to show that [consciousness](consciousness.md) is a solved problem, that the pieces of that solution have existed for sometime.

# "A sensorimotor account of vision and visual consciousness"
J. Kevin O’Regan & Alva Noë
https://philpapers.org/rec/OREASA-4

After 106 minute mark: Paul King propsoses consciouness is a circuit with the environment, feedforward pathway combined with the feedback pathway is creating the conscious experience, its similar in concept to the earlier proposal of [reference frames](reference-frames-cortical-knowledge.md) in Jeff Hawkins A Thousand Brains Theory, and King insists that Jaan Aru's paper points to this but Aru claims he wasn't thinking about that.


00:00

That if you apply pathetic. So drugged brings about [anesthesia](gh-b0232y.md), then this has a very specific cellular effect. So the sales we study the [pyramidal neurons](apical-pyramidal-neurons.md), which are the main class of excitatory neurons in the [brain](agentic-brain.md), they have kind of two compartments. One is the classic compartment around the axon that is the basal compartment.

00:31

The other however, is like top of the [cortex](cortex.md), the surface of the cortex is called [apical](apical-pyramidal-neurons.md) compartment. We will maybe clarify these terms a bit later, but the point that he was doing thing was that [anesthesia](gh-b0232y.md) he coupled or basically functionally cut these two compartments of a single neuron and proposed.

00:59

Listening, a compartment is like a section of the [dendritic](dendritic-computation.md) trait. So basically, you could say that the neuron before it extends any output, then it spikes. It has two compartments. It has to integrate between these two compartments, or the information, we will go into that later. But what not to talk about?

01:18

Showing me, that is that [anesthesia](gh-b0232y.md) cut off this [integration](multimodal-integration.md) it. Basically cut off these two parts and if this was so amazing, I mean, to think about that, wow, this there is a similar effect that anesthesia has and that is probably related to [consciousness](consciousness.md). So, although I didn't want to work on consciousness, I had no other way.
...
However, there on the left. Well, you saw the same effect that an aesthetic couple is single neuron, and that was really like a cellular effect of [anesthesia](gh-b0232y.md) that immediately told me that look there is a cellular mechanism of [consciousness](consciousness.md). So so the theory is that the what's causing these anesthesia's to eliminate consciousness is that they decouple the two parts of the neuron.

03:11

And so the signals can't be combined the [apical](apical-pyramidal-neurons.md) on the basement. If you see it like that, then it sounds like really boring theory, right? You know that makes progress is big. Yeah, well you actually do things. So one thing why I was such an struggling and frustrated [consciousness](consciousness.md) over ideas before before working with model darker and matthew was that there is a lot of papers that showed me some kind of global [integration](multimodal-integration.md) in the brains so that it's some people even write in top review papers.

03:53

That what is a consensus is that [consciousness](consciousness.md) relies on distributed processing, along the [thalamocortical](thalamocortical-network.md) so which is like brain part involving the [cortex](cortex.md) and the [thalamus](thalamic-nuclei.md), basically that it is some kind of a global phenomena and many theories go around that way, but that was kind of a boring for me.
...
It can explain that by this local mechanism, because if you cut this processing within the single parameter neurons, then actually you cut it in the whole [network](conscious-neural-networks.md) because these cells, the so-called [layer five parameter cells](pyramidal-cell.md). They are the cells that send the information to [thalamus](thalamic-nuclei.md). They are the cells that send long range information in contact.

05:05

So if you cut these cells, then you will cut all the global dynamics. So we can actually explain why people with FMRI etc had observed. This global signals and why psychedelics or [anesthesia](gh-b0232y.md) or sleep had affected this global dynamics. It's not because [consciousness](consciousness.md) is something global but it's because there is a local mechanism within each cell each parameter cell that is the coupled.
...
You're saying, seems consistent with the idea that contrast has a global phenomenon if ever let's say [global workspace theory](global-workspace-theory.md) or global neuronal workspace, this idea that I think with Daniel then it calls him in the brain that information is sort of wildly known throughout the [cortex](cortex.md) and assured among cortical areas.

06:23

But that to work, the context information from one part of the [brain](agentic-brain.md) is to be available to other parts of the brain. And if that context information is coming in through these typical dendrites, then wouldn't this just be identifying, the [integration](multimodal-integration.md) mechanism for this global phenomenon tech work? Yeah, exactly.

06:40

I mean, I was, I was not saying that though, this global findings about the global signatures of [consciousness](consciousness.md) are crap, right? I mean, I was just saying that there is actually a local mechanism behind it. So we really think that [global neural workspace theory](global-workspace-theory.md) would benefit from actually considering these findings and our proposal.

07:03

Because this could be a mechanism how you integrate information and now talking about the information integration. We actually also think that they [integrated information theory](integrated-information-theory.md) benefit from this. Because here we have a very specific mechanism that can cut the information integration within the Salomon cortical circuits. So our audit proposed is not really conflict with this theories, but we hope that it kind of complements them and keeps a very specific mechanism.

07:38

So that is our point, in fact, these global a phenomena are interesting. They do exist. However, if you won't to understand [consciousness](consciousness.md) then perhaps, we have the [knowledge](reference-frames-cortical-knowledge.md). That each neuron consists of two parts is based on applicable compartments. And the mechanism of controlling, the global dynamics comes from this local switch between these two compartments.

08:09

Sure. Well, if you look at example, the history of genetics, the idea of genes were around for essentially, but then when DNA was found and then finally, we had in this case, I'm like here like some or how the gene body could be happening. So even we have these high level but sometimes too big models for how [consciousness](consciousness.md) might be working, really, and if you identify as specific neural mechanism, it's an important piece of the puzzle.

08:34

So there are, you know, some different views on [consciousness](consciousness.md) out there and anyone who's listening, if you want to raise your hand, and it will take some questions and kind of explore kind of normal mechanisms of consciousness generally. But so one idea out there, of course, is the [information integration theory](integrated-information-theory.md).

08:50

What this mechanism you're proposing was seem to be aligned anyway. Within [information, integration theory](integrated-information-theory.md) as a proposing, one mechanism by which information could be integrated? Would you agree or not? Yeah, that's what I said. Also that the inputs I mean people be happy if people from different theories could be saying that world, this is indeed by exciting mechanism that we could understand specific switch points for that.

09:19

It can explain the global dynamics that can explain how the [global workspace](global-workspace-theory.md) is set up, or that can explain how the information integration happens and these kind of controlled in the [brain](agentic-brain.md), right? So something like that. However I mean probably it's also important to stress. The other aspect of the theory which goes a bit yawned.
...
So [prior knowledge](reference-frames-cortical-knowledge.md) information about the previous things information coming from the model goes today because then right go today pickle compartment whereas the information from the world from the senses from the external goes to the basal compartment. So this is also very important for us to say that. Look, it's not just that you decouple to parts of the neuron.

10:41

You actually decouple the internal front external. You actually decouple context from the sensory you decouple. The model from data that there is this functional thing. That happens that these important and this is central for our theory because now we say that. Look conscious experience is always affected by [prior knowledge](reference-frames-cortical-knowledge.md).

11:14

I can bring some examples later many series. I mean, for example, the [global neural workspace theory](global-workspace-theory.md) or the [integrated information theory](integrated-information-theory.md), they do not explain it naturally. Do not explain simply with the basic principles of why it is like that. Why God just has affected by prior knowledge, the theory of mindset, for example, does that and theories that based on [predictive coding](prediction.md) to that.

11:43

However, here we say that. Look, here's also our idea that also naturally inherently explains this. Why going to his experience is always affected by prior knowledge. This is because this [apical](apical-pyramidal-neurons.md) compartment. The top compartment carries this context. It carries this prior knowledge. Yeah, and I was going to ask about that because obviously why you main idea there in the mechanism [consciousness](consciousness.md) is the idea of the what we're experiencing the perceptual content of consciousness are really those top-down [predictions](prediction.md) or top-down interpretation.

12:26

If you will, on outside world that's being aligned with sensory input. So aligning that with your model, it sounds like you would say the [apical](apical-pyramidal-neurons.md) compartment. The context integrating apartment is the is the carrying that top down signal and the basal compartment is carrying the bottom up signal and the integration at the parameter.
...
Experiment. But you have to attend to steam today, I'm with John Arun. Is joining us from Estonia. Great to have you on our neuroscience [AI](artificial-intelligence.md) and [consciousness](consciousness.md) conversations series, what got my [attention](attention.md) is that you have a paper titled cellular mechanism of consciousness processing, and you propose, a normal mechanism of consciousness that paper was suggested to me by both Lake Richards and Billy George.
...
Now he's already known but I mean back then he was really one of these key people who invented really and showed that nations are important for perception and [brain](agentic-brain.md). So I was really happy to go to to, by PhD department. And what's your view on camera isolations today? I was super fascinated by [camo oscillations](gamma-oscillations.md), but then, then, I mean, I started to study them and I worked with interpreting a single.

16:44

So, signals that are measured from inside the human [brain](agentic-brain.md),

told me a look at come [oscillations](gamma-oscillations.md). And I started to look at cam oscillations, but they saw that way the minute these this look like something else, so they cover large part of the spectrum.
...
I didn't, and they wanted to actually do this way. I studied [neuroscience](neuroscience.md) reading the [artificial intelligence](artificial-intelligence.md), and then I wanted to do more hardcore neuroscience. I went to Berlin to the lab of matriarchal to actually study a kind of neural computational building. I didn't want to study [consciousness](consciousness.md) but then when I was doing there, my first round dog went to postdocs and one post of showed me something amazing and disposed of was the dark asuzuki and he showed me his recent data rich, demonstrated that if you apply an anesthetic.

21:25

So our drug that brings about [anesthesia](gh-b0232y.md). Then this has a very specific similar effect. So the sentence, we study the [pyramid of neurons](apical-pyramidal-neurons.md), which are the main class of excitatory neurons in the [brain](agentic-brain.md). They have kind of to compartments on is the classic compartment around the axon that is the base or compartment the other.

21:54

However, you like top of the [cortex](cortex.md), the surface of the cortex is called a bigger compartment. We will maybe clarify these terms a bit later, but the point that he was showing then was that [anesthesia](gh-b0232y.md), he coupled or basically functionally cut. These two compartments of a single neuro and proposed.
...
Degradation the basically cut off these two parts and if this was super amazing, I mean, to think about that, wow, this there is a similar effect that [anesthesia](gh-b0232y.md) has and that is probably related to [consciousness](consciousness.md). So although I didn't want to work on consciousness, I had no other way.
...
These are I certainly the governorship [anesthesia](gh-b0232y.md) agents. Like propofol will let the interesting thing was that he did the difference once. So it was also githamin and iso flooring, and you're a thing and that was exactly the point. So Paul was saying that mean has a completed different effect on the older level of circuits.

23:58

However, there on the left, we saw the same effect that an aesthetic couple is single neural, but that was really like a cellular effect of [anesthesia](gh-b0232y.md) that immediately told me that look there is a cellular mechanism of a bunch of stress. So so the theory is that the what's causing these anesthesia's to eliminate [consciousness](consciousness.md) is that they decouple the two parts of the neurone.
...
Anything that makes progress as yeah. You actually do things. So one thing why I was actually struggling and frustrated with [consciousness](consciousness.md) over several years before thoughtful, was that there is a lot of papers that showed just some kind of global [integration](multimodal-integration.md) in the [brain](agentic-brain.md). So that it's some people even write in top review papers.

25:15

That what is a consent is? It is that [consciousness](consciousness.md) relies on distribute processing along the [thalamoportical networks](thalamocortical-network.md), which is like brain part, involving the [cortex](cortex.md). And the [thalamus](thalamic-nuclei.md) basically that it is a kind of a global phenomena, many series, go all out that way, but that was kind of a boring for me.
...
Because if you cut this processing within the single private neurons that actually, you cut it in the whole [network](conscious-neural-networks.md) because these cells, the so-called layer five parameter cells. They are the cells that send the information to [thalamus](thalamic-nuclei.md), which they are the cells that send long-range information important, these cells, then you can cut, all the global dynamics.

26:33

So we can actually explain why people in ethereum are in which etc, ahead of serve. This global sequence and why psychedelics, or [anesthesia](gh-b0232y.md), or sleep had affected this group but dynamics because of course, is something global, but it's because there is a local mechanism within each cell each parameter cell that is the coupled.

27:03

For example, by [anesthesia](gh-b0232y.md) probably sleep and the discovery is changed to psychedelics for example and this affects and explains the global dynamics. So that was the first point. Why we thought that this is actually something interesting? Because we can explain data with a local bio physical very specific mechanism.

27:29

But I guess what you're saying seems consistent with the idea that [consciousness](consciousness.md) is a global phenomena but let's say a [global workspace theory](global-workspace-theory.md) or global neural workspace. This idea that I think what Daniel then it calls thing in the brain that information is sort of widely known throughout the [cortex](cortex.md) and assured among cordial areas.

27:46

But that to work, The context information, from one part of the [brain](agentic-brain.md) is to be available to other parts of the brain. And if that context information is coming in through these [apical](apical-pyramidal-neurons.md) dead rights, then wouldn't this just be identifying, the [integration](multimodal-integration.md) mechanism for this global phenomenon to work?

28:01

Yeah, exactly. I mean, I was, I wasn't saying that though, this global finding is about the global signatures of gorgeousness are prep, right? I mean, I was just saying that there is actually a local mechanism behind it. So we think that, [global neural workspace theory](global-workspace-theory.md) would benefit from actually, considering is finding and our proposal.

28:25

Because this could be a mechanism how you integrate information and now talking about the information [integration](multimodal-integration.md). We actually also think that they [integrated information theory](integrated-information-theory.md) benefit from this. Because here we have a very specific mechanism that can cut day information integration within the political circuits. So our proposed is not the brilliant conflict with this theories but we hope that it kind of compliments them and keeps a very specific mechanism.

29:00

So that is our point in fact that these global phenomena are interesting. They do exist. However, if you want to understand [consciousness](consciousness.md) that perhaps we have knowledge that each new run consists of two parts and studies are that we call compartments. And the mechanism of controlling the global dynamics comes from this local switch between these two compartments.

29:31

Sure. Well, I do if you look at, for example, the history of genetics, the idea of genes for around for a century, but then when DNA was found and then finally, we had them, in this case, on molecular makeup, some for how the gene model could be happening. So maybe we have these higher high level, sometimes big models for how [consciousness](consciousness.md) by the working early, if you identify it as specific normal mechanism, it's a, it's an important piece of a puzzle.

29:56

So there are, you know, some different views of [consciousness](consciousness.md) out there. And anyone who's listening, if you want to raise your hand and will take some questions and kind of explore a kind of growing back in the consciousness, generally. But so one idea out there, of course, is the [information integration theory](integrated-information-theory.md).
...
However, it is also important to stress another aspect of the theory beyond the [biophysical](dendritic-computation.md) point. Once we know there is decoupling within [pyramidal neurons](pyramidal-cell.md), we can ask what that decoupling means functionally.

31:20

When we look at the [brain](agentic-brain.md) functionally, a structure appears: top-down context information, including [prior knowledge](reference-frames-cortical-knowledge.md) from the model, goes to the [apical compartment](apical-pyramidal-neurons.md), while information from the world and the senses goes to the basal compartment.

31:54

This is important because [anesthesia](gh-b0232y.md) does not merely decouple two parts of the neuron. It decouples the internal from the external, the context from [sensory processing](sensory-processing.md), and the model from the data.

32:22

That functional split is central to the theory because conscious experience is always affected by [prior knowledge](reference-frames-cortical-knowledge.md). Aru argues that major theories, including [global neural workspace theory](global-workspace-theory.md) and [integrated information theory](integrated-information-theory.md), do not explain this influence as directly.

32:48

Those theories do not naturally explain, from their basic principles, why conscious experience is shaped by prior knowledge. Theories based on [predictive coding](predictive-coding.md) do address that question, and Aru argues that the apical-compartment proposal also explains it naturally.

33:14

Conscious experience is affected by prior knowledge because the [apical compartment](apical-pyramidal-neurons.md) carries context. Paul King then connects this to the idea that the perceptual content of [consciousness](consciousness.md) comes from top-down [predictions](prediction.md), or top-down interpretations of the outside world, that are aligned with [sensory input](sensory-input-array.md).

33:50

In that alignment, the [apical compartment](apical-pyramidal-neurons.md) carries the top-down signal, the basal compartment carries the bottom-up signal, and [integration](multimodal-integration.md) at the [pyramidal cell](pyramidal-cell.md) level combines the two so the top-down signal can provide context for interpreting the bottom-up signal.

34:12

King asks whether that framing sounds right, and Aru agrees before describing an experiment.

34:29

In the task, subjects attend to a [stimulus](sensory-input-array.md) and report how well they perceived it. The experimenters then remove the stimulus completely, but still ask the subjects how well they perceived it.

34:52

Sometimes the subjects still report perceiving the stimulus very well. In setups where people have a strong expectation about a stimulus, they can perceive it even when none is present, and Aru says the major theories of consciousness do not explain this [perceptual](fractal-conscious-perception.md) phenomenon well.

35:21

This [prior knowledge](reference-frames-cortical-knowledge.md) can create something out of nothing. Aru says that this was one reason he was excited to identify the mechanism and include it in the paper: sometimes perception follows what the prior tells us, not what is actually present in the world.

35:50

In stronger versions of that view, the brain mainly sees the prior, while [sensory input](sensory-input-array.md) modulates the model of what is out there. Aru says the proposed [dendritic integration](dendritic-computation.md) mechanism is compatible with that framing because it can describe how the external world is brought into the model.

36:08

In that account, the [prediction](prediction.md) or model is primary, and the external world is incorporated through dendritic integration into conscious experience.

36:29

Paul King then raises another idea: [consciousness](consciousness.md) may be partly facilitated by recurrent [feedback loops](consciousness-as-neurofeedback-loops.md), which Douglas Hofstadter would call [strange loops](strange-loop.md). King also notes that Victor Lamme has discussed top-down and bottom-up pathways, a framing that appears consistent with Aru's proposed mechanism.

36:50

Aru agrees that this is where the pathway becomes important. In one sense the mechanism is a loop, and he says he originally wanted to name the paper around a "loop of consciousness" because the proposed mechanism has that recursive structure.

37:08

He says the paper's figures show these loops because the loop structure is central. The difference from Hofstadter's account is implementation: Hofstadter helped popularize loop-based accounts of mind, but Aru's paper asks which [neural mechanism](neuroscience.md) could implement the loop.

37:30

For Aru, implementation is the point. The paper asks which cell types are involved, where the loops go, whether they project to the [thalamus](thalamus.md), and which inputs reach the [apical compartment](apical-pyramidal-neurons.md). Those inputs could come from the [cortex](cortex.md).

37:52

They could also come from the thalamus, the amygdala, different cortical areas, or the medial temporal lobe. Aru contrasts this with Lamme's emphasis on [recurrent loops](recurrent-self-reference.md) between [visual cortex](visual-cortex.md) and other sensory cortical areas.

38:22

In Lamme's picture, a higher cortical area projects back to a lower cortical area. Aru says the relevant inputs are broader: thalamic and other areas can also carry different kinds of information, and those streams can contribute to conscious experience.
...
Fortunate to be joined by Kevin O'Regan. Who was our guest last week and who has for 20 years been putting forth a [sensory motor](embodied-cognition.md) and tendency a theory of [consciousness](consciousness.md) really focused on how the and, you know, as it happens had built on that theory and to propose a way that neural [predicted coding](predictive-coding.md), could possibly be a computational mechanism and that might conform to this sensor motor introducing model.
...
As you see. Also in [deep neural networks](deep-learning-neural-networks.md) can happen on consciously, and mainly reliance on this processing in superficial [cortical](cortex.md) layers. And according to our bipolar disease is our conscious cognition. And I guess Kevin raises an interesting point about the relationship between [consciousness](consciousness.md) and cognition, one view, I guess could be that cognition, is something that happens underneath consciousness, that just the ability to sort of plan action and execute behavior is a form of cognition and consciousness, some sort of extra sauce layered on top that can happen or not happen.
...
Yeah. I mean, if I go first and I mean, this is also related to the question about the compatibility of coincidence, right? And that there have been now, really kind of important arguments from the learning from Christophe. And also from Anil saying that he's different from cognition, it is different from [intelligence](agentic-general-intelligence.md) and I tend to agree with these views or that we can see them as independent and moreover we can already propose some independent [neural circuits](neural-circuits.md) the two interact and that's fine.
...
I do think there are different things that they find differently. Cognition is all about function mapping of into output computation of some sort or other consciousness is fundamentally about [phenomenology](reductionism-vs-phenomenology.md). And so in the sense it's really a difference of emphasis when you ask questions and and do experiments and this is where, for instance.

01:03:32

Yeah, I've been very cabins work too back from 20 years ago. It's famous paper with other night that the [sensory motor](embodied-cognition.md) considency theory because it really gets out nominology and trying to explain why particular experience to have the phenomenal character that they have. And if you try and understand the mechanisms that that account for that phenomenal character, then you're asking questions that are about [consciousness](consciousness.md) primer about, you know, what can people do with certain input information so on?
...
So we could as evidence notifications we could have systems computers that we could all probably come to concept some consensus that they're implementing some form of cognition. But without any phenomenology one, I think that's one. Part the public discourse on this, where it gets a little bit. I have a few issues with which is this assumption that as [artificial intelligence](artificial-intelligence.md) or artificial cognition, if you like guess increasingly sophisticated, then ask come on and there's artificial.

01:05:01

Consciousness is well it's actually inflammation of [phenomenology](reductionism-vs-phenomenology.md) and intelligence. I wanted to return just for a moment to the topic of the [sensory motor](embodied-cognition.md) view on consciousness and its relationship to the work that you're doing on context [integration](multimodal-integration.md) beyond just because we have the opportunity to have both the Kevin and Neil here, who've thought about the sensory motor a version and ideal who's also tried to connect that to some of the [neuroscience](category-theory-neuroscience.md).
...
- Source file: `b0235ygoogle.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0235ygoogle.md
