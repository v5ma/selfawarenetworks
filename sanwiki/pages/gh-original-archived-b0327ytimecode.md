...
[01:31.960 --> 01:36.680]  evoke some sort of [[artificial-perception|artificial perception]] would be the real way that perception happens so I
...
[11:14.760 --> 11:20.080]  released and you know with us with a spike with an [[action-potential|action potential]] they release you know one or
...
[13:03.000 --> 13:08.120]  article that says it's called [[synaptic-unreliability|synaptic unreliability]] what is it called what's the recipe so if you

[13:08.120 --> 13:15.760]  go to vrma.io and look at look at the the article that's called so under the featured article

[13:15.760 --> 13:26.680]  section like the third article down says [[synaptic-unreliability|synaptic unreliability]] hold on I'm just gonna leave my

[13:26.680 --> 13:37.760]  mic on while I do this yeah go ahead okay third at WebAR digital fashion [[synaptic-unreliability|synaptic unreliability]] so um so
...
[15:39.680 --> 15:46.400]  so in any case the artificial neuron was like saying that the [[action-potential|action potential]] was summed up
...
[18:17.680 --> 18:23.920]  summing everything up in in the in the [[action-potential|action potential]] in a simplified way because because
...
[18:57.840 --> 19:04.960]  going to affect the amount of uh um the pre-snaptic k potassium modifies the [[action-potential|action potential]] amplitude
...
[19:29.120 --> 19:36.320]  what i think you're talking about so um so an [[action-potential|action potential]] is so uh cell is that right
...
[23:28.000 --> 23:32.960]  [[action-potential|action potential]] instead of being just a split one millisecond event you by fucking with the

[23:32.960 --> 23:39.440]  potassium you just made that [[action-potential|action potential]] a two millisecond or three millisecond event i don't
...
[25:22.080 --> 25:29.200]  yeah so the there's there's sort of like so before the [[action-potential|action potential]] let's zoom in to just the

[25:29.200 --> 25:33.520]  very tip of the axon terminal yeah before the [[action-potential|action potential]] it's just sitting there in
...
[30:18.560 --> 30:24.320]  make this event where you have this wide [[action-potential|action potential]] and multi-vesticular release to where
...
[48:39.920 --> 48:46.320]  so uh you only get so okay first i think it's best to clarify that the [[action-potential|action potential]]

[48:47.840 --> 48:53.440]  you know only it starts at the cell body and it goes down the axon uh the in the simplest

[48:53.440 --> 48:58.080]  way to think about it it it sort of doesn't the [[action-potential|action potential]] doesn't go up the dendrites at
...
[49:32.480 --> 49:38.720]  get enough then it like has a burst right like and that burst is the [[action-potential|action potential]] so the

[49:38.720 --> 49:44.160]  [[action-potential|action potential]] is only happening on the opposite side of all the [[dendrite]] leaky hose dendrites um
...
[53:37.840 --> 53:44.560]  the opposite direction too and that causes what's called a back [[action-potential|action potential]] BAP uh it's and

[53:44.560 --> 53:51.600]  back propagating yeah back propagating [[action-potential|action potential]] and uh that that is that is one component
...
[57:09.360 --> 57:17.760]  spike uh well the well first off the back propagating [[action-potential|action potential]] that dendritic spike
...
[01:00:33.520 --> 01:00:39.920]  tim erbin's [[gh-c0004x|intro]] to neurolink thing that 80 000 word thing he you've written that right
...
[01:01:33.680 --> 01:01:38.640]  whole year in uh in [[gh-c0004x|intro]] neuro i could have just like read this article and got the same rough idea

[01:01:40.240 --> 01:01:46.560]  you know um anyways i think this is his i might this might be from my [[gh-c0004x|intro]] textbook
...
[01:05:53.920 --> 01:06:00.400]  cell spikes and sends a back propagating [[action-potential|action potential]] so now that area that got the input
...
[01:06:06.240 --> 01:06:11.040]  maybe it gets that signal from the back propagating [[action-potential|action potential]] and because it still has calcium
...
[01:11:37.840 --> 01:11:45.440]  brought up [[artificial-perception|artificial perception]] before um yeah yeah i was okay so that's something i've been

[01:11:45.440 --> 01:11:55.040]  super interested in okay um so you know in the you you can uh in like the ar vr or in vr world

[01:11:55.600 --> 01:12:03.120]  you can solve all the visual issues for [[artificial-perception|artificial perception]] but then you're missing tactile and
...
[01:14:22.800 --> 01:14:28.800]  on my wrist uh that's sort of like I think a simple like [[artificial-perception|artificial perception]] issue
...
[01:15:03.360 --> 01:15:08.400]  sort of where we're going here the [[artificial-perception|artificial perception]] yeah exactly yeah so if you
...
[01:25:35.680 --> 01:25:42.080]  want [[artificial-perception|artificial perception]] what makes more sense is just find out what the input is before the
...
[01:34:16.400 --> 01:34:22.880]  infantile like i i don't even know what 3js is what where what would be like a good [[gh-c0004x|intro]] uh
...
- Source file: `original archived b0327ytimecode.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/original archived b0327ytimecode.md
