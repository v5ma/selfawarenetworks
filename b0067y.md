...
So I had this idea that, you know, it's sort of like the it's like a splay state, right?
...
The splay state means the oscillations are now on opposite intervals. The area between two oscillations in a splay state is going to be anti-attractive for growth relative to the areas between oscillators in sync.
