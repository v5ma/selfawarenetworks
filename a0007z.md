...
Brainwave Oscillations, it has been argued by Buzsaki (Rhythms of the Brain 2006), and others, help to bind & synchronize brainwave activity into powerbands with the names delta, theta, alpha, beta, gamma, high gamma etc... these oscillating powerbands serve as binding attractors that absorb discordent oscillating states or otherwise exert an effect that is non-synchronous (describing something like a chaotic attractor, or possibly something like a splay state, or a de-resonating attractor that essentially dissipates the resonating oscillations of burst firing events including sharp wave ripples)
