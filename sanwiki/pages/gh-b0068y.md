...
[[gh-b0049y|Summary]] and keypoints:
...
happening here. Since it's a smell, let's see. Hmm. The [[brain-as-sensory-processor|system of the brain]]. So yeah, so the, so the idea here,
...
[[visual-cortex|visual cortex]], right. But the idea is that the signals travel into like V1. It's like you,
that each of the cortices has like a V1, like for [[visual-cortex|visual cortex]], there's an M1 for the [[motor-cortex|motor cortex]]. There's, this is like layer one of the neoportex. And so incoming input patterns go to
like layer one of the neocortex in the visual or the [[auditory-cortex|audio to cortex]] or the olfactory cortex.
...
think of the [[olfactory-neural-pathway|olfactory cortex]] as, or if we think of the, the [[orbital-frontal-cortex|orbital frontal cortex]] as like the V1
...
to area 02. Alright, so let's look at 01, [[orbital-frontal-cortex|orbital, frontal, cortex]], layer one.
...
The [[orbital-frontal-cortex|orbital frontal cortex]]. Yes.
...
Right. So, yeah.
So can we say that the [[olfactory-neural-pathway|olfactory cortex]] is like analogous to the, the, because in between,
...
[[orbital-frontal-cortex|OFC]] receives projections from the primary olfactory, oh, wait a second, OFC receives
...
strange to look, to look, and where, if it's, okay, so from the [[olfactory-neural-pathway|olfactory cortex]], if it
...
to the, like the [[entorhinal-cortex|enterinocortex]] and the enterinocortex is connected to the [[hippocampus]] and the [[amygdala]].
And there's all this traffic between the [[amygdala]] and the [[hippocampus]] and the hippocampus and
the [[entorhinal-cortex|enterinocortex]]. And so some of the information from the nose feeds directly into that. So
...
that's, I think that's part of why it connects to the, the [[entorhinal-cortex|enterinocortex]] and the, the [[hippocampus]]
...
Yeah. I mean, I think every, I think pretty much every [[sensory-processing|sensation]], every, every, every
...
like, if your brain is not is able to process light because there's a [[brain-as-sensory-processor|sensor in between the brain]]
and the light, which is your eyeball. Right. So the eyeball is the sensor that allows your brain
to process light. And then your brain is able to process your [[olfactory-pathway-uniqueness|sense of smell]] because there's a
...
- Source file: `b0068y.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0068y.md
