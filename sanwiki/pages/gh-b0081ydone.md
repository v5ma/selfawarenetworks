...
This actually ties into the discussion of using holography or the reversing refraction of light for [[3-medical-imaging-technologies-2018|medical imaging]], which is what Open Water (A company by Mary Lou Jepsen) is doing.

00:51

Combining [[fnirs-functional-near-infrared-spectroscopy|near infrared spectroscopy]] with ultrasound & holography.

It ties into how could you present a light field to a human being? What is a [[neural-tomographic-lightfield-rendering|light field]], what is a [[receptive-field|receptive field]], what is an [[inceptive-field|inceptive field]]? What is Light Field Labs? What is the concept of a Light Field for Magic Leap [[augmented-reality|AR]] glasses, or a Light field in the context of Tilt 5's Holographic Game System? 

How might the human brain [[brain-as-rendering-engine|render]] a light field that represents the world around that human being?

01:44

Light field technology is being worked on by many companies both in California & around the world.

Light field lab as one example has privately shown people a [[neural-tomographic-lightfield-rendering|Light Field]] Holodeck concept which is basically like a room with panels and each of the panels has basically a spherical pixel. So that the image that's created is different based upon your eye position in your room relative to that pixel.
...
This allows them to basically stack in an entire wall, from floor to ceiling, in every direction with a [[virtual-reality|virtual reality]] without the glasses. Your viewpoint on the 3D light fields changes and is based upon your eye position in the room.
...
Because in essence, what I'm arguing is that your brain is combining all of these [[pattern-neurons|pattern representations]] together to create effectively like a personal holodeck. That's a simulation of your perspective, in your interactions of an organism's perspective, an organism's interactions with their locations and space. 

The reason I will go so far is to say that your perception of reality is like a Holodeck.

06:17

And your brain is like a Holodeck that is [[brain-as-rendering-engine|rendering]] computer graphics. Like the light fields or like virtual reality, or like interactive computer graphics is, is because I have many life experiences that persuade me that this is the right conclusion.
...
These are some of the things that inspire me the most, and so when I think of basically the analogy is that the human brain basically is a kind of Holodeck that reacts. It [[virtual-models-consciousness|models reality]], a version of reality, and then it reacts to it. We know what we're seeing is a graphical interpretation of reality, and not like some objective real reality, because there are facts that are missing from this reality, such as the fact that the eye is covered in blood vessels.
...
Point based lightfields are different from meshes because a mesh: imagine a [[point-cloud-neural-representation|3D mesh or 3D point model]], basically starts with points, but then there are triangles drawn between the points and surfaces added to the triangles.
...
The image can appear from far away but it's like looking at one of those dot paintings. When you're up close, it's a bunch of dots. And when you're far away seeing an image is possible.
...
The learned patterns that are acquired through the action and perception cycle and these learned patterns acquired through the action and perception cycle eventually take on a [[virtual-models-consciousness|simulation of the universe]] from the human beings perspective.
...
The human body, as a body of oscillators, is a [[dissipative-system|dissipative system]] of oscillating dissipative systems.

Every cell is a dissipative oscillator, a [[dissipative-systems|dissipative system]] that is oscillating.

Every person is a [[consciousness-as-dissipative-self-organizing-system|dissipative system]] that's oscillating.
...
To a great extent what makes each neuron different from any other neuron is its connections. Its synaptic connections determine the neuron's [[receptive-field|receptive field]] (the [[dendrite]]) and its [[inceptive-field|inceptive field]] (the branches of the exit terminal). 

When that neuron fires, it means that its perspective has been activated at that path. It’s activating it’s inceptive field (it’s Exit Terminal Connections).
...
But a Holodeck that's accomplished with sparsely coded & broadly [[distributed-phase-representations|distributed representations]]. It's like the neurons need only to sort of reflect a tiny piece of a pattern to combine many tiny pieces of patterns for each interval of time and each area of your [[receptive-field|receptive field]] to produce the functional equivalent of a Holodeck in your mind.

39:31

This can explain how [[dreams-as-theta-wave-sequences|dreams]] can be so visual and so vivid, even though you may not be getting any sensory input.
...
That is going to provide a strong & wide amplitude pattern perhaps that will oscillate for a long time. That might lower the noise on the brains [[brain-as-sensory-processor|visual patterns]], and the brains audio patterns, and all the worrying thoughts
...
That would be the alternative situation, when you're moving through space really fast you're forcing your [[grid-cells|grid cells]] to update faster than your [[place-cells|place cells]]? Which might be a little bit confusing to your brain. (Shrugs)
...
This is why Sentient & [[gh-a0206z|Self]] Aware Neural Networks will make everyone rich, because we can scale up the production of services, products, technologies, and research.

## Source Provenance

### Original source lineage

- Source-stated recording date: November 1, 2021.
- Source file: `b0081ydone.md` in github.com/v5ma/selfawarenetworks
- Commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/b0081ydone.md
