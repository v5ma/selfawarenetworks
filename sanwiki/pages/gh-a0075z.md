...
(synap, retinal, graph, hippocampus, perceptron, oscillat, field, [dendrite](./dendrite.md), dopamine, cortex)
...
Experience-dependent structural plasticity targets dynamic filopodia in regulating [dendrite](./dendrite.md) maturation and synaptogenesis
...
[Spectral graph theory of brain oscillations](./spectral-graph-theory-brain-oscillations.md) – revisited and improved
...
[Spectral graph theory of brain oscillations](./spectral-graph-theory-brain-oscillations.md)
...
Mechanical surface waves accompany [action potential](./action-potential.md) propagation
...
Equilibrium Propagation: Bridging the Gap Between Energy-Based Models and [backpropagation](./backpropagation.md)
...
Reinforcement Learning Recruits Somata and [Apical Dendrites](./apical-dendrites.md) across Layers of Primary Sensory Cortex.
...
- Original source file: `a0075z ctpr.txt`
- First public GitHub upload: `7d1431213cd4ac9788848a5396ec2992ece11cfd` on 8 Jun 2022, with subject `Add files via upload`.
- Rename event: `25f7a6252b62127548386d2544715ad96825aa46` on 10 Jun 2022 renamed `a0075z ctpr.txt` to `a0075z.md`.
- Later source edits recorded for `a0075z.md`: `6ada31d7eca84f8c4666440cb4c9cb5638f27963` on 21 Aug 2022 and `eb1d1f20f84748e4643b81cc59312ad215e3d1b2` on 30 Aug 2022.
- Current source repository commit checked for this lineage: `d1c26a6fbf273695185a4036411215f53209eb71`.
- Current source blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0075z.md

### Wiki Import and Maintenance Metadata

- Imported into the wiki on 24 Apr 2026 by Lane F bulk file-driven import.
- Source lineage rechecked from local Git history on 25 May 2026.
