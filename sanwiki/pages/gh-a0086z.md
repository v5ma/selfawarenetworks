...
yes because I was thinking of [[swarm-agi|swarm AGI]], or an external [[artificial-general-intelligence|artificial general intelligence]]
...
both neurofeedback, and [[brainwave-entrainment|brainwave entrainment]] drive connections in the mind, and what I do drives connections to brainwaves, which drive the eeg feedback (sounds) and the [[brainwave-entrainment|brainwave entrainment]] (light and sound)
...
- Original source file: `a0086z ctpr.txt` in github.com/v5ma/selfawarenetworks
- First public GitHub upload: 2022-06-08 18:30:49 -0700, commit `7d1431213cd4ac9788848a5396ec2992ece11cfd` (`Add files via upload`)
- Source rename: `a0086z ctpr.txt` to `a0086z.md` on 2022-06-10 16:11:04 -0700, commit `7bb2387b0e9a8a9d218e8d98155bfd68d4bfe679` (`Update and rename a0086z ctpr.txt to a0086z.md`)
- Current source file: `a0086z.md` at commit `d1c26a6fbf273695185a4036411215f53209eb71`
- Current blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0086z.md
