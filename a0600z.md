A0600z Artificial Internal Representation & Conscious Self-Control
...
3. The extensive branching of the soma & dendrite on the pyramidal cell provides for a neuron that can hold extremely sensitive & complex engrams, such that any part of it’s large complex structure can predict the incoming direction from whence a new memory can arrive from.
