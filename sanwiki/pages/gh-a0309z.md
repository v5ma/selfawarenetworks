...
High Phasic bursts, aka Sharp wave ripples trigger collective synchronous events. (Their decay rate or [[action-potential-duration|action potential duration]] sets the timing of the neural array defined by it's exit terminal that is inhibited after the Sharp wave ripple.)
...
# Dr. Itzik Norman on Hippocampal Sharp-Wave Ripples and Episodic Memory
...
# "Preconfigured Dynamics in Our Brains by György Buzsáki, M.D., Ph.D." AUTOLNK_MASK_7
...
- Original source file: `a0309z.md` in `github.com/v5ma/selfawarenetworks`
- Original source commit SHA: `d1c26a6fbf273695185a4036411215f53209eb71`
- Original source blob permalink: https://github.com/v5ma/selfawarenetworks/blob/d1c26a6fbf273695185a4036411215f53209eb71/a0309z.md

### Wiki Import And Maintenance Metadata

- Wiki import date: 24 Apr 2026
- Wiki import lane: Lane F bulk file-driven import (`F.bulk-import`)
